...
<script>	
	...
	function details(id,sopecid){
		...
		if(is_iPad()){
			showPopWin("detailEyesCheckN.action?hid="+id+"&sopecid="+sopecid,970,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}else{
			showPopWin("detailEyesCheckN.action?hid="+id+"&sopecid="+sopecid,screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}
		document.getElementById('popupTitle').innerHTML="【眼部健康检查详细】";
	}
	function search(){
		$("img").removeAttr("onclick");
		mydriasisForm.action = "selEyesCheckN.action";
              ...
              <TR><!--?Start-->
                  ...
                  <TABLE height=22 cellSpacing=0 cellPadding=0 border=0>
					...
					<TD class=tab id=tabLabel__1 
                      onclick="JavaScript:window.location.href='initEyesCheckInsertN.action'" 
