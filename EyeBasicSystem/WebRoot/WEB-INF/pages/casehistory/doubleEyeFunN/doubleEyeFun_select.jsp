...
function chageOne(){
	...
	function specialCheck(){
		...
		$("img").removeAttr("onclick");
		doubleEyeFunForm.action="selectSpecialCheckN.action?dontshow="+dontshow;
		doubleEyeFunForm.submit();
	}
	...
	function refractive(){
		var dontshow = $('#dontshow').val();
		$("img").removeAttr("onclick");
		doubleEyeFunForm.action="initRefractiveSelectN.action?dontshow="+dontshow;
		doubleEyeFunForm.submit();
	}
	...
	function inspection(){
		var dontshow = $('#dontshow').val();
		$("img").removeAttr("onclick");
		doubleEyeFunForm.action="initInspectionSelectN.action?dontshow="+dontshow;
		doubleEyeFunForm.submit();
	}
	
	function glassHistory(){
		doubleEyeFunForm.action="selectGlassesHistoryN.action?viewDetail=true";
		$("img").removeAttr("onclick");
		doubleEyeFunForm.submit();
	}
	...
	function cornealContactlLens(){
		var dontshow = $('#dontshow').val();
		$("img").removeAttr("onclick");
		doubleEyeFunForm.action="initCornealContactlLensSelectN.action?dontshow="+dontshow;
		doubleEyeFunForm.submit();
	}
	
	function contactGlass(){
		var dontshow = $('#dontshow').val();
		doubleEyeFunForm.action="initContactGlassSelectN.action?dontshow="+dontshow;
		$("img").removeAttr("onclick");
		doubleEyeFunForm.submit();
	}
	...
	function fixingInterface(){
		$("img").removeAttr("onclick");
		doubleEyeFunForm.action="selectFixingInterfaceN.action";
		doubleEyeFunForm.submit();
	}
                  ...
                  border=0 align=center cellpadding=1 cellspacing=1 class="privateTable privateBorder">
                                  <tbody>
                                    <tr>
                                      ...
                                      <td width="11%" class="table_none"><div align="left">
                                          ${doubleEyeFunPo.sopdesumdot }&nbsp;<font color="red">*</font>
                                      </div></td>
                                  ...
                                  <TBODY>
                                    <TR>
                                      ...
                                      <TD width="14%" class="table_none"><div align="center">
                                        ${doubleEyeFunPo.sopdefarhetelevel }&nbsp;<font color="red">*</font>
                                      </div></TD>
                                      <TD width="13%" class="table_none"><div align="center">
                                          <c:forEach var="optionParamPoTmp" items="${optionParamPolist}" >
		                                      <c:if test="${optionParamPoTmp.fopparentid=='32'}">
                                      ...
                                      <TD width="8%" class="table_none"><div align="right">水平</div></TD>
                                      <TD class="table_none"><div align="center">
                                          ${doubleEyeFunPo.sopdeclosehetelevel }&nbsp;<font color="red">*</font>
                                      </div></TD>
                                      <TD width="13%" class="table_none"><div align="center">
                                          <c:forEach var="optionParamPoTmp" items="${optionParamPolist}" >
		                                      <c:if test="${optionParamPoTmp.fopparentid=='32'}">
