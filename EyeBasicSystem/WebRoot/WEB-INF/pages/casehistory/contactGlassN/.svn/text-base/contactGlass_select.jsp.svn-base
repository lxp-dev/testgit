...
// 翻方子
	...
	*/
	...
	function refractive(){
		...
		contactGlassForm.action="initRefractiveSelectN.action?dontshow="+dontshow;
		contactGlassForm.submit();
	}
	function inspection(){
		$("img").removeAttr("onclick");
		var dontshow = $('#dontshow').val();
		contactGlassForm.action="initInspectionSelectN.action?dontshow="+dontshow;
		contactGlassForm.submit();
	}
	function specialCheck(){
		$("img").removeAttr("onclick");
		var dontshow = $('#dontshow').val();
		contactGlassForm.action="selectSpecialCheckN.action?dontshow="+dontshow;
		contactGlassForm.submit();
	}
	...
	function doubleEyeFun(){
		$("img").removeAttr("onclick");
		var dontshow = $('#dontshow').val();
		contactGlassForm.action="selectDoubleEyeFunN.action?dontshow="+dontshow;
		contactGlassForm.submit();
	}
	
	function glassHistory(){
		contactGlassForm.action="selectGlassesHistoryN.action?viewDetail=true";
		$("img").removeAttr("onclick");
		contactGlassForm.submit();
	}
  ...
  {   
	...
	function checkCylZero(){
  	...
  	function cornealContactlLens(){
  		var dontshow = $('#dontshow').val();
		$("img").removeAttr("onclick");
		contactGlassForm.action="initCornealContactlLensSelectN.action?dontshow="+dontshow;
		contactGlassForm.submit();
	}

	function fixingInterface(){
		$("img").removeAttr("onclick");
		contactGlassForm.action="selectFixingInterfaceN.action";
		contactGlassForm.submit();
	}
