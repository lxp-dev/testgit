...
// 翻方子
	...
	*/
	...
	function save(){
		...
		contactGlassForm.action="contactGlassInsertN.action?ruleFlag=0&nw='N'";
	...
	function doubleEyeFun(){
		contactGlassForm.action="doubleEyeFunToolN.action?source=doubleeyefuniou";
	...
	function specialCheck() {
		contactGlassForm.action="specialCheckToolN.action?source=specialcheckiou";
		$("img").removeAttr("onclick");
		contactGlassForm.submit();
	}
	...
	function refractive(){
		contactGlassForm.action="refractiveToolN.action?source=refractiveiou";
		$("img").removeAttr("onclick");
		contactGlassForm.submit();
	}
	function inspection(){		
		$("img").removeAttr("onclick");
		contactGlassForm.action="inspectionToolN.action?source=inspectioniou";
		contactGlassForm.submit();
	}
	...
	function glassHistory(){
		...
		contactGlassForm.action="selectGlassesHistoryN.action?customerID="+'${customerInfoPo.smecicustomerid }';
		contactGlassForm.submit();
	}
  ...
  {   
	...
	function checkCylZero(){
  	...
  	function cornealContactlLens(){
		$("img").removeAttr("onclick");
		contactGlassForm.action="cornealContactlLensToolN.action?source=cornealContactlLensu";
		contactGlassForm.submit();
	}

	function fixingInterface(){
		$("img").removeAttr("onclick");
		contactGlassForm.action="fixingInterfaceToolN.action";
		contactGlassForm.submit();
	}
</script>
