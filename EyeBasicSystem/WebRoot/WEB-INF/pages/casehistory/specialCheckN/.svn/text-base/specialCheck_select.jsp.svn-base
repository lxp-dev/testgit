...
window.onload=addfunction;
	...
	function inspection(){
		...
		specialCheckForm.action="initInspectionSelectN.action?dontshow="+dontshow;
		specialCheckForm.submit();
	}
	function doubleEyeFun(){
		var dontshow = $('#dontshow').val();
		$("img").removeAttr("onclick");
		specialCheckForm.action="selectDoubleEyeFunN.action?dontshow="+dontshow;
		specialCheckForm.submit();
	}
	function refractive(){
		var dontshow = $('#dontshow').val();
		$("img").removeAttr("onclick");
		specialCheckForm.action="initRefractiveSelectN.action?dontshow="+dontshow;
		specialCheckForm.submit();
	}
	
	function glassHistory(){
		specialCheckForm.action="selectGlassesHistoryN.action?viewDetail=true";
		$("img").removeAttr("onclick");
		specialCheckForm.submit();
	}
	...
	function cornealContactlLens(){
		var dontshow = $('#dontshow').val();
		$("img").removeAttr("onclick");
		specialCheckForm.action="initCornealContactlLensSelectN.action?dontshow="+dontshow;
		specialCheckForm.submit();
	}
	
	function contactGlass(){
		var dontshow = $('#dontshow').val();
		specialCheckForm.action="initContactGlassSelectN.action?dontshow="+dontshow;
		$("img").removeAttr("onclick");
		specialCheckForm.submit();
	}
	...
	function fixingInterface(){
		$("img").removeAttr("onclick");
		specialForm.action="selectFixingInterfaceN.action";
		specialForm.submit();
	}
</script>
</HEAD>
