...
// 翻方子
	...
	*/
	...
	function inspectionCopy(){
		location.href="inspectionCopyN.action?chuyanfuyan="+'${chuyanfuyan}'+"&oldOptometryID="+'${oldOptometryID}'+"&customerID="+'${customerID }'+"&optometryBasicID="+'${copyBasicOptometryID}'+"&moduleID="+'${moduleID}'+"&optometryID="+'${optometryID}';
		selectHidden();
	}
	var f1;
	...
	function save(){
		...
		if($('[name*=.sopipballglassod]').length!=0){
			if(isSubmit == 0){
				...
				inspectionForm.action="inspectionInsertN.action?ruleFlag=0&nw='N'";
	...
	function doubleEyeFun(){
		inspectionForm.action="doubleEyeFunToolN.action?source=doubleeyefuniou";
		$("img").removeAttr("onclick");
		inspectionForm.submit();
	}
	
	function contactGlass(){
		inspectionForm.action="contactGlassToolN.action?source=contactGlassiou";
		$("img").removeAttr("onclick");
		inspectionForm.submit();
	}
	...
	function specialCheck() {
		inspectionForm.action="specialCheckToolN.action?source=specialcheckiou";
		$("img").removeAttr("onclick");
		inspectionForm.submit();
	}
	...
	function refractive(){
		inspectionForm.action="refractiveToolN.action?source=refractiveiou";
		$("img").removeAttr("onclick");
		inspectionForm.submit();
	}
...
+"</td></tr>";  
	  ...
	  if(myValue == "6"){
		  c1.innerHTML="<tr id="+rowadd+"tr><td><input type='hidden' name='inspectionPos["+Subtr(1,listindex)+"].sopipglasstype' value='6'/>"
		  								...
		  								+"<input needChange='needChange' sph='sph' id='sopipballglassod' name='inspectionPos["+Subtr(1,listindex)+"].sopipballglassod' value='${refractivePo.soprdbalballglassod}' class='text_input' size='2' onKeyPress='EnterDown(this)' enter='enter1'></div></TD>"
		  								+"<TD bgcolor='#F8E0F0' class='PrivateBorderPink'><div align='center'>"
		  								+"<input needChange='needChange' cyl='cyl' id='sopippostglassod' name='inspectionPos["+Subtr(1,listindex)+"].sopippostglassod' value='${refractivePo.soprdbalpostglassod}' class='text_input' size='2' onKeyPress='EnterDown(this)' enter='enter2'></div></TD>"
		  								+"<TD bgcolor='#F8E0F0' class='PrivateBorderPink'><div align='center'>"
		  								+"<input axes='axes' name='inspectionPos["+Subtr(1,listindex)+"].sopipaxesod' value='${refractivePo.soprdbalaxesod}' class='text_input' size='2' onKeyPress='EnterDown(this)' enter='enter6'></div></TD>"
		  								...
		  								+"<input needChange='needChange' sph='sph' id='sopipballglassos' name='inspectionPos["+Subtr(1,listindex)+"].sopipballglassos' value='${refractivePo.soprdbalballglassos}' class='text_input' size='2' onKeyPress='EnterDown(this)' enter='enter8'></div></TD>"
		  								+"<TD bgcolor='#F8E0F0' class='PrivateBorderPink'><div align='center'>"
		  								+"<input needChange='needChange' cyl='cyl' id='sopippostglassos' name='inspectionPos["+Subtr(1,listindex)+"].sopippostglassos' value='${refractivePo.soprdbalpostglassos}' class='text_input' size='2' onKeyPress='EnterDown(this)' enter='enter9'></div></TD>"
		  								+"<TD bgcolor='#F8E0F0' class='PrivateBorderPink'><div align='center'>"
		  								+"<input axes='axes' name='inspectionPos["+Subtr(1,listindex)+"].sopipaxesos' value='${refractivePo.soprdbalaxesos}' class='text_input' size='2' onKeyPress='EnterDown(this)' enter='enter10'></div></TD>"
		  								+"<TD bgcolor='#F8E0F0' class='PrivateBorderPink'><div align='center'>"
	  ...
	  if(myValue == "7"){
		  c1.innerHTML="<tr id="+rowadd+"tr><td><input type='hidden' name='inspectionPos["+Subtr(1,listindex)+"].sopipglasstype' value='7'/>"
		  								...
		  								+"<input needChange='needChange' yyorder='1' sph='sph' name='inspectionPos["+Subtr(1,listindex)+"].sopipballglassod' value='${refractivePo.soprdbalballglassod}' class='text_input' size='4'></div></TD>"
		  								+"<TD width='8%' bgcolor='#DFFFDF' class='PrivateBorderGreen'><div align='center'>"
		  								+"<input  needChange='needChange' yyorder='2' cyl='cyl' name='inspectionPos["+Subtr(1,listindex)+"].sopippostglassod' value='${refractivePo.soprdbalpostglassod}' class='text_input cyl' size='4'></div></TD>"
		  								+"<TD width='8%' bgcolor='#DFFFDF' class='PrivateBorderGreen'><div align='center'>"
		  								+"<input axes='axes' yyorder='3' name='inspectionPos["+Subtr(1,listindex)+"].sopipaxesod' value='${refractivePo.soprdbalaxesod}' class='text_input axes' size='4'></div></TD>"
		  								+"<TD width='8%' bgcolor='#DFFFDF' class='PrivateBorderGreen'><div align='center'>"                         
                                        ...
                                        +"<c:forEach var='optionParamPoTmp' items='${optionParamPolist}' >"
                                         ...
                                         +"</c:forEach>"		  								
		  								...
		  								+"<TD width='8%' bgcolor='#DFFFDF' class='PrivateBorderGreen'><div align='center'>"
		  								+"<input tongju='tongju' name='inspectionPos["+Subtr(1,listindex)+"].sopipinterdistanceod' value='${refractivePo.soprdbalinterdistanceod }' class='text_input' size='4'></div></TD>"
		  								+"<TD width='8%' bgcolor='#DFFFDF' class='PrivateBorderGreen'><div align='center'>"
		  								...
		  								+"<input needChange='needChange' yyorder='8' sph='sph' name='inspectionPos["+Subtr(1,listindex)+"].sopipballglassos' value='${refractivePo.soprdbalballglassos}' class='text_input' size='4'></div></TD>"
		  								+"<TD bgcolor='#DFFFDF' class='PrivateBorderGreen'><div align='center'>"
		  								+"<input needChange='needChange' yyorder='9' cyl='cyl' name='inspectionPos["+Subtr(1,listindex)+"].sopippostglassos' value='${refractivePo.soprdbalpostglassos}' class='text_input' size='4'></div></TD>"
		  								+"<TD bgcolor='#DFFFDF' class='PrivateBorderGreen'><div align='center'>"
		  								+"<input axes='axes' yyorder='10' name='inspectionPos["+Subtr(1,listindex)+"].sopipaxesos' value='${refractivePo.soprdbalaxesos}' class='text_input' size='4'></div></TD>"
		  								+"<TD bgcolor='#DFFFDF' class='PrivateBorderGreen'><div align='center'>"
                                        ...
                                        +"<c:forEach var='optionParamPoTmp' items='${optionParamPolist}' >"
                                         ...
                                         +"</c:forEach>"		  								
		  								...
		  								+"<TD bgcolor='#DFFFDF' class='PrivateBorderGreen'><div align='center'>"
		  								+"<input tongju='tongju' name='inspectionPos["+Subtr(1,listindex)+"].sopipinterdistanceos' value='${refractivePo.soprdbalinterdistanceos }' class='text_input' size='4'></div></TD>"
		  								+"<TD bgcolor='#DFFFDF' class='PrivateBorderGreen'><div align='center'>"
	...
	function checkCylZero(){
  	...
  	function cornealContactlLens(){
		$("img").removeAttr("onclick");
		inspectionForm.action="cornealContactlLensToolN.action?source=cornealContactlLensu";
		inspectionForm.submit();
	}
	...
	function fixingInterface(){
		$("img").removeAttr("onclick");
		inspectionForm.action="fixingInterfaceToolN.action";
		inspectionForm.submit();
	}
								  ...
								  <tr>
                                    ...
                                    <c:forEach var="optionParamPoTmp" items="${optionParamPolist}" >
                                      <c:if test="${optionParamPoTmp.fopparentid=='48'}">
                                      	<input name="inspectionPo.sopipglasstypes" type="checkbox" value="${optionParamPoTmp.fopparamid }">${optionParamPoTmp.fopparamname}
                                      </c:if>	                                      	
                                   	</c:forEach>									
									</td>
								  </tr>
								  <tr>
                                    ...
                                    <c:forEach var="optionParamPoTmp" items="${optionParamPolist}" >
                                      <c:if test="${optionParamPoTmp.fopparentid=='49'}">
                                      	<input name="inspectionPo.sopiptouchglass" type="checkbox" value="${optionParamPoTmp.fopparamid }">${optionParamPoTmp.fopparamname}
                                      </c:if>	                                      	
                                   	</c:forEach>									 	
									</td>
								  </tr>
                                    ...
                                    <c:forEach var="optionParamPoTmp" items="${optionParamPolist}" >
                                      <c:if test="${optionParamPoTmp.fopparentid=='50'}">
                                      	<input name="inspectionPo.sopiptraintypes" type="checkbox" value="${optionParamPoTmp.fopparamid }">${optionParamPoTmp.fopparamname}
                                      </c:if>	                                      	
                                   	</c:forEach> 										
									</td>
								  </tr>
										...
										<table width="99%" border=0 align=center cellpadding=1	cellspacing=1 class="privateTable privateBorder">
											<tbody>
												<tr bgcolor="#CADEE8" height="26px">
													...
													<div align="center">医嘱</div>
													</TD>
													<TD><textarea  id="sopipdoctorsay" name="inspectionPo.sopipdoctorsay" validate="[{'Type' : Type.String, 'Formula' : '', 'Expansion' : {Type : Expansion.LessThanLengthORNULL, Params : [101]}, 'Message' : '医嘱不能大于100字！'}]" style="width:100%" cols="80" rows="7">${fn:trim(inspectionPo.sopipdoctorsay) }</textarea></TD>
												</tr>
											</tbody>
										</table>
									</fieldset>										
