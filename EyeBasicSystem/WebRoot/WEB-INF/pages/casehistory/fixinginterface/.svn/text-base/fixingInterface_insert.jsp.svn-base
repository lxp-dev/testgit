...
<html>
	...
	function save(){
		if(checkForm(refractiveForm)){
			...
			refractiveForm.action="insertFixingInterfaceN.action?source=refractiveiou";
	...
	function refractive(){
		$("img").removeAttr("onclick");
		refractiveForm.action="refractiveToolN.action?source=refractiveiou";
		refractiveForm.submit();
	}
	...
	function refractiveCopy(){
		$("img").removeAttr("onclick");
		location.href="refractiveCopyN.action?chuyanfuyan="+'${chuyanfuyan}'+"&oldOptometryID="+'${oldOptometryID}'+"&customerID="+'${customerID }'+"&optometryBasicID="+'${copyBasicOptometryID}'+"&moduleID="+'${moduleID}'+"&optometryID="+'${optometryID}';
	}
