...
<script type="text/javascript">
	function save(){
		if(checkForm(document.all.glassesHistoryForm)){    
			...
			glassesHistoryForm.action = "updateGlassesHistoryN.action";
	...
	function optometry(){
		glassesHistoryForm.action="initOptometryBasicSelN.action";
		glassesHistoryForm.submit();
	}
	...
	function refractive(){
		if('${optometryPo.sopoyflag}' != '1'){
			$("img").removeAttr("onclick");
			glassesHistoryForm.action="refractiveToolN.action?source=refractiveiou";
			glassesHistoryForm.submit();
		}else{
			var dontshow = $('#dontshow').val();
			$("img").removeAttr("onclick");
			glassesHistoryForm.action="initRefractiveSelectN.action?dontshow="+dontshow;
			glassesHistoryForm.submit();
		}
	}
	function inspection(){
	/*
		...
		*/
		...
		if('${optometryPo.sopoyflag}' != '1'){
			$("img").removeAttr("onclick");
			glassesHistoryForm.action="inspectionToolN.action?source=inspectioniou";
			glassesHistoryForm.submit();
		}else{
			$("img").removeAttr("onclick");
			var dontshow = $('#dontshow').val();
			glassesHistoryForm.action="initInspectionSelectN.action?dontshow="+dontshow;
			glassesHistoryForm.submit();
		}
	}
	function specialCheck(){
		if('${optometryPo.sopoyflag}' != '1'){
			$("img").removeAttr("onclick");
			glassesHistoryForm.action="specialCheckToolN.action?source=specialcheckiou";
			glassesHistoryForm.submit();
		}else{
			$("img").removeAttr("onclick");
			var dontshow = $('#dontshow').val();
			glassesHistoryForm.action="selectSpecialCheckN.action?dontshow="+dontshow;
			glassesHistoryForm.submit();
		}
	}
	...
	function doubleEyeFun(){
		if('${optometryPo.sopoyflag}' != '1'){
			$("img").removeAttr("onclick");
			glassesHistoryForm.action="doubleEyeFunToolN.action?source=doubleeyefuncopy";
			glassesHistoryForm.submit();
		}else{
			$("img").removeAttr("onclick");
			var dontshow = $('#dontshow').val();
			glassesHistoryForm.action="selectDoubleEyeFunN.action?dontshow="+dontshow;
			glassesHistoryForm.submit();
		}
	}
	...
	function cornealContactlLens(){
		if('${optometryPo.sopoyflag}' != '1'){
			$("img").removeAttr("onclick");
			glassesHistoryForm.action="cornealContactlLensToolN.action?source=cornealContactlLensu";
			glassesHistoryForm.submit();	
		}else{
			var dontshow = $('#dontshow').val();
			$("img").removeAttr("onclick");
			glassesHistoryForm.action="initCornealContactlLensSelectN.action?dontshow="+dontshow;
			glassesHistoryForm.submit();
		}
	}
	...
	function contactGlass(){
		if('${optometryPo.sopoyflag}' != '1'){
			glassesHistoryForm.action="contactGlassToolN.action?source=contactGlassiou";
			$("img").removeAttr("onclick");
			glassesHistoryForm.submit();
		}else{
			var dontshow = $('#dontshow').val();
			glassesHistoryForm.action="initContactGlassSelectN.action?dontshow="+dontshow;
			$("img").removeAttr("onclick");
			glassesHistoryForm.submit();
		}
	...
	function fixingInterface(){
		if('${optometryPo.sopoyflag}' != '1'){
			glassesHistoryForm.action="fixingInterfaceToolN.action";
			$("img").removeAttr("onclick");
			glassesHistoryForm.submit();
		}else{
			var dontshow = $('#dontshow').val();
			glassesHistoryForm.action="selectFixingInterfaceN.action?dontshow="+dontshow;
			$("img").removeAttr("onclick");
			glassesHistoryForm.submit();
		}
	}
