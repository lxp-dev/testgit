...
window.onload=addfunction;
	...
	function inspection(){
		...
		specialCheckForm.action="initInspectionSelectBjtr.action?dontshow="+dontshow;
		specialCheckForm.submit();
	}
	function doubleEyeFun(){
		var dontshow = $('#dontshow').val();
		$("img").removeAttr("onclick");
		specialCheckForm.action="selectDoubleEyeFunBjtr.action?dontshow="+dontshow;
		specialCheckForm.submit();
	}
	function refractive(){
		var dontshow = $('#dontshow').val();
		$("img").removeAttr("onclick");
		specialCheckForm.action="initRefractiveSelectBjtr.action?dontshow="+dontshow;
		specialCheckForm.submit();
	}
	
	function glassHistory(){
		specialCheckForm.action="selectGlassesHistoryBjtr.action?viewDetail=true";
		$("img").removeAttr("onclick");
		specialCheckForm.submit();
	}
	...
	function cornealContactlLens(){
		var dontshow = $('#dontshow').val();
		$("img").removeAttr("onclick");
		specialCheckForm.action="initCornealContactlLensSelectBjtr.action?dontshow="+dontshow;
		specialCheckForm.submit();
	}
	
	function contactGlass(){
		var dontshow = $('#dontshow').val();
		specialCheckForm.action="initContactGlassSelectBjtr.action?dontshow="+dontshow;
		$("img").removeAttr("onclick");
		specialCheckForm.submit();
	}
</script>
