...
-->
	...
	function save(){
		if(checkForm(document.all.specialForm)){    
			...
			specialForm.action = "updateSpecialCheckBjtr.action";
			if('${copy}'=='copy'){
				specialForm.action = "insertSpecialCheckBjtr.action";
			}
	...
	function refractive(){
		$("img").removeAttr("onclick");
		specialCheckForm.action="refractiveToolBjtr.action?source=refractiveiou";
		specialCheckForm.submit();
	}
	function inspection(){
		/*
		...
		*/
		$("img").removeAttr("onclick");
		specialCheckForm.action="inspectionToolBjtr.action?source=inspectioniou";
		specialCheckForm.submit();
	}
	
	function doubleEyeFun(){
		$("img").removeAttr("onclick");	
		specialCheckForm.action="doubleEyeFunToolBjtr.action?source=doubleeyefuniou";
		specialCheckForm.submit();
	}
	...
	function glassHistory(){
		...
		specialCheckForm.action="selectGlassesHistoryBjtr.action?customerID="+'${customerInfoPo.smecicustomerid }';
		specialCheckForm.submit();
	}
	...
	function contactGlass(){
		specialCheckForm.action="contactGlassToolBjtr.action?source=contactGlassiou";
		$("img").removeAttr("onclick");
		specialCheckForm.submit();
	}
	...
	function cornealContactlLens(){
		$("img").removeAttr("onclick");
		specialCheckForm.action="cornealContactlLensToolBjtr.action?source=cornealContactlLensu";
		specialCheckForm.submit();
	}
</script>
</HEAD>
