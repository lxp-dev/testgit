...
<html>
	...
	function doubleEyeFun(){
		$("img").removeAttr("onclick");
		refractiveForm.action="doubleEyeFunToolBjtr.action?source=doubleeyefuniou";
		refractiveForm.submit();
	}
	function specialCheck(){
		$("img").removeAttr("onclick");
		refractiveForm.action="specialCheckToolBjtr.action?source=specialcheckiou";
		refractiveForm.submit();
	}
																...
																<table width="99%" class="privateTable" border="0" cellpadding="1" cellspacing="1">
																	...
																	<tr bgcolor="#CADEE8">
																		<TD colspan="9"
																			...
																			<c:if test="${refractivePo.soprdiffusepupil == '10'}">
																				<input type="hidden" name="refractivePo.soprdiffusepupil" value="10"/>复检
																			</c:if>
																			<c:if test="${refractivePo.soprdiffusepupil != '10'}">
																				<input  type="radio" checked="checked" id="pupil" ${refractivePo.soprdiffusepupil != '1' ? '' : 'checked=checked' } name="refractivePo.soprdiffusepupil" value="1">显然验光
																				<input  type="radio" id="pupil" ${refractivePo.soprdiffusepupil != '2' ? '' : 'checked=checked' } name="refractivePo.soprdiffusepupil" value="2">散瞳
																				<input  type="radio" id="pupil" ${refractivePo.soprdiffusepupil != '3' ? '' : 'checked=checked' } name="refractivePo.soprdiffusepupil" value="3">显加快
																				<input  type="radio" id="pupil" ${refractivePo.soprdiffusepupil != '4' ? '' : 'checked=checked' } name="refractivePo.soprdiffusepupil" value="4">左散右显
																				<input  type="radio" id="pupil" ${refractivePo.soprdiffusepupil != '5' ? '' : 'checked=checked' } name="refractivePo.soprdiffusepupil" value="5">左显右散
																			</c:if>
																		</TD>
																	</tr>
																		...
																		<TD width="99%" align="center"
																			class="PrivateBorderBlue" bgcolor="#CADEE8">
																			   <div>
											                                      ...
											                                      BCC&nbsp;&nbsp;
											                                    	<input moveorder="43" class="text_input100" qj=qj  id="enter49" onkeypress="EnterDown(this)" name="doubleEyeFunPo.sopdebcc" value="${doubleEyeFunPo.sopdebcc }" mysel="mysel"/>&nbsp;&nbsp;&nbsp;
											                                      PRA(OU)&nbsp;&nbsp;
											                                      	<input moveorder="44" class="text_input100" qj=qj  id="enter50" onkeypress="EnterDown(this)" name="doubleEyeFunPo.sopdepositiveaccpra" value="${doubleEyeFunPo.sopdepositiveaccpra }" mysel="mysel"/>&nbsp;&nbsp;&nbsp;
											                                      NRA(OU)&nbsp;&nbsp;
											                                      	<input moveorder="45" class="text_input100" qj=qj  id="enter51" onkeypress="EnterDown(this)" name="doubleEyeFunPo.sopdenegativeaccnra" value="${doubleEyeFunPo.sopdenegativeaccnra }" mysel="mysel"/>&nbsp;&nbsp;&nbsp;
																			</td>
																	</TR>
																</TABLE>
