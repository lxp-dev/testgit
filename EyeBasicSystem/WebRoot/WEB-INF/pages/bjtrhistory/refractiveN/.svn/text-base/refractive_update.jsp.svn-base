...
<html>
	...
	function save(){
		...
		if(checkForm(refractiveForm))
		{
			...
			refractiveForm.action="refractiveUpdateBjtr.action";
...
<input type="hidden" id="mydriasisPoid" name="refractivePo.soprsopmdid" value="${refractivePo.soprsopmdid }"/>
																		...
																		<TD width="99%" align="center"
																			class="PrivateBorderBlue" bgcolor="#CADEE8">
																			   <div>
																				  ...
																				  WORTH 4 DOT &nbsp;&nbsp;
																					<select moveorder1="1" id="enter48" onkeypress="EnterDown(this)" name="doubleEyeFunPo.sopdefarworth" mysel="mysel">
																						  <option value="" selected></option>
												                                          <c:forEach var="optionParamPoTmp" items="${optionParamPolist}" >
																	...
																	<TR style="height: 25px" align="center">
																		<TD width="99%" align="center"
																			class="PrivateBorderBlue" bgcolor="#CADEE8">
																			   <div>双眼平衡方法
																					<select jjsgorder="16"
																						name="refractivePo.soprdoublebalanceway" id="enter52" onkeypress="EnterDown(this)">
											                                          <option value="" selected></option>
											                                          <c:forEach var="optionParamPoTmp" items="${optionParamPolist}" >
																				...
																				双眼终点红/绿试验
																					<select jjsgorder="16"
																						name="refractivePo.soprdoublebalancerg" id="enter53" onkeypress="EnterDown(this)">
											                                          <option value="" selected></option>
											                                          <c:forEach var="optionParamPoTmp" items="${optionParamPolist}" >
