...
<html>
	...
	function save(){
			...
			var checkvalue = $("input[name=refractivePo.soprdiffusepupil]:checked").val();
		
		//主导眼
		var check1 = $("[name=refractivePo.soprleadingeye]");
		//WORTH 4 DOT 
		var check2 = $("[name=doubleEyeFunPo.sopdefarworth]");
		//BCC
		var check3 = $("[name=doubleEyeFunPo.sopdebcc]");
		//PRA(OU)
		var check4 = $("[name=doubleEyeFunPo.sopdepositiveaccpra]");
		//NRA(OU)
		var check5 = $("[name=doubleEyeFunPo.sopdenegativeaccnra]");
		...
		if(checkvalue == '3'){
			...
			if(check4.val() == ''){
				alert("显加快状态下，请填写PRA(OU)！");
				check4.focus();
				return;
			}
			
			if(check5.val() == ''){
				alert("显加快状态下，请填写NRA(OU)！");
				check5.focus();
				return;
			}
		}
			if(checkForm(refractiveForm))
			{
				...
				refractiveForm.action="refractiveInsertBjtr.action?source=refractiveiou";
	...
	*/
	...
	function inspection(){
		...
		$("img").removeAttr("onclick");
		refractiveForm.action="inspectionToolBjtr.action?source=inspectioniou";
		refractiveForm.submit();
	}
	function contactGlass(){
		refractiveForm.action="contactGlassToolBjtr.action?source=contactGlassiou";
		$("img").removeAttr("onclick");
		refractiveForm.submit();
	}
	function doubleEyeFun(){
		$("img").removeAttr("onclick");
		refractiveForm.action="doubleEyeFunToolBjtr.action?source=doubleeyefuncopy";
		refractiveForm.submit();
	}
	function specialCheck(){
		$("img").removeAttr("onclick");
		refractiveForm.action="specialCheckToolBjtr.action?source=specialcheckcopy";
		refractiveForm.submit();
	}

	function refractiveCopy(){
		$("img").removeAttr("onclick");
		location.href="refractiveCopyBjtr.action?chuyanfuyan="+'${chuyanfuyan}'+"&oldOptometryID="+'${oldOptometryID}'+"&customerID="+'${customerID }'+"&optometryBasicID="+'${copyBasicOptometryID}'+"&moduleID="+'${moduleID}'+"&optometryID="+'${optometryID}';
	}
	...
	function glassHistory(){
		...
		refractiveForm.action="selectGlassesHistoryBjtr.action?customerID="+'${customerInfoPo.smecicustomerid }';
		refractiveForm.submit();
	}
	
	function cornealContactlLens(){
		$("img").removeAttr("onclick");
		refractiveForm.action="cornealContactlLensToolBjtr.action?source=cornealContactlLensu";
		refractiveForm.submit();
	}
</script>
...
<input type="hidden" id="mydriasisPoid" name="mydriasisPoid" value="${mydriasisPo.sopmdid }"/>
										...
										<TR>
											...
											<c:if test="${not empty(eyesCheckPo) && eyesCheckPo.sopecfruit == '1' }">	
												...
												<TD class="PrivateBorderBlue" width="6%">
																	...
																	<tr bgcolor="#CADEE8" height="30px">
																		<TD colspan="4"
																			...
																			<c:if test="${chuyanfuyan == '1'}">
																				<input type="hidden" name="refractivePo.soprdiffusepupil" value="10"/>复检
																			</c:if>
																			<c:if test="${chuyanfuyan == '0'}">
																				<input  type="radio" checked="checked" id="pupil" name="refractivePo.soprdiffusepupil" value="1">显然验光
																				<input  type="radio" id="pupil" name="refractivePo.soprdiffusepupil" ${eyesCheckPo.sopecismydriasis == '2' ? 'checked="checked"' : ''} value="2">散瞳
																				<input  type="radio" id="pupil" name="refractivePo.soprdiffusepupil" ${eyesCheckPo.sopecismydriasis == '3' ? 'checked="checked"' : ''} value="3">显加快
																				<input  type="radio" id="pupil" name="refractivePo.soprdiffusepupil" ${eyesCheckPo.sopecismydriasis == '4' ? 'checked="checked"' : ''} value="4">左散右显
																				<input  type="radio" id="pupil" name="refractivePo.soprdiffusepupil" ${eyesCheckPo.sopecismydriasis == '5' ? 'checked="checked"' : ''} value="5">左显右散
																			</c:if>
																		</TD>
																		<TD class="PrivateBorderBlue" align="center" width="20%">
																			散瞳用药：
																			  <c:forEach var="optionParamPoTmp" items="${optionParamPolist}" >
																		...
																		<TD colspan="4" class="PrivateBorderBlue">
																			&nbsp;
																		</TD>
																	</TR>																
																	...
																	<TR style="height: 25px" align="center">
																		<TD width="99%" align="center"
																			class="PrivateBorderBlue" bgcolor="#CADEE8">
																			   <div>
																				     主导眼
																					<select jjsgorder="16" name="refractivePo.soprleadingeye" id="enter47" onkeypress="EnterDown(this)">
																						  <option value="" selected></option>
												                                          <c:forEach var="optionParamPoTmp" items="${optionParamPolist}" >
																				  ...
																				  WORTH 4 DOT &nbsp;&nbsp;
																					<select moveorder1="1" name="doubleEyeFunPo.sopdefarworth" mysel="mysel" id="enter48" onkeypress="EnterDown(this)">
																						  <option value="" selected></option>
												                                          <c:forEach var="optionParamPoTmp" items="${optionParamPolist}" >
											                                      ...
											                                      BCC&nbsp;&nbsp;
											                                    	<input moveorder="43" id="enter49" onkeypress="EnterDown(this)" class="text_input100" qj=qj name="doubleEyeFunPo.sopdebcc" value="${doubleEyeFunPo.sopdebcc }" mysel="mysel"/>&nbsp;&nbsp;&nbsp;
											                                      PRA(OU)&nbsp;&nbsp;
											                                      	<input moveorder="44" id="enter50" onkeypress="EnterDown(this)" class="text_input100" qj=qj name="doubleEyeFunPo.sopdepositiveaccpra" value="${doubleEyeFunPo.sopdepositiveaccpra }" mysel="mysel"/>&nbsp;&nbsp;&nbsp;
											                                      NRA(OU)&nbsp;&nbsp;
											                                      	<input moveorder="45" id="enter51" onkeypress="EnterDown(this)" class="text_input100" qj=qj name="doubleEyeFunPo.sopdenegativeaccnra" value="${doubleEyeFunPo.sopdenegativeaccnra }" mysel="mysel"/>&nbsp;&nbsp;&nbsp;
																			</td>
																	</TR>
																</TABLE>
																...
																<table width="99%" border=0 align=center cellpadding=1	cellspacing=1 class="privateTable privateBorder">
																	<TR style="height: 25px" align="center">
																		<TD width="99%" align="center" class="PrivateBorderBlue" bgcolor="#CADEE8">
																			   		双眼平衡方法
																					<select jjsgorder="16" name="refractivePo.soprdoublebalanceway" id="enter52" onkeypress="EnterDown(this)">
											                                          <option value="" selected></option>
											                                          <c:forEach var="optionParamPoTmp" items="${optionParamPolist}" >
																					...
																					双眼终点红/绿试验
																					<select jjsgorder="16" name="refractivePo.soprdoublebalancerg" id="enter53" onkeypress="EnterDown(this)">
											                                          <option value="" selected></option>
											                                          <c:forEach var="optionParamPoTmp" items="${optionParamPolist}" >
