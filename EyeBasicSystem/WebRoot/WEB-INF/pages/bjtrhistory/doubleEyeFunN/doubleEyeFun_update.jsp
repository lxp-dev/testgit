...
function save(){
	if(document.getElementById('radio02').checked==true&&document.getElementById('radio02').value=="0"){			
		...
		if(checkForm(document.all.doubleEyeFunForm)){    
			...
			doubleEyeFunForm.action = "updateDoubleEyeFunBjtr.action";
			if('${copy}'=='copy'){
	...
	function none1() {
		document.getElementById('sopdeaccount').readOnly = false;
		document.getElementById('sopdeaccount').disabled=false;
		var account = document.getElementById('sopdeaccount').value;
		document.getElementById('sopdeaccount').value=account;
	}

	function chageOne(){
		if($('input[type=radio][name=doubleEyeFunPo.sopdeequalwatch]:checked').val() == '1'){
			document.getElementById('sopdedifwatch').readOnly=false;			
		}else{
			document.getElementById('sopdedifwatch').readOnly=true;
			document.getElementById('sopdedifwatch').value="";
		}
	}
	function refractive(){
		$("img").removeAttr("onclick");
							  ...
							  <tr>
								...
								<tr class="trBlue">
										<td  height="30" class="table_body" align="center" >
											...
											&nbsp;原因：&nbsp;
											<select id="sopdeaccount" name="doubleEyeFunPo.sopdeaccount" readonly="readonly" myinput="myinput">
	                                          <option value=""></option>
								...
								<TABLE width="99%" border=0 align=center cellPadding=1 cellSpacing=1 class="privateBorder privateTable">
                                  <TBODY>
                                    ...
                                    <TR>
                                      ...
                                      <TD class="table_none"><div align="right">垂直</div></TD>
                                      <TD class="table_none"><div align="center">
                                          <input moveorder="11" id="sopdecloseheteuprightness" name="doubleEyeFunPo.sopdecloseheteuprightness" class="text_input40" value="${doubleEyeFunPo.sopdecloseheteuprightness }">&nbsp;&nbsp;&nbsp;
                                      </div></TD>
                                      <TD class="table_none"><div align="center">
                                    ...
                                    <TR class="table_body" height="30">
                                    	<TD width="13%" class="table_body" align="center">立体视</TD>
                                    ...
                                    <TR>
                                      ...
                                      <TD class="table_none" width="14%"><input moveorder="26" id="validatedotNum" name="doubleEyeFunPo.sopdenpc" class="text_input100" value="${doubleEyeFunPo.sopdenpc }">&nbsp;<font color="red">*</font></TD>
                                      <TD class="table_none" width="13%"><div align="right">BCC</div></TD>
                                      <TD class="table_none" width="15%" colspan="4">
                                            <input moveorder="27" class="text_input100" qj=qj id="sopdebcc" name="doubleEyeFunPo.sopdebcc" value="${doubleEyeFunPo.sopdebcc }" mysel="mysel">&nbsp;<font color="red">*</font></TD>
                                    </TR>
                                    <TR>
                                      <TD class="table_body" align="center">辅辏近点</TD>
                                      <TD class="table_none"><div align="right">OU</div></TD>
                                      <TD class="table_none"><input moveorder="28" id="sopdefacilityou" name="doubleEyeFunPo.sopdefacilityou" class="text_input100" value="${doubleEyeFunPo.sopdefacilityou }">&nbsp;<font color="red">*</font></TD>
                                      <TD class="table_none"><div align="right">OD</div></TD>
                                      <TD class="table_none"><input moveorder="29" id="sopdefacilityod" name="doubleEyeFunPo.sopdefacilityod" class="text_input100" value="${doubleEyeFunPo.sopdefacilityod }">&nbsp;<font color="red">*</font></TD>
                                      <TD class="table_none"><div align="right">OS </div></TD>
                                      <TD class="table_none" colspan="2"><input moveorder="30" id="sopdefacilityos" name="doubleEyeFunPo.sopdefacilityos" class="text_input100" value="${doubleEyeFunPo.sopdefacilityos }">&nbsp;<font color="red">*</font></TD>
                                    </TR>
                                    <TR>
                                      <TD class="table_body" width="15%" align="center">调节幅度</TD>
                                      <TD class="table_none" width="8%"><div align="right">OU</div></TD>
                                      <TD class="table_none" width="14%"><input moveorder="31" id="sopdeaccou" name="doubleEyeFunPo.sopdeaccou" class="text_input100" value="${doubleEyeFunPo.sopdeaccou }">&nbsp;<font color="red">*</font></TD>
                                      <TD class="table_none" width="13%"><div align="right">OD</div></TD>
                                      <TD class="table_none" width="15%"><input moveorder="32" id="sopdeaccod" name="doubleEyeFunPo.sopdeaccod" class="text_input100" value="${doubleEyeFunPo.sopdeaccod}">&nbsp;<font color="red">*</font></TD>
                                      <TD class="table_none" width="15%"><div align="right">OS</div></TD>
                                      <TD class="table_none" colspan="2"><input moveorder="33" id="sopdeaccos" name="doubleEyeFunPo.sopdeaccos" class="text_input100" value="${doubleEyeFunPo.sopdeaccos}">&nbsp;<font color="red">*</font></TD>
                                    </TR>
                                  </TBODY>
                                </TABLE>
								...
								<table width="99%" border=0 align=center cellpadding=1 cellspacing=1 class="privateTable privateBorder">
                                  <TBODY>
                                      ...
                                      <td  class="table_none" colspan="6">
										...
										有
										<input moveorder="36"  id="sopdedifwatch" name="doubleEyeFunPo.sopdedifwatch" class="text_input100" value="${doubleEyeFunPo.sopdedifwatch }" >
									  </td>
                                    </TR>
                                    <TR>
                                    ...
                                    <TR>
                                      ...
                                      <TD width="10%" class="table_none"><div align="right">－ </div></TD>
                                      <TD class="table_none"><div align="center">
                                        <input moveorder="37" id="validateLevel" name="doubleEyeFunPo.sopdefaramaleveln" class="text_input40" value="${doubleEyeFunPo.sopdefaramaleveln }">
                                      </div></TD>
                                      <TD class="table_none"><div align="center">
                                        <input moveorder="38" id="validateLevel" name="doubleEyeFunPo.sopdefaramalevelno" class="text_input40" value="${doubleEyeFunPo.sopdefaramalevelno }">
                                      </div></TD>
                                      <TD class="table_none"><div align="center">
                                        <input moveorder="39" id="validateLevel" name="doubleEyeFunPo.sopdefaramalevelnt" class="text_input40" value="${doubleEyeFunPo.sopdefaramalevelnt }">
                                      </div></TD>
                                      ...
                                      <TD width="5%" class="table_none"><div align="center">
                                        <input moveorder="43" id="validatedotNum" name="doubleEyeFunPo.sopdefaramalbu" class="text_input40" value="${doubleEyeFunPo.sopdefaramalbu }">
                                      </div></TD>
                                      <TD width="6%" class="table_none"><div align="center">
                                        <input  moveorder="44" id="validatedotNum" name="doubleEyeFunPo.sopdefaramalbuo" class="text_input40" value="${doubleEyeFunPo.sopdefaramalbuo }">
                                      </div></TD>
                                      <TD width="6%" class="table_none"><div align="center">
                                        <input moveorder="47" id="validatedotNum" name="doubleEyeFunPo.sopdefaramabu" class="text_input40" value="${doubleEyeFunPo.sopdefaramabu }" >
                                      </div></TD>
                                      <TD width="6%" class="table_none"><div align="center">
                                        <input moveorder="48" id="validatedotNum" name="doubleEyeFunPo.sopdefaramabuo" class="text_input40" value="${doubleEyeFunPo.sopdefaramabuo }">
                                      </div></TD>
                                    </TR>
                                    <TR>
                                      <TD class="table_none"><div align="right">＋</div></TD>
                                      <TD width="6%" class="table_none"><div align="center">
                                        <input moveorder="40" id="validateLevel" name="doubleEyeFunPo.sopdefaramalevelp" class="text_input40" value="${doubleEyeFunPo.sopdefaramalevelp }">
                                      </div></TD>
                                      <TD width="6%" class="table_none"><div align="center">
                                        <input moveorder="41" id="validateLevel" name="doubleEyeFunPo.sopdefaramalevelpo" class="text_input40" value="${doubleEyeFunPo.sopdefaramalevelpo }">
                                      </div></TD>
                                      <TD width="6%" class="table_none"><div align="center">
                                        <input moveorder="42" id="validateLevel" name="doubleEyeFunPo.sopdefaramalevelpt" class="text_input40" value="${doubleEyeFunPo.sopdefaramalevelpt }">
                                      </div></TD>
                                      <TD class="table_none"><div align="right">BD</div></TD>
                                      <TD class="table_none"><div align="center">
                                        <input  moveorder="45" id="validatedotNum" name="doubleEyeFunPo.sopdefaramalbd" class="text_input40" value="${doubleEyeFunPo.sopdefaramalbd }">
                                      </div></TD>
                                      <TD class="table_none"><div align="center">
                                        <input moveorder="46" id="validatedotNum" name="doubleEyeFunPo.sopdefaramalbdo" class="text_input40" value="${doubleEyeFunPo.sopdefaramalbdo }">
                                      </div></TD>
                                      <TD class="table_none"><div align="center">
                                        <input moveorder="49" id="validatedotNum" name="doubleEyeFunPo.sopdefaramabd" class="text_input40" value="${doubleEyeFunPo.sopdefaramabd }">
                                      </div></TD>
                                      <TD class="table_none"><div align="center">
                                        <input moveorder="50" id="validatedotNum" name="doubleEyeFunPo.sopdefaramabdo" class="text_input40" value="${doubleEyeFunPo.sopdefaramabdo }">
                                      </div></TD>
                                    </TR>
                                    <TR>
                                      <TD colspan="8" bgcolor="#FFFFFF" class="Privateborder">&nbsp;</TD>
                                    ...
                                    <TR>
                                      ...
                                      <TD width="10%" class="table_none"><div align="right">－ </div></TD>
                                      <TD class="table_none"><div align="center">
                                          <input moveorder="51" id="validateLevel" name="doubleEyeFunPo.sopdecloseamaleveln" class="text_input40" value="${doubleEyeFunPo.sopdecloseamaleveln }">
                                      </div></TD>
                                      <TD class="table_none"><div align="center">
                                          <input moveorder="52" id="validateLevel" name="doubleEyeFunPo.sopdecloseamalevelno" class="text_input40" value="${doubleEyeFunPo.sopdecloseamalevelno }">
                                      </div></TD>
                                      <TD class="table_none"><div align="center">
                                          <input moveorder="53" id="validateLevel" name="doubleEyeFunPo.sopdecloseamalevelnt" class="text_input40" value="${doubleEyeFunPo.sopdecloseamalevelnt }">
                                      </div></TD>
                                      <TD width="8%" class="table_none" rowspan="2"><div align="right">垂直</div></TD>
                                      <TD width="6%" class="table_none"><div align="right">BU</div></TD>
                                      <TD width="5%" class="table_none"><div align="center">
                                          <input moveorder="57" id="validatedotNum" name="doubleEyeFunPo.sopdecloseamalbu" class="text_input40" value="${doubleEyeFunPo.sopdecloseamalbu }">
                                      </div></TD>
                                      <TD width="6%" class="table_none"><div align="center">
                                          <input moveorder="58" id="validatedotNum" name="doubleEyeFunPo.sopdecloseamalbuo" class="text_input40" value="${doubleEyeFunPo.sopdecloseamalbuo }">
                                      </div></TD>
                                      <TD width="6%" class="table_none"><div align="center">
                                          <input moveorder="61" id="validatedotNum" name="doubleEyeFunPo.sopdecloseamabu" class="text_input40" value="${doubleEyeFunPo.sopdecloseamabu }">
                                      </div></TD>
                                      <TD width="6%" class="table_none"><div align="center">
                                          <input moveorder="62" id="validatedotNum" name="doubleEyeFunPo.sopdecloseamabuo" class="text_input40" value="${doubleEyeFunPo.sopdecloseamabuo }">
                                      </div></TD>
                                    </TR>
                                    <TR>
                                      <TD class="table_none"><div align="right">＋ </div></TD>
                                      <TD width="6%" class="table_none"><div align="center">
                                          <input moveorder="54" id="validateLevel" name="doubleEyeFunPo.sopdecloseamalevelp" class="text_input40" value="${doubleEyeFunPo.sopdecloseamalevelp }">
                                      </div></TD>
                                      <TD width="6%" class="table_none"><div align="center">
                                          <input moveorder="55" id="validateLevel" name="doubleEyeFunPo.sopdecloseamalevelpo" class="text_input40" value="${doubleEyeFunPo.sopdecloseamalevelpo }">
                                      </div></TD>
                                      <TD width="6%" class="table_none"><div align="center">
                                          <input moveorder="56" id="validateLevel" name="doubleEyeFunPo.sopdecloseamalevelpt" class="text_input40" value="${doubleEyeFunPo.sopdecloseamalevelpt }">
                                      </div></TD>
                                      <TD class="table_none"><div align="right">BD</div></TD>
                                      <TD class="table_none"><div align="center">
                                          <input moveorder="59" id="validatedotNum" name="doubleEyeFunPo.sopdecloseamalbd" class="text_input40" value="${doubleEyeFunPo.sopdecloseamalbd }">
                                      </div></TD>
                                      <TD class="table_none"><div align="center">
                                          <input moveorder="60" id="validatedotNum" name="doubleEyeFunPo.sopdecloseamalbdo" class="text_input40" value="${doubleEyeFunPo.sopdecloseamalbdo }">
                                      </div></TD>
                                      <TD class="table_none"><div align="center">
                                          <input moveorder="63" id="validatedotNum" name="doubleEyeFunPo.sopdecloseamabd" class="text_input40" value="${doubleEyeFunPo.sopdecloseamabd }">
                                      </div></TD>
                                      <TD class="table_none"><div align="center">
                                          <input moveorder="64" id="validatedotNum" name="doubleEyeFunPo.sopdecloseamabdo" class="text_input40" value="${doubleEyeFunPo.sopdecloseamabdo }">
                                      </div></TD>
                                    </TR>
                                  </TBODY>
                                </TABLE>
