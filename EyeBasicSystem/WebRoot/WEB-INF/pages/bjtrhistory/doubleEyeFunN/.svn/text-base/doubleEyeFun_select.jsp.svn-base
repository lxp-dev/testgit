...
function save(){
	...
	function specialCheck(){
		...
		$("img").removeAttr("onclick");
		doubleEyeFunForm.action="selectSpecialCheckBjtr.action?dontshow="+dontshow;
		doubleEyeFunForm.submit();
	}
	...
	function refractive(){
		var dontshow = $('#dontshow').val();
		$("img").removeAttr("onclick");
		doubleEyeFunForm.action="initRefractiveSelectBjtr.action?dontshow="+dontshow;
		doubleEyeFunForm.submit();
	}
	...
	function inspection(){
		var dontshow = $('#dontshow').val();
		$("img").removeAttr("onclick");
		doubleEyeFunForm.action="initInspectionSelectBjtr.action?dontshow="+dontshow;
		doubleEyeFunForm.submit();
	}
	
	function glassHistory(){
		doubleEyeFunForm.action="selectGlassesHistoryBjtr.action?viewDetail=true";
		$("img").removeAttr("onclick");
		doubleEyeFunForm.submit();
	}
	...
	function cornealContactlLens(){
		var dontshow = $('#dontshow').val();
		$("img").removeAttr("onclick");
		doubleEyeFunForm.action="initCornealContactlLensSelectBjtr.action?dontshow="+dontshow;
		doubleEyeFunForm.submit();
	}
	
	function contactGlass(){
		var dontshow = $('#dontshow').val();
		doubleEyeFunForm.action="initContactGlassSelectBjtr.action?dontshow="+dontshow;
		$("img").removeAttr("onclick");
		doubleEyeFunForm.submit();
	}
</script>
								...
								<TABLE width="99%" border=0 align=center cellPadding=1 cellSpacing=1 class="privateBorder privateTable">
                                  <TBODY>
                                    ...
                                    <TR height="26px">
                                      ...
                                      <TD class="table_none" colspan="7">
	                                      <div align="left">
	                                      	...
	                                      	双面镜度数：
                                          <c:forEach var="optionParamPoTmp" items="${optionParamPolist}" >
		                                      <c:if test="${doubleEyeFunPo.sopdetwosidespec == optionParamPoTmp.fopparamid}">
		                                      	${optionParamPoTmp.fopparamname}
		                                      </c:if>	                                      	
	                                      </c:forEach>	                                      	
											&nbsp;&nbsp;
											视标：
                                          <c:forEach var="optionParamPoTmp" items="${optionParamPolist}" >
		                                      <c:if test="${doubleEyeFunPo.sopdetwosidetest == optionParamPoTmp.fopparamid}">
		                                      	${optionParamPoTmp.fopparamname}
		                                      </c:if>	                                      	
	                                      </c:forEach>												
	                                      </div>
                                    ...
                                    <TR height="26px">
                                      ...
                                      <TD class="table_none" width="14%">${doubleEyeFunPo.sopdenpc }&nbsp;</TD>
                                      <TD class="table_none" width="13%"><div align="right">BCC</div></TD>
                                      <TD class="table_none" width="15%" colspan="4">${doubleEyeFunPo.sopdebcc }&nbsp;</TD>
                                    </TR>
                                    <TR height="26px">
                                      ...
                                      <TD class="table_none"><div align="right">OS </div></TD>
                                      <TD class="table_none" colspan="2">${doubleEyeFunPo.sopdefacilityos }&nbsp;</TD>
                                    </TR>
                                    <TR height="26px">
                                      <TD class="table_body" width="15%" align="center">调节幅度</TD>
                                      <TD class="table_none" width="8%"><div align="right">OU</div></TD>
                                      <TD class="table_none" width="14%">${doubleEyeFunPo.sopdeaccou }&nbsp;</TD>
                                      <TD class="table_none" width="13%"><div align="right">OD</div></TD>
                                      <TD class="table_none" width="15%">${doubleEyeFunPo.sopdeaccod }&nbsp;</TD>
                                      <TD class="table_none" width="15%"><div align="right">OS</div></TD>
                                      <TD class="table_none" colspan="2">${doubleEyeFunPo.sopdeaccos }&nbsp;</TD>
                                    </TR>
                                  </TBODY>
                                </TABLE>
