...
// 翻方子
	...
	*/
	...
	function save(){
		...
		contactGlassForm.action="contactGlassInsertBjtr.action?ruleFlag=0&nw='N'";
	...
	function doubleEyeFun(){
		contactGlassForm.action="doubleEyeFunToolBjtr.action?source=doubleeyefuniou";
	...
	function specialCheck() {
		contactGlassForm.action="specialCheckToolBjtr.action?source=specialcheckiou";
		$("img").removeAttr("onclick");
		contactGlassForm.submit();
	}
	...
	function refractive(){
		contactGlassForm.action="refractiveToolBjtr.action?source=refractiveiou";
		$("img").removeAttr("onclick");
		contactGlassForm.submit();
	}
	function inspection(){		
		$("img").removeAttr("onclick");
		contactGlassForm.action="inspectionToolBjtr.action?source=inspectioniou";
		contactGlassForm.submit();
	}
	...
	function glassHistory(){
		...
		contactGlassForm.action="selectGlassesHistoryBjtr.action?customerID="+'${customerInfoPo.smecicustomerid }';
		contactGlassForm.submit();
	}
  ...
  {   
	...
	function checkCylZero(){
  	...
  	function cornealContactlLens(){
		$("img").removeAttr("onclick");
		contactGlassForm.action="cornealContactlLensToolBjtr.action?source=cornealContactlLensu";
		contactGlassForm.submit();
	}
</script>
