...
// 翻方子
	...
	*/
	...
	function inspection(){
		$("img").removeAttr("onclick");
		var dontshow = $('#dontshow').val();
		contactGlassForm.action="initInspectionSelectBjtr.action?dontshow="+dontshow;
		contactGlassForm.submit();
	}
	function specialCheck(){
		$("img").removeAttr("onclick");
		var dontshow = $('#dontshow').val();
		contactGlassForm.action="selectSpecialCheckBjtr.action?dontshow="+dontshow;
		contactGlassForm.submit();
	}
	...
	function doubleEyeFun(){
		$("img").removeAttr("onclick");
		var dontshow = $('#dontshow').val();
		contactGlassForm.action="selectDoubleEyeFunBjtr.action?dontshow="+dontshow;
		contactGlassForm.submit();
	}
	
	function glassHistory(){
		contactGlassForm.action="selectGlassesHistoryBjtr.action?viewDetail=true";
		$("img").removeAttr("onclick");
		contactGlassForm.submit();
	}
  ...
  {   
	...
	function checkCylZero(){
  	...
  	function cornealContactlLens(){
  		var dontshow = $('#dontshow').val();
		$("img").removeAttr("onclick");
		contactGlassForm.action="initCornealContactlLensSelectBjtr.action?dontshow="+dontshow;
		contactGlassForm.submit();
	}
