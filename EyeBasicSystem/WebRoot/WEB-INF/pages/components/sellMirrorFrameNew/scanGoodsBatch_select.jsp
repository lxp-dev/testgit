...
<script>
  ...
  function setSingleValue(obj){
	...
	function RorL(obj){
		...
		goodsForm.action="scanGoodsSelAllBatchNew.action?rl="+$("input[name=rightOrleft][checked]").val()+'&kucun='+kucun;
		goodsForm.submit();
	}

	function changeKun(){
		goodsForm.action="scanGoodsSelAllBatchNew.action?kucun="+$('#kucun').val();
		goodsForm.submit();
	}
</script>
