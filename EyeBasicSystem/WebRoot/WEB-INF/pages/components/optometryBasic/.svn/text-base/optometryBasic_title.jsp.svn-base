	...
	<TABLE width="98%" id="title1" border=0 align=center cellpadding=1 cellspacing=1 class="privateTable privateBorder">
	  <tr>
	    <td bgcolor="#cadee8"><li class="horizontal">验光号&nbsp;
	            <input name="optometryPo.sopoyoptometryid" class="text_input200" value="${optometryPo.sopoyoptometryid }" readOnly="readOnly">
      ...
      <tr>
        <td bgcolor="#cadee8">
          <li class="horizontal">卡号&nbsp;
            ...
            onkeydown="selectCustomer()" ${ person.bdplinkhisflag == '1' ? 'readonly=readonly':'' }>
          ...
          <li class="horizontal">
            <img src="${ctx }/img/newbtn/btn_hybq_0.png" btn=btn hiss=hiss title='查找' >
