                      ...
                      <TBODY>
					  	<TR>
			               ...
			               <TD width="23%" class="table_none">
                            <input class="text_input100" type="text"  id="supplierID" name="supplierID" value="${requestScope.supplierID}">
			               </TD>
			               <TD width="10%" height="26" class="table_body">制造商</TD>
			               <TD width="23%" class="table_none">
                            <input class="text_input160" type="text"  id="supplierName" name="supplierName" value="${requestScope.supplierName}">
			               </TD>
			               <TD width="10%" height="26" class="table_body">商品类别</TD>
			               <TD width="23%" class="table_none">
                            <select id="goodsCategoryID" name="goodsCategoryID" ${(not empty(categoryID_open) && !fn:contains(categoryID_open, ",")) ? 'disabled="disabled"' : '' }>
					...
					<table width="100%"   border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                      ...
                      <TBODY>
                        <TR class=table_title align=middle>
                          <TH width="5%" scope=col>全选<input type="checkbox" id="chks" onclick="chkAll()"></TH>
                        ...
                        <TR class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">
						  <TD height="26">
		                      <input type="checkbox" id="chk" departmentid="${bspid}" onClick="setValue();" value="{'bdpdepartmentid':'${bspid}','bdpdepartmentname':'${bspsuppliername}'}">
		                  </TD>
