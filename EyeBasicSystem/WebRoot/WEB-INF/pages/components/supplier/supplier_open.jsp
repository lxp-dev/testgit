...
<script>	
	...
	function search(){
		...
		supplierOpenForm.action = "selSupplierOpen.action";
		supplierOpenForm.submit();
		showLoadingBar();
	}
	...
	function setValue(id, value, bspcategoryid, bspsettlement, bspsettlementmonth){	
		var json = {'id' : id, 'value' :　value, 'bspcategoryid' :　bspcategoryid, 'bspsettlement': bspsettlement, 'bspsettlementmonth':bspsettlementmonth};
					...
					<table width="100%"   border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                      ...
                      <TBODY>
                        ...
                        <TR class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">
                          <TD>
		                     <img src="${ctx }/img/newbtn/select_0.png" btn=btn title="选择" onClick="setValue('${bspid}', '${bspsuppliername}', '${bspcategoryid}','${bspsettlement }','${bspsettlementmonth }');">
		                  </TD>
