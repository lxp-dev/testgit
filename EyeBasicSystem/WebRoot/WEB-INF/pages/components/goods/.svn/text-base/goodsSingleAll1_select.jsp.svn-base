...
<script>	
	...
	function update(id){
        ...
        window.parent.openValues1(id,supplierID,supplierName,goodscategoryID);
        parent.hidePopWin();
	}
	...
	function details(id){
		...
		document.getElementById('popupTitle').innerHTML="【调拨申请单详细】";
	}
	
	function search(){
	$("img").removeAttr("onclick");
		goodsForm.action = "selGoodsSingleAlls.action";
		goodsForm.submit();
		showLoadingBar();
	}
	function clean(){
