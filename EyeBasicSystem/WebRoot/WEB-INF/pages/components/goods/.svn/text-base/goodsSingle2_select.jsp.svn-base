...
<script>	
	...
	$("img").removeAttr("onclick");
		goodsForm.action = "selGoodsSingle2.action";
		goodsForm.submit();
		showLoadingBar();
	}
	function clean(){
...
<input type="hidden" id='jm' name="jm" value="${jm }" />
				  ...
				  <table width="100%" id="title0"  border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                     <TBODY>
                      ...
                      <TBODY>
			               ...
			               <TD class="table_none" colspan="5">
                            ...
                            <select id="goodscategoryID" name="goodscategoryID" onchange="category();" ${not empty(categoryID_open) ? 'disabled="disabled"' : '' }>
      		                 ...
      		                 <s:iterator value="goodsCategorys">
      		                 	<c:if test="${(systemParameterPo.fspstealtheffective=='1' || systemParameterPo.fspstealtheffective=='2')&&bgcid!='4'&&bgcid!='5'}">
		               ...
		               <tr>		               
						   <TD height="26" class="table_body">批发价</TD>
			               <TD class="table_none">
			               <input class="text_input100" type="text" clean=clean id="bgiwholesalebeginprice" name="bgiwholesalebeginprice" value="${requestScope.bgiwholesalebeginprice}" onKeyUp="value=value.replace(/[^\d\.]/g,'')"> ~ <input class="text_input100" type="text" clean=clean id="bgiwholesaleendprice" name="bgiwholesaleendprice" value="${requestScope.bgiwholesaleendprice}" onKeyUp="value=value.replace(/[^\d\.]/g,'')"></TD>
                          </TD>
                      ...
                      <TBODY>
                        ...
                        <TR class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">                         
                          ...
                          <input type="checkbox" onClick="setSingleValue(this);" id="chk" goodsid="${bgigoodsbarcode}"
                           ...
                           'bginottaxrate':'${bginottaxrate}','bginottaxrateamount':'0.00','bgispec':'${bgispec}','bgicolor':'${bgicolor}','bgisph':'${bgisph}','bgicyl':'${bgicyl}','bgiaxis':'${bgiaxis}','bgicurvature1':'${bgicurvature1}','bgidia':'${bgidia}','bgibrandname':'${bgibrandname}',
                           ...
                           'bgisource':'${bgisource }','bgiwholesaleprice':'${bgiwholesaleprice }','bgirksj':'${bgirksj}','bgigoodsquantity':'0'}">
                          </TD>
                           <c:choose>
                          	<c:when test="${goodscategoryID == '1' }">
	                          	 <TD>${bgigoodsid}</TD>
