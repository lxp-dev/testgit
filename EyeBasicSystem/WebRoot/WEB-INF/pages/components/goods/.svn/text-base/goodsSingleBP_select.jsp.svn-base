...
<script>
	...
	function search(){
		...
		goodsForm.action = "selGoodsSingleBP.action";
		goodsForm.submit();
		showLoadingBar();
	}
                     ...
                     <TBODY>
                      ...
                      <TBODY>
                        ...
                        <TD width="60" height="26" class="table_body">商品类别</TD>
			               ...
			               <TD class="table_none">
	      	                   <select id="warehouseID" name="warehouseID" style="width:120" clean=clean>
	                           	<option value="">----请选择----</option>
                      ...
                      <TBODY>
                        ...
                        <TR class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">                         
                          ...
                          <input type="checkbox" onClick="setSingleValue(this);" id="chk" goodsid="${bgigoodsbarcode}"
                           ...
                           'bgipcbarcode':'${bgigoodsbarcode }','bgisuppliername':'${bgisuppliername }','bgisupplierid':'${bgisupplierid }',
                           ...
                           'bgisource':'${bgisource }','bgiwholesaleprice':'${bgiwholesaleprice }','guaranteeperiod':'${guaranteeperiod}','batch':'${batch}','bgigoodsquantity':'${bgigoodsquantity }'}">
                          </TD>
                           <c:choose>
                          	<c:when test="${goodscategoryID == '1' }">
	                          	 <TD>${bgigoodsid}</TD>
                          	...
                          	<c:when test="${goodscategoryID == '2' }">
	                         	 ...
	                         	 <TD>${bgiviewgoodsname}</TD>
	                          	 <TD>${bgispec}</TD>
	                          	 <TD>${bgiunitname}</TD>
                          		 <TD scope=col >${bgiretailprice} </TD>
	                        	 <TD scope=col >
