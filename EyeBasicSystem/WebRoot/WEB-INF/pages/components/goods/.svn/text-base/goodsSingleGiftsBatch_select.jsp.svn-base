...
<script>	
	...
	function search(){
		...
		goodsForm.action = "selGoodsSingleGiftsBatch.action";
		goodsForm.submit();
		showLoadingBar();
	}
	function clean(){
	...
	function setValue(obj){
		var objValue=eval('(' + obj.value + ')');
      	if(obj.checked==true){
  		if(objValue.guaranteeperiod!='' && typeof(objValue.guaranteeperiod)!='undefined'){
        ...
        objValueadd="["+obj.value+"]";
        window.parent.addGifts(objValueadd);
	}
	/**
	 *  checkbox全选
	 */	
				  ...
				  <table width="100%" id="title0"  border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                         ...
                         <TD width="60" height="26" class="table_body">商品类别</TD>
			               ...
			               <TD class="table_none">
						   			...
						   			<li class="horizontal_onlyRight">
						  				...
						  				<img src="${ctx }/img/newbtn/btn_change_0.png" onmouseover="JavaScript:$(this).attr('src','${ctx }/img/newbtn/btn_change_1.png');" onmouseout="JavaScript:$(this).attr('src','${ctx }/img/newbtn/btn_change_0.png');" title="选 择" onClick="openSupplier();" ></li>
						   				</c:if>
						   	</TD>			               
						   ...
						   <li class="horizontal_onlyRight">
						  <img src="${ctx }/img/newbtn/btn_change_0.png" onmouseover="JavaScript:$(this).attr('src','${ctx }/img/newbtn/btn_change_1.png');" onmouseout="JavaScript:$(this).attr('src','${ctx }/img/newbtn/btn_change_0.png');" title="选 择" onClick="openBrand();"></li>
			              </TD>
			              </c:if>
                        </TR>
					...
					<!-- END 分页 -->
                      ...
                      <TBODY>
                        ...
                        <c:if test="${goodscategoryID != '4' && goodscategoryID != '5'}">
                          <TH width="5%" height="26" scope=col colspan="2">全选<input type="checkbox" id="chks" onclick="chkAll()"></TH>                      
                        ...
                        <c:if test="${goodscategoryID != '4' && goodscategoryID != '5'}">                         
                          <TD height="26">
                           <input type="checkbox" id="chk"  onClick="setValue(this);" id="chk" goodsid="${bgigoodsid}" goodsbarcode="${bgigoodsbarcode}" stockid="${bgiwarehouseid }"
                           value="{'bgsgoodsid':'${bgigoodsid}','bgigoodsname':'${bgigoodsname}','bgiunitname':'${bgiunitname}','bgscostprice':'${bgicostprice}','bgiretailprice':'0.00','bgitaxrate':'${bgitaxrate}',
                           'bgsnottaxrate':'${bginottaxrate}','bgsgoodstype':'','bgicolor':'${bgicolor}','bgsviewname':'${bgigoodsname}','bgicyl':'${bgicyl}','bgiaxis':'${bgiaxis}','bgicurvature1':'${bgicurvature1}','bgidia':'${bgidia}','bgibrandname':'${bgibrandname}','bgsgoodsbarcode':'${bgigoodsbarcode }','bgisuppliername':'${bgisuppliername }','bgisupplierid':'${bgisupplierid }',bgisource:'${bgisource }','bgiwarehousename':'${bgiwarehousename}','bgiwarehouseid':'${bgiwarehouseid}','bgigoodsquantity':'${bgigoodsquantity}'}">
                          </TD>
                        ...
                        <c:if test="${goodscategoryID == '4' || goodscategoryID == '5'}">                       
                          <TD height="26">
                           <input type="checkbox" id="chk"  onClick="setValue(this);" id="chk" goodsid="${bgigoodsid}" goodsbarcode="${bgigoodsbarcode}" stockid="${bgiwarehouseid }"
                           value="{'bgsgoodsid':'${bgigoodsid}','bgigoodsname':'${bgigoodsname}','bgiunitname':'${bgiunitname}','bgscostprice':'${bgicostprice}','bgiretailprice':'0.00','bgitaxrate':'${bgitaxrate}'
                           ,'bgsnottaxrate':'${bginottaxrate}','bgsgoodstype':'','bgicolor':'${bgicolor}','bgsviewname':'${bgigoodsname}','bgicyl':'${bgicyl}','bgiaxis':'${bgiaxis}','bgicurvature1':'${bgicurvature1}'
                           ,'bgidia':'${bgidia}','bgibrandname':'${bgibrandname}','bgsgoodsbarcode':'${bgigoodsbarcode }','bgisuppliername':'${bgisuppliername }','bgisupplierid':'${bgisupplierid }',bgisource:'${bgisource }'
                           ,'bgiwarehousename':'${bgiwarehousename}','bgiwarehouseid':'${bgiwarehouseid}','bgigoodsquantity':'${bgigoodsquantity}','guaranteeperiod':'${guaranteeperiod}','batch':'${batch}'}">
                          </TD>
                          <TD  height="26"><img src="${ctx }/img/newbtn/select_0.png" btn=btn title='选择并关闭页面' onClick="javascript:setSingleValue1('${bgigoodsid}','${bgigoodsbarcode}','${bgiwarehouseid }')"></TD>
                          <TD>${bgigoodsid}</TD>
                          <td>${bgigoodsbarcode }</td>
