...
<script>
	...
	function search(){
		...
		goodsForm.action = "selGoodsSingleForPremiums.action";
		goodsForm.submit();
		showLoadingBar();
	}
					...
					<table width="100%"   border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                      ...
                      <TBODY>
                        <TR class=table_title align=middle>
                          <TH width="3%" height="26" scope=col>选择<input style="display: none;" type="checkbox" id="chks" onclick="chkAll()"></TH>                        
                          <c:choose>
                        ...
                        <TR class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">                         
                          <TD height="26">
                          <img src="${ctx }/img/newbtn/select_0.png" btn=btn title='选择' onClick="javascript:$('#chk${sta.index }').click();">
                          <input style="display: none;" type="checkbox" onClick="setSingleValue(this);" id="chk${sta.index }" goodsid="${bgigoodsid}"
