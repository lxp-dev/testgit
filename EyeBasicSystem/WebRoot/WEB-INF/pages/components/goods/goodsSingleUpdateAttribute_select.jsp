...
<script>
	...
	function search(){
		...
		goodsForm.action = "selGoodsSingleUpdateAttribute.action";
		goodsForm.submit();
		showLoadingBar();
	}
    ...
    function setCheckValue(){
        var chktext="";
        $("input[id=updateGoodsID]",window.parent.document).each(function(){
    ...
    function setSingleValue(obj){
       // var objValue="["+obj.value+"]";
        ...
        //}
        window.parent.$("#updateGoodsID").val('');
        var goodsidString=''
        $("input[id=chk]:checked").each(function(){
            	goodsidString=goodsidString+','+$(this).val();
        });
        window.parent.$("#updateGoodsID").val(goodsidString);
    }
	/**
	 *  调用页面赋值删除
	 */
