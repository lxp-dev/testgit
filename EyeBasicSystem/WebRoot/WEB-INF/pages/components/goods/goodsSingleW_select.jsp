...
<script>	
	...
	$("img").removeAttr("onclick");
		goodsForm.action = "selGoodsSingleW.action";
		goodsForm.submit();
		showLoadingBar();
	}
				  ...
				  <table width="100%" id="title0"  border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                     <TBODY>
                      ...
                      <TBODY>
		               ...
		               <tr>		               
						   <TD height="26" class="table_body">批发价格</TD>
			               <TD class="table_none" colspan="5">
			               <input class="text_input100" type="text" clean=clean id="bgiwholesalebeginprice" name="bgiwholesalebeginprice" value="${requestScope.bgiwholesalebeginprice}" onKeyUp="value=value.replace(/[^\d\.]/g,'')"> ~ 
			               <input class="text_input100" type="text" clean=clean id="bgiwholesaleendprice" name="bgiwholesaleendprice" value="${requestScope.bgiwholesaleendprice}" onKeyUp="value=value.replace(/[^\d\.]/g,'')"></TD>
                          </TD>
                        </TR>
                      </TBODY>
                    </TABLE>
