...
<script>	
	...
	function details(id){
		...
		if(is_iPad()){
			showPopWin("reAllocationDetails.action?hid="+id+"&moduleID="+moduleID,970,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}else{
			showPopWin("reAllocationDetails.action?hid="+id+"&moduleID="+moduleID,screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}
	...
	function search(){
		...
		goodsForm.action = "selGoodsAllocationOut.action";
		goodsForm.submit();
		showLoadingBar();
	}
	function clean(){
