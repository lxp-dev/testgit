...
<script>	
	...
	function search(){
		if(checkForm(document.all.otherGoodsForm)){  
			...
			otherGoodsForm.action = "selectWindowOtherGoods.action";
			otherGoodsForm.submit();
		}
	}
	function selectOthers(obj){
		if(event.keyCode==13){
			if (obj.value === ''||obj.value.length<26) {
				...
				otherGoodsForm.action = "selectOthersByGoodsbarcode.action";
				otherGoodsForm.submit();
			}
    ...
    <TD><!-- ?? Start -->
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          ...
          <TR>
            <TD class=menubar_function_text height=27><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：选择其他商品</TD>
				   ...
				   <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      ...
                      <TR>
                      	...
                      	<TD width="%35" class="table_none" colspan="3" >
                            <input class="text_input200" type="text" onkeydown="selectOthers(this)" id="bgigoodsbarcode" name="bgigoodsbarcode" value="" style="ime-mode:disabled">
					...
					<table width="100%"   border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                      ...
                      <TBODY>
						...
						<c:forEach var="i" items="${otherGoodsList}" varStatus="index"> 
