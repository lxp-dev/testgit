...
<script>
	...
	function getPersonDetails(obj){
		if(event.keyCode==13){
			...
			barcodeScanForm.action="updateInvisibleDistribution.action?personcardid="+$("#personcardid").val();
	...
	function updateState(){
		...
		barcodeScanForm.action = "updateInvisibleDistribution.action";
		barcodeScanForm.submit();
	}
</script>
...
<input type="hidden" id="ssesblocation" name="ssesblocation" value="${ssesblocation }"/>
<br/>
