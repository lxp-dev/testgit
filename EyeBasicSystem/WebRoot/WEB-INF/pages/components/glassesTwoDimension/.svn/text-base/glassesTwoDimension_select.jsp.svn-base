				...
				<TD>
                  <TABLE height=22 cellSpacing=0 cellPadding=0 border=0>
                    ...
                    <TD width=3><IMG id=tabImgLeft__1 height=22 
                      ...
                      <TD class=tab id=tabLabel__1 
                      background=${ctx }/img/pic/tab_unactive_bg.gif 
                      onclick="JavaScript:window.location.href='selgalessDWOpen.action?moduleID=${requestScope.moduleID}&justType=Retail&categoryID=${goodsCategoryID }&supplierID=${supplierID }&brandID=${brandID}&supplierName=${supplierName }&brandName=${brandName}&whichretail=${whichretail}&ishide=${ishide }';"
