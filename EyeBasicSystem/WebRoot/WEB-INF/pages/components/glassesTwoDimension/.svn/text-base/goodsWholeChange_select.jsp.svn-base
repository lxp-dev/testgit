...
<script>
	...
	$("img").removeAttr("onclick");
		glassesFrameForm.action = "selgalessDWOpen.action?justType=Wholesale";
				...
				<TD>
                  <TABLE height=22 cellSpacing=0 cellPadding=0 border=0>
                    ...
                    <TR>
                      ...
                      onclick="JavaScript:window.location.href='selgalessDWOpen.action?moduleID=${requestScope.moduleID}&justType=Cost&categoryID=${goodsCategoryID }&supplierID=${supplierID }&brandID=${brandID}&supplierName=${supplierName }&brandName=${brandName}';"
          ...
          <TD bgColor=#ffffff height="100%">
            <TABLE cellSpacing=0 cellPadding=0 width="100%" height="100%" border=0>
              ...
              <TR>
                ...
                vAlign=top><DIV id="pf">
                <c:if test="${brandID!=''}">
	                <c:if test="${fn:substring(goodsCategoryID,1,2)!='D'}">
	                <iframe id="reportFrame" src="report.action?reportlet=selgalessDWWholesaleOpen.cpt&supplierid=${supplierID }&brandid=${brandID}&goodscategoryid=${fn:substring(goodsCategoryID,0,1)}&iscustomize=${fn:substring(goodsCategoryID,1,2)}" width="100%" height="100%">
					</iframe><%--成品 --%>
					</c:if>
					 <c:if test="${fn:substring(goodsCategoryID,1,2)=='D'}">
	                <iframe id="reportFrame" src="report.action?reportlet=selgalessDWWholesale_DOpen.cpt&supplierid=${supplierID }&brandid=${brandID}&goodscategoryid=${fn:substring(goodsCategoryID,0,1)}&iscustomize=${fn:substring(goodsCategoryID,1,2)}" width="100%" height="100%">
					</iframe><%--订制 --%>
					</c:if>
				</c:if>
                </DIV>
