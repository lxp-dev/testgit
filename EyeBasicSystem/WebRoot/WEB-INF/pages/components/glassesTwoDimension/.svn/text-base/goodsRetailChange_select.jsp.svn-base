            ...
            <TABLE cellSpacing=0 cellPadding=0 height="100%" width="100%" border=0>
              ...
              <TR>
                ...
                <c:if test="${fn:substring(goodsCategoryID,1,2)!='D'}">
                  <iframe id="reportFrame" src="report.action?reportlet=selgalessDWRetailOpen.cpt&supplierid=${supplierID }&brandid=${brandID}&goodscategoryid=${fn:substring(goodsCategoryID,0,1)}&iscustomize=${fn:substring(goodsCategoryID,1,2)}" width="100%" height="100%">
				</iframe><%--成品 --%>
				</c:if>
				<c:if test="${fn:substring(goodsCategoryID,1,2)=='D'}">
