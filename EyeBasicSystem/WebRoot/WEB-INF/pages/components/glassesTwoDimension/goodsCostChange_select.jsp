...
<script>
	...
	function openBrandValues(json){
		...
		$("img").removeAttr("onclick");
		glassesFrameForm.action = "selgalessDWOpen.action?justType=Cost";
		glassesFrameForm.submit();
	}
				...
				<TD>
                  <TABLE height=22 cellSpacing=0 cellPadding=0 border=0>
                    ...
                    <TD width=3><IMG id=tabImgLeft__1 height=22 
                      ...
                      onclick="JavaScript:window.location.href='selgalessDWOpen.action?moduleID=${requestScope.moduleID}&justType=Retail&categoryID=${goodsCategoryID }&supplierID=${supplierID }&brandID=${brandID}&supplierName=${supplierName }&brandName=${brandName}';"
                    ...
                    <TD width=3><IMG id=tabImgLeft__1 height=22 
                      ...
                      <TD class=tab id=tabLabel__1 
                      background=${ctx }/img/pic/tab_unactive_bg.gif  
                      onclick="JavaScript:window.location.href='selgalessDWOpen.action?moduleID=${requestScope.moduleID}&justType=Wholesale&categoryID=${goodsCategoryID }&supplierID=${supplierID }&brandID=${brandID}&supplierName=${supplierName }&brandName=${brandName}';"
              ...
              <TR>
                ...
                <c:if test="${brandID!=''}">
                 <c:if test="${fn:substring(goodsCategoryID,1,2)!='D'}">
                   <iframe id="reportFrame" src="report.action?reportlet=selgalessDWCostOpen.cpt&supplierid=${supplierID }&brandid=${brandID}&goodscategoryid=${fn:substring(goodsCategoryID,0,1)}&iscustomize=${fn:substring(goodsCategoryID,1,2)}" width="100%" height="100%">
					</iframe><%--成品 --%>
				</c:if>
				 <c:if test="${fn:substring(goodsCategoryID,1,2)=='D'}">
	                <iframe id="reportFrame" src="report.action?reportlet=selgalessDWCost_DOpen.cpt&supplierid=${supplierID }&brandid=${brandID}&goodscategoryid=${fn:substring(goodsCategoryID,0,1)}&iscustomize=${fn:substring(goodsCategoryID,1,2)}" width="100%" height="100%">
					</iframe><%--订制 --%>
					</c:if>
				</c:if>
                </DIV>
