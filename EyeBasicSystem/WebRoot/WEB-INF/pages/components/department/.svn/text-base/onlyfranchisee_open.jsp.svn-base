...
<script>
	...
	function search(){
		...
		departmentstForm.action = "selOnlyFranchiseeOpen.action";
                  ...
                  <DIV>
					...
					<s:iterator value="departmentList">	
						<TR class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">
                          <TD>
		                     <img src="${ctx }/img/newbtn/select_0.png" btn=btn title="选择" onClick="setValue('${bdpdepartmentid}', '${bdpdepartmentname}');">
		                  </TD>
