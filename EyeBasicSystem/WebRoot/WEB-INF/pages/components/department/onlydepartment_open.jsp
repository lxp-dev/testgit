...
<script>
	...
	function search(){
		...
		departmentstForm.action = "selDepartmentOpen.action";
		departmentstForm.submit();
		showLoadingBar();
	}
                    ...
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        <TR>
                          ...
                          <TD width="23%" class="table_none"><select clean="clean" id="bdptype" name="bdptype"">
                            <option value="">----请选择----</option>
                            <option value="1" ${departmentType == '1' ?'selected="selected"':''}>销售门店</option>
                            <option value="2" ${departmentType == '2' ?'selected="selected"':''}>加工中心</option>
                            <option value="3" ${departmentType == '3' ?'selected="selected"':''}>总仓库房</option>
                            <option value="4" ${departmentType == '4' ?'selected="selected"':''}>财务</option>
                            <option value="5" ${departmentType == '5' ?'selected="selected"':''}>其他</option>
                          </select></TD>
                        </TR>
                    ...
                    <table width="100%"   border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                      ...
                      <TBODY>
                        <TR class=table_title align=middle>
                          <TH width="10%" height="30" scope=col>操作</TH>  
						...
						<s:iterator value="departmentList">	
							<TR class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">
								<TD height="28">
								 <img src="${ctx }/img/newbtn/select_0.png" btn=btn title='选择' onClick="setValue(this);" value="{'bdpdepartmentid':'${bdpdepartmentid}','bdpdepartmentname':'${bdpdepartmentname}'}">
		                          
		                        </TD>
                          		<TD height="28">${bdpdepartmentid}</TD>
