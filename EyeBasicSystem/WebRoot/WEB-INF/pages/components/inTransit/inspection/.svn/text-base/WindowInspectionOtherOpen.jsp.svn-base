                      ...
                      <TBODY>
                        <TR class=table_title align=middle>
                         <TH width="3%" height="30" scope=col >操作</TH>
                          <TH width="10%" height="30" scope=col>商品代码</TH>                        
                          <TH width="15%" scope=col>商品品种</TH>      
                          <TH width="10%" scope=col>商品名称</TH>   
                          <TH width="15%" scope=col>商品价格</TH>                                                                                                         
						  </TR>
						<s:iterator value="goodsList">
                        <TR class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">                         
                          <TD height="28"><input icon="icon-apply" type='button' value='选择' onClick="setValue('${bgigoodsname}');"></TD>
                          <TD>${bgigoodsid}</TD>
                          <TD>${bgibrandname}</TD>      
                           <TD>${bgigoodsname}</TD>     
