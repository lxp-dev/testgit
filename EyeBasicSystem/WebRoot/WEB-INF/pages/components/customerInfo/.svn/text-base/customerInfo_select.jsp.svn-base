...
<script>
	...
	function search(){
		...
		customerInfoForm.action = "selCustomerInfoWin.action";
	...
	function selectCustomer(memberid,cname,cphone,cintegral,customerid){
		if('${type }'.trim() == '1'){
			window.parent.setCustomer1(memberid,cname,cphone,cintegral,customerid);
		}else{
			window.parent.setCustomer(memberid,cname,cphone,cintegral,customerid);
		}
						 ...
						 <s:iterator value="customerInfoList">
	                        <TR class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">
	                          <TD>
	                             ...
	                             <img src="${ctx }/img/newbtn/select_0.png" btn=btn title='选择' onClick="javascript:selectCustomer('${smecimemberid }','${smeciname}','${smeciphone}','${smeciintegral}','${smecicustomerid}')">
			                  	</c:if>
