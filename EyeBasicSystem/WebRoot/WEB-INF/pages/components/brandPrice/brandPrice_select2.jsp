...
<script>
	...
	function search(){
		...
		goodsForm.action = "selBrandPrice2.action";
		goodsForm.submit();
		showLoadingBar();
	}
			            ...
			            <tr>
			               <TD  class="table_body">含税单价</TD>
 			               <TD  class="table_none" colspan="5">
			                 <input class="text_input100" type="text" clean=clean id="begincostprice" name="begincostprice" value="${begincostprice}" onKeyUp="value=value.replace(/[^\d\.]/g,'')"> ~ <input class="text_input100" type="text" clean=clean id="endcostprice" name="endcostprice" value="${endcostprice}" onKeyUp="value=value.replace(/[^\d\.]/g,'')">
			               </TD>
                        <t/tr>
                      </TBODY>
                    </TABLE>
                      ...
                      <TBODY>
                        ...
                        <TR class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">                         
                          ...
                          <input type="checkbox" onClick="setSingleValue(this);" id="chk" goodsid="${bbdremark}"
                           ...
                           ,'bbdcostprice':'${bbdcostprice}','bbdsupplierid':'${bbdsupplierid}','bbdid':'${bbdid}','goodsid':'${bbdremark}'}">
                          </TD>
                          <TD>${brands}</TD>
	                      <TD>${bbdbrandname}</TD>
