...
<script>
	...
	function search(){
		...
		goodsForm.action = "selBrandPrice3.action";
		goodsForm.submit();
		showLoadingBar();
	}
                      ...
                      <TBODY>
                        ...
                        <TD width="60" height="26" class="table_body">商品类别</TD>
	                        <TD width="23%" class="table_none">
							  	<select name="goodscategoryID" ${!empty(categoryID_open) ? 'disabled="disabled"' : '' } onchange="onchangeGoodsType();">
                      ...
                      <TBODY>
                        ...
                        <TR class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">                         
                          ...
                          <input type="checkbox" onClick="setSingleValue(this);" id="chk" goodsid="${bbdremark}"
                           ...
                           ,'bbdwholesaleprice':'${bbdwholesaleprice}','bbdsupplierid':'${bbdsupplierid}','bbdid':'${bbdid}','goodsid':'${bbdremark}'}">
                          </TD>
                          <TD>${brands}</TD>
	                      <TD>${bbdbrandname}</TD>
	                      <TD >${bspsuppliername}</TD>
	                      <TD>${bbdwholesaleprice}</TD>
                          </TR>
						</s:iterator>
                      </TBODY>
                    </TABLE>
