...
<script>	
	...
	function search(){
		if(checkForm(document.all.goodsForm)){
			...
			goodsForm.action = "selConsignProcessReceiptForOpen.action";
			goodsForm.submit();
			showLoadingBar();
		}
	}
	function clean(){
	    document.all.poID.value="";
  ...
  <TR>
    <TD><!-- ?? Start -->
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            <TD class=menubar_title><img border='0' src='${ctx }/img/pic/module.gif' align='absmiddle' hspace='3' vspace='3'>选择委外订单</TD>
					...
					<table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
						...
						<TR> 					 
                          ...
                          <TD class="table_none" colspan="3"><input id="startTime"
					       name="startTime" 
					...
					<table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        ...
                        <TR class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">
                          <TD height="28">${po.cstcpoorderbillid }</TD>
                          <TD>${fn:substring(po.cstcpobilldate,0,10)}</TD>
						  <td>${po.bspsuppliername }</td>
                          <TD>${po.createPersonName }</TD>
                          <TD>${po.auditPersonName }</TD>
                          <TD>
		                     <input icon="icon-apply" type='button' value='选中' onClick="javascript:setValue('${po.cstcpoorderbillid}')">
		                  </TD>
                        </TR>
                        </c:forEach>
                      </TBODY>
