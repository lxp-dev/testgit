...
<script>	
	...
	function selectDiscount(){
		if(event.keyCode==13){
			var fpdpersonid = document.getElementById('cardid').value;
			if(fpdpersonid==''){
				alert("请输入员工卡号!");
			...
			personDiscountForm.action = "changeSaleserCard.action";
			personDiscountForm.submit();
		}
	}	
				...
				<TD>
                  <TABLE height=22 cellSpacing=0 cellPadding=0 border=0>
                    ...
                    <TR>
                      ...
                      onclick="JavaScript:window.location.href='initChangeSaleser.action';"
                ...
                vAlign=top><DIV id=tabContent__1>
                  <DIV>		
				   <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                      <TR>
                      	<TD width="%35" height="30" class="table_body" align="right" >员工卡号:</TD>
