...
$(document).ready(function() { 
	...
	function search(){
		...
		supplierOpenForm.action = "selCustomerOpen.action";
                      ...
                      <TBODY>
					  	<TR>
			               ...
			               <TD colspan="3" class="table_none">
                            <input class="text_input100" type="text"  id="bctcustomername" name="bctcustomername" value="${requestScope.bctcustomername}">
			               </TD>
					...
					<table width="100%"   border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                      ...
                      <TBODY>
                        ...
                        <TH width="4%" scope=col>操作</TH>
                          <TH width="15%" height="26" scope=col>客户代码</TH>
                          <TH width="30%" scope=col>客户名称</TH>
                          <TH width="15%" scope=col>联系人</TH>
                          <TH width="15%" scope=col>客户电话</TH>                         
                          <TH width="15%" scope=col>客户传真</TH>
                        ...
                        <TR class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">
                        	<TD width="4%">
		                     ...
		                     <img src="${ctx }/img/newbtn/select_0.png" btn=btn title='选择' onClick="setValue('${bctid}', '${bctcustomername}');">
		                  </TD>
