...
<script>	
	function doList(link,perPage_Select,perPage_Text_Hidden){
	  	...
	  	finishedGlassesForm.action=link;
	  	finishedGlassesForm.submit();
	}
	function search(){
		...
		if(checkForm(document.all.finishedGlassesForm)){  
			$("img").removeAttr("onclick");
			finishedGlassesForm.action = "selectFinishedGlasses.action";
			finishedGlassesForm.submit();
		}
	}
	function selectFinished(obj){
		if(event.keyCode==13){
			if (obj.value === ''||obj.value.length<26) {
				...
				finishedGlassesForm.action = "selecFinishedtByGoodsbarcode.action";
				finishedGlassesForm.submit();
			}
...
<form name="finishedGlassesForm" method="post" action="">
    ...
    <TD><!-- ?? Start -->
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          ...
          <TR>
            <TD class=menubar_function_text height=27><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：选择成品镜商品</TD>
				   ...
				   <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      ...
                      <TR>
                      	...
                      	<TD width="%35" class="table_none" colspan="3" >
                            <input class="text_input200" type="text" onkeydown="selectFinished(this)" id="bgigoodsbarcode" name="bgigoodsbarcode" value="" style="ime-mode:disabled">
                    ...
                    <br/>
					<c:if test="${not empty(finishedGlassesList)}"> 
