					...
					<!-- END 分页 -->
                      ...
                      <TBODY>
                        ...
                        <TR class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">
						  <TD  height="26"><input id=chk type="checkbox" goodsid="${bgigoodsid}${rl}" stockid="${bgiwarehouseid }" onClick="setSingleValue(this);"  value="{'chkgoodis':'${bgigoodsid }${rl}','bgiordercycle':'${bgiordercycle }','bgigoodsid':'${bgigoodsid}','bgigoodsname':'${bgigoodsname}','bgiretailprice':'${bgiretailprice }','bgigoodsbarcode':'${bgigoodsbarcode }','bgicostprice':'${bgicostprice }','bginottaxrate':'${bginottaxrate }','rl':'${rl}','iscustomize':'${ bgiiscustomize}','bgiwarehouseid':'${ bgiwarehouseid}','bgigoodscategoryid':'${bgigoodscategoryid }','bgigoodsquantity':'${bgigoodsquantity }','maxdiscount':'${maxdiscount }','bgiintransitgoodsnum':'${empty(bgiintransitgoodsnum) ? '0':bgiintransitgoodsnum}','bgispec':'${bgispec}'}"></TD>
                          <TD>${bgigoodsid}</TD>
                          <TD>${bgigoodsname}</TD>
                          <c:if test="${systemParameterPo.fspisshowsupplierandbrand == '1'}"> 
                          <TD>${bgibrandname}</TD>
