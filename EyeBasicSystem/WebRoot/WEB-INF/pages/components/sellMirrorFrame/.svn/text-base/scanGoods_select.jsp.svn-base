...
<script>
	...
	function RorL(obj){
		...
		goodsForm.action="scanGoodsSelAll.action?rl="+$("input[name=rightOrleft][checked]").val()+'&kucun='+kucun;
		goodsForm.submit();
	}
	
	function changeKun(){
		goodsForm.action="scanGoodsSelAll.action?kucun="+$('#kucun').val()+"&rl="+$("input[name=rightOrleft][checked]").val();
		goodsForm.submit();
	}
</script>
