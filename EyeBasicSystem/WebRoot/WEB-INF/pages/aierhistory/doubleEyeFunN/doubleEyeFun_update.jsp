...
function save(){
	if(document.getElementById('radio02').checked==true&&document.getElementById('radio02').value=="0"){			
		...
		arrayObj = new Array();　//赋值"sopdesumdot","sopdefarworth"
		...
		if(ischeck == '0'){
			if(checkForm(document.all.doubleEyeFunForm)){    
				...
				doubleEyeFunForm.action = "updateDoubleEyeFunAier.action";
	...
	function refractive(){
		$("img").removeAttr("onclick");
		doubleEyeFunForm.action="refractiveToolAier.action?source=refractiveiou";
		doubleEyeFunForm.submit();
	}
	function inspection(){
		...
		$("img").removeAttr("onclick");
		doubleEyeFunForm.action="inspectionToolAier.action?source=inspectioniou";
		doubleEyeFunForm.submit();
	}
	
	function specialCheck(){
		$("img").removeAttr("onclick");
		doubleEyeFunForm.action="specialCheckToolAier.action?source=specialcheckiou";
		doubleEyeFunForm.submit();
	}
	function contactGlass(){
		doubleEyeFunForm.action="contactGlassToolAier.action?source=contactGlassiou";
		$("img").removeAttr("onclick");
		doubleEyeFunForm.submit();
	}
	...
	function glassHistory(){
		...
		doubleEyeFunForm.action="selectGlassesHistoryAier.action?customerID="+'${customerInfoPo.smecicustomerid }';
		doubleEyeFunForm.submit();
	}
	...
	function cornealContactlLens(){
		$("img").removeAttr("onclick");
		doubleEyeFunForm.action="cornealContactlLensToolAier.action?source=cornealContactlLensu";
		doubleEyeFunForm.submit();
	}
	...
	function fixingInterface(){
		$("img").removeAttr("onclick");
		doubleEyeFunForm.action="fixingInterfaceToolAier.action";
		doubleEyeFunForm.submit();
	}
							  ...
							  <tr>
								...
								<tr class="trBlue">
										<td  height="30" class="table_body" align="center" >
											...
											&nbsp;原因：&nbsp;
											<select id="sopdeaccount" moveorder="1" name="doubleEyeFunPo.sopdeaccount" readonly="readonly" myinput="myinput">
	                                          <option value=""></option>
								...
								<table width="99%" border=0 align=center cellpadding=1 cellspacing=1 class="privateTable privateBorder">
                                  <tbody>
                                    <tr>
                                      ...
                                      <td width="11%" class="table_none"><div align="left">
                                          <input  moveorder="5" id="sopdesumdot" name="doubleEyeFunPo.sopdesumdot" class="text_input60" value="${doubleEyeFunPo.sopdesumdot }">&nbsp;
                                      </div></td>
                                 ...
                                 <TABLE width="99%" border=0 align=center cellPadding=1 cellSpacing=1 class="privateBorder privateTable">
                                  <TBODY>
                                    <TR>
                                      ...
                                      <TD width="15%" class="table_none">AC/A：</TD>
                                      <TD class="table_none" colspan="2"><input moveorder="19" id="sopdeaca" name="doubleEyeFunPo.sopdeaca" class="text_input60" value="${doubleEyeFunPo.sopdeaca }"></TD>
                                    </TR>
                                    </TBODY>
                                    </TABLE>
                                  </c:if>
                                  ...
                                  <TBODY>
                                      ...
                                      <TD class="table_none"><div align="right">OU：</div></TD>
                                      <TD class="table_none">
                                      	    <input class="text_input100" id="addOU" moveorder="33" qj=qj name="doubleEyeFunPo.sopdeaddou" value="${doubleEyeFunPo.sopdeaddou }" mysel="mysel"/>
									  </TD>
                                      <TD class="table_none"><div align="right">OD：</div></TD>
                                      <TD class="table_none">
                                      		<input class="text_input100" id="addOD" moveorder="34" qj=qj name="doubleEyeFunPo.sopdeaddod" value="${doubleEyeFunPo.sopdeaddod }" mysel="mysel"/>
									  </TD>
                                      <TD class="table_none"><div align="right">OS：</div></TD>
                                      <TD colspan="2" class="table_none">
											<input class="text_input100" moveorder="35" id="addOS" qj=qj name="doubleEyeFunPo.sopdeaddos" value="${doubleEyeFunPo.sopdeaddos }" mysel="mysel"/>
                                      </TD>
                                      <td  class="table_none" colspan="6">
                                      	不等像视
										<INPUT  type="radio" name="doubleEyeFunPo.sopdeequalwatch" value="0" checked="checked" ${doubleEyeFunPo.sopdeequalwatch == "0" ? 'checked="checked"' : '' } onclick="javascript:chageOne();" >
