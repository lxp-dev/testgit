...
<html>
	...
	function save(){
			...
			if(checkForm(refractiveForm))
			{
				...
				refractiveForm.action="refractiveInsertAier.action?source=refractiveiou";
	...
	*/
	...
	function refractiveCopy(){
		$("img").removeAttr("onclick");
		refractiveForm.action="refractiveCopyAier.action?chuyanfuyan="+'${chuyanfuyan}'+"&oldOptometryID="+'${oldOptometryID}'+"&customerID="+'${customerID }'+"&optometryBasicID="+'${copyBasicOptometryID}'+"&moduleID="+'${moduleID}'+"&optometryID="+'${optometryID}';
		refractiveForm.submit();
	}
	...
	function fixingInterface(){
		$("img").removeAttr("onclick");
		refractiveForm.action="fixingInterfaceToolAier.action";
		refractiveForm.submit();
	}
												...
												<TD class="PrivateBorderBlue" width="6%">
																...
																<table width="99%" border=0 align=center cellpadding=1	cellspacing=1 class="privateTable privateBorder">															  		
																	<tr bgcolor="#CADEE8" height="30px">
																		<TD colspan="9" class="PrivateBorderBlue">
																...
																<fieldset>
																<legend>试戴镜结果<label style="color:red;">&nbsp;*&nbsp;</label></legend>
