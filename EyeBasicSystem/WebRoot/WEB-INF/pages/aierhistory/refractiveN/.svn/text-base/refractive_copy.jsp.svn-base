...
<html>
	...
	function doubleEyeFun(){
		$("img").removeAttr("onclick");
		refractiveForm.action="doubleEyeFunToolAier.action?source=doubleeyefuniou";
		refractiveForm.submit();
	}
	function specialCheck(){
		$("img").removeAttr("onclick");
		refractiveForm.action="specialCheckToolAier.action?source=specialcheckiou";
		refractiveForm.submit();
	}
												...
												<TBODY>
													<TR>
														...
														<TD style="PADDING-RIGHT: 15px; PADDING-LEFT: 15px; PADDING-BOTTOM: 15px; PADDING-TOP: 15px; "
															...
															<s:action name="initCustomerOptometryTitleN" executeResult="true" ignoreContextParams="true"/>
												<fieldset>
												<legend>
													主诉
												</legend>
																...
																<table width="99%" class="privateTable" border="0" cellpadding="0" cellspacing="0">
																	<tr>
																		<td>
																			...
																			<TD width="8%" class="PrivateBorderBlue" width="10%">&nbsp;</TD>
																						<TD class="PrivateBorderBlue" width="6%">
																							<div align="center">
																								裸眼视力：
																							</div>
