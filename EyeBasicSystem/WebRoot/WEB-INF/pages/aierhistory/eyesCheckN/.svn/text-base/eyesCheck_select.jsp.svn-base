...
<script>	
	...
	function details(id,sopecid){
		...
		if(is_iPad()){
			showPopWin("detailEyesCheckAier.action?hid="+id+"&sopecid="+sopecid,970,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}else{
			showPopWin("detailEyesCheckAier.action?hid="+id+"&sopecid="+sopecid,screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}
