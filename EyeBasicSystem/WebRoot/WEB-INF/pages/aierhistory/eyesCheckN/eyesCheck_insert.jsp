...
window.onload=function(){
	...
	if(checkForm(document.all.mydriasisForm)){    
	        var smecicustomerid = document.getElementById('smecicustomerid').value;
	        document.getElementById('psmecicustomerid').value = smecicustomerid;
        	$("img").removeAttr("onclick");
			mydriasisForm.action = "insertEyesCheckAier.action";
	...
	function setCustomer(memberid){
		...
		$("img").removeAttr("onclick");   
		mydriasisForm.action = "selEyesCheckForCustomerAier.action";
		mydriasisForm.submit();
	}
...
<input type="hidden" id="psmecicustomerid" name="psmecicustomerid" value="">
              ...
              <TR><!--?Start-->
                  ...
                  <TABLE height=22 cellSpacing=0 cellPadding=0 border=0>
					...
					<TD class=tab id=tabLabel__1 
                      onclick="JavaScript:window.location.href='initEyesCheckSelAier.action;'" 
									  ...
									  <tr>
										<td class="table_body">
										 <li class="horizontal"> 顾客卡号：
										  ...
										  <input name="eyesCheckPo.sopeccustomerid" id="smecicustomerid" type="hidden" value="${customerInfoPo.smecicustomerid}" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '卡号不能为空！'}]">
										  &nbsp;&nbsp;</li>
										  <li class="horizontal">
                  ...
                  border=0 align=center cellPadding=3 cellSpacing=1 class="privateBorder privateTable">
                                  <TBODY>
                                    ...
                                    <TR>
                                      ...
                                      <TD width="10%" class="table_none"><input name="eyesCheckPo.sopeciopod" class="text_input80" value="${eyesCheckPo.sopeciopod }" validate="[{'Type' : Type.String, 'Formula' : '', 'Expansion' : {Type : Expansion.LessThanLengthORNULL, Params : [21]}, 'Message' : '不能大于10字！'}]">&nbsp;mmHg</TD>
                                    </TR>
                                    <TR>
                                      <TD height="30" class="table_body"><div align="center">OS</div></TD>
                                      <TD class="table_none"><div align="center">
                                      ...
                                      <TD width="10%" class="table_none"><input name="eyesCheckPo.sopeciopos" class="text_input80" value="${eyesCheckPo.sopeciopos }" validate="[{'Type' : Type.String, 'Formula' : '', 'Expansion' : {Type : Expansion.LessThanLengthORNULL, Params : [21]}, 'Message' : '不能大于10字！'}]">&nbsp;mmHg</TD>
                                    </TR>
                                  </TBODY>
                                </TABLE></td>
							  </tr>
