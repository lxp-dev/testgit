...
<html>
	...
	function refractive(){
		...
		refractiveForm.action="initRefractiveSelectAier.action?dontshow="+dontshow;
	...
	function inspection(){
		$("img").removeAttr("onclick");
		var dontshow = $('#dontshow').val();
		refractiveForm.action="initInspectionSelectAier.action?dontshow="+dontshow;
		refractiveForm.submit();
	}
	function contactGlass(){
		var dontshow = $('#dontshow').val();
		refractiveForm.action="initContactGlassSelectAier.action?dontshow="+dontshow;
		$("img").removeAttr("onclick");
		refractiveForm.submit();
	}
	function doubleEyeFun(){
		$("img").removeAttr("onclick");
		var dontshow = $('#dontshow').val();
		refractiveForm.action="selectDoubleEyeFunAier.action?dontshow="+dontshow;
		refractiveForm.submit();
	}
	function specialCheck(){
		var dontshow = $('#dontshow').val();
		refractiveForm.action="selectSpecialCheckAier.action?dontshow="+dontshow;
		$("img").removeAttr("onclick");
		refractiveForm.submit();
	}
	
	function glassHistory(){
		refractiveForm.action="selectGlassesHistoryAier.action?viewDetail=true";
		$("img").removeAttr("onclick");
		refractiveForm.submit();
	}
	...
	function cornealContactlLens(){
  		var dontshow = $('#dontshow').val();
		$("img").removeAttr("onclick");
		refractiveForm.action="initCornealContactlLensSelectAier.action?dontshow="+dontshow;
		refractiveForm.submit();
	}
