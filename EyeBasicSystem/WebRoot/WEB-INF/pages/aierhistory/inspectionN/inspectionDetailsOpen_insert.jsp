...
<script type="text/javascript">
	function save(){
		if(confirm('是否为正式提交处方？')){
			inspectionForm.action="inspectionInsertDetailsOpenAier.action?ruleFlag=1&nw='N' ";
			$("img").removeAttr("onclick");
			inspectionForm.submit();
		}else{
			inspectionForm.action="inspectionInsertDetailsOpenAier.action?ruleFlag=''&nw='N' ";
			$("img").removeAttr("onclick");
			inspectionForm.submit();
		}
	}
