	...
	function save(){
		...
		if($('[name*=.sopipballglassod]').length!=0){
			if(isSubmit == 0){
				...
				inspectionForm.action="inspectionInsertAier.action?ruleFlag=0&nw='N'";
...
+"</td></tr>";  
	...
	function checkCylZero(){
  	...
  	function cornealContactlLens(){
		$("img").removeAttr("onclick");
		inspectionForm.action="cornealContactlLensToolAier.action?source=cornealContactlLensu";
		inspectionForm.submit();
	}
	...
	function fixingInterface(){
		$("img").removeAttr("onclick");
		inspectionForm.action="fixingInterfaceToolAier.action";
		inspectionForm.submit();
	}
