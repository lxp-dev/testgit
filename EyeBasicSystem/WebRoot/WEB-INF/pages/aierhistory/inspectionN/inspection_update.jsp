...
function changeFocus(obj)
{
	...
	function save(){
		...
		if($('[name*=.sopipballglassod]').length!=0){
			if(isSubmit == 0){
				...
				inspectionForm.action="inspectionUpdateAier.action?ruleFlag=0&nw='N' ";
	...
	function refractive(){
		inspectionForm.action="refractiveToolAier.action?source=refractiveiou";//refractiveTool.action?source=refractiveiou
		$("img").removeAttr("onclick");
		inspectionForm.submit();
	}
	...
	function specialCheck(){
		...
		if('$(oldOptometryID)'!=''){
			inspectionForm.action="specialCheckToolAier.action?source=specialcheckcopy";
		}
		$("img").removeAttr("onclick");
		inspectionForm.submit();
	}
