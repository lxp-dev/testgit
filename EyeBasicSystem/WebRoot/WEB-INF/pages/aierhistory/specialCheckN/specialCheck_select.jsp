...
window.onload=addfunction;
	...
	function inspection(){
		...
		specialCheckForm.action="initInspectionSelectAier.action?dontshow="+dontshow;
		specialCheckForm.submit();
	}
	function doubleEyeFun(){
		var dontshow = $('#dontshow').val();
		$("img").removeAttr("onclick");
		specialCheckForm.action="selectDoubleEyeFunAier.action?dontshow="+dontshow;
		specialCheckForm.submit();
	}
	function refractive(){
		var dontshow = $('#dontshow').val();
		$("img").removeAttr("onclick");
		specialCheckForm.action="initRefractiveSelectAier.action?dontshow="+dontshow;
		specialCheckForm.submit();
	}
	
	function glassHistory(){
		specialCheckForm.action="selectGlassesHistoryAier.action?viewDetail=true";
		$("img").removeAttr("onclick");
		specialCheckForm.submit();
	}
	...
	function cornealContactlLens(){
		var dontshow = $('#dontshow').val();
		$("img").removeAttr("onclick");
		specialCheckForm.action="initCornealContactlLensSelectAier.action?dontshow="+dontshow;
		specialCheckForm.submit();
	}
	
	function contactGlass(){
		var dontshow = $('#dontshow').val();
		specialCheckForm.action="initContactGlassSelectAier.action?dontshow="+dontshow;
		$("img").removeAttr("onclick");
		specialCheckForm.submit();
	}
	...
	function fixingInterface(){
		$("img").removeAttr("onclick");
		specialForm.action="selectFixingInterfaceAier.action";
		specialForm.submit();
	}
</script>
</HEAD>
                                          ...
                                          <TR>
                                            ...
                                            <TD bgcolor="#E9F2F7" class="Privateborder"><div align="center">
                                               <c:forEach var="optionParamPoTmp" items="${optionParamPolist}" >
			                                      <c:if test="${optionParamPoTmp.fopparentid=='37' && (healthCheckPo.sophctearfilmgradeod1 == optionParamPoTmp.fopparamid)}">
			                                      	${optionParamPoTmp.fopparamname}
			                                      </c:if>	                                      	
		                                       </c:forEach>&nbsp;
                                            </div></TD>
                                            <TD bgcolor="#E9F2F7" class="Privateborder"><div align="center">
                                               ${healthCheckPo.sophcschirme5od }&nbsp;
                                            </div></TD>
                                            <TD bgcolor="#E9F2F7" class="Privateborder"><div align="center">
                                               ${healthCheckPo.sophcbu7od }s&nbsp;
                                            </div></TD>
                                          </TR>
                                          <TR>
                                            ...
                                            <TD bgcolor="#E9F2F7" class="Privateborder"><div align="center">
                                               <c:forEach var="optionParamPoTmp" items="${optionParamPolist}" >
			                                      <c:if test="${optionParamPoTmp.fopparentid=='37' && (healthCheckPo.sophctearfilmgradeos1 == optionParamPoTmp.fopparamid)}">
			                                      	${optionParamPoTmp.fopparamname}
			                                      </c:if>
		                                       </c:forEach>&nbsp;
                                            </div></TD>
                                            <TD bgcolor="#E9F2F7" class="Privateborder"><div align="center">
                                                 ${healthCheckPo.sophcschirme5os }&nbsp;
                                            </div></TD>
                                            <TD bgcolor="#E9F2F7" class="Privateborder"><div align="center">
                                                 ${healthCheckPo.sophcbu7os }s&nbsp;
                                            </div></TD>
                                          </TR>
                                        </TBODY>
                                    </TABLE></td>
                   ...
                   border=0 align=center cellpadding=1 cellspacing=1 class="privateTable privateBorder">
							...
							<fieldset>
								<table width="99%" border=0 align=center cellpadding=1	cellspacing=1 class="privateTable privateBorder">
									<tbody>
										<tr bgcolor="#CADEE8" height="26">
											<TD class="PrivateBorderBlue" width="10%">
											<div align="center">备注</div>
											</TD>
											<TD>${fn:trim(healthCheckPo.sophcremark) }</TD>
										</tr>
									</tbody>
								</table>
							</fieldset>
