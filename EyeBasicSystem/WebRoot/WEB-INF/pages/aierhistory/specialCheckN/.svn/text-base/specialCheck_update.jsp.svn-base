...
-->
	...
	function save(){
		if(checkForm(document.all.specialForm)){    
			...
			specialForm.action = "updateSpecialCheckAier.action";
			if('${copy}'=='copy'){
				specialForm.action = "insertSpecialCheckAier.action";
			}
	...
	function refractive(){
		$("img").removeAttr("onclick");
		specialCheckForm.action="refractiveToolAier.action?source=refractiveiou";
		specialCheckForm.submit();
	}
	function inspection(){
		$("img").removeAttr("onclick");
		specialCheckForm.action="inspectionToolAier.action?source=inspectioniou";
		specialCheckForm.submit();
	}
	
	function doubleEyeFun(){
		$("img").removeAttr("onclick");	
		specialCheckForm.action="doubleEyeFunToolAier.action?source=doubleeyefuniou";
		specialCheckForm.submit();
	}
	...
	function glassHistory(){
		...
		specialCheckForm.action="selectGlassesHistoryAier.action?customerID="+'${customerInfoPo.smecicustomerid }';
		specialCheckForm.submit();
	}
	...
	function contactGlass(){
		specialCheckForm.action="contactGlassToolAier.action?source=contactGlassiou";
		$("img").removeAttr("onclick");
		specialCheckForm.submit();
	}
	...
	function cornealContactlLens(){
		$("img").removeAttr("onclick");
		specialCheckForm.action="cornealContactlLensToolAier.action?source=cornealContactlLensu";
		specialCheckForm.submit();
	}

	function fixingInterface(){
		$("img").removeAttr("onclick");
		specialForm.action="fixingInterfaceToolAier.action";
		specialForm.submit();
	}
                                  ...
                                  <TBODY>
                                    ...
                                    <TR>
                                      ...
                                      <TD bgcolor="#E9F2F7" class="Privateborder">
                                        <div align="center">
                                          <input moveorder="1" name="healthCheckPo.sophceyeaxisod" value="${healthCheckPo.sophceyeaxisod }" class="text_input60">
                                      mm</div></TD>
                                    ...
                                    <TR>
                                      ...
                                      <TD bgcolor="#E9F2F7" class="Privateborder"><div align="center">
                                          <input moveorder="6" name="healthCheckPo.sophceyeaxisos" value="${healthCheckPo.sophceyeaxisos }" class="text_input60">
                                        mm</div></TD>
                                      <TD bgcolor="#E9F2F7" class="Privateborder"><div align="center">
                                  ...
                                  <TBODY>
                                    ...
                                    <TR>
                                      <TD height="30" class="table_body">OD</TD>
                                       <TD bgcolor="#E9F2F7" class="Privateborder">
                                        <div align="center">
                                          <input moveorder="11" name="healthCheckPo.sophccornealthicknessod" value="${healthCheckPo.sophccornealthicknessod }" class="text_input60" >
                                      µm</div></TD>
                                      <TD class="Privateborder" bgcolor="#E9F2F7"><div align="center">
                                        <input moveorder="12" name="healthCheckPo.sophccorneacurvatureods1" value="${healthCheckPo.sophccorneacurvatureods1 }" class="text_input60">
                                        @
  										<input moveorder="13" name="healthCheckPo.sophccorneacurvatureods2" value="${healthCheckPo.sophccorneacurvatureods2 }" class="text_input60">
                                      </div></TD>
                                      <TD class="Privateborder" bgcolor="#E9F2F7"><div align="center">
                                        <input moveorder="14" name="healthCheckPo.sophccorneacurvatureodf1" value="${healthCheckPo.sophccorneacurvatureodf1 }" class="text_input60">
                                        @
                                        <input moveorder="15" name="healthCheckPo.sophccorneacurvatureodf2" value="${healthCheckPo.sophccorneacurvatureodf2 }" class="text_input60" >
                                      </div></TD>
                                    </TR>
                                    <TR>
                                      <TD height="30" class="table_body" >OS</TD>
                                        <TD bgcolor="#E9F2F7" class="Privateborder"><div align="center">
                                          <input moveorder="16" name="healthCheckPo.sophccornealthicknessos" value="${healthCheckPo.sophccornealthicknessos }" class="text_input60" >
                                        µm</div></TD>
                                        <TD bgcolor="#E9F2F7" class="Privateborder"><div align="center">
                                        <input moveorder="17" name="healthCheckPo.sophccorneacurvatureoss1" value="${healthCheckPo.sophccorneacurvatureoss1 }" class="text_input60">
                                        @
                                        <input moveorder="18" name="healthCheckPo.sophccorneacurvatureoss2" value="${healthCheckPo.sophccorneacurvatureoss2 }" class="text_input60">
                                      </div></TD>
                                      <TD bgcolor="#E9F2F7" class="Privateborder"><div align="center">
                                        <input moveorder="19" name="healthCheckPo.sophccorneacurvatureosf1" value="${healthCheckPo.sophccorneacurvatureosf1 }" class="text_input60">
                                        @
                                        <input moveorder="20" name="healthCheckPo.sophccorneacurvatureosf2" value="${healthCheckPo.sophccorneacurvatureosf2 }" class="text_input60" >
                                      </div></TD>
                                    </TR>
                                  </TBODY>
							</table>
                   ...
                   border=0 align=center cellpadding=1 cellspacing=1 class="privateTable privateBorder">
                                        <TBODY>
                                          ...
                                          <TR>
                                            ...
                                            <TD width="10%" class="Privateborder"><div align="center">Schirmer's Test</div></TD>
                                            <TD width="10%" class="Privateborder"><div align="center">BUT</div></TD>
                                          </TR>
                                          <TR>
                                            <TD class="table_body">OD</TD>
                                            <TD class="Privateborder" bgcolor="#E9F2F7"><div align="center">
                                               <input moveorder="21" name="healthCheckPo.sophctopographyskod" class="text_input80" value="${healthCheckPo.sophctopographyskod }">
                                            </div></TD>
                                            <TD class="Privateborder" bgcolor="#E9F2F7"><div align="center">
                                              <input moveorder="22" name="healthCheckPo.sophctopographyfkod" class="text_input80" value="${healthCheckPo.sophctopographyfkod }">
                                            </div></TD>
                                            <TD class="Privateborder" bgcolor="#E9F2F7"><div align="center">
                                            ...
                                            <TD class="Privateborder" bgcolor="#E9F2F7"><div align="center">
                                              <input moveorder="25" name="healthCheckPo.sophctopographysaiod" class="text_input80" value="${healthCheckPo.sophctopographysaiod }">
                                            </div></TD>
                                            <TD class="Privateborder" bgcolor="#E9F2F7"><div align="center">
                                              <input moveorder="26" name="healthCheckPo.sophctopographysriod" class="text_input80" value="${healthCheckPo.sophctopographysriod }" >
                                            </div></TD>
                                            <TD bgcolor="#E9F2F7" class="Privateborder"><div align="center">
                                            ...
                                            <TD bgcolor="#E9F2F7" class="Privateborder"><div align="center">
                                              <input moveorder="28" name="healthCheckPo.sophcschirme5od" class="text_input60" value="${healthCheckPo.sophcschirme5od }" >mm
                                            </div></TD>
                                            <TD bgcolor="#E9F2F7" class="Privateborder"><div align="center">
                                              <input moveorder="29" name="healthCheckPo.sophcbu7od" class="text_input60" value="${healthCheckPo.sophcbu7od }" >s
                                            </div></TD>
                                          </TR>
                                          <TR>
                                            <TD class="table_body" >OS</TD>
                                            <TD class="Privateborder" bgcolor="#E9F2F7"><div align="center">
                                                <input moveorder="30" name="healthCheckPo.sophctopographyskos" class="text_input80" value="${healthCheckPo.sophctopographyskos }">
                                            </div></TD>
                                            <TD class="Privateborder" bgcolor="#E9F2F7"><div align="center">
                                                <input moveorder="31" name="healthCheckPo.sophctopographyfkos" class="text_input80" value="${healthCheckPo.sophctopographyfkos }">
                                            </div></TD>
                                            <TD class="Privateborder" bgcolor="#E9F2F7"><div align="center">
                                            ...
                                            <TD class="Privateborder" bgcolor="#E9F2F7"><div align="center">
                                                <input moveorder="34" name="healthCheckPo.sophctopographysaios" class="text_input80" value="${healthCheckPo.sophctopographysaios }">
                                            </div></TD>
                                            <TD class="Privateborder" bgcolor="#E9F2F7"><div align="center">
                                                <input moveorder="35" name="healthCheckPo.sophctopographysrios" class="text_input80" value="${healthCheckPo.sophctopographysrios }" >
                                            </div></TD>
                                            <TD bgcolor="#E9F2F7" class="Privateborder"><div align="center">
                                            ...
                                            <TD bgcolor="#E9F2F7" class="Privateborder"><div align="center">
                                                <input moveorder="37" name="healthCheckPo.sophcschirme5os" class="text_input60" value="${healthCheckPo.sophcschirme5os }" >mm
                                            </div></TD>
                                            <TD bgcolor="#E9F2F7" class="Privateborder"><div align="center">
                                                <input moveorder="38" name="healthCheckPo.sophcbu7os" class="text_input60" value="${healthCheckPo.sophcbu7os }" >s
                                            </div></TD>
                                          </TR>
                                        </TBODY>
                                    </TABLE></td>
                   ...
                   border=0 align=center cellpadding=1 cellspacing=1 class="privateTable privateBorder">
                                    <TBODY>
                                      ...
                                      <TR>
                                        <TD height="30" class="table_body">OD</TD>
                                        <TD class="Privateborder" bgcolor="#E9F2F7"><div align="center">
                                          <input moveorder="39" name="healthCheckPo.sophcthicknessod" class="text_input100" value="${healthCheckPo.sophcthicknessod }">&nbsp;个/mm<sup>2</sup>
                                        </div></TD>
                                        <TD class="Privateborder" bgcolor="#E9F2F7"><div align="center">
                                          <input moveorder="40" name="healthCheckPo.sophcareaod" value="${healthCheckPo.sophcareaod }" class="text_input100" >&nbsp;um<sup>2</sup>
                                        </div></TD>
                                        <TD class="Privateborder" bgcolor="#E9F2F7"><div align="center">
                                          <input moveorder="41" name="healthCheckPo.sophcscaleod" value="${healthCheckPo.sophcscaleod }" class="text_input100" >&nbsp;%
                                        </div></TD>
										 <TD bgcolor="#E9F2F7" class="Privateborder"><div align="center">
                                      ...
                                      <TR>
                                        <TD height="30" class="table_body" >OS</TD>
                                        <TD class="Privateborder" bgcolor="#E9F2F7"><div align="center">
                                          <input moveorder="44" name="healthCheckPo.sophcthicknessos" class="text_input100" value="${healthCheckPo.sophcthicknessos }">&nbsp;个/mm<sup>2</sup>
                                        </div></TD>
                                        <TD class="Privateborder" bgcolor="#E9F2F7"><div align="center">
                                          <input moveorder="45" name="healthCheckPo.sophcareaos" value="${healthCheckPo.sophcareaos }" class="text_input100" >&nbsp;um<sup>2</sup>
                                        </div></TD>
                                        <TD class="Privateborder" bgcolor="#E9F2F7"><div align="center">
                                          <input moveorder="46" name="healthCheckPo.sophcscaleos" value="${healthCheckPo.sophcscaleos }" class="text_input100" >&nbsp;%
                                        </div></TD>
										 <TD bgcolor="#E9F2F7" class="Privateborder"><div align="center">
                                          <input moveorder="47" name="healthCheckPo.sophcvariationos" value="${healthCheckPo.sophcvariationos }" class="text_input100">&nbsp;%
                                        </div></TD>
                                        <TD bgcolor="#E9F2F7" class="Privateborder"><div align="center">
								...
								<table width="99%" border=0 align=center cellpadding=1	cellspacing=1 class="privateTable privateBorder">
									<tbody>
										<tr bgcolor="#CADEE8" height="26px">
											...
											<TD><textarea  id="sophcremark" name="healthCheckPo.sophcremark" validate="[{'Type' : Type.String, 'Formula' : '', 'Expansion' : {Type : Expansion.LessThanLengthORNULL, Params : [101]}, 'Message' : '备注不能大于100字！'}]" style="width:100%" cols="80" rows="5">${fn:trim(healthCheckPo.sophcremark) }</textarea></TD>
										</tr>
									</tbody>
								</table>
							</fieldset>
