...
<script type="text/javascript">
	function save(){
		if(checkForm(document.all.glassesHistoryForm)){    
			...
			glassesHistoryForm.action = "updateGlassesHistoryAier.action";
	...
	function optometry(){
		glassesHistoryForm.action="initOptometryBasicSelAier.action";
		glassesHistoryForm.submit();
	}
	...
	function refractive(){
		if('${optometryPo.sopoyflag}' != '1'){
			$("img").removeAttr("onclick");
			glassesHistoryForm.action="refractiveToolAier.action?source=refractiveiou";
			glassesHistoryForm.submit();
		}else{
			var dontshow = $('#dontshow').val();
			$("img").removeAttr("onclick");
			glassesHistoryForm.action="initRefractiveSelectAier.action?dontshow="+dontshow;
			glassesHistoryForm.submit();
		}
	}
	function inspection(){
	/*
		...
		*/
		...
		if('${optometryPo.sopoyflag}' != '1'){
			$("img").removeAttr("onclick");
			glassesHistoryForm.action="inspectionToolAier.action?source=inspectioniou";
			glassesHistoryForm.submit();
		}else{
			$("img").removeAttr("onclick");
			var dontshow = $('#dontshow').val();
			glassesHistoryForm.action="initInspectionSelectAier.action?dontshow="+dontshow;
			glassesHistoryForm.submit();
		}
	}
	function specialCheck(){
		if('${optometryPo.sopoyflag}' != '1'){
			$("img").removeAttr("onclick");
			glassesHistoryForm.action="specialCheckToolAier.action?source=specialcheckiou";
			glassesHistoryForm.submit();
		}else{
			$("img").removeAttr("onclick");
			var dontshow = $('#dontshow').val();
			glassesHistoryForm.action="selectSpecialCheckAier.action?dontshow="+dontshow;
			glassesHistoryForm.submit();
		}
	}
	...
	function doubleEyeFun(){
		if('${optometryPo.sopoyflag}' != '1'){
			$("img").removeAttr("onclick");
			glassesHistoryForm.action="doubleEyeFunToolAier.action?source=doubleeyefuncopy";
			glassesHistoryForm.submit();
		}else{
			$("img").removeAttr("onclick");
			var dontshow = $('#dontshow').val();
			glassesHistoryForm.action="selectDoubleEyeFunAier.action?dontshow="+dontshow;
			glassesHistoryForm.submit();
		}
	}
	...
	function cornealContactlLens(){
		if('${optometryPo.sopoyflag}' != '1'){
			$("img").removeAttr("onclick");
			glassesHistoryForm.action="cornealContactlLensToolAier.action?source=cornealContactlLensu";
			glassesHistoryForm.submit();	
		}else{
			var dontshow = $('#dontshow').val();
			$("img").removeAttr("onclick");
			glassesHistoryForm.action="initCornealContactlLensSelectAier.action?dontshow="+dontshow;
			glassesHistoryForm.submit();
		}
	}
	...
	function contactGlass(){
		if('${optometryPo.sopoyflag}' != '1'){
			glassesHistoryForm.action="contactGlassToolAier.action?source=contactGlassiou";
			$("img").removeAttr("onclick");
			glassesHistoryForm.submit();
		}else{
			var dontshow = $('#dontshow').val();
			glassesHistoryForm.action="initContactGlassSelectAier.action?dontshow="+dontshow;
			$("img").removeAttr("onclick");
			glassesHistoryForm.submit();
		}
	...
	function fixingInterface(){
		if('${optometryPo.sopoyflag}' != '1'){
			glassesHistoryForm.action="fixingInterfaceToolAier.action";
			$("img").removeAttr("onclick");
			glassesHistoryForm.submit();
		}else{
			var dontshow = $('#dontshow').val();
			glassesHistoryForm.action="selectFixingInterfaceAier.action?dontshow="+dontshow;
			$("img").removeAttr("onclick");
			glassesHistoryForm.submit();
		}
	}
