...
<script type="text/javascript">
	...
	function update(){
	 if(checkForm(postForm))
	 {
		...
		postForm.action = "updateShiftMaintainPo.action";
		postForm.submit();
		}
	}
                ...
                vAlign=top><DIV id=tabContent__1>
				  ...
				  <table width="100%" id="title0"  border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                    ...
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        <input type="hidden" value="${shiftMaintainPo.msmuuid}" name="shiftMaintainPo.msmuuid" id="msmuuid"/>
			            ...
			            <TR>
                          ...
                          <TD width="24%" class="table_none"><input class="text_input160" value="${shiftMaintainPo.msmworkLong}" name="shiftMaintainPo.msmworkLong" id="msmworkLong" onblur="if(!isNaN(this.value)) {this.value = new Number(this.value).toFixed(2);}" onchange="changeTime();"   validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '时长不能为空！'}, {'Type' : Type.Number, 'Formula' : '', 'Expansion' : {Type : Expansion.DecimalValidation, Params : [2]}, 'Message' : '时长格式错误！'}]">小时<label style="color:red;">&nbsp;*</label></TD>
			            </TR>
			            
			             <TR>
						   <TD width="8%" height="26" class="table_body">工作时间</TD>
			               <TD width="24%" class="table_none"><input class="text_input100" value="${shiftMaintainPo.msmworkBegin}" name="shiftMaintainPo.msmworkBegin" id="msmworkBegin" onFocus="WdatePicker({readOnly:true, dateFmt:'HH:mm'})" onchange="changeTime();"   maxlength="10" >-<input class="text_input100" value="${shiftMaintainPo.msmworkEnd}" name="shiftMaintainPo.msmworkEnd" id="msmworkEnd" onFocus="pickedFunc()" readonly="readonly" maxlength="10" ><label style="color:red;">格式为8:30</label></TD>
