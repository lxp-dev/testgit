    ...
    <TD><!-- ?? Start -->
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        ...
        <TR>
          ...
          <TD width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：员工薪酬模板详细</TD>
          <TD>&nbsp;</TD></TR>
        <TR>
                    ...
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        <TR>
			              ...
			              <TD width="23%" class="table_none">${compensationTemplatePo.mctpersonid }</TD>
						  <TD width="10%" height="30" class="table_body">姓名</TD>
                          <TD width="23%" class="table_none">${compensationTemplatePo.personname }</TD>
						  <TD width="10%" height="30" class="table_body">部门名称</TD>
                          <TD width="24%" class="table_none">${compensationTemplatePo.departmentname }</TD>
                        </TR>
                      </TBODY>
                    </TABLE>                     
                   <TABLE id=ctl00_PageBody_PostButton cellSpacing=1 cellPadding=3 width="100%" align=center border=0>
                   <tr>
                   	<td align="left">基本工资信息</td>
                   </tr>
                   </TABLE>
                   <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
						<TR>
				            ...
				            <TD width="23%" class="table_none">${compensationTemplatePo.mctjibengongzi }</TD>
							<TD width="10%" height="30" class="table_body">岗位津贴</TD>
	                        <TD width="24%" class="table_none">${ compensationTemplatePo.mctgangweijintie}</TD>                         
							<TD width="10%" height="30" class="table_body">工龄工资</TD>
	                        <TD width="23%" class="table_none">${compensationTemplatePo.mctgonglingjintie }</TD> 
                        </TR>
						<TR>
							<TD width="10%" height="30" class="table_body">保险</TD>
				            <TD width="23%" class="table_none">${compensationTemplatePo.mctbaoxian }</TD>
							<TD width="10%" height="30" class="table_body">公积金</TD>
	                        <TD width="24%" class="table_none">${ compensationTemplatePo.mctgongjijin}</TD>                         
							<TD width="10%" height="30" class="table_body">误餐费</TD>
	                        <TD width="23%" class="table_none">${compensationTemplatePo.mctwucanfei }</TD> 
                        </TR> 
						<TR>
							<TD width="10%" height="30" class="table_body">洗理费</TD>
				            <TD width="23%" class="table_none">${compensationTemplatePo.mctxilifei }</TD>
