...
$(document).ready(function() {
	...
	function save(){
		if(checkForm(personInfoForm))
		{
			...
			personInfoForm.action = "updateCompensationTemplatePo.action";
...
<input type="hidden" value="${compensationTemplatePo.mctpersonid}" name="compensationTemplatePo.mctpersonid" id="mctpersonid"/>
    ...
    <TD><!-- ?? Start -->
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        ...
        <TR>
          ...
          <TD width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：员工薪酬模板修改</TD>
          <TD>&nbsp;</TD></TR>
        <TR>
