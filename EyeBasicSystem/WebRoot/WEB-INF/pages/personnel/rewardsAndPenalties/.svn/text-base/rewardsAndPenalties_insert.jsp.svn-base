...
<script>	
	...
	function save(){
		if(checkForm(personInfoForm)){
			...
			personInfoForm.action = "insertRewardsAndPenalties.action";
                    ...
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        <TR>
			              ...
			              <TD width="23%" class="table_none"><li class="horizontal_onlyRight">
			              <input id="personid" class="text_input160" name="rewardsAndPenaltiesPo.mrppersonid" value="${rewardsAndPenaltiesPo.mrppersonid }" readonly="readonly"  validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '人员不能为空！'}]" /></li>
                          ...
                          <TD width="23%" class="table_none"><input class="text_input100" id=personname name="rewardsAndPenaltiesPo.mrppersonname" value="${rewardsAndPenaltiesPo.mrppersonname }" readonly="readonly" ></TD>
                          <TD class="table_body" width="9%">类型</TD>
						   ...
						   <select id="mrprewardsorpenalties" name="rewardsAndPenaltiesPo.mrprewardsorpenalties">
                            ...
                            <option value="0">罚款</option>                            
						   </select>
						  </TD>
                        </TR>
                        <TR>	
						   <TD class="table_body" width="9%">金额</TD>
						   <TD height="26" align="left" class="table_none" width="24%" colspan="5">
                          ...
                          <textarea name="rewardsAndPenaltiesPo.mrpremark" id="mrpremark"
                          	validate="[{'Type' : Type.String, 'Formula' : '', 'Expansion' : {Type : Expansion.LessThanLengthORNULL, Params : [2001]}, 'Message' : '备注不能大于2000字！'}]">${rewardsAndPenaltiesPo.mrppersonname }</textarea>
                          </label></TD>
                        </TR>
                           </TBODY>
                    </TABLE>  
