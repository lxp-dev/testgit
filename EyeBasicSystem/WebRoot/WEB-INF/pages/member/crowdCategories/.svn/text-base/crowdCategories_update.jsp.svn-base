...
<script>
	...
	if(checkForm(document.all.crowdCategoriesForm)){
		...
		crowdCategoriesForm.action = "updateCrowdCategories.action";
...
<input type="hidden" id="fccid" name="crowdCategoriesPo.fccid" value="${crowdCategoriesPo.fccid}" />
<DIV>
  ...
  <TR>
    <TD><!-- ?? Start -->
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        ...
        <TR>
          <TD class=menubar_function_text height=27><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：会员人群分类修改</TD>
                  ...
                  <DIV>
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      ...
                      <TR>
			               ...
			               <TD width="20%" class="table_none"><input value="${crowdCategoriesPo.fccmembertypename}" class="text_input100" type="text"  id="fccmembertypename" name="crowdCategoriesPo.fccmembertypename" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '顾客类型名称不能为空！'},{'Type' : Type.String, 'Formula' : Formula.LongDateFormat, 'Expansion' : {Type : Expansion.LessThanLength, Params : [51]}, 'Message' : '顾客类型名称输入长度不能大于50个字符！'}]"></TD>
						
                          
						  <TD width="10%" height="30" class="table_body">积分范围</TD>
                          <TD width="56%" class="table_none"><input value="${crowdCategoriesPo.fccup}" class="text_input100" type="text"  id="fccup" name="crowdCategoriesPo.fccup" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '积分范围上限不能为空！'},{'Type' : Type.String, 'Formula' : Formula.INT, 'Message' : '积分范围上限必须为整数！'},{'Type' : Type.String, 'Formula' : Formula.LongDateFormat, 'Expansion' : {Type : Expansion.LessThanLength, Params : [11]}, 'Message' : '积分范围上限输入长度不能大于10个字符！'}]">
                          到 <input class="text_input100" value="${crowdCategoriesPo.fccdown}" type="text"  id="fccdown" name="crowdCategoriesPo.fccdown" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '积分范围下限不能为空！'},{'Type' : Type.String, 'Formula' : Formula.INT, 'Message' : '积分范围下限必须为整数！'},{'Type' : Type.String, 'Formula' : Formula.LongDateFormat, 'Expansion' : {Type : Expansion.LessThanLength, Params : [11]}, 'Message' : '积分范围下限输入长度不能大于10个字符！'}]"></TD>
                     </TR>
                      </TBODY>
                    </TABLE>
