...
<script>
	function del(){
		...
		crowdCategoriesForm.action = "deleteCrowdCategories.action";
...
<input type="hidden" name="hid" value="${crowdCategoriesPo.fccid}">
  ...
  <TR>
    <TD><!-- ?? Start -->
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        ...
        <TR>
          <TD class=menubar_function_text height=27><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：会员人群分类删除</TD>
                ...
                vAlign=top><DIV id=tabContent__1>
                  <DIV>
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 id="title1">
                      <TBODY>
                      <TR>
						   <TD width="10%" height="30">会员人群分类为:${crowdCategoriesPo.fccmembertypename},此条数据确认删除么</TD>
                        </TR>
                      </TBODY>
                    </TABLE>
                    <TABLE id=ctl00_PageBody_PostButton cellSpacing=1 cellPadding=3 width="100%" align=center border=0>
                      <TBODY>
                        <TR>
                          <TD><input id="submitButton" icon='icon-delete' type='button' value='删除' onClick="javascript:del()">
                          </TD>
						  </TR>
                      </TBODY>
                    </TABLE>
