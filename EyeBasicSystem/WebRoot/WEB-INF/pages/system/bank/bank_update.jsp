...
<script>
	...
	function update(){
	 if(checkForm(postForm)){
		...
		postForm.action = "updateBankPo.action";
		postForm.submit();
		}
	}
</script>
                ...
                vAlign=top><DIV id=tabContent__1>
				  ...
				  <table width="100%" id="title0"  border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                    ...
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        <TR>
                        	<input type="hidden" value="${bankPo.bbuuid}" name="bankPo.bbuuid" id="bbuuid"/>
                        	<TD width="8%" height="26" class="table_body">类型编号</TD>
			               <TD width="24%" class="table_none">${bankPo.bbnumber}<input type="hidden" class="text_input100" value="${bankPo.bbnumber}" name="bankPo.bbnumber" id="bbnumber" maxlength="10" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '银行编号不能为空！'},{'Type' : Type.String, 'Formula' : Formula.Word, 'Message' : '银行编号只允许输入整数和字母！'}]"></TD>
