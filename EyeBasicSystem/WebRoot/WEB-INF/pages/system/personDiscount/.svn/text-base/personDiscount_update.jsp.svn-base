...
　　 }
	...
	function save(){
		if(checkForm(document.all.personDiscountForm)){ 
			...
			personDiscountForm.action = "updatePersonDiscount.action";
                      ...
                      <TBODY>
					  	<TR>
			               ...
			               <TD width="24%" class="table_none">
                            ${personDiscountPo.fpdpersonid}<input type="hidden"  id="fpdpersonid" name="personDiscountPo.fpdpersonid" value="${personDiscountPo.fpdpersonid}">
			               </TD>
                        ...
                        <TR>
			               ...
			               <TD class="table_none" >
                            <input class="text_input100" type="text" maxlength="10" onKeyUp="value=value.replace(/[^\d\.]/g,'')" onblur="if(!isNaN(this.value)) { if(trim(this.value)!='')this.value = new Number(this.value).toFixed(2);};checkDiscount(this);" id="fpddiscount" name="personDiscountPo.fpddiscount" value="${personDiscountPo.fpddiscount}" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '折扣不能为空！'},{'Type' : Type.String, 'Formula' : Formula.UDiscount, 'Message' : '请重新填写折扣！'}]">&nbsp;<font color="red">&nbsp;折扣在0-1之间</font>
			               </TD>
			               ...
			               <TD class="table_none">
                            <input maxlength="4" class="text_input100" type="text" onKeyUp="value=value.replace(/[^\d\.]/g,'')" id="fpdspecialdiscount" onblur="if(!isNaN(this.value)) { if(trim(this.value)!='')this.value = new Number(this.value).toFixed(2);};checkDiscount(this);" name="personDiscountPo.fpdspecialdiscount" value="${personDiscountPo.fpdspecialdiscount}">&nbsp;<font color="red">&nbsp;折扣在0-1之间</font>
			               </TD>
                        </TR>
                        </table>
                        ...
                        <TR>
					       ...
					       <td class="table_none" width="16%">
					       		<input type="text" class="text_input100" name="personDiscountDetailsPo.fpdddiscounts" value="${fpdddiscount}" onblur="if(!isNaN(this.value)) { if(trim(this.value)!='')this.value = new Number(this.value).toFixed(2);};checkDiscount(this);" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '折扣不能为空！'}]">&nbsp;<font color="red">&nbsp;折扣在0-1之间</font>
					       </td>
					       <td class="table_body" width="8%">
					       		特殊折扣次数
					       </td>
					       ...
					       <td class="table_none">
					       		<input type="text" class="text_input100" name="personDiscountDetailsPo.fpddspecialdiscounts" value="${fpddspecialdiscount}" onblur="if(!isNaN(this.value)) { if(trim(this.value)!='')this.value = new Number(this.value).toFixed(2);};checkDiscount(this);">&nbsp;<font color="red">&nbsp;折扣在0-1之间</font>
					       </td>
                        </TR>
                        </s:iterator>
                      </TBODY>
