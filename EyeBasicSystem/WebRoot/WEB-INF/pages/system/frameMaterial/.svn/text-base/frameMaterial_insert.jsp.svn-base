...
<script>
	...
	function save(){
		...
		frameMaterialForm.action = "insertFrameMaterial.action";
		frameMaterialForm.submit();
		}
	}
	function clean(){
		document.getElementById('bfmid').value = "";
		document.getElementById('bfmname').value = "";
	} 
</script>
</head>
    ...
    <!-- ?? Start 
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        ...
        <TR>
          ...
          <td align="left"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：镜架材质维护新增</td>
                    ...
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        <TR>
			               ...
			               <TD width="24%" class="table_none"><input class="text_input100" value="${frameMaterialPo.bfmid}" name="frameMaterialPo.bfmid" id="bfmid" maxlength="5" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '镜架材质编码不能为空！'},{'Type' : Type.String, 'Formula' : Formula.Word, 'Message' : '镜架材质编码只允许输入整数和字母！'}]"><label style="color:red;">&nbsp;*</label></TD>
