...
<script>
	$(document).ready(function() {
		...
		for(var i=0; i<personjobtype.length; i++){
			$("input[id=personjobtype][value="+personjobtype[i].trim()+"]").attr("checked","checked");
		}
	});
	...
	function save(){
		if(checkForm(personInfoForm)){
			...
			personInfoForm.action = "updatePersonInfo.action";
                    ...
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        <TR>
			               ...
			               <TD width="23%" class="table_none">${personInfoPo.id }<input class="text_input100" class="text_input100" type="hidden" name="personInfoPo.id" value="${personInfoPo.id }" maxlength="7"></TD>
						   <TD width="8%" height="26" class="table_body">员工姓名</TD>
                           <TD width="23%" class="table_none"><input class="text_input100" name="personInfoPo.personName" value="${personInfoPo.personName }" maxlength="10" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '员工姓名不能为空！'},{'Type' : Type.String, 'Formula' : Formula.ALL_CN, 'Message' : '姓名为全中文！'}]"><label style="color:red;">&nbsp;*</label></TD>
						   <TD width="8%" height="26" class="table_body">性别</TD>
                           <TD class="table_none"><input type="radio" name="personInfoPo.sex" ${empty(personInfoPo.sex) ? 'checked="checked"' : '' } ${personInfoPo.sex != '1'? '' : 'checked="checked"' } value="1" />&nbsp;男 <input type="radio" name="personInfoPo.sex" ${personInfoPo.sex != '2'? '' : 'checked="checked"' } value="2" />&nbsp;女</TD>
                        </TR>
						<TR>
						   <TD height="26" class="table_body">联系电话</TD>
			               <TD class="table_none"><input class="text_input100" name="personInfoPo.phone" value="${personInfoPo.phone }" maxlength="13" validate="[{'Type' : Type.String, 'Formula' : Formula.PhoneORNULL, 'Message' : '联系电话格式错误！'}]"><label style="color:red;">&nbsp;&nbsp;如：022-85123455</label></TD>
                          ...
                          <TD class="table_none"><input class="text_input100" name="personInfoPo.email" value="${personInfoPo.email }" validate="[{'Type' : Type.String, 'Formula' : Formula.emailORNULL, 'Message' : '邮箱格式错误！'}]"/><label style="color:red;">&nbsp;&nbsp;&nbsp;如：123@qq.com</label></TD>
                        </TR>
                        <TR>
							<TD width="10%" height="26" class="table_body">员工卡号</TD>
							<TD width="23%" class="table_none">
								<input class="text_input100" id="cardid" name="personInfoPo.cardid" value="${personInfoPo.cardid }" validate="[{'Type' : Type.String, 'Formula' : Formula.WordNull, 'Message' : '员工卡号只允许输入整数和字母！'}]" value="${personInfoPo.cardid }" maxlength="20">
							</TD>
						...
						<TR>
						   <TD width="10%" height="26" class="table_body">员工角色</TD>
						   ...
						   <select id="roleid" name="personInfoPo.roleid" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '请选择员工角色！'}]">
								...
								<input name="changeDiscount" type="checkbox" checked="checked" value="changeDiscount">修改员工打折权限
								<label style="color:red;">&nbsp;*(勾选时，员工角色变更后，会同时修改该员工已有的打折权限。未勾选，则保留员工原有打折权限。)</label></TD>
						...
						<TR>
                          ...
                          <TD width="23%" class="table_none" colspan="5">
                          	<c:forEach var="personJobTypePo" items="${personJobTypePos }" >
                             	<input type="checkbox" id="personjobtype" name="personInfoPo.personjobtype" value="${personJobTypePo.bpjtid }">&nbsp;${personJobTypePo.bpjtname}&nbsp;&nbsp;&nbsp;&nbsp;
                            </c:forEach>
                          </TD>
						...
						<TR>
                          ...
                          <TD class="table_none" colspan="5">
                            <input class="text_input200" name="personInfoPo.address" value="${personInfoPo.address }" maxlength="100" style="width: 600">
						    <input type="hidden" id="checkMac" name="personInfoPo.checkMac" value="${personInfoPo.checkMac }"/>
                          </TD>
						</TR>
						<TR>
