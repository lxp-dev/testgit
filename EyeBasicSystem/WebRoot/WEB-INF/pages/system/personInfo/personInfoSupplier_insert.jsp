...
<script>
	...
	function save(){
		if(checkForm(personInfoForm)){
			...
			personInfoForm.action = "insertPersonInfoSupplier.action";
              ...
              <TR><!--?Start-->
                  ...
                  <TABLE height=22 cellSpacing=0 cellPadding=0 border=0>
                    ...
                    <TR>
                      ...
                      onClick="JavaScript:window.location.href='initSupplierUpdate.action?hid=${hid }&parent=${parent}&goodsTree=${goodsTree}&moduleID=${requestScope.moduleID}';" 
                    ...
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        <TR>
			               ...
			               <TD width="23%" class="table_none"><input class="text_input100" id="id" name="personInfoPo.id" value="${personInfoPo.id }" maxlength="10" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '人员编号不能为空！'},{'Type' : Type.String, 'Formula' : Formula.Word, 'Message' : '人员编号只允许输入整数和字母！'}]"><label style="color:red;">&nbsp;*</label></TD>
						
                          
						  <TD width="10%" height="30" class="table_body">人员姓名</TD>
                          <TD class="table_none"><input class="text_input100" id="personName" name="personInfoPo.personName" value="${personInfoPo.personName }" maxlength="10" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '人员姓名不能为空！'},{'Type' : Type.String, 'Formula' : Formula.ALL_CN, 'Message' : '姓名为全中文！'}]"><label style="color:red;">&nbsp;*</label></TD>
                        </TR>
						...
						<TR>
						   ...
						   <select id="roleid" name="personInfoPo.roleid" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '请选择人员角色！'}]">
					    	...
					    	<c:if test="${permissionPo.keyf == '1'}">
					    		<input type="text" class="text_input100" id="password" name="personInfoPo.password" value="${personInfoPo.password }" maxlength="20" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '人员密码不能为空！'},{'Type' : Type.String, 'Formula' : Formula.Word, 'Message' : '人员密码只允许输入整数和字母！'}]"/><label style="color:red;">&nbsp;*</label>
					    	</c:if>
					    	<c:if test="${permissionPo.keyf != '1'}">
					    	    <input type="password" class="text_input100" id="password" name="personInfoPo.password" value="${personInfoPo.password }" maxlength="20" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '人员密码不能为空！'},{'Type' : Type.String, 'Formula' : Formula.Word, 'Message' : '人员密码只允许输入整数和字母！'}]"/><label style="color:red;">&nbsp;*</label>
					    	</c:if>
					    	&nbsp;
