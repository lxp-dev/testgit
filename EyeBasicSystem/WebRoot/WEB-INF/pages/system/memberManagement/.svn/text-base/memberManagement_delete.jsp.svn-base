...
<script>
	...
	function del(){
		...
		memberManagementForm.action = "deleteMemberManagement.action";
...
<input type="hidden" name="hid" value="${memberManagementPo.fmmid}">
                ...
                vAlign=top><DIV id=tabContent__1>
                  <DIV>
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 id="title1">
                      <TBODY>
                      <TR>
						   <TD width="10%" height="30">会员卡类型为:${memberManagementPo.fmmmembername},此条数据确认删除吗?</TD>
                        </TR>
                      </TBODY>
                    </TABLE>
