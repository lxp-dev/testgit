...
<script>
	...
	function clean(){
		document.getElementById('fmmmembername').value = "";
		document.getElementById('fmmdown').value = "";
		document.getElementById('fmmup').value = "";
		document.getElementById('fmmtypeid').value = "";
		document.getElementById('fmmsubintegral').value = "";
		document.getElementById('fmdmaxdiscount').value = "";
		document.getElementById('fmmup').value = "";
	...
	if(checkForm(document.all.memberManagementForm)){
		...
		memberManagementForm.action = "insertMemberManagement.action";
                  ...
                  <DIV>
                    ...
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      ...
                      <TR>
			              ...
			              <TD width="18%" class="table_none"><input class="text_input160" type="text"  id="fmmmembername" name="memberManagementPo.fmmmembername" maxlength="10" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '会员卡类型名称不能为空！'}]"><label style="color:red;">&nbsp;*</label></TD>
						  <TD width="15%" height="26" class="table_body">积分范围</TD>
                          <TD width="24%" class="table_none"><input class="text_input100" type="text"  id="fmmdown" name="memberManagementPo.fmmdown" maxlength="10" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '积分范围下限不能为空！'},{'Type' : Type.String, 'Formula' : Formula.UINT, 'Message' : '积分范围下限必须为整数！'}]">&nbsp;与&nbsp; <input class="text_input100" type="text"  id="fmmup" name="memberManagementPo.fmmup" maxlength="10" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '积分范围上限不能为空！'},{'Type' : Type.String, 'Formula' : Formula.UINT, 'Message' : '积分范围上限必须为整数！'}]"><label style="color:red;">&nbsp;*</label></TD>
						  <TD width="11%" class="table_body">升级后会员卡类型</TD>
                          <TD class="table_none">
                         ...
                         <TR height="26"> 
                          ...
                          <TD class="table_none" colspan="3">
                             <input class="text_input100" onblur="yzZheKou();" id="fmdmaxdiscount" name="memberManagementPo.fmmdiscount" value="" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '折扣不能为空！'}]"  maxlength="4" >&nbsp;折&nbsp;&nbsp;&nbsp;
                             <input type="checkbox" name="memberManagementPo.fmmsetdefault" value="1">&nbsp;设置为默认会员卡类型
                             <input type="checkbox" id="isfavorable" name="memberManagementPo.fmmisfavorable" value="1">&nbsp;参与优惠活动
                          </TD>
                        </TR>
                    ...
                    <TABLE id=ctl00_PageBody_PostButton cellSpacing=1 cellPadding=3 width="100%" align=center border=0>
                      <TBODY>
                        <TR>
                          <TD>
                            <label style="color:red;">&nbsp;会员卡积分在【积分下限】以上(包含)且低于(不包含)【积分上限】之间。</label>
                          </TD>
                        </TR>
                        <TR>
