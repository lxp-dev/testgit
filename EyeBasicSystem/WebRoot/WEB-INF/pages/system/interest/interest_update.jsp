...
<script>
	...
	function update(){
	 if(checkForm(interestForm)){
		...
		interestForm.action = "updateInterest.action";
		interestForm.submit();
		}
	}
</script>
    ...
    <!-- ?? Start 
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        ...
        <TR>
          ...
          <td align="left"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：工艺类型维护修改</td>
                    ...
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        <TR>
			               ...
			               <TD width="24%" class="table_none">${interestPo.birid}<input type="hidden" value="${interestPo.birid}" name="interestPo.birid" id="birid"  maxlength="5" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '兴趣爱好编码不能为空！'}]"></TD>
