...
<script>
	function del(){
		...
		interestForm.action = "deleteInterest.action";
		interestForm.submit();
	}
</script>
<body  ${sessionScope.systemParameterPo.fsprightshowurl eq '1' ? 'onkeydown="KeyDown()" oncontextmenu="event.returnValue=false" onhelp="Showhelp();return false;"' : '' }>
<form action="" method="post" name="interestForm">
<input type="hidden" name="hid" value="${interestPo.birid}">
  ...
  <TR>
    <TD><br/><!-- ?? Start 
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
        <TR>
          <TD class=menubar_title><img border='0' src='${ctx}/img/pic/module.gif' align='absmiddle' hspace='3' vspace='3'>工艺类型维护</TD>
        ...
        <TR>
          <TD class=menubar_function_text height=27><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：工艺类型删除</TD>
                ...
                vAlign=top><DIV id=tabContent__1>
                  <DIV>
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 id="title1">
                      <TBODY>
                      <TR>
						   <TD width="10%" height="26">兴趣爱好为:${interestPo.birname},此条数据确认删除吗?</TD>
                        </TR>
                      </TBODY>
                    </TABLE>
