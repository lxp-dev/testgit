...
<script>
	...
	function save(){
		if(checkForm(interestForm)){
		$("img").removeAttr("onclick");
		interestForm.action = "insertInterest.action";
		interestForm.submit();
		}
	}
	function clean(){
		document.getElementById('firid').value = "";
		document.getElementById('birname').value = "";
	} 
</script>
</head>
                ...
                vAlign=top><DIV id=tabContent__1>
				  ...
				  <table width="100%" id="title0"  border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                    ...
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        <TR>
						   <TD width="8%" height="26" class="table_body">兴趣爱好编码</TD>
			               <TD width="24%" class="table_none"><input class="text_input100" value="${interestPo.birid}" name="interestPo.birid" id="birid" maxlength="5" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '兴趣爱好编码不能为空！'},{'Type' : Type.String, 'Formula' : Formula.Word, 'Message' : '兴趣爱好编码只允许输入整数和字母！'}]"><label style="color:red;">&nbsp;*</label></TD>
						
						  <TD width="8%" height="26" class="table_body">兴趣爱好名称</TD>
                          <TD colspan="3" class="table_none"><input class="text_input160" value="${interestPo.birname}" name="interestPo.birname" id="birname"  maxlength="20" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '兴趣爱好名称不能为空！'}]"><label style="color:red;">&nbsp;*</label></TD>
			            </TR>
                      </TBODY>
                    </TABLE>
