...
<script>
	...
	function save(){
		if(checkForm(teachnologyTypeForm)){
			$("img").removeAttr("onclick");
		teachnologyTypeForm.action = "insertTeachnologyType.action";
		teachnologyTypeForm.submit();
		}		
	}
	function clean(){
		document.getElementById('fttid').value = "";
		document.getElementById('fttname').value = "";
	} 
</script>
</head>
                    ...
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        <TR>
			               ...
			               <TD width="24%" class="table_none"><input class="text_input100" value="${teachnologyTypePo.fttid}" name="teachnologyTypePo.fttid" id="fttid" maxlength="5" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '编码不能为空！'},{'Type' : Type.String, 'Formula' : Formula.Word, 'Message' : '编码只允许输入整数和字母！'}]"><label style="color:red;">&nbsp;*</label></TD>
						
						  <TD width="8%" height="26" class="table_body">工艺名称</TD>
                          <TD colspan="3" class="table_none"><input class="text_input160" value="${teachnologyTypePo.fttname}" name="teachnologyTypePo.fttname" id="fttname"  maxlength="20" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '工艺名称不能为空！'}]"><label style="color:red;">&nbsp;*</label></TD>
			            </TR>
                      </TBODY>
                    </TABLE>
