...
<script>
	...
	function update(){
	 if(checkForm(teachnologyTypeForm)){
		...
		teachnologyTypeForm.action = "updateTeachnologyType.action";
                    ...
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        <TR>
			               ...
			               <TD width="24%" class="table_none">${teachnologyTypePo.fttid}<input type="hidden" value="${teachnologyTypePo.fttid}" name="teachnologyTypePo.fttid" id="fttid"  maxlength="5" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '编码不能为空！'}]"></TD>
