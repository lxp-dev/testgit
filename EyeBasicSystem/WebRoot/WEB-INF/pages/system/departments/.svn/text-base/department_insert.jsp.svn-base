...
<script>	
	...
	function clean(){
		document.getElementById('bdpdepartmentid').value = "";
		document.getElementById('bdpdepartmentname').value = "";
		document.getElementById('bdptype').selectedIndex = 0;
		document.getElementById('bdpwizardflag').selectedIndex = 0;
	}
	
	function save(){
		if(checkForm(departmentstForm)){
			document.all.submitButton.disabled="true";
			departmentstForm.action = "insertDepartment.action";
  ...
  <TR>
    <TD><!-- ?? Start -->
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        ...
        <TR>
          <TD class=menubar_function_text height=27><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：部门新增</TD>
                    ...
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        <TR>
			            	...
			            	<TD width="23%" class="table_none"><input class="text_input100" id="bdpdepartmentid" name="departmentsPo.bdpdepartmentid" value="${departmentsPo.bdpdepartmentid }" maxlength="10" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '编码不能为空！'},{'Type' : Type.String, 'Formula' : Formula.Word, 'Message' : '编码只允许输入整数和字母！'}]"><label style="color:red;">&nbsp;*</label></TD>
							<TD width="10%" height="30" class="table_body">部门名称</TD>
                        	<TD width="23%" class="table_none"><input class="text_input200" id="bdpdepartmentname" name="departmentsPo.bdpdepartmentname" value="${departmentsPo.bdpdepartmentname }" maxlength="50" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '部门名称不能为空！'}]"><label style="color:red;">&nbsp;*</label>	</TD>
							<TD width="10%" height="30" class="table_body">部门类型</TD>
                        	<TD width="23%" class="table_none">
                        		<select id="bdptype" name="departmentsPo.bdptype">
			            ...
			            <TR>
							<TD width="10%" height="30" class="table_body">精灵提醒</TD>
                        	<TD width="23%" class="table_none" colspan="5">
                        		<select id="bdpwizardflag" name="departmentsPo.bdpwizardflag">
