...
<script>
	$(document).ready(function() { 
	    ...
	    changeCompanyType('${companyNamePo.fcncompanytype}');
	});
...
<input type="hidden" id="fcnmasterorvice" name="companyNamePo.fcnmasterorvice" value="${companyNamePo.fcnmasterorvice }"/>
<input type="hidden" id="insertorupdate" name="insertorupdate" value="u">
<input type="hidden" id="fcnId"  name="companyNamePo.fcnId" value="${companyNamePo.fcnId}">
<DIV>
                    ...
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
					   ...
					   <TR>
                          ...
                          <TD colspan="3" class="table_none ">
                          	<input type="radio" id="companytype" name="companyNamePo.fcncompanytype" value="1" ${companyNamePo.fcncompanytype eq '1' ? 'checked="checked"' : '' } onclick="changeCompanyType('1');setwholesaleprice();">向本公司调拨时，默认填写成本价
                          	
                          	<c:if test="${systemParameterPo.fspwholesalepriceset eq '0'}">
                          	<input type="radio" id="companytype2" name="companyNamePo.fcncompanytype" value="2" ${companyNamePo.fcncompanytype eq '2' ? 'checked="checked"' : '' } onclick="changeCompanyType('2');setwholesaleprice();">向本公司调拨时，需要手工填写批发价
                            </c:if>
                          </TD>
					   </TR>
					   ...
					   <TR>
                          ...
                          <TD colspan="3" class="table_none ">
                          <li class="horizontal_onlyRight">
                             <img src="${ctx }/img/${empty(companyNamePo.fcnLogoPath) ? 'frame/index01-eims12.jpg':companyNamePo.fcnLogoPath}">
                             </li>
                          </TD>
					   </TR>				   
					   <TR>
                          ...
                          <TD colspan="3" class="table_none ">
                          <li class="horizontal_onlyRight">
                             <img src="${ctx }/img/${empty(companyNamePo.fcnbackGroundPath) ? 'frame/index02-eims.jpg':companyNamePo.fcnbackGroundPath}">
                          </li>
                          </TD>
					   </TR>
					   <TR>
                          ...
                          <TD colspan="3" class="table_none ">
                          <li class="horizontal_onlyRight">
                             <img src="${ctx }/img/${empty(companyNamePo.fcndepgroundPath) ? 'frame/index02-eims.jpg':companyNamePo.fcndepgroundPath}">
                          </li>
                          </TD>
					   </TR>
                      </TBODY>
                    ...
                    <TABLE id=ctl00_PageBody_PostButton cellSpacing=1 cellPadding=3 width="100%" align=center border=0>
                      <TBODY>
                        <TR>
                          ...
                          <img src="${ctx}/img/newbtn/btn_logo_0.png" title='默认logo' btn=btn onclick="defaultCompanyInfo('l')">
						  <img src="${ctx}/img/newbtn/btn_background_0.png" title='默认背景图' btn=btn onclick="defaultCompanyInfo('b')">  
						  <img src="${ctx}/img/newbtn/btn_gifchdep_0.png" title='默认部门选择背景' btn=btn onclick="defaultCompanyInfo('d')">  
                          </TD>
                        </TR>
                      </TBODY>
                    </TABLE>
