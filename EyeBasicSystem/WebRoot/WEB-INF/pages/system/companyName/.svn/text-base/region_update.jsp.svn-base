...
<script>
	...
	function insert(){
		if(checkForm(document.all.regionForm)){			    
			...
			regionForm.action = "updateRegion.action";
			regionForm.submit();
		}
	}
                ...
                vAlign=top><DIV id=tabContent__1>
				  ...
				  <table width="100%" id="title0"  border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                    ...
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
			           <TR>
			           	  <TD height="26" class="table_body " align="right" width="10%">区域ID</TD>
                          <TD class="table_none" width="25%">
                          	${companyNamePo.fcnjrid}
                            <input type="hidden" id="fcnjrid"  name="companyNamePo.fcnjrid" maxlength="4" value="${companyNamePo.fcnjrid}">
                          </TD>
                          <TD height="26" class="table_body "  align="right" width="10%">区域名称</TD>
                          <TD class="table_none ">
                            <input class="text_input240"  id="fcnjrname"  name="companyNamePo.fcnjrname" maxlength="20" value="${companyNamePo.fcnjrname}" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '请填写区域名称！'}]">
                          </TD>
					   </TR>
					</TBODY>
					</table>
