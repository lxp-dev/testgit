...
<script>
	...
	function save(){
		if(checkForm(document.all.mallBrandForm)){	
			...
			mallBrandForm.action = "insertMallBrandPo.action";
                      ...
                      <TBODY>
                        <TR>
			             ...
			             <TD class="table_none" colspan="5">
			               <input clean=clean class="text_input400" id="mbname" name="mallBrandPo.mbname" maxlength="100" value="${mallBrandPo.mbname }" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '商品品种名称不能为空！'}]">
                        ...
                        <TR>
						  ...
						  <td class="table_none">
                            <input type="text" class="text_input300" name="mallBrandPo.mbpicurl" id="mbpicurl" value="${mallBrandPo.mbpicurl}" readonly="readonly"/>
