...
<script>	
	...
	function search(){
		if(checkForm(supplierOpenForm)){  
			...
			supplierOpenForm.action = "selectSalesIds.action";
	...
	function setValue(billID, salesid){	
		...
		if(is_iPad()){
			showPopWin("consignProcessTakeInsert.action?billID="+billID+"&salesid="+salesid+"&moduleID=${moduleID}",970,screen.height-200,topRows,topCols,returnRefresh(true),true);
		}else{
			showPopWin("consignProcessTakeInsert.action?billID="+billID+"&salesid="+salesid+"&moduleID=${moduleID}",screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),true);
		}
...
<img src="${ctx }/img/newbtn/btn_today_0.png"  btn=btn title="今天" onClick="today()"></li>
                        ...
                        <TR>
                          ...
                          <TD height="26" class="table_body">球镜</TD>
			               <TD class="table_none">
                            <input class="text_input80" type="text" onchange="checkNumberType(this);"  id="minSphjp" name="qjv" value="${requestScope.qjv}" maxlength="6" validate="[{'Type' : Type.String, 'Formula' : Formula.SphCylOrNull, 'Message' : '请重新填写球镜度数！'}]">
			               </TD>
						   <TD height="26" class="table_body" >柱镜</TD>
			               <TD class="table_none">
                            <input class="text_input80" type="text" onchange="checkNumberType(this);" id="minCyljp" name="zjv" value="${requestScope.zjv}" maxlength="6" validate="[{'Type' : Type.String, 'Formula' : Formula.SphCylOrNull, 'Message' : '请重新填写柱镜度数！'}]">	
                           </TD>                        
                        </TR>
                        <c:if test="${systemParameterPo.fspdjsbm == '1'}">
                        <TR>
					...
					<table width="100%"   border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                      ...
                      <TBODY>
                        ...
                        <TR class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">
                          ...
                          <TD>${cstcpodmembername}</TD>
                          <TD>${cstcpoddepartmentname}</TD>
