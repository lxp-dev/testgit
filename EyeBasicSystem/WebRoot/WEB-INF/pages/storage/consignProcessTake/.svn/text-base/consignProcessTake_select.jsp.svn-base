...
<script>	
	...
	function search(){
		...
		consignProcessReceiptForm.action = "selConsignProcessTake.action";
	...
	function details(id){
		...
		if(is_iPad()){
			showPopWin("consignProcessTakeDetails.action?hid="+id,970,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}else{
			showPopWin("consignProcessTakeDetails.action?hid="+id,screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}
				...
				<TD>
                  <TABLE height=22 cellSpacing=0 cellPadding=0 border=0>
                    ...
                    <TD width=3><IMG id=tabImgLeft__1 height=22 
                      ...
                      <TD class=tab id=tabLabel__1 
                      background=${ctx }/img/pic/tab_unactive_bg.gif 
                       onclick="JavaScript:window.location.href='initSalesIdsSelW.action?moduleID=${requestScope.moduleID}';"
...
<img src="${ctx }/img/newbtn/btn_today_0.png"  btn=btn title="今天" onClick="today()"></li></TD>
                    	...
                    	<TR>
                    	   <TD class="table_body" width="10%" height="26">收入仓位</TD>
			               <TD class="table_none">
			               ...
			               <TD class="table_body" width="10%" height="26">审核状态</TD>
			               <TD class="table_none">
			               ...
			               <TD width="60" height="26" class="table_body">审核日期</TD>
			               <TD class="table_none">
...
<img src="${ctx }/img/newbtn/btn_today_0.png"  btn=btn title="今天" onClick="today1()"></li></TD>
                        ...
                        <TR>
			                ...
			                <TD class="table_none" >
	                            <input class="text_input160" type="text"  id="createPersonName" name="cstcprCreatePersonName" value="${cstcprCreatePersonName}">
	                            <input class="text_input100" type="hidden"  id="createPersonID" name="cstcprCreatePersonID" value="${cstcprCreatePersonID}">
			               </TD>
                          <TD class="table_body" height="26">审核人</TD>
			                <TD class="table_none">
	                            <input class="text_input160" type="text"  id="auditPersonName" name="cstcprAuditPersonName" value="${cstcprAuditPersonName}">
	                            <input class="text_input100" type="hidden"  id="auditPersonID" name="cstcprAuditPersonID" value="${cstcprAuditPersonID}">
			               </TD>
					...
					<c:if test="${not empty(consignProcessReceipts)}"> 
					<table width="100%"   border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                      ...
                      <TBODY>
                        <TR class=table_title align=middle>
						  ...
						  <TH width="15%" scope=col>关联配镜单号</TH>	
						...
						<s:iterator value="consignProcessReceipts">
                        <TR class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">
                          <TD>
		                     <img src="${ctx }/img/newbtn/search_0.png" btn=btn title='详细' onClick="javascript:details('${cstcprreceiptbillid }')">
		                  </TD>
                          <TD height="26">${cstcprreceiptbillid}</TD>
                          <TD>${cstcprsalesid }</TD>
                          <TD>${cstcprsuppliername}</TD>
                          <TD>${cstcprinstockname}</TD>
                          <TD>${cstcprcreatepersonname}</TD>
                          <TD>${fn:substring(cstcprbilldate,0,16)}</TD>
                          <TD>${cstcprauditpersonname}</TD>
                          <TD>${fn:substring(cstcprauditdate,0,16)}</TD>
                          <TD title="${cstcprremark}"><div class="autocut50">${cstcprremark}</div></TD>
						</TR>
						</s:iterator>						  
                      </TBODY>
                    </TABLE>
