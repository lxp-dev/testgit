                    ...
                    <table width="100%" id="title0"  border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                      ...
                      <TBODY>
                        ...
                        <TR>
			               ...
			               <TD class="table_none">${workingCheckPo.pchckchecklabourname}</TD>
					...
					<table width="100%" border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                     ...
                     <table id="jdjTable" width="100%" border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder">
                      <TBODY>
                        <TR class="row" align=middle>
						  <TH width="10%" scope=col height="26"><font color="red">[×]该销售单未检验</font></TH>		
						  </TR>
						</TBODY>
					 </table>
                     </c:if>
                     ...
                     <table width="100%" border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder">
                      <TBODY>
                        ...
                        <TR class="row" height="25">
                          <TD>${workingCheckPo.pchckcokecentervertical }mm</TD>
                          <TD>${workingCheckPo.pchckcolor }mm</TD>
                          <TD>√</TD>
						</TR>				  
                      </TBODY>
                    </TABLE>
