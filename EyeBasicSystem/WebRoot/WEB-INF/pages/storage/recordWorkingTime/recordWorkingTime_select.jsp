...
<script>	
	...
	function search(){
		...
		recordWorkingTimeForm.action = "selectRecordWorkingTime.action";
		recordWorkingTimeForm.submit();
		showLoadingBar();
	}	
	...
	function recordWorkingTime(ssesbsalesid){
		...
		if('${systemParameterPo.fspfirstchecktype }' == '1'){
			if(confirm("配镜单:"+ssesbsalesid+",确认此销售单是否初检完成？")){ 
				$("img").removeAttr("onClick");
				recordWorkingTimeForm.action = "insertRecordWorkingTime.action?moduleID="+moduleID+"&ssesbsalesid="+ssesbsalesid;
				recordWorkingTimeForm.submit();
			}
		}else{
			...
			if(is_iPad()){
				showPopWin("initInsertRecordWorkingTime.action?moduleID="+moduleID+"&ssesbsalesid="+ssesbsalesid,970,screen.height-200,topRows,topCols,returnRefresh(true),true);
			}else{
				showPopWin("initInsertRecordWorkingTime.action?moduleID="+moduleID+"&ssesbsalesid="+ssesbsalesid,screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),true);
			}
			document.getElementById('popupTitle').innerHTML="【加工初检新增】";
		}
	}
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <td><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：初检查询</td>
            ...
            <TABLE cellSpacing=0 cellPadding=0 border=0>
              ...
              <TR><!--?Start-->
                  ...
                  <TABLE height=22 cellSpacing=0 cellPadding=0 border=0>
                    ...
                    <c:if test="${systemParameterPo.fspfirstchecktype == '2'}">
                    <TD width=3><IMG id=tabImgLeft__1 height=22 
                        src="${ctx}/img/pic/tab_unactive_left.gif" width=3></TD>
                      <TD class=tab id=tabLabel__1                       
                      background=${ctx}/img/pic/tab_unactive_bg.gif 
                      onclick="JavaScript:window.location.href='initRecordWorkingCheckSel.action?moduleID=${requestScope.moduleID}';"
                      ...
                      <TBODY>
                        ...
                        <TR ${ssesbworrytype != '2' ? '':'style="color: red;font:bold;"'} class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">
                          ...
                          <TD>
		                     ...
		                     <img id="${ssesbsalesid}" src="${ctx}/img/newbtn/check_0.png" btn=btn title='检验' onClick="javascript:recordWorkingTime('${ssesbsalesid}')">
		                  	</c:if>  
		                  </TD>
