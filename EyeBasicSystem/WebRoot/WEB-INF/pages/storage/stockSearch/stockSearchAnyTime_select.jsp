...
<script>
    ...
    function storagefxSel(id){
    	...
    	var warehouseID=document.all.warehouseID.value;
        ...
        var DataURL = "report.action?reportlet=StorageSearchSelRpt.cpt&goodsID="+goodsID+"&goodsBarcode="+goodsBarcode+"&goodscategoryID="
                      ...
                      +"&minSphlh="+minSphlh+"&maxSphlh="+maxSphlh+"&pjlx="+pjlx+"&talerttype="+talerttype;
	...
	function search(){
		...
		if($('#goodsBarcode').val() != ''){
			if($('#goodsBarcode').val().length != 26 && '${systemParameterPo.fspeffectivealert}' != '0'){
				alert("填写条码长度应为26位！");
				$('#goodsBarcode').focus();
				return;
			}
    	...
    	if(checkForm(procurementReceiptForm)){  
    		...
    		procurementReceiptForm.action = "selStockSearchAnyTime.action";
	...
	function clean(){
		...
		$('#price_group_no').attr('checked',true);
	...
	function showStockDetails(bgigoodsid,bgiwarehouseid,goodsBarcode){
		...
		if(is_iPad()){
			showPopWin("selectStockGoodsinfoPo.action?moduleID=${requestScope.moduleID}&bgigoodsid="+bgigoodsid+"&bgiwarehouseid=" + bgiwarehouseid+"&goodsBarcode="+goodsBarcode+"&startTime="+$('#startTime').val()+"&endTime="+$('#endTime').val(),970,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}else{
			showPopWin("selectStockGoodsinfoPo.action?moduleID=${requestScope.moduleID}&bgigoodsid="+bgigoodsid+"&bgiwarehouseid=" + bgiwarehouseid+"&goodsBarcode="+goodsBarcode+"&startTime="+$('#startTime').val()+"&endTime="+$('#endTime').val(),screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}
		document.getElementById('popupTitle').innerHTML="【商品详细】";
	}

	function showBrandDetails(bgigoodsid,bgiwarehouseid,bgiretailprice){
	    var topRows = top.document.getElementById("total").rows;
		var topCols = top.document.getElementById("btmframe").cols;
		
		if(is_iPad()){
			showPopWin("selStockSearchLs2.action?moduleID=${requestScope.moduleID}&bgigoodsid="+bgigoodsid+"&bgiwarehouseid=" + bgiwarehouseid+"&bgiretailprice="+bgiretailprice+"&startTime="+$('#startTime').val()+"&endTime="+$('#endTime').val(),970,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}else{
			showPopWin("selStockSearchLs2.action?moduleID=${requestScope.moduleID}&bgigoodsid="+bgigoodsid+"&bgiwarehouseid=" + bgiwarehouseid+"&bgiretailprice="+bgiretailprice+"&startTime="+$('#startTime').val()+"&endTime="+$('#endTime').val(),screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}
		document.getElementById('popupTitle').innerHTML="【商品详细】";
	}
	
	function showBrandDetails1(bgibrandsid,bgiwarehouseid,bgiretailprice){
		var bgispecjj=$('#bgispecjj').val();              //型号
    	var bgicolorjj=$('#bgicolorjj').val();            //色号
    	var bgiframesizejj=$('#bgiframesizejj').val();         //尺寸 
    	var bgieyeglassmaterialtypejp=$('#bgieyeglassmaterialtypejp').val(); //镜片材料分类
		...
		var topCols = top.document.getElementById("btmframe").cols;
		if(is_iPad()){
			showPopWin("selStockSearchAnyTime.action?moduleID=${requestScope.moduleID}&searchKey=openwindow&radio_type=brand&price_group=yes&usingWarehouse=0&bgiretailbeginprice="+bgiretailprice+"&bgiretailendprice="+bgiretailprice+"&whichretail="+ ${whichretail} +"&goodsID="+bgibrandsid+"&warehouseID=" + bgiwarehouseid+url,970,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}else{
			showPopWin("selStockSearchAnyTime.action?moduleID=${requestScope.moduleID}&searchKey=openwindow&radio_type=brand&price_group=yes&usingWarehouse=0&bgiretailbeginprice="+bgiretailprice+"&bgiretailendprice="+bgiretailprice+"&whichretail="+ ${whichretail} +"&goodsID="+bgibrandsid+"&warehouseID=" + bgiwarehouseid+url,screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}
		document.getElementById('popupTitle').innerHTML="【商品详细】";
	}
                  ...
                  <DIV>
					...
					<table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      ...
                      <TR>
			               ...
			               <TD width="20%" class="table_none">
                            <input type="radio" id="price_group_no" value="no" name="price_group" checked>不分组
      	                    <input type="radio" id="price_group_yes" value="yes" name="price_group" ${price_group eq 'yes' ? 'checked' : '' }>分组
			               </TD>
                        ...
                        <TR>
			               ...
			               <TD  class="table_none"><input class="text_input100" type="text"  id="bgiretailbeginprice" name="bgiretailbeginprice" value="${requestScope.bgiretailbeginprice}" onKeyUp="value=value.replace(/[^\d\.]/g,'')" validate="[{'Type' : Type.String, 'Formula' : Formula.UFloatORNULL, 'Message' : '请重新填写零售价!'}]" maxlength="10"> ~ <input class="text_input100" type="text"  id="bgiretailendprice" name="bgiretailendprice" value="${requestScope.bgiretailendprice}" onKeyUp="value=value.replace(/[^\d\.]/g,'')" validate="[{'Type' : Type.String, 'Formula' : Formula.UFloatORNULL, 'Message' : '请重新填写零售价!'}]" maxlength="10">
			               ...
			               <TD height="26" class="table_body">库存时间</TD>
                        	 <TD class="table_none" colspan="3"><li class="horizontal_onlyRight"><input id="startTime"
					       name="startTime" 
					       type="text" class="text_input120" 
					       onFocus="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd HH:mm', maxDate:'#F{$dp.$D(\'endTime\')}'})"
					       value="${startTime }" /> 至 <input id="endTime"
					       name="endTime" 
					       type="text" class="text_input120" 
					       onfocus="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd HH:mm',minDate:'#F{$dp.$D(\'startTime\')}'})" 
					        value="${endTime }" />
					        </li>
                        	 </TD>
                        </TR>
					...
					<!-- Loading Bar ----------------------------------------------------------------------------------------------------------------->
                     ...
                     <c:if test="${not empty(brandsList)}">
                      ...
                      <TBODY>
						...
						<!-- 
						<TR class=table_title align=middle> 
						  <TH width="40%" height="26" ${systemParameterPo.fspisshowsupplierandbrand == '1' || departmenttype != '1' ? 'colspan="6"':'colspan="5"'} scope=col align="right">期初数量：&nbsp;&nbsp;&nbsp;&nbsp;</TH>
					      <TH scope=col width="5%" >${bgigoodsquantityCount }</TH>
				   		</TR>
				   		 -->
						<TR class=table_title align=middle> 
						  	<TH width="40%" height="26" ${systemParameterPo.fspisshowsupplierandbrand == '1' || departmenttype != '1' ? 'colspan="6"':'colspan="5"'}  scope=col align="right">页内合计：&nbsp;&nbsp;&nbsp;&nbsp;</TH>
						...
						<TR class=table_title align=middle> 
						  	<TH height="26" ${systemParameterPo.fspisshowsupplierandbrand == '1' || departmenttype != '1' ? 'colspan="6"':'colspan="5"'} scope=col align="right">库存合计：&nbsp;&nbsp;&nbsp;&nbsp;</TH>
					...
					<c:if test="${not empty(goodsList)}"> 
                      ...
                      <TBODY>
						...
						<TR class=table_title align=middle> 
						    <TH width="40%" height="26"  ${systemParameterPo.fspisshowsupplierandbrand == '1' || departmenttype != '1' ? 'colspan="6"':'colspan="5"'} scope=col align="right">库存合计：&nbsp;&nbsp;&nbsp;&nbsp;</TH>
					    	<TH scope=col width="5%">${requestScope.titlenum}</TH>
				   		</TR>  
                      </TBODY>
                    </table>
...
说明：	<br/>										
&nbsp;&nbsp;&nbsp;&nbsp;【库存时间】：非必填项。	<br/>												
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;当只填写库存时间的起始日期时，将只查询此日期以后(包含此日期)的库存变更。<br/>		
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;当只填写库存时间的截止日期时，将只查询此日期之前(包含此日期)的库存变更。<br/>		
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;当填写库存时间的起始和截止查询日期时，将查询此日期之间(包含此起始日期和截止日期)的库存变更。<br/>	
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;库存时间的起始和截止查询日期均未填写时，将查询所有的库存变更。<br/>				
