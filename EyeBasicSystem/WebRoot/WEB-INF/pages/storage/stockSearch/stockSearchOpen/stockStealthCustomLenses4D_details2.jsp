                    ...
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        ...
                        <TR>
			               ...
			               <TD class="table_none">${goodsInfoPo.bgiaxisul}-${goodsInfoPo.bgiaxisup}&nbsp;
	                         </TD>
						   <TD height="26" class="table_body">曲率1</TD>
			               <TD class="table_none">${goodsInfoPo.bgicurvature1ul}-${goodsInfoPo.bgicurvature1up}&nbsp;
	                         </TD>
			               <TD class="table_body">曲率2</TD>
			               <TD class="table_none">${goodsInfoPo.bgicurvature2ul}-${goodsInfoPo.bgicurvature2up}&nbsp;
	                        </TD>
                        </TR> 
 
                        <TR>
                         <TD class="table_body">直径</TD>
			               <TD class="table_none">${goodsInfoPo.bgidiaul}-${goodsInfoPo.bgidiaup}&nbsp;
	                         </TD>
						...
						<TR>
						  <TD height="26" class="table_body">柱镜</TD>
			               <TD class="table_none">
									${goodsInfoPo.bgicylul }- ${goodsInfoPo.bgicylup}&nbsp;
	                            </TD>
