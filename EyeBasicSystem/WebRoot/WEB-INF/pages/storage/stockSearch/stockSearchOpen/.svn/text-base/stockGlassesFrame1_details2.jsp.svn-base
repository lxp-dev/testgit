                ...
                vAlign=top><DIV id=tabContent__1>
                  <DIV>
                    ...
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        <TR>
						   <TD width="11%" height="26" class="table_body">商品代码</TD>
			               ...
			               <TD width="11%" height="26" class="table_body">商品条码</TD>
			               <TD width="24%" class="table_none">
                          ...
                          <TD height="26" class="table_body">工艺类型</TD>
			               <TD class="table_none">
                             <s:iterator value="teachnologyList" >
                             	${fttid eq goodsInfoPo.bgiframeprocesscrafttype ? fttname : '' }
                             </s:iterator>&nbsp;
			               </TD>
                       ...
                       <TR>
			               ...
			               <TD class="table_none"  colspan="5">${goodsInfoPo.bgiretailprice}&nbsp;</TD>                           
                        </TR>
