...
<script>	
	...
	function details(uuid,changeid,tflag){		
		...
		if(is_iPad()){
			showPopWin("selectStockEntry.action?hid="+ uuid +"&changeid="+changeid+"&moduleID="+'${requestScope.moduleID}&bgiwarehouseid=&tflag='+tflag,970,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}else{
			showPopWin("selectStockEntry.action?hid="+ uuid +"&changeid="+changeid+"&moduleID="+'${requestScope.moduleID}&bgiwarehouseid=&tflag='+tflag,screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}
                ...
                vAlign=top><DIV id=tabContent__1>
                  <DIV>
				   ...
				   <c:if test="${not empty(goodsDetailsList)}"> 		
						...
						<TR class=table_title align=middle> 
						  	<TH width="40%" height="26"  colSpan=7 scope=col align="right">销售合计：&nbsp;&nbsp;&nbsp;&nbsp;</TH>
