...
//-----------向下复制数量-------------------------
	...
	function save(){
		if(checkForm(document.all.procurementReceiptForm)){ 
			...
			procurementReceiptForm.action = "insertProcurementReceipt.action?cstiauditstate="+cstiauditstate;
			procurementReceiptForm.submit();
		}
	}
                  ...
                  border=0>
                      <TBODY>
                        <TR height="26">
                         ...
                         <TD width="9%" class="table_body">订单单号</TD>
                          ...
                          <li class="horizontal_onlyRight">
                          <img src="${ctx }/img/newbtn/btn_change_0.png" onmouseover="JavaScript:$(this).attr('src','${ctx }/img/newbtn/btn_change_1.png');" onmouseout="JavaScript:$(this).attr('src','${ctx }/img/newbtn/btn_change_0.png');" title="选择" onClick="javascript:openOrders();">
                          </li>
                          </TD>
                          <TD class="table_body" width="9%">采购类型</TD>
                          <TD class="table_none">
	                          <select id="cstpgoodscategory" name="inventoryPo.cstigoodscategory"  onchange="deleteROW('1');isshow('');"><!--onchange="if(this.value == 7)  document.all.alertGoods.disabled=true; else document.all.alertGoods.disabled=false; "-->
							  		<option value="">----请选择----</option>
							  		<option value="1"  ${inventoryPo.cstigoodscategory== '1' ?'selected="selected"':''}>镜架</option>
										<option value="2" ${inventoryPo.cstigoodscategory== '2' ?'selected="selected"':''} >配件</option>
										<option value="3"  ${inventoryPo.cstigoodscategory== '3' ?'selected="selected"':''}>镜片</option>
		     	               			<c:if test="${systemParameterPo.fspstealtheffective==0}"> 
										<option value="4"  ${inventoryPo.cstigoodscategory== '4' ?'selected="selected"':''}>隐形镜片</option>
										<option value="5"  ${inventoryPo.cstigoodscategory== '5' ?'selected="selected"':''}>隐形护理液</option>
		     	               			</c:if>
										<option value="6"  ${inventoryPo.cstigoodscategory== '6' ?'selected="selected"':''}>太阳镜</option>
										<option value="8"  ${inventoryPo.cstigoodscategory== '8' ?'selected="selected"':''}>老花镜</option>
										<option value="7"  ${inventoryPo.cstigoodscategory== '7' ?'selected="selected"':''}>耗材</option>
										<option value="9"  ${inventoryPo.cstigoodscategory== '9' ?'selected="selected"':''}>视光</option>
                        ...
                        <TR>
						   ...
						   <li class="horizontal_onlyRight">
						   <img src="${ctx }/img/newbtn/btn_change_0.png" onmouseover="JavaScript:$(this).attr('src','${ctx }/img/newbtn/btn_change_1.png');" onmouseout="JavaScript:$(this).attr('src','${ctx }/img/newbtn/btn_change_0.png');" title="选 择" name=ctl00$PageBody$Button1   onClick="deleteROW('2');">
						   </li>
						   </TD>
					...
					<table id="addTable" width="100%" border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder">
                      <TBODY>
                    	...
                    	<TR class=table_title align=middle> 
						  	<TH width="40%" height="26" id="heji" colSpan=19 scope=col align="right">合计：&nbsp;&nbsp;&nbsp;&nbsp;</TH>
                        ...
                        <td  id=xjg>${po.bgibelowplusluminosity}</td>
                          ...
                          <td id=sylx><c:if test="${po.bgiusetype=='1'}"> 常带型</c:if>
		                          	...
		                          	<c:if test="${po.bgiusetype=='3'}">塑形镜</c:if> </td>
