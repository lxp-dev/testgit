...
<script>	
	...
	if(checkForm(document.all.adjustmentPriceForm)){ 
		...
		var adflag=false;
		$('input[id=updatecostprice]').each(function(){
			if($(this).val()==''){
				alert('请先填写调整价格!');
				adflag=true;
				return false;
		...
		adjustmentPriceForm.action = "brandPriceInsert2.action";
	...
	function openGoodSingle(){
		...
		if(is_iPad()){
			showPopWin("initBrandPriceSel2.action",970,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}else{
			showPopWin("initBrandPriceSel2.action",screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}
	...
	function addRow(goodInfo){
		...
		c5.innerHTML = goodInfo.bbdcostprice+ '<input type="hidden" id="costprice" name="brandTempPo.costprice" value="' + goodInfo.bbdcostprice +'" />';
		c6.innerHTML = '<input  type="text" id="updatecostprice" name="brandTempPo.updatecostprice" value="" onkeyup="toFixAndNan(this)" class="text_input60" onblur="toFix(this)" >';	
                ...
                vAlign=top><DIV id=tabContent__1>
                  <DIV>
                    ...
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        <TR>
                          <TD height="26" width="10%" class="table_body">单据编号</TD>
                         ...
                         <input name="adcostPricePo.cpraccreatedate" type="hidden" value="<fmt:formatDate value="${now}" type="both" dateStyle="long" pattern="yyyy-MM-dd" />"/>
                        </TR>
                        <TR>
					      ...
					      <TD width="24%" class="table_none">
					        <input type="hidden" id="adcostPriceWay" name="adcostPricePo.cprapflag" value="0">
                          ...
                          <TD width="40%" class="table_none">${person.personName }</TD>
                        </TR>
                        ...
                        <TR>
                          ...
                          <TD class="table_none" colSpan=6><textarea name="adcostPricePo.cpracremark" id="textarea2"></textarea></TD>
                        </TR>
                      </TBODY>
                    </TABLE>
