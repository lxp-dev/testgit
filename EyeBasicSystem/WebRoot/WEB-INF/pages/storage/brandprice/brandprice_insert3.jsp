...
<script>	
	...
	if(checkForm(document.all.adjustmentPriceForm)){ 
		...
		var adflag=false;
		$('input[id=updatewholesaleprice]').each(function(){
			if($(this).val()==''){
				alert('请先填写调整价格!');
				adflag=true;
				return false;
		...
		adjustmentPriceForm.action = "brandPriceInsert3.action";
	...
	function openGoodSingle(){
		...
		if(is_iPad()){
			showPopWin("initBrandPriceSel3.action",970,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}else{
			showPopWin("initBrandPriceSel3.action",screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}
	...
	function addRow(goodInfo){
		...
		c5.innerHTML = goodInfo.bbdwholesaleprice+ '<input type="hidden" id="wholesaleprice" name="brandTempPo.wholesaleprice" value="' + goodInfo.bbdwholesaleprice +'" />';
		c6.innerHTML = '<input  type="text" id="updatewholesaleprice" name="brandTempPo.updatewholesaleprice" value="" onkeyup="toFixAndNan(this)" class="text_input60" onblur="toFix(this)" >';	
                ...
                vAlign=top><DIV id=tabContent__1>
                  <DIV>
                    ...
                    <TABLE id=ctl00_PageBody_PostButton cellSpacing=1 cellPadding=3 width="100%" align=center border=0>
                      <TR>
                        <TD align="left">
                          <img name="button22" src="${ctx}/img/newbtn/btn_ppaddgoods_0.png" onmouseover="JavaScript:$(this).attr('src','${ctx }/img/newbtn/btn_ppaddgoods_1.png');" onmouseout="JavaScript:$(this).attr('src','${ctx }/img/newbtn/btn_ppaddgoods_0.png');" title="添加品种" 
