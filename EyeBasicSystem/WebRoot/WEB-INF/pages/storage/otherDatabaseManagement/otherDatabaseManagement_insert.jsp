  ...
  <TR>
    <TD><!-- ?? Start -->
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
        <TR>
          <TD class=menubar_title><img border='0' src='${ctx}/img/pic/module.gif' align='absmiddle' hspace='3' vspace='3'>其它出库</TD>
                    ...
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
						...
						<TR>
						   ...
						   <TD width="10%" height="30" class="table_body">发出部门</TD>
			               <TD class="table_none">
                        ...
                        <TR>
			               <TD width="10%" height="30" class="table_body">发出仓位</TD>
			               <TD class="table_none">                            
