...
<script>
	...
	function printReport(id){
		...
		url+="eims_reporting/storage_checkSurPlusSumRpt&billId="+id+"&rs:Command=Render";
			</c:when>
           	<c:when test="${overagelossesPo.cstibilltypeid==6}">
		url+="eims_reporting/storage_checkSurDefSumRpt&billId="+id+"&rs:Command=Render";
			</c:when>
        </c:choose>
          ...
          <TD align="right" colspan="3">
            <s:action name="getFittingTemplateTypeInfo" executeResult="true">
	            <s:param name="actionTypeID">
	            	<c:choose>
						<c:when test="${overagelossesPo.cstibilltypeid eq '5'}">19</c:when>
			       		<c:when test="${overagelossesPo.cstibilltypeid eq '6'}">47</c:when>
			       	</c:choose>				
				</s:param>
	            <s:param name="actionImgUrl">${ctx}/img/newbtn/btn_print_0.png</s:param>
	            <s:param name="actionFinereportRequestString"></s:param>
	            <s:param name="actionReportingServiceRequestString">&billId=${overagelossesPo.cstibillid}</s:param>
				<s:param name="actionReportTitle">盘盈盘亏单打印</s:param>	            
            </s:action>          
          </TD>
        </TR>
              ...
              <TR>
                ...
                vAlign=top><DIV id=tabContent__1>
                  <DIV>
                    ...
                    <TABLE class="privateBorder" cellSpacing=1 cellPadding=3 width="100%" align=center border=0>
                      <TBODY>
                        <TR>
