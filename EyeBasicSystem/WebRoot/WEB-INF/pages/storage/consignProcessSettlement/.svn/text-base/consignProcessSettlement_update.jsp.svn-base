...
<script>
	...
	function save(){
		if(checkForm(document.all.financialSettlementForm)){
			...
			financialSettlementForm.action = "updateConsignProcessSettlement.action?cstifinanceauditstate="+cstifinanceauditstate;
        ...
        <TR>
		   <TD colspan="3" align="right">
            <s:action name="getFittingTemplateTypeInfo" executeResult="true">
	            <s:param name="actionTypeID">20</s:param>
				...
				<s:param name="actionReportTitle">委外收货结算单打印</s:param>	            
            </s:action>	   
          </TD>
        </TR>
                    ...
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        <TR>
			               ...
			               <TD class="table_none" width="23%">&nbsp;${inventoryPo.cstibillid}<input type="hidden" id="cstibillid" name="inventoryPo.cstibillid" value="${inventoryPo.cstibillid}"></TD>
					...
					<table id="addTable" width="100%" border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder">
                        ...
                        <tr class=table_title align=middle> 
				   		...
				   		<s:iterator value="inventoryEntryList" status="idx">
	                        ...
	                        <TD>${cstiespec}</TD>
	                        <TD>${cstiegoodsquantity}<input type="hidden" readOnly="readonly" onchange="remove();" style="background-color:#ACA899;width:100%" value="${cstiegoodsquantity}" name="goodsInfoTempPo.goodsquantity" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '请填写商品数量！'},{'Type' : Type.String, 'Formula' : Formula.UINT, 'Message' : '请填写正确的商品数量！'}]" readonly="readonly"/></TD>                                               
	                        <TD><input type="text" style="background-color:#ACA899;width:100%" onchange="remove();" readOnly="readonly" name="goodsInfoTempPo.nottaxrate" value="${cstienottaxrate}" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '请填写单位成本！'},{'Type' : Type.String, 'Formula' : Formula.UFloat, 'Message' : '请填写正确的单位成本！'}]"/></TD>
	                        <TD><input type="text" readOnly="readonly" onchange="remove();" style="background-color:#ACA899;width:100%" name="goodsInfoTempPo.nottaxrateamount" value="${cstienottaxrateamount}" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '请填写成本合计！'},{'Type' : Type.String, 'Formula' : Formula.UFloat, 'Message' : '请填写正确的成本合计！'}]"/></TD>
	                        <TD><input type="text" onchange="autoCountOnlyOne(this);" style="width:100%" name="goodsInfoTempPo.taxrate" value="${cstietaxrate}" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '请填写税率！'},{'Type' : Type.String, 'Formula' : Formula.UINT, 'Message' : '请填写正确的税率！'}]"/></TD>
	                        ...
	                        <TD><input type="text" readOnly="readonly" onchange="remove();" style="background-color:#ACA899;width:100%" name="goodsInfoTempPo.taxamount" value="${cstietaxamount}" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '请填写税额合计！'},{'Type' : Type.String, 'Formula' : Formula.UFloat, 'Message' : '请填写正确的税额合计！'}]"/></TD>
	                        <TD><input type="text" style="background-color:#ACA899;width:100%" name="goodsInfoTempPo.costpriceamount" value="${cstiecostpriceamount}" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '请填写价税合计！'},{'Type' : Type.String, 'Formula' : Formula.UFloat, 'Message' : '请填写正确的价税合计！'}]"/></TD>
