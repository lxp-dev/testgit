...
<script>
	function del(){
		...
		adcostPriceForm.action = "adcostPriceDelete.action";
                ...
                vAlign=top><DIV id=tabContent__1>
                  <DIV>
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 id="title1">
                      <TBODY>
                      <TR>
						   <TD width="10%" height="30">含税单价调价单:${requestScope.bid},此条数据确认删除吗?</TD>
                        </TR>
                      </TBODY>
                    </TABLE>
                    <TABLE id=ctl00_PageBody_PostButton cellSpacing=1 cellPadding=3 width="100%" align=center border=0>
                      <TBODY>
                        <TR>
                          <TD>
                          <img id="button1" src="${ctx }/img/newbtn/btn_delete_0.png" btn=btn title="删除" onClick="del();">
                          </TD>
						  </TR>
                      </TBODY>
                    </TABLE>
