...
<script>	
	...
	if(checkForm(document.all.adjustmentPriceForm)){ 
		...
		adjustmentPriceForm.action = "adcostPriceInsert.action";
	...
	function openGoodSingle(){
		var supplierID='';
		var categoryID_open='';	
		//showPopWin("","initGoodsModifyPriceSel.action?categoryID_open="+categoryID_open+"&supplierID_open=" + supplierID ,screen.width-200,screen.height-200, '', null, true);
		//selectHidden();
		var topRows = top.document.getElementById("total").rows;
		var topCols = top.document.getElementById("btmframe").cols;
                        ...
                        <TR>
                          <TD align="left" valign="bottom">
                             <li class="horizontal_onlyRight">
                              <input class="text_input100" id="adjustmentPrice" name="adjustmentPrice" type="text" maxlength="20">&nbsp;
                             </li>
                             <li class="horizontal_onlyRight">
