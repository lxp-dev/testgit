...
<script>
	...
	if(checkForm(document.all.financialSettlementForm)){ 
		...
		if (document.getElementsByName("inventoryPo.cstifinanceauditstate")[0].checked==true){
		...
		financialSettlementForm.action = "updateOtherReceiptSettlement.action?cstifinanceauditstate="+cstifinanceauditstate;
                ...
                vAlign=top><DIV id=tabContent__1>
                  <DIV>
                    ...
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        <TR>
						   <TD width="11%" height="26" class="table_body">单据编号</TD>
                        ...
                        <tr>
			               ...
			               <TD class="table_none" colspan="5"><jsp:useBean id="now" class="java.util.Date" />
                         ...
                         <TR>
                          ...
                          <TD class="table_none" colSpan=5 height="80">${inventoryPo.cstiremark}&nbsp;</TD>
                        </TR>
                      </TBODY>
                    </TABLE>
					...
					<table id="addTable" width="100%" border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder">
                        ...
                        <tr class=table_title align=middle> 
				   		...
				   		<s:iterator value="inventoryEntryList" status="idx">
	                        ...
	                        <TD>${cstiespec}</TD>
	                        <TD><input type="text" readOnly="readonly" onchange="remove();" style="background-color:#ACA899" style="width:100%" value="${cstiegoodsquantity}" name="goodsInfoTempPo.goodsquantity" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '请填写商品数量！'},{'Type' : Type.String, 'Formula' : Formula.INT, 'Message' : '请填写正确的商品数量！'}]"/></TD>                                               
