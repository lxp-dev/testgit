...
<script>
	...
	function search(){
		...
		allocationForm.action = "selProcurementOrdersForApp.action";
	...
	function openSupplier(){
		...
		if (typeof categoryID_open == 'undefined'){
			categoryID_open = '';
		}
	...
	function setValueSeles(selesid,type,supplierid,suppliername){
		...
		var topCols = top.document.getElementById("btmframe").cols;
		if(is_iPad()){
			showPopWin("selApplyBills.action?billID="+selesid+"&goodsCategoryID="+type+"&supplierID="+supplierid+"&supplierName="+encodeURIComponent(suppliername)+"&moduleID=${requestScope.moduleID}",970,screen.height-200,topRows,topCols,returnRefresh(true),true);
		}else{
			showPopWin("selApplyBills.action?billID="+selesid+"&goodsCategoryID="+type+"&supplierID="+supplierid+"&supplierName="+encodeURIComponent(suppliername)+"&moduleID=${requestScope.moduleID}",screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),true);
		}
				...
				<TD>
                  <TABLE height=22 cellSpacing=0 cellPadding=0 border=0>
                    ...
                    <TD width=3><IMG id=tabImgLeft__1 height=22 
                      ...
                      onclick="JavaScript:window.location.href='selProcurementOrders.action?moduleID=${requestScope.moduleID}';"
                    ...
                    <table width="100%" id="title0"  border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                      ...
                      <TBODY>
                    	...
                    	<TR>
			               ...
			               <TD class="table_none">
                            <select id="goodscategoryID" name="goodscategoryID" onchange="changecategory();">
      		                 <option value="">----请选择----</option>
                    	...
                    	<TR>
			               ...
			               <TD class="table_none" colspan="5">
				               	<li class="horizontal_onlyRight">
							   		<input id="supplierName" clean=clean class="text_input160"  value="${bspsuppliername}" name="bspsuppliername"  readonly="readonly" />
							   		<input type="hidden" id="supplierID" clean=clean  value="${chaasupplier}" name="chaasupplier"/>
							   	</li>
							   	<li class="horizontal_onlyRight">
					...
					<table width="100%"   border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                      ...
                      <TBODY>
                        <TR class=table_title align=middle>
                          ...
                          <TH width="15%" height="26" scope=col>申请单号</TH>
                        ...
                        <TR class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">
                          <TD>
		                    <img src="${ctx }/img/newbtn/cgsh_0.png" btn=btn title='生成采购订单' onClick="setValueSeles('${po.cshaabillid}','${po.goodscategoryid}','${po.chaasupplier}','${po.chaasuppliername}')">
		                  </TD>
                          <TD height="26">${po.cshaabillid}</TD>
                          <TD>${po.goodscategoryname}</TD>
                          <Td>${po.chaasuppliername}</Td>		
                          <TD>${po.cshaaindepartmentname}</TD>
                          <TD>${po.cshaaoutdepartmentname}</TD>
                          <TD>${fn:substring(po.cshaabilldate,0,16)}</TD>
                          <TD>${fn:substring(po.cshaaauditdate,0,16)}</TD>
                          <TD title="${po.cshaaremark}"><div class="autocut50">${po.cshaaremark}</div></TD>
						</TR>
						</c:forEach>	
                      </TBODY>
                    </TABLE>
