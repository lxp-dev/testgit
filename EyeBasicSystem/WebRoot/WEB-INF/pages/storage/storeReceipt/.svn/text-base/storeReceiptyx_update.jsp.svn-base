...
<script>
	...
	function addtdgoods(){
		storeReceiptForm.action = "addStoreReceiptDimension.action";
	...
	function save(){
	if(checkForm(document.all.storeReceiptForm)){ 
		...
		if ($("[name=inventoryPo.cstiauditstate]").eq(0).attr("checked") == true){
		    cstiauditstate=1;
		}	
		...
		storeReceiptForm.action = "updateStoreReceipt.action?cstiauditstate="+cstiauditstate;
		storeReceiptForm.submit();
		}
	}
	...
	function openOrders(){	
		...
		if(is_iPad()){
			showPopWin("initStoreOrdersForOpen.action?poType="+poType+"&updatepage=u&supplierID="+supplierID+"&supplierName="+supplierName+"&category="+category,970,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}else{
			showPopWin("initStoreOrdersForOpen.action?poType="+poType+"&updatepage=u&supplierID="+supplierID+"&supplierName="+supplierName+"&category="+category,screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}
	...
	function openStoreOrdersValues(objValue,poID){
...
//			if (chk[i].value == goodInfo.bgigoodsid) return;
	...
	*/
    ...
    function setValue(billid,id,name,type){
		...
		storeReceiptForm.action="initInsertStoreReceipt.action?hid="+billid+"&type="+type+"&cstibillid="+cstibillid;
		storeReceiptForm.submit();
    }
...
<input type="hidden" id="cstigoodscategory" name="inventoryPo.cstigoodscategory" value="4"/>
<DIV>
                  ...
                  border=0>
                      <TBODY>
                        <TR>
                          ...
                          <TD width="23%" class="table_none">${inventoryPo.cstibillid}<input type="hidden" id="cstibillid" name="inventoryPo.cstibillid" value="${inventoryPo.cstibillid}">
						  ...
						  <input type="hidden" id="cstisupplierid" name="inventoryPo.cstisupplierid" value="${inventoryPo.cstisupplierid}"/>
						   </TD>
					...
					<table id="addTable" width="100%" border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder">
                      <TBODY>
                        ...
                        <TR class=table_title align=middle> 
						  	<TH width="40%" height="27" colSpan=3 scope=col align="right">合计：&nbsp;&nbsp;&nbsp;&nbsp;</TH>
                        ...
                        <input type="hidden" id="guaranteeperiod" name="goodsInfoTempPo.guaranteeperiod"  value="${cstieguaranteeperiod}"/>
                        <input type="hidden" id="batch" name="goodsInfoTempPo.batch"  value="${cstiebatch}"/>
                        </TD>
