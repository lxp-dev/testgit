...
<script>
	...
	function save(){
		if(checkForm(document.all.procurementReceiptForm)){ 
			...
			procurementReceiptForm.action = "insertStoreReceiptyx.action?cstiauditstate=0";
			procurementReceiptForm.submit();
		}
	}
    ...
    */
	...
	function importFile(){
		...
		procurementReceiptForm.action = "importStoreFrameManyExcel.action?gt="+$("#gt").val();
		procurementReceiptForm.submit();
	}
...
<input type="hidden" id="gt" name="goodstype" value="yx" />
                  ...
                  border=0>
					...
					<table id="addTable" width="100%" border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder">
                      <TBODY>
                        ...
                        <input type="hidden" id="guaranteeperiod" name="goodsInfoTempPo.guaranteeperiod"  value="${po.guaranteeperiod}"/>
                        <input type="hidden" id="batch" name="goodsInfoTempPo.batch"  value="${po.batch}"/>
                        </TD>
