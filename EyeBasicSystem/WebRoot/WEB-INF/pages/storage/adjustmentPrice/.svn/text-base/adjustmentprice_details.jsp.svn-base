              ...
              <TBODY>
                    ...
                    <td width=auto align="right" valign="top">
		             <s:action name="getFittingTemplateTypeInfo" executeResult="true">
						<s:param name="actionTypeID">29</s:param>
		           		<s:param name="actionImgUrl">${ctx}/img/newbtn/btn_print_0.png</s:param>
		           		<s:param name="actionFinereportRequestString">&billid=${adjustmentPricePo.cprapbillid}</s:param>
		           		<s:param name="actionReportingServiceRequestString"></s:param>
		           		<s:param name="actionReportTitle">商品零售价调价单打印</s:param>
		             </s:action>
		             </td>                     
					</TR>
			  </TBODY></TABLE></TD>
                    ...
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        <TR height="26">
                          ...
                          <TD width="41%" class="table_none">${adjustmentPricePo.cprapbillid }</TD>
                          <TD class="table_body">生效日期</TD>
                          <TD class="table_none">${fn:substring(adjustmentPricePo.cprapeffectivedate,0,16) }&nbsp;</TD>
                        </TR>
                        <TR height="26">
                          ...
                          <TD width="41%" class="table_none">${fn:substring(adjustmentPricePo.cprapcreatedate,0,16) }</td>
                        </TR>
                        <TR>
                          <TD class="table_body" height="60">备注</TD>
                          <TD class="table_none" colSpan=6>&nbsp;${adjustmentPricePo.cprapremark }</TD>
                        </TR>
                      </TBODY>
                    </TABLE>
                    ...
                    <table  id="addTable" width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title2">
                      <TBODY>
                        ...
                        <TR class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">
                          ...
                          <TD height="28">${adjustmentPriceEntry.cprapegoodsid }<input name="goodsInfoTempPo.goodsid" value="${adjustmentPriceEntry.cprapegoodsid }" type="hidden"/></TD>
                          ...
                          <TD>${adjustmentPriceEntry.cprapebbdbrandname }<input name="goodsInfoTempPo.goodsbarcode" value="${adjustmentPriceEntry.cprapebbdbrandname }" type="hidden"/></TD>
                          ...
                          <TD>${adjustmentPriceEntry.cprapeadprice }</TD>
