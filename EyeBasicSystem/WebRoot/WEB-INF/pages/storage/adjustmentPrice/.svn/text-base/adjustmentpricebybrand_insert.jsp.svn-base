...
<script>	
	...
	if(checkForm(document.all.adjustmentPriceForm)){ 
		...
		adjustmentPriceForm.action = "adjustmentPriceInsert.action";
	...
	*/
	function open2D(){
		...
		if(is_iPad()){
			showPopWin("initAdjustPriceGoodsOpen_dimensional.action",970,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}else{
			showPopWin("initAdjustPriceGoodsOpen_dimensional.action",screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}
                    ...
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        <TR>
                          ...
                          <TD width="41%" class="table_none"><input class="text_input160" id="cshaabillid" name="adjustmentPricePo.cprapbillid" value="${adjustmentPricePo.cprapbillid }" readonly="readonly"></TD>
                      ...
                      <TR>
                        <TD align="left">
						  ...
						  onClick="javascript:openGoodSingle();">
							 <img src="${ctx}/img/newbtn/btn_pladdgoods_0.png" onmouseover="JavaScript:$(this).attr('src','${ctx }/img/newbtn/btn_pladdgoods_1.png');" onmouseout="JavaScript:$(this).attr('src','${ctx }/img/newbtn/btn_pladdgoods_0.png');" title="批量添加商品" 
						  onClick="javascript:moreAdjustmentPrice_open();">
