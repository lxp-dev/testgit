...
<script>
	...
	function receiveAllocation(){
		$('#recTD').hide();
		allocationForm.action = "receiveAllocationForApp.action";
		allocationForm.submit();
		
	}
    function printReport(id){		
		var DataURL = "report.action?reportlet=storage_ApplyallocationForAppRpt.cpt&billid="+id;
    ...
    function returnAudit(){
    	allocationForm.action = "returnAuditForApp.action";
    	allocationForm.submit();
    }
</script>
                ...
                <TD>
                    ...
                    <c:if test="${statusPo.cshastatusbillid != null}">
                      ...
                      UNSELECTABLE="on">商品调拨单详细</TD>
						...
						<TD style="PADDING-LEFT: 2px; HEIGHT: 22px" 
          background=${ctx}/img/pic/tab_top_bg.gif align="right">
			          		<img src="${ctx }/img/newbtn/btn_print_0.png" btn=btn title="打印单据" onClick="printReport('${allocationPo.cshaabillid}');">
			            </TD>
					</TR>
        <TR>
                  ...
                  border=0>
                      <TBODY>
                        <TR>
                          ...
                          <TD width="20%" class="table_none">${allocationPo.cshaabillid}<input type="hidden" id="cshaabillid" name="cshaabillid" value="${allocationPo.cshaabillid}"></TD>
