...
<script>
	...
	function search(){
		...
		allocationForm.action = "selApplyWholeForAppOpen.action";
		allocationForm.submit();
		showLoadingBar();
	}	
...
<input type="hidden" id="auditState" name="auditState" value="1">
<DIV>
                    ...
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        ...
                        <TR>
			               ...
			               <TD class="table_none">
			               <input clean=clean id="goodsId" clean=clean name="goodsId" type="text" class="text_input160" value="${goodsId }" maxlength="30"/>
					       </TD>
                        </TR>
                        </c:if> 
			            <TR>
			               ...
			               <TD class="table_none">
                            <input clean=clean class="text_input100" clean=clean type="text"  id="createPersonName" name="createPersonName" value="${requestScope.createPersonName}">
			               </TD>
						   <TD height="26" class="table_body">审核人工号</TD>
			               <TD class="table_none">
                               <input class="text_input100" type="text" clean=clean id="auditPersonName" name="auditPersonName" value="${requestScope.auditPersonName}">
					...
					<table width="100%"   border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                      ...
                      <TBODY>
                        ...
                        <TR class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">
                          <TD width="4%">
		                     <img src="${ctx }/img/newbtn/select_0.png" title='选择' btn=btn onClick="javascript:setValue('${cshawbillid}')">
		                  </TD>
