    ...
    $(document).ready(function(){
       <c:if test="${permissionPo.keyf == 1}">	
	       ...
	       $("input[name=goodsInfoTempPo.nottaxrateamount]").each(function (){
	    	   amount1 = accAdd(amount1,$(this).val());
	       });
	       $("#nottaxrateamountTotal").text(parseFloat(amount1).toFixed(2));
	       var amount2 = 0;
	       $("input[name=goodsInfoTempPo.costpriceamount]").each(function (){
	    	   amount2 = accAdd(amount2,$(this).val());
	       });
	       $("#costpriceamountTotal").text(parseFloat(amount2).toFixed(2));       
       </c:if>
        ...
        <TR>
          <TD align="right" colspan="3">
             <s:action name="getFittingTemplateTypeInfo" executeResult="true">
				<s:param name="actionTypeID">35</s:param>
           		...
           		<s:param name="actionReportTitle">客户批发退货单打印</s:param>
             </s:action>
          </TD>
        </TR>
