...
function deleterow(goodInfo){
	...
	if(checkForm(document.all.otherReceiptForm)){ 
		...
		otherReceiptForm.action = "updateOtherReceipt.action?cstiauditstate="+cstiauditstate;
	...
	function addRow(goodInfo){
		...
		if('${systemParameterPo.fspbarcodetype}'=='1'||'${systemParameterPo.fspbarcodetype}'=='2')
		{
			c8.innerHTML = '<input type="text" class="text_input40" maxlength="18" name="goodsInfoTempPo.goodsquantity" onkeydown="OnKeyDownEnter(this)" onblur="amount();" value="" validate="[{\'Type\' : Type.String, \'Formula\' : Formula.notNull, \'Message\' : \'请填写商品数量！\'},{\'Type\' : Type.String, \'Formula\' : Formula.INT, \'Message\' : \'商品数量应为整数！\'}]"/>';
	...
	function addRow2(goodInfo){
		...
		if('${systemParameterPo.fspbarcodetype}'=='1'||'${systemParameterPo.fspbarcodetype}'=='2')
		{
			c7.innerHTML = '<input type="text" class="text_input40" maxlength="18" name="goodsInfoTempPo.goodsquantity" onkeydown="OnKeyDownEnter(this)" onblur="amount();" value="" validate="[{\'Type\' : Type.String, \'Formula\' : Formula.notNull, \'Message\' : \'请填写商品数量！\'},{\'Type\' : Type.String, \'Formula\' : Formula.INT, \'Message\' : \'商品数量应为整数！\'}]"/>';
			c6.innerHTML ='<input type="text" class="text_input160" onBlur="barcodes(\''+goodInfo.bgigoodsid+'\',this)" maxlength="26" name="goodsInfoTempPo.pcbarcode"  value="'+goodInfo.bgipcbarcode+'" />';
			
		}
		if('${systemParameterPo.fspbarcodetype}'=='3')
		{
			c6.innerHTML = '<input type="text" class="text_input40" maxlength="18" name="goodsInfoTempPo.goodsquantity" onkeydown="OnKeyDownEnter(this)" onblur="amount();" value="" validate="[{\'Type\' : Type.String, \'Formula\' : Formula.notNull, \'Message\' : \'请填写商品数量！\'},{\'Type\' : Type.String, \'Formula\' : Formula.INT, \'Message\' : \'商品数量应为整数！\'}]"/><input type="hidden" name="goodsInfoTempPo.pcbarcode"  value="'+goodInfo.bgipcbarcode+'" />';
                  ...
                  border=0>
                      <TBODY>
                        <TR>
                          ...
                          <TD width="24%" class="table_none">其他入库                         
                          ...
                          <input id="cstibilldate" class="text_input160" name="inventoryPo.cstibilldate" type="hidden" value="${fn:substring(inventoryPo.cstibilldate,0,10)}"/></TD>					       
						</TR>
						<TR>
					...
					<table id="addTable" width="100%" border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder">
                      <TBODY>
                        ...
                        <TR class="row">
                        <TD height="26">
                        <input id="chk" type="checkbox" value="${cstiegoodsid}" >
                        </TD>
                        <TD>${cstiegoodsid}
                        ...
                        <c:if test="${systemParameterPo.fspbarcodetype==1||systemParameterPo.fspbarcodetype==2}">                        
                         <TD><input type="text" class="text_input200" onBlur="barcodes('${cstiegoodsid}',this)" maxlength="26" name="goodsInfoTempPo.pcbarcode"  value='${cstiebarcode}' /></TD>    
                        </c:if>         
                        <TD><input type="text" class="text_input40" name="goodsInfoTempPo.goodsquantity" onkeydown="OnKeyDownEnter(this)" onblur="amount();" value="${cstiegoodsquantity}" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '请填写商品数量！'},{'Type' : Type.String, 'Formula' : Formula.INT, 'Message' : '商品数量应为整数！'}]"/>                                               
                       <c:if test="${systemParameterPo.fspbarcodetype==3}"> 
                        <input type="hidden" ame="goodsInfoTempPo.pcbarcode" id="pcbarcode" index="${idx.index }" value='${cstiebarcode}' />
                        </c:if></TD>  
                        </TR>
                        </s:iterator>
                      </TBODY>
