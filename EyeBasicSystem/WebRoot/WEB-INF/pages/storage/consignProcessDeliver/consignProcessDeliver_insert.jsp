...
<script>
	...
	if(checkForm(document.all.consignProcessDeliverForm)){ 
		...
		consignProcessDeliverForm.action = "insertConsignProcessDeliver.action";
                  ...
                  border=0>
                      <TBODY>
                        <TR>
                          ...
                          <TD width="24%" class="table_none"><input class="text_input160" id="cstddeliverbillid" name="deliverPo.cstddeliverbillid" value="${deliverPo.cstddeliverbillid}" readonly="readonly"></TD>
                         
						  <TD width="9%" class="table_body">单据日期</TD>
                          <TD width="24%" class="table_none">
                          <jsp:useBean id="now" class="java.util.Date" />
                          <fmt:formatDate value="${now}" type="both" dateStyle="long" pattern="yyyy-MM-dd" />
                          <input name="deliverPo.cstddeliverdate" type="hidden" value="<fmt:formatDate value="${now}" type="both" dateStyle="long" pattern="yyyy-MM-dd" />"/></TD>	
						  </TD>
						  <TD width="9%" class="table_body" height="26">制单人</TD>
                          <TD class="table_none" >${person.personName }<input type="hidden" name="deliverPo.cstdcreateperson" value="${person.id}"></TD>
                        </TR>
                        <TR>
                          <TD class="table_body">送货单位</TD>
                          <TD class="table_none" colspan="5"><input class="text_input160" id="cstddeliverdept" name="deliverPo.cstddeliverdept" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '送货单位不能为空！'},{'Type' : Type.String, 'Formula' : '', 'Expansion' : {Type : Expansion.LessThanLengthORNULL, Params : [51]}, 'Message' : '送货单位不能大于50字！'}]"></TD>
						</TR>
                        <TR>
                          <TD class="table_body">备注</TD>
                          <TD class="table_none" colSpan=5><label>
                          <textarea id="textarea" name="deliverPo.cstdremark" validate="[{'Type' : Type.String, 'Formula' : '', 'Expansion' : {Type : Expansion.LessThanLengthORNULL, Params : [51]}, 'Message' : '备注不能大于50字！'}]"></textarea>
                          </label></TD>
                        </TR>
                      </TBODY>
                    </TABLE>
