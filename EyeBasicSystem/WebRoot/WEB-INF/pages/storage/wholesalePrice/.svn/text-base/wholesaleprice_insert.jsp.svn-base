...
<script>	
	...
	if(checkForm(document.all.wholesalePriceForm)){ 
		if($('#wholesalePriceWay').val() == '1' && $('#effecticeTime').val()==''){
			alert('请先填写生效日期!');
			return;
		}
		...
		wholesalePriceForm.action = "wholesalePriceInsert.action";
	...
	function moreWholesalePrice_open(){
		var supplierID='';
		var categoryID_open='';	
		//showPopWin("","initMoreWholesalePriceOpen.action?categoryID_open="+categoryID_open+"&supplierID_open=" + supplierID ,screen.width-200,screen.height-200, '', null, true);
		//selectHidden();
	...
	function addRow(goodInfo){
		...
		c7.innerHTML = '<input  type="text" id="adprice" name="goodsInfoTempPo.adprice" value="" onkeyup="toFixAndNan(this)" class="text_input60" onblur="toFix(this)" >';	
    ...
    function setWholesalePrice(){
        ...
        var wholesalePrice=Math.round(parseFloat(price)*Math.pow(10,2))/Math.pow(10,2);
        var count = document.getElementsByName('goodsInfoTempPo.adprice').length;        
        for ( var i = 0; i < count; i++ ){
            document.getElementsByName('goodsInfoTempPo.adprice')[i].value=wholesalePrice;
       }
    }
                ...
                vAlign=top><DIV id=tabContent__1>
                  <DIV>
                    ...
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        <TR>
                          ...
                          <TD width="41%" class="table_none"><input class="text_input160" id="cshaabillid" name="wholesalePricePo.cprwpbillid" value="${wholesalePricePo.cprwpbillid }" readonly="readonly"></TD>
                          <TD width="9%" class="table_body">制单日期</TD>
                          <TD width="41%" class="table_none">
                          <jsp:useBean id="now" class="java.util.Date" />
                          <fmt:formatDate value="${now}" type="both" dateStyle="long" pattern="yyyy-MM-dd" /></TD>
                         <input name="wholesalePricePo.cprwpcreatedate" type="hidden" value="<fmt:formatDate value="${now}" type="both" dateStyle="long" pattern="yyyy-MM-dd" />"/>
                        </TR>
                        <TR>
					      ...
					      <TD width="24%" class="table_none">
					        <input type="hidden" id="wholesalePriceWay" name="wholesalePricePo.cprwpflag" value="0">
                          ...
                          <TD width="24%" class="table_none">${person.personName }</TD>
                        </TR>
                        ...
                        <TR>
                          ...
                          <TD class="table_none" colSpan=6><textarea name="wholesalePricePo.cprwpremark" id="textarea2"></textarea></TD>
                        </TR>
                      </TBODY>
                    </TABLE>
                    <TABLE id=ctl00_PageBody_PostButton cellSpacing=1 cellPadding=3 width="100%" align=center border=0>
                      <TR>
                        <TD align="left">
                          <img name="button22" src="${ctx}/img/newbtn/btn_addgoods_0.png" btn=btn title="单品添加商品" 
                    ...
                    <table  id="addTable" width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title2">
                      <TBODY>
                        ...
                        <TR class=table_title align=middle>
                         <TH width="7%" height="30" scope=col>全选<input type="checkbox"  id="chks" name="chks" onclick="chkAll()"></TH>                        
                        ...
                        <TR>
                          <TD align="left" valign="bottom">
                             <li class="horizontal_onlyRight">
                              <input class="text_input100" id="wholesalePrice" name="wholesalePrice" type="text" maxlength="20">&nbsp;
                             </li>
                             <li class="horizontal_onlyRight">
