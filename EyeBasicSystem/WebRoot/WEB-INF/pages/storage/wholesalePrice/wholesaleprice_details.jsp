...
<script>	
	...
	function addRow(goodInfo){
		...
		c5.innerHTML = goodInfo.bgiretailprice+ '<input type="hidden" id="retailprice" name="goodsInfoTempPo.costprice" value="' + goodInfo.bgiretailprice +'" />';
              ...
              <TBODY>
                    ...
                    <td width=auto align="right" valign="top">
		             <s:action name="getFittingTemplateTypeInfo" executeResult="true">
						<s:param name="actionTypeID">31</s:param>
		           		<s:param name="actionImgUrl">${ctx}/img/newbtn/btn_print_0.png</s:param>
		           		<s:param name="actionFinereportRequestString">&billid=${wholesalePricePo.cprwpbillid}</s:param>
		           		<s:param name="actionReportingServiceRequestString"></s:param>
		           		<s:param name="actionReportTitle">商品批发价调价单打印</s:param>
		             </s:action> 
		             </td>                     
					</TR>
			  </TBODY></TABLE></TD>
                    ...
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        <TR height="26">
                          ...
                          <TD width="41%" class="table_none">${wholesalePricePo.cprwpbillid }</TD>
                          <TD class="table_body">生效日期</TD>
                          <TD class="table_none">${fn:substring(wholesalePricePo.cprwpeffectivedate,0,16) }</TD>
                        </TR>
                        <TR height="26">
             			  <TD class="table_body">制单人</TD>
                          <TD class="table_none">${wholesalePricePo.cprwpcreatepersonname }</TD>
                          <TD width="9%" class="table_body">制单日期</TD>
                          <TD width="41%" class="table_none">${fn:substring(wholesalePricePo.cprwpcreatedate,0,16) }</td>
                        </TR>
                        <TR>
                          <TD class="table_body" height="60">备注</TD>
                          <TD class="table_none" colSpan=6>&nbsp;${wholesalePricePo.cprwpremark }</TD>
                        </TR>
                      </TBODY>
                    </TABLE>
                    ...
                    <table  id="addTable" width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title2">
                      <TBODY>
                        ...
                        <TR class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">
                          ...
                          <TD height="28">${wholesalePriceEntry.cprwpegoodsid }<input name="goodsInfoTempPo.goodsid" value="${wholesalePriceEntry.cprwpegoodsid }" type="hidden"/></TD>
                          ...
                          <TD>${wholesalePriceEntry.cprwpebbdbrandname }<input name="goodsInfoTempPo.goodsbarcode" value="${wholesalePriceEntry.cprapebbdbrandname }" type="hidden"/></TD>
                          ...
                          <TD>${wholesalePriceEntry.cprwpeadprice }</TD>
