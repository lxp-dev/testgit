...
<script>
	...
	function audit(){
		...
		checkStorageForm.action = "buildSCI.action?stockid="+document.getElementById('stockid').value;
		checkStorageForm.submit();
	}
...
<input type="hidden" name="hid" value="${checkStoragePo.cshcsbillid}">
<input type="hidden" name="moduleID" value="${requestScope.moduleID}">
<input type="hidden" name="type" id="type" value="${fn:substring(checkStorageEntrys[0].cshcsegoodsid,0,1)}" /> 
<DIV>
                ...
                vAlign=top><DIV id=tabContent__1>
                  <DIV>
                    ...
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        <TR>
                          <TD width="8%" class="table_body" height="26">单据编号</TD>
                          <TD width="20%" class="table_none">&nbsp;${checkStoragePo.cshcsbillid }</TD>
                          <TD width="8%" class="table_body">单据日期</TD>
                          <TD width="20%" class="table_none">&nbsp;${fn:substring(checkStoragePo.cshcscheckdate,0,10)}</TD>
                          <TD width="8%" class="table_body">盘点单名称</TD>
                        ...
                        <TR> 
                          ...
                          <TD class="table_none" colspan="3">&nbsp;${checkStoragePo.cshcscheckstockpersonname }</TD>
                    ...
                    <TABLE id=ctl00_PageBody_PostButton cellSpacing=1 cellPadding=3 width="100%" align=center border=0>
                      <TBODY>
                        <TR><input id="stockid"  type="hidden" value='${checkStoragePo.cshcsstockid}'>
                          <TD><img src="${ctx}/img/newbtn/btn_save_0.png" btn=btn id="button1" title='保存' onClick="javascript:audit();">
