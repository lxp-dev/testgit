...
<script>
	...
	function audit(){
		...
		checkStorageForm.action = "buildSCO.action?stockid="+document.getElementById('stockid').value;
		checkStorageForm.submit();
	}
                    ...
                    <TABLE id=ctl00_PageBody_PostButton cellSpacing=1 cellPadding=3 width="100%" align=center border=0>
                      <TBODY>
                        <TR><input id="stockid"  type="hidden" value='${checkStoragePo.cshcsstockid}'>
                          <TD><img id="button1" src="${ctx}/img/newbtn/btn_save_0.png" btn=btn title='保存' onClick="javascript:audit();">
