...
<script>	
	...
	function search(){
		brandForm.action = "selectConsignProcessOrderStatus.action";
		brandForm.submit();
		showLoadingBar();
	}	
	
	function detaile(id){
		showPopWin("","selectConsignProcessSend.action?hid="+id, screen.width-200,screen.height-200, '',null,true);
		selectHidden();
	}
    ...
    <TD><!-- ?? Start -->
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          ...
          <TR>
            <TD class=menubar_function_text height=27><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：委外配镜单查询</TD>
          </TR>
          <TR>
              ...
              <TR>
                ...
                vAlign=top><DIV id=tabContent__1>
				  ...
				  <table width="100%" id="title0"  border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                        ...
                        <TR>
						  ...
						  <select id="cstpauditstate" name="auditstate">
                                ...
                                <option value='2'>确认</option>
                                 <option value='4'>正在加工</option>
                                <option value='5'>制造商备货</option>
					...
					<!-- Loading Bar ----------------------------------------------------------------------------------------------------------------->
					<c:if test="${not empty(consignProcessOrderStatusList)}">
                    <table width="100%" id="title0"  border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                              <TBODY>
                                <TR>
                                  <TD width="5%"><div align="left"><img src="${ctx }/img/pic/queryCondition.gif" width="86" height="20" ></div></TD>
					...
					<table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        <TR class=table_title align=middle>
                          <TH width="20%" height="30" scope=col>配镜单号</TH>
                        ...
                        <c:forEach var="po" items="${consignProcessOrderStatusList}">
                        <TR class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">
                          ...
                          <TD>确认</TD>
                           ...
                           <c:if test="${po.cstpauditstate==4 }">
                          <TD>正在加工</TD>
                          </c:if>
                          <c:if test="${po.cstpauditstate==5 }">
                          <TD>制造商备货</TD>
                          </c:if>
