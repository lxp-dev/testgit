...
<script>
	...
	*/
	...
	function addRow(goodInfo){
		...
		c5.innerHTML = '<input type="text" class="text_input60" ondblclick="batchCheckQutity(this);" maxlength="18" onkeydown="OnKeyDownEnter(this)" name="needNumber" onblur="needAmount();" value="" validate="[{\'Type\' : Type.String, \'Formula\' : Formula.notNull, \'Message\' : \'请填写商品数量！\'},{\'Type\' : Type.String, \'Formula\' : Formula.INT, \'Message\' : \'商品数量应为整数！\'}]"/>';
		$('#del'+index).btn().init();
    }
