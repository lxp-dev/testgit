...
<script>
	function del(){
		...
		salesOutForm.action = "deleteOtherOut.action";
		salesOutForm.submit();
	}
  ...
  <TR>
    <TD><!-- ?? Start -->
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        ...
        <TR>
          <TD class=menubar_function_text height=27><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：其它出库删除</TD>
                ...
                vAlign=top><DIV id=tabContent__1>
                  <DIV>
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 id="title1">
                      <TBODY>
                      <TR>
						   <TD width="10%" height="30">销售出库单:${inventoryPo.cstibillid},此条数据确认删除么</TD>
                        </TR>
                      </TBODY>
                    </TABLE>
