...
<script>
	...
	function search(){
		...
		workingCheckForm.action = "selectWorkingCheck.action";
		workingCheckForm.submit();
		showLoadingBar();
	}	
	...
	function workingCheck(ssesbsalesid){
		...
		if(is_iPad()){
			showPopWin("initWorkingCheckIns.action?ssesbsalesid="+ssesbsalesid+"&moduleID="+moduleID,970,screen.height-200,topRows,topCols,returnRefresh(true),true);
		}else{
			showPopWin("initWorkingCheckIns.action?ssesbsalesid="+ssesbsalesid+"&moduleID="+moduleID,screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),true);
		}
		document.getElementById('popupTitle').innerHTML="【加工检验新增】";
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <td align="left"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：加工检验查询</td>
              ...
              <TR><!--?Start-->
                  ...
                  <TABLE height=22 cellSpacing=0 cellPadding=0 border=0>
                    ...
                    <TD width=3><IMG id=tabImgLeft__1 height=22 
                      ...
                      onclick="JavaScript:window.location.href='initPrintWorkingCheckSel.action?moduleID=${requestScope.moduleID}';"
			               ...
			               <td class="table_none">
		                          <select name="ssesbsupplierid" id="ssesbsupplierid">
		                              ...
		                              <s:iterator value="warehouseList">
		                               <option value="${bwhdeptid }" ${requestScope.ssesbsupplierid == bwhdeptid ? 'selected="selected"' : '' }>${bdpdepartmentname }</option>
		                              </s:iterator>
		                          </select>
		                          </td>
					...
					<table width="100%"   border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                      ...
                      <TBODY>
                        <TR class=table_title align=middle>
						  ...
						  <TH width="10%" scope=col>发料人</TH>
						  <TH width="15%" scope=col>发料日期</TH>
						  </TR>
