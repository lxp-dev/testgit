...
<script>
	...
	function insert(){
		...
		try{
			...
			$('input[pd=pd]').each(function(){
				if($(this).attr('style').toLocaleLowerCase()=='background-color: green' || $(this).attr('style').toLocaleLowerCase()=='background-color: green;'){
	...
	*/
    ...
    function zzCheck(){
    	if('${oDPo.ssesbsupplierid }'.toUpperCase() == 'ZZ'){
			$('#pchckcokepupildistanceod').attr("style","background-color: green");
			$('#pchckcokecentervertical').attr("style","background-color: green");
			$('#pchckcokeballglassod').attr("style","background-color: green");
			$('#pchckcokeballglassod2').attr("style","background-color: green");
    	...
    	if('${oSPo.ssesbsupplierid }'.toUpperCase() == 'ZZ'){
			$('#pchckcokepupildistanceos').attr("style","background-color: green");
			$('#pchckcokecentervertical').attr("style","background-color: green");
			$('#pchckcokeballglassos').attr("style","background-color: green");
			$('#pchckcokeballglassos2').attr("style","background-color: green");
                    ...
                    <table width="100%" id="title0"  border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                      ...
                      <TBODY>
                        ...
                        <TR>
			               ...
			               <TD class="table_none" >
			                <c:if test="${not empty(inTransitPo.sseitcreatepersonname) }">
			                ...
			                <c:if test="${empty(inTransitPo.sseitcreatepersonname) }">
				               	<select id="pchckprocesspersonid"  name="workingCheckPo.pchckprocesspersonid">
	                             	<option value="">----请选择----</option>
	      		                 	<c:if test="${not empty(workingCheckpersonList)}">
					               	 	 <s:iterator value="workingCheckpersonList">
	                    	           	<OPTION value="${id}" ${workingCheckPo.pchckcokebasisos== id ? 'selected="selected"': ''}>${personName}</OPTION>
	                    	         	 </s:iterator>
	                    	        	</c:if>
	      	                   	</select>
      	                   	</c:if>
                        ...
                        <TR>
                          ...
                          <TR>
						   <TD height="24" class="table_body">备注</TD>
					...
					<table width="100%" border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                     ...
                     <table id="jdjTable" width="100%" border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder">
                      <TBODY>
                        ...
                        <TR class="row">
                          <TD align="center" height="24" rowspan="4">R</TD>
                          <TD height="24">主子午面一</TD>
						...
						<TR class="row" >
                          <TD align="center" height="24">焦度计</TD>
                          <TD><input class="text_input60" pd="pd" type="text" sys=sys Enter="1" id="pchckcokeballglassod" name="workingCheckPo.pchckcokeballglassod" value="" onkeydown="OnKeyDownEnter(this)" onblur="assignmentZT()"></TD>
                          <TD><input class="text_input60" pd="pd" type="text" sys=sys Enter="2" id="pchckcokepostglassod" name="workingCheckPo.pchckcokepostglassod" value="" onkeydown="OnKeyDownEnter(this)" onblur="assignmentZT()"></TD>
                          <TD><input class="text_input60" pd="pd" type="text" sys=sys Enter="3" id="pchckcokeaxesod" name="workingCheckPo.pchckcokeaxesod" value="" onkeydown="OnKeyDownEnter(this)" onblur="assignmentZT()"></TD>
                          <TD rowspan="3">
                          	<input class="text_input60" type="text" sys=sys id="pchckcokearriseglassod" name="workingCheckPo.pchckcokearriseglassod" value="">
                          	&nbsp;
                          	...
                          	<input class="text_input60" type="text" sys=sys id="pchckcokearriseglassod1" name="workingCheckPo.pchckcokearriseglassod1" value="">
                          	&nbsp;
                          ...
                          <TD rowspan="3"><input class="text_input60" pd="pd" sys=sys type="text" Enter="4" id="pchckcokeaddod" name="workingCheckPo.pchckcokeaddod" value="" onkeydown="OnKeyDownEnter(this)"></TD>
                          <TD rowspan="3"><input class="text_input60" pd="pd" sys=sys type="text" Enter="5" id="pchckcokepupildistanceod" name="workingCheckPo.pchckcokepupildistanceod" value="" onkeydown="OnKeyDownEnter(this)"></TD>
						</TR>
						<tr class="row" >
						  <TD height="24">主子午面二</TD>
						...
						<TR class="row" >
                          <TD align="center" height="24" rowspan="4">L</TD>
                          <TD height="24">主子午面一</TD>
						...
						<TR class="row">
                          <TD align="center" height="24">焦度计</TD>
                          <TD><input class="text_input60" pd="pd" type="text" sys=sys Enter="6" id="pchckcokeballglassos" name="workingCheckPo.pchckcokeballglassos" value="" onkeydown="OnKeyDownEnter(this)" onblur="assignmentZT()"></TD>
                          <TD><input class="text_input60" pd="pd" type="text" sys=sys Enter="7" id="pchckcokepostglassos" name="workingCheckPo.pchckcokepostglassos" value="" onkeydown="OnKeyDownEnter(this)" onblur="assignmentZT()"></TD>
                          <TD><input class="text_input60" pd="pd" type="text" sys=sys Enter="8" id="pchckcokeaxesos" name="workingCheckPo.pchckcokeaxesos" value="" onkeydown="OnKeyDownEnter(this)" onblur="assignmentZT()"></TD>
                          <TD rowspan="3">
                          	<input class="text_input60"  type="text" sys=sys id="pchckcokestrabismusos" name="workingCheckPo.pchckcokearriseglassos" value=""/>
                          	&nbsp;
                          	...
                          	<input class="text_input60" type="text" sys=sys id="pchckcokestrabismusos1" name="workingCheckPo.pchckcokearriseglassos1" value=""/>
                          	&nbsp;
                          ...
                          <TD rowspan="3"><input class="text_input60" sys=sys pd="pd" Enter="9" type="text"  id="pchckcokeaddos" name="workingCheckPo.pchckcokeaddos" value="" onkeydown="OnKeyDownEnter(this)"></TD>
                          <TD rowspan="3"><input class="text_input60" sys=sys pd="pd" Enter="10" type="text"  id="pchckcokepupildistanceos" name="workingCheckPo.pchckcokepupildistanceos" value="" onkeydown="OnKeyDownEnter(this)"></TD>
						</TR>
						<tr class="row">
						  <TD height="24">主子午面二</TD>
                     ...
                     <table width="100%" border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder">
                      <TBODY>
                        ...
                        <TR class="row">
                          <TD align="center" height="24" id="oldgxcc">${salesBasicPo.ssesblightvertical}</TD>
                          <TD><input class="text_input100" type="text" sys=sys pd="pd" Enter="11" id="pchckcokecentervertical" name="workingCheckPo.pchckcokecentervertical" value="" onkeydown="OnKeyDownEnter(this)"></TD>
                          <TD><input class="text_input100" type="text" sys=sys id="pchckcenterhigh" name="workingCheckPo.pchckcenterhigh" value="√"></TD>
                          <TD><input class="text_input100" type="text" sys=sys id="pchckcolor" name="workingCheckPo.pchckcolor" value="√"></TD>
                          <TD><input class="text_input100" type="text" sys=sys id="pchckquality" name="workingCheckPo.pchckquality" value="√"></TD>
                          <TD><input class="text_input100" type="text" sys=sys id="pchckshaping" name="workingCheckPo.pchckshaping" value="√"></TD>
						</TR>				  
                      </TBODY>
                    </TABLE>
                          ...
                          <TD align="center">
                            ...
                            <c:if test="${systemParameterPo.fspwhichmachine != '3'}">
	                            <li class="horizontal_onlyRight">
	                              <input id="jdjtype" name="jdjtype" type='radio' value='0' ${systemParameterPo.fspwhichmachine == '1' ? 'checked':'' }>
	                              NIDEK
	                              &nbsp;&nbsp;
                            ...
                            <li class="horizontal_onlyRight">
	                            <c:if test="${systemParameterPo.fspwhichmachine != '3'}">
	                              <img id="readBtn" name="button" src="${ctx }/img/newbtn/btn_readjdj_0.png" btn=btn title='读取焦度计' onClick="READ()">
	                              &nbsp;&nbsp;
	                            </c:if>  
