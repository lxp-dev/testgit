...
<script>
	...
	function save(){
		if(checkForm(document.all.stockAlertSettingForm)){  
			...
			stockAlertSettingForm.action = "updateStockAlertSetting.action";
                    ...
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        <TR>
			               ...
			               <TD class="table_none" width="24%">${alertSettingPo.csasagoodsid }<input type="hidden" name="alertSettingPo.csasaid" value="${alertSettingPo.csasaid }"/></TD>
			               <TD width="9%" height="26" class="table_body">商品名称</TD>
			               <TD class="table_none" width="24%">${alertSettingPo.csasagoodsname }</TD>
			               <TD width="9%" height="26" class="table_body">制造商</TD>
			               <TD class="table_none">${alertSettingPo.csasasuppliername }</TD>
                        </TR>
                        <tr>
                        	<TD height="26" class="table_body">所属品种</TD>
			                <TD class="table_none">${alertSettingPo.csasabrandname }</TD>
                        	<TD height="26" class="table_body">仓位名称</TD>
			               	<TD class="table_none" colspan="3" >${alertSettingPo.csasawarehouseName }</TD>
			            </tr>
			            <TR>
						   <TD width="12%" height="26" class="table_body">库存上限</TD>
			               <TD class="table_none">
			               ...
			               <TD width="12%" height="26" class="table_body">库存下限</TD>
			               <TD class="table_none">
			               ...
			               <TD class="table_none">
                             <input class="text_input100" type="text" id="bgistorageredlimit" name="alertSettingPo.csasastockred"  value="${alertSettingPo.csasastockred }"
                        ...
                        <TR>
                          <TD>
                          	<img id="submitButton" src="${ctx}/img/newbtn/btn_save_0.png" btn=btn  title='保存' onclick="save();">
                       	  	<img src="${ctx }/img/newbtn/btn_reset_0.png" btn=btn title='重置' onclick="document.stockAlertSettingForm.reset(); ">
                          </TD>
						  </TR>
                      </TBODY>
                    </TABLE>
