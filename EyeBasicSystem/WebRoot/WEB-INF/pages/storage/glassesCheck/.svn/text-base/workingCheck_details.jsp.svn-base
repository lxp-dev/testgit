                  ...
                  <DIV>
                    ...
                    <table id="jdjTable" width="100%" border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder">
                      <TBODY>
                        ...
                        <TR class="row">
                          <TD align="center" height="24">R</TD>
                          <TD>${workingCheckPo.pchckcokeballglassod }</TD>
                          <TD>${workingCheckPo.pchckcokepostglassod }</TD>
                          <TD>${workingCheckPo.pchckcokeaxesod }</TD>
                          <TD>${workingCheckPo.pchckcokeaddod }</TD>
                          <TD>${workingCheckPo.pchckcokepupildistanceod }</TD>
                          <TD>${workingCheckPo.pchckfarvaod }</TD>
                          <TD>${workingCheckPo.pchckclosevaod }</TD>
						</TR>
						<TR class="row" >
                          <TD align="center" height="24">L</TD>
                          <TD>${workingCheckPo.pchckcokeballglassos }</TD>
                          <TD>${workingCheckPo.pchckcokepostglassos }</TD>
                          <TD>${workingCheckPo.pchckcokeaxesos }</TD>
                          <TD>${workingCheckPo.pchckcokeaddos }</TD>
                          <TD>${workingCheckPo.pchckcokepupildistanceos }</TD>
						  <TD>${workingCheckPo.pchckfarvaos }</TD>
                          <TD>${workingCheckPo.pchckclosevaos }</TD>
						</TR>
						</TBODY>
                    </TABLE>
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                          <TR>
			               ...
			               <TD class="table_none" style="height: 40px;">
			               	${workingCheckPo.pchckremark }
			               </TD>
                        </TR>                           
                      </TBODY>
                    </TABLE>
                     <table width="100%" border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder">
                      <TBODY>
                        ...
                        <TR class="row" height="24px">
                          <TD>${workingCheckPo.pchckshuiping }</TD>
                          <TD>${workingCheckPo.pchckchuizhi }</TD>
                          <TD>${workingCheckPo.pchckzhouwei }</TD>
                          <TD>${workingCheckPo.pchckhege == '1' ? '合格':'不合格' }</TD>
                          <TD>
                          	${workingCheckPo.pchckdengji }
                          </TD>
						</TR>				  
                      </TBODY>
                    </TABLE>
