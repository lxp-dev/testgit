...
<script>	
	...
	function search(){
		...
		workingCheckForm.action = "selectGlassesChecked.action";
	...
	function details(hid){
		...
		if(is_iPad()){
			showPopWin("selectGlassesCheckDetails.action?hid="+hid,970,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}else{
			showPopWin("selectGlassesCheckDetails.action?hid="+hid,screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}
		document.getElementById('popupTitle').innerHTML="【配镜评级详细】";
	}
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <td align="left"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：已配镜评级查询</td>
              ...
              <TR><!--?Start-->
                  ...
                  <TABLE height=22 cellSpacing=0 cellPadding=0 border=0>
                    ...
                    <TD width=3><IMG id=tabImgLeft__1 height=22 
                      ...
                      onclick="JavaScript:window.location.href='initGlassesCheckSel.action?moduleID=${requestScope.moduleID}';"
              ...
              <TR>
                ...
                vAlign=top><DIV id=tabContent__1>
                    ...
                    <table width="100%" id="title0"  border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                      ...
                      <TBODY>
                        ...
                        <TR>
			               ...
			               <TD class="table_none">
                            <select id="pchckprocesspersonid" name="pchckprocesspersonid">
                             	<option value="">----请选择----</option>
      		                 	<c:if test="${not empty(workingDopersonList)}">
				               	 <s:iterator value="workingDopersonList">
			               ...
			               <c:if test="${person.departmenttype eq '1'}">
	                          ${person.bdpdepartmentname}<input type="hidden" name="shopcode" id="shopcode" value="${person.departmentID}">
	                       </c:if>
			               <c:if test="${person.departmenttype ne '1'}">
	                          <select name="shopcode" id="shopcode">
	                              <option value="">----请选择----</option>
	                              <s:iterator value="departmentsList">
	                               <option value="${bdpdepartmentid }" ${shopcode == bdpdepartmentid ? 'selected="selected"' : '' }>${bdpdepartmentname }</option>
	                              </s:iterator>
	                          </select>
	                       </c:if>
	                       </td>
                        ...
                        <TR>
                            ...
                            <TD class="table_none">
                            	<input type="text" class="text_input160" id="remark" name="remark" value="${ remark}">
                            </TD>
                            <TD height="26" class="table_body">等级</TD>
			               <TD class="table_none" colspan="3">
                            <select id="pingji" name="pingji">
                             	<option value="">----请选择----</option>
                   	           	<OPTION value="A" ${pingji!= 'A'  ? '' : 'selected="selected"' } >A</OPTION>
                   	           	<OPTION value="B" ${pingji!= 'B'  ? '' : 'selected="selected"' } >B</OPTION>
                   	           	<OPTION value="C" ${pingji!= 'C'  ? '' : 'selected="selected"' } >C</OPTION>
      	                   	</select>
			               </TD>
                        </TR>                       
                      </TBODY>
				 ...
				 <!-- Loading Bar ----------------------------------------------------------------------------------------------------------------->
					...
					<!-- Loading Bar ----------------------------------------------------------------------------------------------------------------->	
					<c:if test="${not empty(glassesCheckedList)}"> 
					<table width="100%"   border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                      ...
                      <TBODY>
						...
						<s:iterator value="glassesCheckedList">
