...
//		alert(StatusID);
			<s:iterator value="procurementCheckPos">
		     var json = {'goodsid':'${cstpoegoodsid}',
		     				...
		     				'dnumber':'${cstpoeordergoodsquantity}','rnumber':'${cstpoegoodsquantity}','fhl':'${cstpoecoincidencerate}',
		     				'bz':'${cstpoepack}','wg':'${cstpoeapp}','hg':'${cstpoequalifiedquantity}','bhg':'${cstpoeunqualifiedquantity}','hgl':'${cstpoeunqualifiedrate}'
		     			};
		     addRow1(json);          
			</s:iterator>
...
//				window.close();hidePopWin();selectShow();
        ...
        c3.innerHTML = goodInfo.dnumber + '<input type="hidden" class="text_input60 number" id="'+index+'cstpoeordergoodsquantity" readonly="readonly" name="procurementCheckEntryPo.cstpoeordergoodsquantitys" value="' + goodInfo.dnumber +'" onblur="amount(this);"/>';
		c4.innerHTML = goodInfo.rnumber + '<input type="hidden" class="text_input60 number" maxlength="18" id="'+index+'cstpoegoodsquantity" name="procurementCheckEntryPo.cstpoegoodsquantitys" value="' + goodInfo.rnumber +'" onblur="check($(this),1);amount(this);" validate="[{\'Type\' : Type.String, \'Formula\' : Formula.notNull, \'Message\' : \'请填写商品数量！\'},{\'Type\' : Type.String, \'Formula\' : Formula.INT, \'Message\' : \'商品数量应为整数！\'}]"/>';
		c5.innerHTML = goodInfo.fhl + '<input type="hidden" class="text_input100 number" id="'+index+'cstpoecoincidencerate" name="procurementCheckEntryPo.cstpoecoincidencerates" value="' + goodInfo.fhl +'"/>';
		if(goodInfo.bz=='1')
		{
			c6.innerHTML = '√';
		}else{
		...
		c8.innerHTML = goodInfo.hg +'<input type="hidden" class="text_input60 number" id="'+index+'hg" style="background-color: #E1E3E6;" readonly="readonly" name="hg" value="' + goodInfo.hg +'" onblur="amount(this);"/>';
		c9.innerHTML = goodInfo.bhg +'<input type="hidden" class="text_input60 number" id="'+index+'cstpoeunqualifiedquantity" name="procurementCheckEntryPo.cstpoeunqualifiedquantitys" onblur="check($(this),2);rowamount($(this));amount(this);" value="' + goodInfo.bhg +'"/>';
		c10.innerHTML = goodInfo.hgl +'<input type="hidden" class="text_input60 number" style="background-color: #E1E3E6;" readonly="readonly" id="'+index+'cstpoeunqualifiedrate" name="procurementCheckEntryPo.cstpoeunqualifiedrates" value="' + goodInfo.hgl +'"/>';
    }
