...
<html>
	...
	function save(){
		...
		refractiveForm.action="refractiveInsert.action?source=refractiveiou";
	...
	*/
	...
	function doubleEyeFun(){
		$("img").removeAttr("onclick");
		refractiveForm.action="doubleEyeFunTool.action?source=doubleeyefuncopy";
		refractiveForm.submit();
	}
	function specialCheck(){
		$("img").removeAttr("onclick");
		refractiveForm.action="specialCheckTool.action?source=specialcheckcopy";
		refractiveForm.submit();
	}

	function refractiveCopy(){
		$("img").removeAttr("onclick");
		location.href="refractiveCopy.action?chuyanfuyan="+'${chuyanfuyan}'+"&oldOptometryID="+'${oldOptometryID}'+"&customerID="+'${customerID }'+"&optometryBasicID="+'${copyBasicOptometryID}'+"&moduleID="+'${moduleID}'+"&optometryID="+'${optometryID}';
		selectHidden();
	}
</script>
			...
			<DIV>
				<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
					<TBODY>
															...
															<td>
																...
																<table width="99%" class="privateTable" border="0" cellpadding="1" cellspacing="1">
																	...
																	<tr bgcolor="#CADEE8">
																		<TD colspan="9"
																			...
																			<input  type="radio" checked="checked" id="pupil" name="refractivePo.soprdiffusepupil" value="1">散瞳
																			<input  type="radio" id="pupil" name="refractivePo.soprdiffusepupil" value="0">不散瞳
																		</TD>
																	</TR>
																	...
																	<TBODY>
																		...
																		<TD class="PrivateBorderBlue">
																				<div align="center">
																					<input type="button" value="检影" onclick="mydriasis()">
																				</div>
																			</TD>
																...
																<table width="99%" border=0 align=center cellpadding="1" cellspacing="1" class="privateTable" >
																	...
																	<TBODY>
																		...
																		<TD class="PrivateBorderBlue">
																				<div align="center">
																					<input type='button' value="主观屈光" onclick="kgqg()"; >
																				</div>
																			</TD>
																			<td colspan=2></td>
																		</tr>
																		...
																		<TD width="99%" align="center"
																			class="PrivateBorderBlue" bgcolor="#CADEE8">
																			   <div>双眼平衡方法
																				...
																				主导眼
																					<select jjsgorder="16"
																						name="refractivePo.soprleadingeye" id="enter51" onkeypress="EnterDown(this)"
																						>
																						<option value="" selected="selected">
																						----请选择----	
																						</option>
						...
						<TR>
							<TD background=${ctx}/img/pic/tab_bg.gif bgColor=#ffffff colspan="3">
							</TD>
						</TR>
					</TBODY>
				</TABLE>
