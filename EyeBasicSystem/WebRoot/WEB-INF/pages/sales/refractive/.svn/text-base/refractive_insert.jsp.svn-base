																	...
																	<tbody>
																		<tr bgcolor="#CADEE8">
																			...
																			<TD width="8%"
																				...
																				<div align="center">
																					<input type="text" jjorder="1" needChange="needChange"
																						va='va' maxlength='20' name="refractivePo.soprnakedod"
																			...
																			<TD width="8%"
																				...
																				<div align="center">
																					<input type="text" jjorder="2" needChange="needChange"
																						va='va' maxlength='20' name="refractivePo.soprnakedos"
																			...
																			class="PrivateBorderBlue" bgcolor="#CADEE8">
																			   <div>双眼平衡方法
																				...
																				主导眼
																					...
																					&nbsp;&nbsp;&nbsp;接诊医师
																					<input type="text" id="soprexaminedoctorName" name="soprexaminedoctoridName" value="${personName}">
