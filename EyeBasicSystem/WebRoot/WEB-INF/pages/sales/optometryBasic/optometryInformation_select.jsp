...
<script>	
	...
	//打开配镜详细信息 
	 function printDetails(optometryID,optometryBasicID,dontshow,chuyanfuyan){
	 	var topRows = top.document.getElementById("total").rows;
		var topCols = top.document.getElementById("btmframe").cols;
		
		var optometrydetailstype = '${systemParameterPo.fspoptometrydetailstype}';
		
		if(optometrydetailstype == ''){
			optometrydetailstype = "initRefractiveSelectN";
		}
		...
		if(is_iPad()){
			showPopWin(optometrydetailstype+".action?optometryID="+optometryID+"&customerID="+'${customerID}'+"&optometryBasicID="+optometryBasicID+"&moduleID="+'${moduleID}'+"&dontshow="+dontshow+"&chuyanfuyan="+chuyanfuyan,970,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}else{
			showPopWin(optometrydetailstype+".action?optometryID="+optometryID+"&customerID="+'${customerID}'+"&optometryBasicID="+optometryBasicID+"&moduleID="+'${moduleID}'+"&dontshow="+dontshow+"&chuyanfuyan="+chuyanfuyan,screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}
                      ...
                      <TBODY>
                        ...
                        <c:forEach var="optometry" items="${basicPo.optometrys}" varStatus="optometryIndex">
                       	<TR class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">
                       		<TD height="28"><a href="javascript:void(0);" onclick="printDetails('${optometry.sopoyoptometryid }','${ basicPo.sopoboptometrybasicid}','1',${optometry.sopoyrownumber})" >${optometry.sopoyoptometryid}</a></TD>
