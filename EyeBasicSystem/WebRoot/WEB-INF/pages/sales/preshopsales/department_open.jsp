                      ...
                      <TBODY>
						...
						<s:iterator value="departmentList">	
							<TR class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">
								<TD height="26">
		                          	<input type="checkbox" id="chk" departmentid="${bdpdepartmentid}" onClick="setSingleValue(this);" value="{'bdpdepartmentid':'${bdpdepartmentid}','bdpdepartmentname':'${bdpdepartmentname}'}">
		                        </TD>
