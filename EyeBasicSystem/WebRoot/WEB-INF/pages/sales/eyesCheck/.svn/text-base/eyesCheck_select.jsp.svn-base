...
if($("#title1").is(":visible"))
	...
	function search(){
		...
		mydriasisForm.action = "selEyesCheck.action";
		mydriasisForm.submit();
		showLoadingBar();
	}
	function insert(){
		var moduleID=document.all.moduleID.value;
		showPopWin("","initEyesCheckInsert.action?moduleID="+moduleID,screen.width-200,screen.height-200, '',null,true);
		selectHidden();
	}
              ...
              <TR><!--?Start-->
                  ...
                  <TABLE height=22 cellSpacing=0 cellPadding=0 border=0>
					...
					<TD class=tab id=tabLabel__1 
                      onclick="JavaScript:window.location.href='initEyesCheckInsert.action'" 
