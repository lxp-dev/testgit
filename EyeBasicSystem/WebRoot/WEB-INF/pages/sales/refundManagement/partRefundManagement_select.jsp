...
<script type="text/javascript">
	...
	function pay2(json,flag,ssesbhandlestate,id,handlestatecount,flag2,flag3){
		...
		var topCols = top.document.getElementById("btmframe").cols;
		if(is_iPad()){
			showPopWin("initPartRefundOpen.action?hid="+json+"&moduleID="+moduleID,970,screen.height-200,topRows,topCols,returnRefresh(true),true);
		}else{
			showPopWin("initPartRefundOpen.action?hid="+json+"&moduleID="+moduleID,screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),true);
		}
		document.getElementById('popupTitle').innerHTML="【商品退款】";
	}
                        ...
                        <table width="98%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateTable privateBorder">
                          <tr>
                            <td bgcolor="#cadee8"><li class="horizontal">卡号&nbsp;
                                    ...
                                    onkeydown="selectCustomer();" ${systemParameterPo.fsphisflag == '2' && person.bdplinkhisflag == '1' ? 'readonly=readonly':'' } class="text_input100" size="6">
                              </li>
                                <li class="horizontal">
                    ...
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder">
                      <TBODY>
                        ...
                        <TR class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">
                          ...
                          <TD align="center" width="3%"><img src="${ctx }/img/newbtn/refund_0.png" btn=btn name="button3223" title="商品退款" onclick=pay2('${ssesbsalesid}','${ssesbcheckoutflag}','${ssesbhandlestate }','${ssesbsalesid }','${ssesbhandlestatecount }','${ssesbhispayflag}','${ssesbhiscancelflag}')></TD>
