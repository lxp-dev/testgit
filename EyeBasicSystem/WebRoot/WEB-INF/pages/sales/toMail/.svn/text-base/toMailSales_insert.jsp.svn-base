...
<script>	
  function save(){
		if(checkForm(document.all.toMailForm)){
			...
			toMailForm.action = "salesOpenToMailInsert.action";
			toMailForm.submit();
		}
	}
                ...
                vAlign=top><DIV id=tabContent__1>
                  <DIV>
                    <table width="100%" id="title0"  border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                      ...
                      <TBODY>
					  	<TR>
                          <TD height="26" class="table_body">配镜单号</TD>
					  	  <TD class="table_none"><li class="horizontal_onlyRight"><input type="text" readonly="readonly" style="background-color: #E0E0E0" id="ssetmlinksalesid" name="toMailPo.ssetmlinksalesid" value="${salseID }"/></li>		 
					  	  <label style="color:red;">&nbsp;*&nbsp;</label> 
					  	  </TD>
					  	  <TD height="26" class="table_body">会员卡号</TD>
					  	  <TD class="table_none"><input type="text" readonly="readonly" style="background-color: #E0E0E0" id="ssetmmemberid" name="toMailPo.ssetmmemberid" value="${customerInfoPo.smecimemberid }"/><label style="color:red;">&nbsp;*&nbsp;</label> </TD>
					  	</TR>
                    	<TR>
                    	  <TD width="10%" height="26" class="table_body">顾客姓名</TD>
                    	  <TD width="30%" class="table_none"><input class="text_input200" type="text"  id="ssetmcustomername" name="toMailPo.ssetmcustomername" value="${customerInfoPo.smeciname }" maxlength="16" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '顾客姓名不能为空!'}]"/><label style="color:red;">&nbsp;*&nbsp;</label> </TD>
                    	...
                    	<TR>
                    	  ...
                    	  <TD class="table_none">
                    	    <input class="text_input200" type="text"  id="ssetmcustomerphone" name="toMailPo.ssetmcustomerphone" value="${customerInfoPo.smeciphone }" maxlength="18" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '顾客电话不能为空!'},{'Type' : Type.String, 'Formula' : Formula.PhoneORNULL, 'Message' : '顾客电话格式错误!'}]"/>
                    	  <label style="color:red;">&nbsp;*&nbsp;</label> 
                    	  </TD>
                    	  <TD width="8%" height="26" class="table_body">联系人</TD>
                    	  <TD class="table_none"><input class="text_input160" type="text"  id="ssetmlinkman" name="toMailPo.ssetmlinkman" value="${customerInfoPo.smeciname}" maxlength="16" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '联系人不能为空!'}]"/><label style="color:red;">&nbsp;*&nbsp;</label> </TD>                   	
                    	</TR>
                        ...
                        <TR>
                          <TD height="62" class="table_body">快递地址</TD>
                          <TD class="table_none" colspan="3"><textarea name="toMailPo.ssetmmaiiladdress" id="ssetmmaiiladdress"
                          	validate="[{'Type' : Type.String, 'Formula' : '', 'Expansion' : {Type : Expansion.LessThanLengthORNULL, Params : [101]}, 'Message' : '地址不能大于100字！'}]"></textarea>&nbsp;<label style="color:red;">&nbsp;*&nbsp;</label> </TD>                      
                        </TR>
                      </TBODY>
                    </TABLE>
