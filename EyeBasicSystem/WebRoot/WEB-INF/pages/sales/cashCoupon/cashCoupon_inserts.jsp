...
　　 }
	function save(){
		if(checkForm(document.all.glassesFrameForm)){ 
			...
			glassesFrameForm.action = "insertsCashCoupon.action";
                ...
                vAlign=top><DIV id=tabContent__1>
                  <DIV>
                    ...
                    <table width="100%"  border=0 align=center cellpadding=0 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        <TR>
						    <TD width="6%" height="26" class="table_body">代金券号</TD>
			                <TD width="30%" class="table_none">
			                <input class="text_input80" type="text" id="djq1"  maxlength="6" value="${djq1}" name="djq1" >&nbsp;固定号段
                            <input class="text_input100" type="text" id="djq2" maxlength="10" value="${djq2}" name="djq2" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '请填写代金券号！'},{'Type' : Type.String, 'Formula' : Formula.UINT, 'Message' : '代金券号应为数字！'}]" >&nbsp;动态号段
			               ...
			               <TD width="8%" height="26" class="table_body">新增数量</TD>
			               <TD class="table_none" valign="middle" width="23%">
                            	<input class="text_input100" type="text" id="cardnumber" maxlength="4" value="${cardnumber}" name="cardnumber" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '请填写批量新增的数量！'},{'Type' : Type.String, 'Formula' : Formula.UINT, 'Message' : '请填写正确的新增数量！'}]" onblur="this.value=$.trim(this.value);">
			               	<label style="color:red;">&nbsp;*</label>
                            </TD>			                
			             </TR>
			             <TR>
			                ...
			                <TD width="23%" class="table_none" valign="middle" >
                            	<input class="text_input160" type="text" id="bccexpense" maxlength="18" value="${cashCouponPo.bccexpense}" value="0.00" name="cashCouponPo.bccexpense" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '请填写使用限制金额！'},{'Type' : Type.String, 'Formula' : Formula.UFloat, 'Message' : '请填写正确的使用限制金额！'}]" onKeyUp="value=value.replace(/[^\d\.]/g,'')"  onblur="if(!isNaN(this.value)) { if(trim(this.value)!='')this.value = new Number(this.value).toFixed(2);}">&nbsp;&nbsp;元之上使用
                           <label style="color:red;">&nbsp;*</label>
                            </TD>
