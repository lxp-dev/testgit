...
function save(){
	if(checkForm(setMealFrm)){
    	...
    	setMealFrm.action = "updateSetMealDepartments.action";
    	setMealFrm.submit();
	}
}
...
function openDepartment(){
	...
	if(is_iPad()){
		showPopWin("initDepartmentOpen.action?departmentType=1&isclosed=0",970,screen.height-200,topRows,topCols,returnRefresh(true),false);
	}else{
		showPopWin("initDepartmentOpen.action?departmentType=1&isclosed=0",screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),false);
	}
	
	document.getElementById('popupTitle').innerHTML="【活动部门查询】";
}
                      ...
                      <TBODY>
			            ...
			            <TR>
			              ...
			              <input id="ssmsmcreatedate" clean="clean" 
					       ...
					       type="hidden" class="text_input100" 
					       ...
					       value="${setMealPo.ssmsmeffectivedate }"/>
			              </TD>
           				  <TD height="26" class="table_body">截止日期</TD>
                        	<TD height="26" class="table_none" ><input id="ssmsmenddate" clean="clean"
				        ...
				        <TR>                             
				           ...
				           <TD height="26" class="table_none" colspan="5">
								<li class="horizontal_onlyRight">
								    <input class="text_input300" id="bdpdepartmentname" name="setMealPo.ssmsmshopcodename" value="${setMealPo.ssmsmshopcodename }" type="hidden" />
								    <textarea id="ds"  name="ds" readonly="readonly" style="width:1000" value="${setMealPo.ssmsmshopcodename}">${setMealPo.ssmsmshopcodename }</textarea>&nbsp;
								    <input class="text_input100" type="hidden" id="departmentID" name="setMealPo.ssmsmshopcode" value="${setMealPo.ssmsmshopcode }" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '请选取活动部门！'}]"/>
