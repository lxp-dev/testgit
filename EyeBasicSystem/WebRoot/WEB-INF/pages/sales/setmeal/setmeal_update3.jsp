...
<input type="hidden" name="setMealPo.ssmsmdetailform" value="12" />
                    ...
                    <table width="100%" id="title0"  border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                      <TBODY>
                        <TR align=middle>
                          ...
                          <TD align="left" class="table_none"><input type="text" class="text_input100" maxlength="10" value="${setMealPo.ssmsmexpensespendup }" name="setMealPo.ssmsmexpensespendup" validate="[{'Type' : Type.String, 'Formula' : Formula.UFloatORNULL, 'Message' : '请重新填写的整单金额！'}]" onblur="amoumtAddZero(this)">&nbsp;至&nbsp;<input type="text" class="text_input100" maxlength="10" value="${setMealPo.ssmsmexpensespendul }" name="setMealPo.ssmsmexpensespendul" validate="[{'Type' : Type.String, 'Formula' : Formula.UFloatORNULL, 'Message' : '请重新填写的整单金额！'}]" onblur="amoumtAddZero(this)"></TD>
                        </TR>
                      </TBODY>
                    </TABLE>  
                    <br/>
					...
					<TABLE cellSpacing=1 cellPadding=3 width="100%" align=center border=0>
                      <TR valign="middle">
                        <td align="left" width="28%">
                          ...
                          <img src="${ctx }/img/newbtn/btn_pltjgmsp_0.png" btn=btn title="批量添加购买商品" onclick="addGoodsBatch('1')">
					...
					<TABLE cellSpacing=1 cellPadding=3 width="100%" align=center border=0>
                      <TR valign="middle">
                        <td align="left" width="28%">
                          ...
                          <img src="${ctx }/img/newbtn/btn_pltjgmsp_0.png" btn=btn title="批量添加购买商品" onclick="addGoodsBatch('2')">
