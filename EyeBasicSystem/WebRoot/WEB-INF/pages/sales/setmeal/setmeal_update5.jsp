...
function changeClassif(){
   ...
   if ($('#ssmsmform').val() == '1'){
    	setMealFrm.action="initSetMealInsert.action"; 
    }
    setMealFrm.submit();
 }
                    ...
                    <table width="100%" id="title0"  border=0 align=center cellpadding=0 cellspacing=0>
                      <TBODY>
                        <TR align=middle>
                          ...
                          <TD align="left" class="table_none" width="20%"><input type="text" class="text_input100" maxlength="10" name="setMealPo.ssmsmexpensespendup" value="${setMealPo.ssmsmexpensespendup}" validate="[{'Type' : Type.String, 'Formula' : Formula.UFloatORNULL, 'Message' : '请重新填写的整单金额！'}]" onblur="amoumtAddZero(this)">&nbsp;至&nbsp;<input type="text" class="text_input100" maxlength="10" name="setMealPo.ssmsmexpensespendul" value="${setMealPo.ssmsmexpensespendul}" validate="[{'Type' : Type.String, 'Formula' : Formula.UFloatORNULL, 'Message' : '请重新填写的整单金额！'}]" onblur="amoumtAddZero(this)"></TD>
                          <td align="left" class="table_none" width="15%">
                                  ...
                                  <option value="" ${setMealPo.ssmsmdetailform eq '' ? 'selected="selected"' : '' }>----请选择----</option>
                                  <option value="23" ${setMealPo.ssmsmdetailform eq '23' ? 'selected="selected"' : '' }>打折</option>
                                  <option value="22" ${setMealPo.ssmsmdetailform eq '22' ? 'selected="selected"' : '' }>返现</option>
                                  <option value="24" ${setMealPo.ssmsmdetailform eq '24' ? 'selected="selected"' : '' }>特价</option>
                              </select>
                          </td>
                          <td class="table_none" width="6%">
                              <input type="text" ${setMealPo.ssmsmdetailform eq '23' ? 'class="text_input60 inInput"' : 'class="text_input60 inInput readyonlyInput" readonly="readonly" noValidate="noValidate" ' } style="width: 50" maxlength="10" name="setMealPo.ssmsmdiscountrate" value="${setMealPo.ssmsmdiscountrate }" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '请填写整单折扣！'},{'Type' : Type.String, 'Formula' : Formula.UDiscount, 'Message' : '请重新填写的整单折扣！'}]">
                          </td>
                          <td class="table_none" width="6%">
                              <input type="text" ${setMealPo.ssmsmdetailform eq '22' ? 'class="text_input60 inInput"' : 'class="text_input60 inInput readyonlyInput" readonly="readonly" noValidate="noValidate" ' } style="width: 50" maxlength="10" name="setMealPo.ssmsmexpenseamount" value="${setMealPo.ssmsmexpenseamount }" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '请填写整单优惠金额！'},{'Type' : Type.String, 'Formula' : Formula.UFloat, 'Message' : '请重新填写的整单优惠金额！'}]" onblur="amoumtAddZero(this)">
                          </td>
                          <td class="table_none" width="6%">
                              <input type="text" ${setMealPo.ssmsmdetailform eq '24' ? 'class="text_input60 inInput"' : 'class="text_input60 inInput readyonlyInput" readonly="readonly" noValidate="noValidate" ' } style="width: 50" maxlength="10" name="setMealPo.ssmsmsalesbillamount" value="${setMealPo.ssmsmsalesbillamount }" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '请填写整单特价金额！'},{'Type' : Type.String, 'Formula' : Formula.UFloat, 'Message' : '请重新填写的整单特价金额！'}]" onblur="amoumtAddZero(this)">
                          </td>
