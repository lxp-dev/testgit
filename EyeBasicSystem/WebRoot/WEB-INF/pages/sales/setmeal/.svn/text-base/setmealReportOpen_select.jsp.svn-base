...
<script>
	...
	function search(){
		departmentstForm.action = "selSetMealReportOpen.action";
	...
	function setValue(){ 	         
        ...
        var objValue="";
        var count=0;
        var chktext=$("input[id=MealID]",window.parent.document).val();
		var chkname=$("input[id=MealName]",window.parent.document).val();
          	...
          	{         		
          		...
          		{	
		           ...
		           if(mm)
		           {
		           		if(objValue=="")
		           	 	{
			           		objValue="{'MealID':'"+temp[i]+"','MealName':'"+t1[i]+"'}";
			         	}else
			         	{
			           		objValue=objValue+","+"{'MealID':'"+temp[i]+"','MealName':'"+t1[i]+"'}";
			         	}  
			        }
          		}
		}
        ...
        window.parent.openSetMealValues(objValue);
                  ...
                  <DIV>
                    ...
                    <c:if test="${not empty(setMealList)}">
                      ...
                      <TBODY>
                        <TR class=table_title align=middle>
                          <TH width="6%" scope=col>选择</TH><!-- <input type="checkbox" id="chks" onclick="chkAll()"> -->
					...
					<s:iterator value="setMealList">	
						<TR class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">
						  <TD height="26">
		                          	<!-- <input type="checkbox" id="chk" departmentid="${ssmsmid}" onClick="setValue();" value="{'MealID':'${ssmsmid}','MealName':'${ssmsmtitle}'}"> -->
                          	  <img src="${ctx }/img/newbtn/select_0.png" btn=btn departmentid="${ssmsmid}" onClick="setValue(this);" value="{'MealID':'${ssmsmid}','MealName':'${ssmsmtitle}'}"/>
                          </TD>
                          <TD width="3%">
