...
function save(){
	if(checkForm(setMealFrm)){
    	...
    	setMealFrm.action = "auditSetMeal.action?hid=${setMealPo.ssmsmid}";
    	setMealFrm.submit();
	}
}
                    ...
                    <table width="100%"  border=0 align=center cellpadding=0 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
			            ...
			            <TR>
						  ...
						  <TD class="table_none" colspan="5">${setMealPo.ssmsmissum eq '0' ? '不允许' : '允许' }&nbsp;</TD>
			            </TR>	
				        <TR>                             
		...
		<c:if test="${(setMealPo.ssmsmdetailform eq '11' || setMealPo.ssmsmdetailform eq '12')}">	
                  ...
                  <s:iterator value="salesGoodsArrayList" status="idx">
                    ...
                    <TABLE id=ctl00_PageBody_PostButton cellSpacing=1 cellPadding=3 width="100%" align=center border=0>
                      <TBODY>
                        <TR>
                          <TD><img src="${ctx}/img/newbtn/btn_audit_0.png" btn=btn id="submitButton" title='审核' onclick="save();"></TD>
                        </TR>
                      </TBODY>
                    </TABLE>	                     
              </TABLE> 
