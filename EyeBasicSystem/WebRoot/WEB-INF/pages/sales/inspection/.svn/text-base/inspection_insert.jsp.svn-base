...
// 翻方子
	...
	*/
	...
	function inspectionCopy(){
		location.href="inspectionCopy.action?chuyanfuyan="+'${chuyanfuyan}'+"&oldOptometryID="+'${oldOptometryID}'+"&customerID="+'${customerID }'+"&optometryBasicID="+'${copyBasicOptometryID}'+"&moduleID="+'${moduleID}'+"&optometryID="+'${optometryID}';
		selectHidden();
	}
	var f1;
	...
	function save(){
		...
		if($('[name*=.sopipballglassod]').length!=0){
			if(isSubmit == 0){
				...
				inspectionForm.action="inspectionInsert.action?ruleFlag=0&nw='N'";
  ...
  {   
	  ...
	  if(myValue == "1"){
		...
		c1.innerHTML="<tr id="+rowadd+"tr ><td><TABLE width='99%' border=0 align=center cellPadding=1 cellSpacing=1 class='privateTable' id='jy'><input type='hidden' name='inspectionPos["+Subtr(1,listindex)+"].sopipglasstype' value='2'/><TR><TD colspan='9' style='height:20px' class='PrivateBorderBlue' bgcolor='#E1EBFD'><p>框架--近用&nbsp;&nbsp;&nbsp;<img onmouseover=\"JavaScript:$(this).attr('src','${ctx }/img/newbtn/btn_delete_0.png');\" onmouseout=\"JavaScript:$(this).attr('src','${ctx }/img/newbtn/btn_delete_1.png');\" src='${ctx }/img/newbtn/btn_delete_0.png' btn=btn  title='删除' ln="+allTrafficCount+" onclick='javascript:deletechufang(1,this);'><br></p></TD></TR><TR><TD bgcolor='#E1EBFD' class='PrivateBorderBlue'>&nbsp;</TD><TD bgcolor='#E1EBFD' class='PrivateBorderBlue'><div align='center'>球镜</div></TD><TD bgcolor='#E1EBFD' class='PrivateBorderBlue'><div align='center'>柱镜</div></TD><TD bgcolor='#E1EBFD' class='PrivateBorderBlue'><div align='center'>轴向</div></TD><TD bgcolor='#E1EBFD' class='PrivateBorderBlue'><div align='center'>三棱镜</div></TD><TD bgcolor='#E1EBFD' class='PrivateBorderBlue'><div align='center'>基底</div></TD>"
										...
										+"<TD bgcolor='#E1EBFD' class='PrivateBorderBlue'><div align='center'><input jjorder='16' va='va' maxlength='20' name='inspectionPos["+Subtr(1,listindex)+"].sopipclosevaos' onKeyPress='EnterDown(this)' enter='enter"+(enternum++)+"' class='text_input' size='4' value='${refractivePo.soprdbalvaos }'></div></TD></TR><TR><TD colspan='4' bgcolor='#E1EBFD' class='PrivateBorderBlue'></TD><TD colspan='5' bgcolor='#E1EBFD' class='PrivateBorderBlue'><div align='center'>中距离：<INPUT type='checkbox' value='1' name='inspectionPos["+Subtr(1,listindex)+"].sopipmiddledistance'>建议镜框：<SELECT name='inspectionPos["+Subtr(1,listindex)+"].sopipsuggestframe'><OPTION value='' selected>----请选择----</OPTION><OPTION value='打孔'>打孔</OPTION><OPTION value='拉丝'>拉丝</OPTION><OPTION value='板材'>板材</OPTION><OPTION value='框高'>框高</OPTION></SELECT><INPUT name='inspectionPos["+Subtr(1,listindex)+"].sopipframeheight' size='12'></div></TD></TR><TR><TD bgcolor='#E1EBFD' class='PrivateBorderBlue'><div align='right'>建议镜片材质:</div></TD><TD bgcolor='#E1EBFD' class='PrivateBorderBlue'><SELECT name='inspectionPos["+Subtr(1,listindex)+"].sopipglassmaterial'><OPTION value='' selected>----请选择----</OPTION><OPTION value='老花渐进'>老花渐进</OPTION><OPTION value='青少年渐进'>青少年渐进</OPTION><OPTION value='非球面树脂'>非球面树脂</OPTION><OPTION value='抗辐射镜片'>抗辐射镜片</OPTION><OPTION value='染色镜片'>染色镜片</OPTION><OPTION value='变色镜片'>变色镜片</OPTION><OPTION value='普通树脂'>普通树脂</OPTION><OPTION value='高折玻璃'>高折玻璃</OPTION><OPTION value='玻璃片'>玻璃片</OPTION><OPTION value='树脂偏光镜片（茶/灰）'>树脂偏光镜片（茶/灰）</OPTION><OPTION value='树脂抗疲劳镜片'>树脂抗疲劳镜片</OPTION><OPTION></OPTION></SELECT></TD><TD bgcolor='#E1EBFD' class='PrivateBorderBlue'><div align='right'>处理方式： </div></TD><TD colspan='2' bgcolor='#E1EBFD' class='PrivateBorderBlue'><select name='inspectionPos["+Subtr(1,listindex)+"].sopipdisposemanner'><option value='' selected>----请选择----</option><option value='足矫'>足矫</option><option value='欠矫'>欠矫</option><option value='过矫'>过矫</option><option value='附加棱镜'>附加棱镜</option><option value='调整'>调整</option><option value='平衡'>平衡</option><option value='医嘱'>医嘱</option><option value='全矫'>全矫</option><option value='患者要求减度'>患者要求减度</option></select></TD><TD bgcolor='#E1EBFD' class='PrivateBorderBlue'><div align='right'>备注：</div></TD><TD colspan='3' bgcolor='#E1EBFD' class='PrivateBorderBlue'><textarea name='inspectionPos["+Subtr(1,listindex)+"].sopipdignosisre'></textarea></TD></TR></TBODY></TABLE></td></tr>";
                                  ...
                                  <TBODY>
                                    ...
                                    <TR>
                                      <TD height="30" bgcolor="#E8F8FF"><div align="center" class="PrivateBorder">复诊时间：
                                          <input id="sopipseccheckdate" name="inspectionPo.sopipseccheckdate" onFocus="WdatePicker({readOnly:true})" class="text_input120">
                                          <!-- <SELECT name="inspectionPo.sopipsubvisitunit">
