...
<script>	
	...
	function search(){
		...
		procurementReturnForm.action = "selPrePlanOpenForRpt.action";
		procurementReturnForm.submit();
		showLoadingBar();
	}
	function insert(){
...
//		selectHidden();
	...
	*/
	...
	function selectPrePlan(prePlanId) {
		procurementReturnForm.action = "prePlanOpenSelect.action?prePlanPo.planId="+prePlanId;
		procurementReturnForm.submit();
	}
	function setParentPrePlanIdAndName(id, name) {
		window.parent.setPrePlanIdAndName(id, name);
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD align="left"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：门店计划销售计划选择</TD>
                    ...
                    <table width="100%" id="title0"  border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                      ...
                      <TBODY>
					  	<TR>
			               ...
			               <TD class="table_none">
						      <li class="horizontal_onlyRight"> <input id="startDate" clean=clean
			               ...
			               <TD class="table_none" width="30%">
			               	<SELECT clean=clean name="prePlanPo.overdue" id="overdue">
					...
					<table width="100%"   border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                      ...
                      <TBODY>
                        <TR class=table_title align=middle>
						  <TH width="13%" scope=col>计划销售名称</TH>						
						  <TH width="12%" scope=col>计划销售日期</TH>
                          <TH width="6%" height="26" scope=col >操作</TH>
					   </TR>
						 <s:iterator value="prePlanPoList">
	                        <TR class="row" height="26" style="${Overdue eq 1 ? 'color: red' : '' }" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">
	                          ...
	                          <TD>
	                          	<img src="${ctx }/img/newbtn/select_0.png" btn=btn title='选择' onClick="javascript:setParentPrePlanIdAndName('${planId }', '${planName }')">
