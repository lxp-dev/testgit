...
<script>	
	...
	function doorStoreDelivery_YD(){
		$("img").removeAttr("onclick");
		doorStoreDeliveryForm.action = "selectDoorStoreDelivery.action?type=4";
		doorStoreDeliveryForm.submit();
	}
					...
					<table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
					 ...
					 <s:iterator value="salesBasicPoList">
						<TR class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">
                          <TD height="28"><input type="checkbox" id="chk" name="ssesbsalesid" salestype="${ssesborderstype}" value="${ssesbsalesid }"></TD>
                          <TD>${ssesbsalesid }</TD>
