...
<script>
	...
	function search(){
		...
		warehouseForm.action = "weiXinIntegralMSelectSel.action";
	...
	function details(uuid,flag){
		if (flag == '0'){
            alert('当前会员卡已被停用，不能兑换商品!');
            return;
	    }
		...
		if(is_iPad()){
			showPopWin("initWeiXinIntegralUpdate.action?hid="+ uuid ,400,140,topRows,topCols,returnRefresh(true),false);
		}else{
			showPopWin("initWeiXinIntegralUpdate.action?hid="+ uuid ,400,140,topRows,topCols,returnRefresh(true),false);
		}
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD align="left"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：微信积分兑换</TD>
          </TR>
          <TR>
                    ...
                    <table width="100%" border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder">
                      <TBODY>
                        <TR class=table_title align=middle>
                          ...
                          <TH width="8%" scope=col>兑换操作</TH>
                          <TH width="35%" scope=col>商品名称</TH>
                        ...
                        <TR height="26px;" class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">
                         ...
                         <TD><c:if test="${wieflag!=1}"><a href="#" onClick="javascript:details('${wieid}','${wiecustomerenable}')">兑换</a></c:if></TD>
                         <TD>${ wiegoodname}</TD>
                         <TD>${ wieintegral}</TD>
                        </TR>
                        </s:iterator>
