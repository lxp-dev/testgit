...
if($("#title1").is(":visible"))
	...
	function details(id){
		...
		if(is_iPad()){
			showPopWin("selIntegralExchangeManagementDetail.action?hid="+id,970,screen.height-200,topRows,topCols,returnRefresh(true),true);
		}else{
			showPopWin("selIntegralExchangeManagementDetail.action?hid="+id,screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),true);
		}
	...
	function search(){
		...
		mydriasisForm.action = "selIntegralExchangeManagementList.action";
		mydriasisForm.submit();
		showLoadingBar();
	}
              ...
              <TR><!--?Start-->
                  ...
                  <TABLE height=22 cellSpacing=0 cellPadding=0 border=0>
					...
					<TD class=tab id=tabLabel__1 
                      onclick="JavaScript:window.location.href='initIntegralExchangeManagement.action?moduleID=document.all.moduleID.value;'" 
              ...
              <TR>
                ...
                vAlign=top><DIV id=tabContent__1>
                  <DIV>
                    <table width="100%" id="title0"  border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                      ...
                      <TBODY>
					  	<TR>
			               ...
			               <TD width="8%" class="table_body">兑换时间</TD>
							<TD class="table_none">
					...
					<!-- Loading Bar ----------------------------------------------------------------------------------------------------------------->
					<c:if test="${not empty(integralExchangeList)}"> 
					<table width="100%"   border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                      ...
                      <TBODY>
                        <TR class=table_title align=middle>
                          ...
                          <TH width="18%" height="30" scope=col>会员卡号</TH>
                          <TH width="18%" scope=col>顾客姓名</TH>
                          <TH width="18%" scope=col>兑换人</TH>
                          <TH width="18%" scope=col>兑换时间</TH>
                          <TH scope=col>积分变动</TH>
						  </TR>
						<s:iterator value="integralExchangeList">
                        <TR class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">
                          <TD>
		                     <img src="${ctx }/img/newbtn/search_0.png" btn=btn title='详细' onclick="javascript:details('${filuuid}')">
		                  </TD>
                          <TD height="26">${filmemberid}</TD>
                          <TD>${filcustomername}</TD>
                          <TD>${filpersonname}</TD>
                          <TD>${fn:substring(fildatetime,0,16)}</TD>
                          <TD>${filintegralnumber}</TD>
						</TR>
						</s:iterator>
                      </TBODY>
                    </TABLE>
