              ...
              <TR>
                ...
                vAlign=top><DIV id=tabContent__1>
                  <DIV>
                      ...
                      <TBODY>
                        <TR height="26px">
                          <TD width="9%" class="table_body">制造商代码</TD>
                          <TD width="24%" class="table_none">${supplierID}
                          <input type="hidden" id="supplierID" name="supplierID" value="${supplierID}" />
                          <input type="hidden" id="startDate" name="startDate" value="${startDate}" />
                          <input type="hidden" id="endDate" name="endDate" value="${endDate}" />
						  </TD>
                          <TD width="9%" class="table_body">制造商简称</TD>
                          <TD width="24%" class="table_none">${supplierName}</TD>
                          <TD width="9%" class="table_body">日期</TD>
                    ...
                    <table width="100%" border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                      ...
                      <TBODY>
                        <TR class=table_title align='middle'>
						  ...
						  <TH scope=col width="18%">单据号</TH>	
                          <TH scope=col width="30%">货单号</TH>					
                          <TH scope=col width="8%">类型</TH>  
                          <TH width="10%" scope=col>单据金额</TH>
                          <TH scope=col width="10%">回款金额</TH>                        
 						  <TH scope=col width="10%">应付金额</TH>	
                        </TR>
                        <tr class=table_title align=middle> 
						  	<th height="26"  colSpan=7 scope=col align="right">期初金额：&nbsp;&nbsp;&nbsp;&nbsp;</th>
                        ...
                        <tr class=table_title align=middle> 
						  	<th height="26" colSpan=7 scope=col align="right">合计：&nbsp;&nbsp;&nbsp;&nbsp;</th>
