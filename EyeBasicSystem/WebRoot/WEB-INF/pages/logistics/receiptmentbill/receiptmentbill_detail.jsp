	 ...
	 */        
	 function save(){
         ...
         if (checkForm(insertReceiptMentFrm)){
 	         if (Number($('#sLpbpbCostPriceAmount').val()) != Number($('#receiptMentAmount').val())){
                  ...
                  <DIV>
                      ...
                      <TBODY>
                        ...
                        <TR height="26px">
                          ...
                          <TD class="table_none">${receiptMentBillPo.sLrbrbTypeID == '1' ? '批发收款' : '调账' }&nbsp;</TD>                          
                          <TD class="table_body">核销金额</TD>
                          <TD class="table_none">${receiptMentBillPo.sLrbrbCurrentReceiptMentAmount}&nbsp;</TD>
                        </TR>
                        <TR height="26px">
                          <TD class="table_body">实际收款</TD>
                          <TD class="table_none" colspan="5">${receiptMentBillPo.sLrbrbCurrentReverseAmount }&nbsp;</TD>
                        </TR>
                        <TR height="62px">
                          <TD class="table_body">摘要</TD>
                          <TD class="table_none" colSpan=6><label>${receiptMentBillPo.sLrbrbRemark}&nbsp;</label></TD>
                        </TR>
                      </TBODY>
                    </TABLE> 
                ...
                <c:if test="${not empty(receiptMentBillEntryList)}">
                    ...
                    <s:iterator value="receiptMentBillEntryList" status="idx">
                        <TR class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">
						  ...
						  <TD>${sLrbrbeAllocateID}</TD>
						  <TD>${sLrbrbeBillTypeID}</TD>
						  <TD>${sLrbrbeBillDate}</TD>
						  <TD id="td1">${sLrbrbeCostPriceAmount}</TD>
						  <TD id="td2">${sLrbrbeReceiptedMentAmount}</TD>
						  <TD id="td3">${sLrbrbeNotReceiptedMentAmount}</TD>
						  <TD id="td4">${sLrbrbeReceiptMentAmount}</TD>
						  <TD>${sLrbrbeRemark}</TD>
                        </TR>                    
                    </s:iterator>
                      </TBODY>
