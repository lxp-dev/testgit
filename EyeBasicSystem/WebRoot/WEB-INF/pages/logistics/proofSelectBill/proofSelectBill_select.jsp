...
<script>	
	...
	function search(){	    
		...
		selectBill.action = "selectSelectBills.action";
		selectBill.submit();
		showLoadingBar();
	}
	...
	function billinfo(id,billType){
		...
		if(is_iPad()){
			showPopWin("initBillInfoSels.action?hid="+id+"&billType="+billType+"&moduleID=${moduleID}",970,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}else{
			showPopWin("initBillInfoSels.action?hid="+id+"&billType="+billType+"&moduleID=${moduleID}",screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}		
                ...
                vAlign=top><DIV id=tabContent__1>
                  <DIV>
                      ...
                      <TBODY>
					  	<TR>
			               ...
			               <TD class="table_none" width="24%">
                            <input class="text_input160" type="text" id="billid" name="billid" maxlength=22 value="${requestScope.billid}">
			               </TD>
			               <TD width="9%" height="30" class="table_body">结算日期</TD>
                        ...
                        <TR>
                         ...
                         <c:if test="${type == '8'}">                       
                    	   ...
                    	   <TD height="26" class="table_body">门店名称</TD>
			               <TD class="table_none">
                    ...
                    <table id="title2" cellspacing="2">
						<tr height="10">
							<td>
								<img btn=btn id="submitButton" src="${ctx }/img/newbtn/btn_search_0.png" title='查询' onclick="search();" >			
