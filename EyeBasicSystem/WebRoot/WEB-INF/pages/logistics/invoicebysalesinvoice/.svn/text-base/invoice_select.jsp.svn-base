...
<script>
	...
	function update(bid){
		...
		var topCols = top.document.getElementById("btmframe").cols;		
		if(is_iPad()){
			showPopWin("initInvoiceBySalesInvoiceUpdate.action?invoiceID="+bid+"&moduleID="+document.getElementById('moduleID').value,970,screen.height-200,topRows,topCols,returnRefresh(true),true);
		}else{
			showPopWin("initInvoiceBySalesInvoiceUpdate.action?invoiceID="+bid+"&moduleID="+document.getElementById('moduleID').value,screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),true);
		}		
		document.getElementById('popupTitle').innerHTML="【发票修改】";
	}
	
	function search(){
		invoiceForm.action = "selInvoiceBySalesInvoice.action";
		invoiceForm.submit();
		showLoadingBar();
	}	
	function detail(bid){
		...
		var topCols = top.document.getElementById("btmframe").cols;			
		if(is_iPad()){
			showPopWin("initInvoiceBySalesInvoiceDetail.action?invoiceID="+bid+"&moduleID=${moduleID}",970,screen.height-200,topRows,topCols,returnRefresh(true),true);
		}else{
			showPopWin("initInvoiceBySalesInvoiceDetail.action?invoiceID="+bid+"&moduleID=${moduleID}",screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),true);
		}		
	...
	function insert(){
		...
		var topCols = top.document.getElementById("btmframe").cols;		
		if(is_iPad()){
			showPopWin("initInvoiceBySalesInvoiceInsert.action?moduleID="+document.getElementById('moduleID').value,970,screen.height-200,topRows,topCols,returnRefresh(true),true);
		}else{
			showPopWin("initInvoiceBySalesInvoiceInsert.action?moduleID="+document.getElementById('moduleID').value,screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),true);
		}		
	...
	function del(bid){	
		var topRows = top.document.getElementById("total").rows;
		var topCols = top.document.getElementById("btmframe").cols;
		showPopWin("initInvoiceBySalesInvoiceDelete.action?invoiceID="+bid+"&moduleID="+document.getElementById('moduleID').value,450,140,topRows,topCols,returnRefresh(true),true);
