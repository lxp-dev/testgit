                    ...
                    <table width="100%"   border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                      ...
                      <TBODY>
                        ...
                        <TR class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')" height="26">	
						  ...
						  <TD id="td1">${lieiesourcenottaxrateamount }</TD>
						  <TD id="td2">${lieiesourcetaxamount }</TD>
                          <TD id="td3">${lieiesourcecostpriceamount}</TD>
                          <TD id="td4">${lieienottaxrateamount }</TD>
						  <TD id="td5">${lieietaxamount }</TD>
                          <TD id="td6">${lieiecostpriceamount}</TD>
                        </TR>
                        </s:iterator>
                        <TR class="table_title" align=middle height="26" >
