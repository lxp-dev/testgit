...
<script>
    ...
    function doList(link,perPage_Select,perPage_Text_Hidden){
	  	...
	  	invoiceDetailFrm.action=link;
	  	invoiceDetailFrm.submit();
	}
                   ...
                   <TABLE id="title2" cellSpacing=1 cellPadding=3 width="100%" align=center border=0>
                    ...
                    <table width="100%"   border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                      ...
                      <TBODY>
                        ...
                        <TR class="table_title" align=middle height="26" >
						  <TD colspan="4" align="right">总合计：</TD>
                          <TD>${invoiceEntryPo.lieiegoodsquantity }</TD>
                          <TD>${invoiceEntryPo.lieiecheckgoodsquantity }</TD>
                          <TD>&nbsp;</TD>
