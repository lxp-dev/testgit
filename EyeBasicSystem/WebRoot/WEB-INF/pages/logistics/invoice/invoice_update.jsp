	...
	function save(){	
	    ...
	    if (auditState != null && auditState.length != 0){
		    if (!auditState[0].checked){
	            invoiceForm.action = "invoiceUpdate.action?auditState=0";
	        }else{
	            invoiceForm.action = "invoiceUpdate.action?auditState=1";
	        }
	    }else{
	        invoiceForm.action = "invoiceUpdate.action?auditState=0";
	    }
                    ...
                    <table width="100%"   border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                      ...
                      <TBODY>
                        ...
                        <TR class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">
                          ...
                          <TD id="td2"><input onblur="shuliangCal(this);" type="text" onkeyup="toFixAndNum(this);hexiaoDown(this);" id="hexiao${idx.index}" name="invoiceEntryPo.lieiecheckgoodsquantity" value="${lieiecheckgoodsquantity }"  class="text_input60" readonly="readonly"></TD>
                          <TD><input type="text" onblur="danweiCal(this);toFix(this)" id="danwei${idx.index}" class="text_input60" onkeyup="toFixAndNan(this);danweiDown(this);" value="${lieienottaxrate}" name="invoiceEntryPo.lieienottaxrate"/></TD>
