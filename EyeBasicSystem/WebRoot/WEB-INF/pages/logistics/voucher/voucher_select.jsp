...
<script type="text/javascript">
    ...
    */ 
	function insert(){	 
		...
		if(is_iPad()){
			showPopWin("initVoucherInsert.action?moduleID=${moduleID}",970,screen.height-200,topRows,topCols,returnRefresh(true),true);
		}else{
			showPopWin("initVoucherInsert.action?moduleID=${moduleID}",screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),true);
		}
    ...
    */ 
	function update(voucherID){	
		...
		var topCols = top.document.getElementById("btmframe").cols;		
		if(is_iPad()){
			showPopWin("initVoucherUpdate.action?voucherID="+voucherID+"&parentID="+$("#parentID").val()+"&moduleID=${moduleID}",970,screen.height-200,topRows,topCols,returnRefresh(true),true);
		}else{
			showPopWin("initVoucherUpdate.action?voucherID="+voucherID+"&parentID="+$("#parentID").val()+"&moduleID=${moduleID}",screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),true);
		}
    ...
    */ 
	function detail(voucherID){
		...
		var topCols = top.document.getElementById("btmframe").cols;		
		if(is_iPad()){
			showPopWin("selVoucherDetail.action?voucherID="+voucherID+"&moduleID=${moduleID}",970,screen.height-200,topRows,topCols,returnRefresh(true),true);
		}else{
			showPopWin("selVoucherDetail.action?voucherID="+voucherID+"&moduleID=${moduleID}",screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),true);
		}
    ...
    */        
	function search(){
	    voucherSelFrm.action = "selVoucher.action";
	    voucherSelFrm.submit();
		showLoadingBar();
	 }
    ...
    */ 
	...
	function selBill(){		
		...
		var topCols = top.document.getElementById("btmframe").cols;		
		if(is_iPad()){
			showPopWin("initSelBill.action",970,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}else{
			showPopWin("initSelBill.action",screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}		
	...
	function selInvoiceAndReversal(){
		...
		var topCols = top.document.getElementById("btmframe").cols;		
		if(is_iPad()){
			showPopWin("initSelInvoiceAndReversal.action",970,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}else{
			showPopWin("initSelInvoiceAndReversal.action",screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}		
					 ...
					 <table width="100%" border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder">
                      <TBODY>
                        <TR class=table_title align=middle>
						  ...
						  <TH scope=col width="16%">制造商简称</TH>						
