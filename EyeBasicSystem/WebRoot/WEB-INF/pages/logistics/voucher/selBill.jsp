...
<script>   	
	...
	function search(){
		selectBill.action = "selBill.action";
		selectBill.submit();
		showLoadingBar();
	}
	...
	function printBill(billID){
        ...
        switch(printStatus){
            case '1':
                url="report.action?reportlet=logistics_BillByTypeRpt.cpt&billID="+billID+"&bgnDate="+bgnDate+"&endDate="+endDate;		        		
                break;
            case '2':
                url="report.action?reportlet=logistics_BillBySupplierRpt.cpt&billID="+billID+"&bgnDate="+bgnDate+"&endDate="+endDate;		        		
                break;
            case '3':
                url="report.action?reportlet=logistics_BillByBrandRpt.cpt&billID="+billID+"&bgnDate="+bgnDate+"&endDate="+endDate;		        		
                break;           
        }
		...
		document.getElementById('popupTitle').innerHTML="【冲回】";
	}
                      ...
                      <TBODY>
						 ...
						 <li class="horizontal_onlyRight">
						  <input id="begintime" clean=clean
			               ...
			               <TD class="table_none" width="24%" >
			               	<input clean=clean class="text_input160" type="text" id="goodsID" name="goodsID" value="${requestScope.goodsID}">
                           </TD>
                        </TR>
                    	<TR>
                           <TD height="26" class="table_body">核销状态</TD>
			               <TD class="table_none">			               
						   ...
						   <TD class="table_body">凭证编号</TD>
						   <TD class="table_none" >
						   		<input clean=clean id="voucherID" class="text_input160" name="voucherID" value="${voucherID}"/>
						   </TD>
                        </TR> 
                        <tr>
                           <TD height="26" class="table_body">打印级别</TD>
						   <TD class="table_none">
						   		<select clean=clean id="printStatus" name="printStatus">                                
							  		<option value="1" selected="selected">商品类别</option>
							  		<option value="2">制造商</option>
							  		<option value="3">品种</option>
                                </select> 
						   </TD>
						   <TD class="table_body">冲回日期</TD>
                           <TD class="table_none">						       
						<li class="horizontal_onlyRight">
						  <input id="bgnDate" clean=clean
					       name="bgnDate" 
					       type="text" class="text_input100" 
						   ...
						   <TD class="table_body">凭证标识</TD>
						   <TD class="table_none">
						   		<select clean=clean id="voucherStatus" name="voucherStatus">  
