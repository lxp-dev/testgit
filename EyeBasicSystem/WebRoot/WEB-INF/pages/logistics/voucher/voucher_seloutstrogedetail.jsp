                  ...
                  <DIV>
                      ...
                      <TBODY>
                        ...
                        <TR height="62px">
                          ...
                          <TD class="table_none" colSpan=5 validate="[{'Type' : Type.String, 'Formula' : '', 'Expansion' : {Type : Expansion.LessThanLengthORNULL, Params : [2001]}, 'Message' : '备注不能大于2000字！'}]">${po.sLvvRemark}</TD>
                        </TR>
                      </TBODY>
                    </TABLE>
					...
					<table width="100%" border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder">
                      <TBODY>
						...
						<TR class="table_title" align=middle>
						  <TD height="26" colspan="4" align="right">合计：</TD>
