...
<script type="text/javascript">
	...
	function save(){	  
       ...
       insertSubjectFrm.action = "inorOutComeTypeInsert.action";
  ...
  <TR>
    <TD><!-- ͷ˵ Start -->
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        ...
        <TR>
          <TD class=menubar_function_text height=27><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：收支类型新增</TD>
                  ...
                  <DIV>
                      ...
                      <TBODY>
                        <TR height="30px">
                          ...
                          <TD width="30%" class="table_none"><input clean="clean" class="text_input200" id="inOrOutComeTypeID" name="inOrOutComeTypePo.sLioioTypeID" type="text" maxlength="20">
                         
                          </TD>
                          <TD width="10%" class="table_body">收支类型名称</TD>
                          <TD class="table_none" width="30%" colspan="5">
                             <input clean="clean" class="text_input200" id="inOrOutComeTypeName" name="inOrOutComeTypePo.sLioioTypeName" type="text" maxlength="100">
                          </TD>
                        </TR>
                      </TBODY>
                    </TABLE>
