	        ...
	        if (chk != 0){ 
			    ...
			    if (auditState != null  && auditState.length != 0 ){
				    if (!auditState[0].checked){
			            editVoucherTempletFrm.action = "voucherTallyUpdate.action?auditState=0";
			        }else{
			            editVoucherTempletFrm.action = "voucherTallyUpdate.action?auditState=1";
			        }
			    }else{
			        editVoucherTempletFrm.action = "voucherTallyUpdate.action?auditState=0";
			    }
                  ...
                  <DIV>
                      ...
                      <TBODY>
                        <TR>
                          ...
                          <TD width="24%" class="table_none">
                              <input id="voucherDate" name="po.sLvvDate" type="text" class="text_input100" 
					                 ...
					                 value="${po.sLvvDate}" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '填写凭证日期！'}]"/>
                          </TD>
                        ...
                        <TR >
                          ...
                          <TD class="table_none"><input id="attchBillCount" name="po.sLvvAttchBillCount" type="text" class="text_input100" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '填写附单数！'},{'Type' : Type.String, 'Formula' : Formula.UINT, 'Message' : '填写的附单数不正确！'}]" value="${po.sLvvAttchBillCount }"/></TD>
                         
                        </TR>
                        <TR height="62px">
                          <TD class="table_body">备注</TD>
                          <TD class="table_none" colSpan=6>
                            <textarea name="po.sLvvRemark" id="remark" validate="[{'Type' : Type.String, 'Formula' : '', 'Expansion' : {Type : Expansion.LessThanLengthORNULL, Params : [2001]}, 'Message' : '备注不能大于2000字！'}]">${po.sLvvRemark}</textarea>
                            </TD>
                        </TR>
                      </TBODY>
                    </TABLE>
