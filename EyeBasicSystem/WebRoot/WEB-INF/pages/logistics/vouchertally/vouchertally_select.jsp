...
<script type="text/javascript">
    ...
    */        
	function search(){
	    voucherSelFrm.action = "voucherTallySel.action";
	    voucherSelFrm.submit();
		showLoadingBar();
	 }
    ...
    *  反审核凭证
    */
	function auditVoucher(voucherID){
		var topRows = top.document.getElementById("total").rows;
		var topCols = top.document.getElementById("btmframe").cols;
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        ...
        <TR>
          ...
          <c:if test="${permissionPo.keya == '1'}">          
                <img btn=btn src="${ctx }/img/newbtn/btn_jzpzxz_0.png" title='记账凭证新增' onClick="insert()">
          </c:if>
                  ...
                  <DIV>
                      ...
                      <TBODY>
					   ...
					   <TR height="26px">
                          ...
                          <li class="horizontal_onlyRight">
                            <input clean=clean type="text" id="supplierName" name="supplierName" class="text_input200" readonly="readonly" value="${supplierName}">
                            <input clean=clean type="hidden" id="supplierID" name="supplierID" class="text_input200" value="${supplierID}">
                          </li>
                            <li class="horizontal_onlyRight">
                        ...
                        <TR class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">
                         <c:if test="${sLvvAuditStatue=='1'}">
		                  ...
		                  <c:if test="${permissionPo.keyh == '1'}">
                             <img btn=btn src="${ctx }/img/newbtn/unaudit_0.png" title='反审核' onClick="javascript:auditVoucher('${sLvvID}')">
                             </c:if>
		                  </TD>
		                   </c:if>	                  
