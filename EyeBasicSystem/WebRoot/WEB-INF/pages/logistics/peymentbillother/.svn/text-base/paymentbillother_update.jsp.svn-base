...
<script type="text/javascript">
		...
		if (checkForm(updatePayMentBillFrm)){
		    ...
		    if (auditState != null  && auditState.length != 0 ){
			    if (!auditState[0].checked){
		            updatePayMentBillFrm.action = "updatePayMentBillOther.action?auditState=0";
		        }else{
		            updatePayMentBillFrm.action = "updatePayMentBillOther.action?auditState=1";
		        }
		    }else{
		        updatePayMentBillFrm.action = "updatePayMentBillOther.action?auditState=0";
		    }
	 ...
	 */ 
     function openInOrOutComeType(value){
         ...
         showPopWin("","initInOrOutComeTypeOpen.action",screen.width-200,screen.height-200, '', null, true);
		 selectHidden();
     }
	 ...
	 */ 
     function openSubject(value){
         ...
         showPopWin("selSubjectOpenTree.action?&moduleID=${moduleID}",970,screen.height-200,topRows,topCols,returnRefresh(true),false);
              ...
              <TR>
                ...
                vAlign=top><DIV id=tabContent__1>
                  <DIV>
                      ...
                      <TBODY>
                        <TR height="26px">
                          <TD width="8%" class="table_body">其他付款单号</TD>
                          ...
                          <TD width="30%" class="table_none" >${payMentBillPo.sLpbpbSupplierName}&nbsp;
                            <input type="hidden" name="payMentBillPo.sLpbpbSupplierID" value="${payMentBillPo.sLpbpbSupplierID}" />
                          </TD>
                        ...
                        <TR height="26px">
                          ...
                          <TD class="table_none" colspan="5">
                            <c:if test="${ payMentBillPo.sLpbpbPayMentDptID != ''}">
                                 ${payMentBillPo.sLpbpbPayMentDptName}
							     <input type="hidden" id="departmentID" name="payMentBillPo.sLpbpbPayMentDptID" class="text_input160" clean=clean value="${payMentBillPo.sLpbpbPayMentDptID}" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '部门名称不能为空！'}]"/>
                        ...
                        <s:iterator value="payMentBillEntryList" status="index">
                         <TR class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">
                          ...
                          <li class="horizontal_onlyRight">
                              <input type="text" id="InOrOutComeType${index.index }" value="${sLpbpbeOutComeName}" readonly="readonly" class="text_input160"/>
                              <input type="hidden" id="InOrOutComeTypeID${index.index }" name="payMentBillEntryTempPo.sLpbpbeInvoiceID" value="${sLpbpbeInvoiceID}" />
                          </li>
                          <li class="horizontal_onlyRight">
                              <img btn=btn src="${ctx }/img/newbtn/btn_change_0.png" title="选择" onClick="openSubject(${index.index });" >	
                          </li>
                          </TD>
                          <TD><input style="width:100" id="notpayamount${index.index }" type="text" name="payMentBillEntryTempPo.sLpbpbeCostPriceAmount" value="${sLpbpbeCostPriceAmount}" onblur="toFixAndNan(this,${index.index })"/></TD>
			              <TD><input style="width:350" type="text" name="payMentBillEntryTempPo.sLpbpbeRemark" value="${sLpbpbeRemark}"/></TD>                          
                         </TR>
                        </s:iterator>
                      </TBODY>
                    </TABLE>
