                    ...
                    <table width="99%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        <TR>
			               ...
			               <TD class="table_none" width="24%">${goodsInfoPo.bgiframesize}&nbsp;</TD>
			               <TD class="table_body" width="9%">功能</TD>
			               <TD class="table_none" width="24%">
			                 <c:if test="${goodsInfoPo.bgiframematerialtype eq '1'}">遮阳</c:if>
			                 <c:if test="${goodsInfoPo.bgiframematerialtype eq '2'}">偏光</c:if>
			               &nbsp;</TD>   
                        ...
                        <TR>
			               ...
			               <TD class="table_none" colspan="5">${goodsInfoPo.bgibrandyear}&nbsp;</TD>			              
			             </tr>
                      </TBODY>
                    </TABLE>
                    </fieldset>
             ...
             <c:if test="${(permissionPo.keyf==1)}">     
				 <c:if test="${systemParameterPo.fspwholesalepriceset eq '0'}">       
                       <TR>            
                       	   <TD height="26" class="table_body" width="9%">税率</TD>
			               <TD class="table_none" width="24%">${goodsInfoPo.bgitaxrate}&nbsp;</TD>             
                           <TD class="table_body" width="9%">成本价格</TD>
				 ...
				 <c:if test="${systemParameterPo.fspwholesalepriceset eq '1'}">       
                       <TR>            
                       	   <TD height="26" class="table_body" width="9%">税率</TD>
			               <TD class="table_none" width="24%">${goodsInfoPo.bgitaxrate}&nbsp;</TD>             
                           <TD height="26" class="table_body" width="9%">成本价格</TD>
