...
　　 }
	...
	function save(){
		...
		if(checkForm(document.all.glassesFrameForm)){  
			...
			glassesFrameForm.action = "insertGlassesManyPresbyopic.action";
	...
	function importFile(){
		...
		glassesFrameForm.action = "importGlassesPresbyopicManyExcel.action";
		glassesFrameForm.submit();
		showLoadingBar();
	}
					...
					<table id="addTable" width="100%" border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder">
                        ...
                        <TR id=cktr class="row" ${bgiisinserted eq '1' ? 'style="background-color: red;"':'' } ${bgiisinserted eq '1' ? 'cktype="1"':'' }>
                          ...
                          <TD ${bgicolorck eq '1' ? 'style="background-color: red;"':'' }>
                          	<div id=f1>${bgicolor}</div>
                          	<input id="f1" type="hidden" name="goodsInfoManyPo.bgicolors" value="${bgicolor }"/>
                      ...
                      <TBODY>
						<tr>
						  	<td>
								...
								&nbsp; &nbsp; &nbsp; &nbsp; <font color="#FF0000">度数:必须以“+”号开头、必须为数字类型并小于等于20</font><br>
