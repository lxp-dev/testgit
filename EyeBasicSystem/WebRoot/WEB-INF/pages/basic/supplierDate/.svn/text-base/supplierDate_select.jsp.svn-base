...
<script>	
	...
	function search(){
		roleDiscountForm.action = "selSupplierDate.action";
		roleDiscountForm.submit();
		showLoadingBar();
	}
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD align="left"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：制造商效期查询</TD>
              ...
              <TR><!--?Start-->
                  ...
                  <TABLE height=22 cellSpacing=0 cellPadding=0 border=0>
                    ...
                    <TR>
                      ...
                      <TD class=tab id=tabLabel__1   
                       onclick="JavaScript:window.location.href='selSupplierAgentDate.action?bsplicencetype=1&moduleID=${requestScope.moduleID}';"                    
					...
					<table width="100%"   border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                      ...
                      <TBODY>
                        <TR class=table_title align=middle>
                          ...
                          <TH width="10%" height="26" scope=col>制造商ID</TH>
