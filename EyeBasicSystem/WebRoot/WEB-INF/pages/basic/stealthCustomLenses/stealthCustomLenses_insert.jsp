...
　　 }
	...
	function save(){
		...
		stealthCustomLensesForm.action = "insertStealthCustomLenses.action";
                  ...
                  <DIV>
					...
					<c:if test="${systemParameterPo.fspisusegoodslevel eq '1'}">   
                        <TR>
			               ...
			               <TD  class="table_none">
	                          <input class="text_input160" clean=clean type="text" id="bgiordercycle" name="goodsInfoPo.bgiordercycle" value="${goodsInfoPo.bgiordercycle}" maxlength="5" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '订做周期不能为空！'},{'Type' : Type.String, 'Formula' : Formula.Float, 'Message' : '订做周期应为数字！'},{'Type' : Type.String, 'Formula' : Formula.Word, 'Message' : '订做周期只允许输入正整数！'}]">天<label style="color:red;">&nbsp;*</label>
			               </TD>
                    ...
                    <table width="99%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        ...
                        <TR>
			               ...
			               <TD class="table_none"> 
			               	 <select id="bgicontacttype" name="goodsInfoPo.bgicontacttype">
      		                 <option value="">----请选择----</option>
                             <option value="1" ${goodsInfoPo.bgicontacttype == "1" ? 'selected="selected"' : '' }>RGP</option>
                             <option value="2" ${goodsInfoPo.bgicontacttype == "2" ? 'selected="selected"' : '' }>塑形镜</option>
                             <option value="3" ${goodsInfoPo.bgicontacttype == "3" ? 'selected="selected"' : '' }>软性隐性</option>
                             <option value="4" ${goodsInfoPo.bgicontacttype == "4" ? 'selected="selected"' : '' }>医用隐性</option>
      	                   </select>
			               </TD>
			               <TD class="table_body">材质</TD>
			               <TD class="table_none">
                           <select id="bgistealthtype" name="goodsInfoPo.bgistealthtype" >
      		                 <option value="">----请选择----</option>
      		                 ...
      		                 <option value="1" ${goodsInfoPo.bgistealthtype != "1" ? '' : 'selected="selected"' }>硬镜</option>
      		                  <option value="2" ${goodsInfoPo.bgistealthtype != "2" ? '' : 'selected="selected"' }>塑形镜</option>
      	                   </select> 
			               </TD>
                      ...
                      <TBODY>
						...
						<tr>
						  	<td>
								...
								&nbsp; &nbsp; &nbsp; &nbsp; <font color="#FF0000">隐形效期大于效期提醒上限。 （正常贮备期）</font><br>
								&nbsp; &nbsp; &nbsp; &nbsp; <font color="#FF0000">隐形效期小于效期提醒上限并且大于下限。 （滞销退货期）</font><br>
								&nbsp; &nbsp; &nbsp; &nbsp; <font color="#FF0000">隐形效期小于效期提醒下限并且大于过期时间。（即将失效期）</font><br>
								&nbsp; &nbsp; &nbsp; &nbsp; <font color="#FF0000">隐形效期小于过期时间。（报废）</font><br>
