	...
	function save(){
		if(checkForm(document.all.stealthCustomLensesForm)){  
		  ...
		  var bgisphup=parseFloat(document.all.bgisphup.value);
			...
			stealthCustomLensesForm.action = "updateStealthCustomLenses.action";
                    ...
                    <table width="99%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        ...
                        <TR>
			               ...
			               <TD  class="table_none">
	                          <input class="text_input160" type="text" id="bgiordercycle" name="goodsInfoPo.bgiordercycle" value="${goodsInfoPo.bgiordercycle}" maxlength="5" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '订做周期不能为空！'},{'Type' : Type.String, 'Formula' : Formula.Float, 'Message' : '订做周期应为数字！'},{'Type' : Type.String, 'Formula' : Formula.Word, 'Message' : '订做周期只允许输入正整数！'}]">天<label style="color:red;">&nbsp;*</label>
			               </TD>
