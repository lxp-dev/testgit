                      ...
                      <TBODY>
                        ...
                        <TR>
                          <TD height="26" class="table_body">商品编号</TD>
			               ...
			               <TD class="table_none">
			               	   ${goodsInfoPo.bgisphup }&nbsp;至&nbsp;
	                           ${goodsInfoPo.bgisphul }
	                           &nbsp;跨度&nbsp; ${goodsInfoPo.bgisphspan}
			               </TD>
                        ...
                        <TR>
						  	...
						  	<TD height="26" class="table_body">柱镜</TD>
			               	<TD class="table_none">
								${goodsInfoPo.bgicylup}&nbsp;至&nbsp;${goodsInfoPo.bgicylul }&nbsp;跨度&nbsp; ${goodsInfoPo.bgicylspan}
	                        </TD>
                    ...
                    <table width="99%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        ...
                        <TR>
			               ...
			               <TD width="10%" height="30" class="table_body">材质</TD>
			               <TD  class="table_none">
