...
<script>
	...
	function clean(){
		...
		$("input[goodsid=goodsid]").val('9.00.00.000000000.0000');
		$("input[goodscode=goodscode]").val('900000000000000000');
...
　　 }
	...
	function save(){
	if(checkForm(document.all.visualOpticsForm)){  
		...
		visualOpticsForm.action = "insertVisualOpticsAR.action";
	...
	function openBrand(){
		...
		if(is_iPad()){
			showPopWin("selBrandOpen.action?categoryID_open=9&supplierID_open=" + document.getElementById('bgisupplierid').value,970,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}else{
			showPopWin("selBrandOpen.action?categoryID_open=9&supplierID_open=" + document.getElementById('bgisupplierid').value,screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}
                      ...
                      <TBODY>
                        <TR>
			               ...
			               <TD width="24%" class="table_none">
                            ...
                            <input class="text_input200" type="text" goodsid=goodsid id="bgigoodsid" value="${goodsInfoPo.bgigoodsid}" name="goodsInfoPo.bgigoodsid" readonly="readonly">
			               </c:if>
			                <c:if test="${empty goodsInfoPo.bgigoodsid}">
                            <input class="text_input200" type="text" goodsid=goodsid id="bgigoodsid" name="goodsInfoPo.bgigoodsid" value="9.00.00.000000000.0000" readonly="readonly">
			               </c:if>
			               </TD>
			               ...
			               <c:if test="${!empty goodsInfoPo.bgigoodsbarcode}">
			                ...
			                <c:if test="${empty goodsInfoPo.bgigoodsbarcode}">
                            <input class="text_input160" type="text" goodscode=goodscode id="bgigoodsbarcode" readonly="readonly" name="goodsInfoPo.bgigoodsbarcode" value="900000000000000000" maxlength="18" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '商品条码不能为空！'}]"><label style="color:red;">&nbsp;*</label>
			               </c:if>
			               </TD>
			               <TD width="9%" class="table_body">商品名称</TD>
			               <TD class="table_none">
                             <input class="text_input160" type="text" clean=clean id="bgigoodsname" value="${goodsInfoPo.bgigoodsname}" name="goodsInfoPo.bgigoodsname" maxlength="100" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '商品名称不能为空！'},{'Type' : Type.String, 'Formula' : Formula.LongDateFormat, 'Expansion' : {Type : Expansion.LessThanLength, Params : [101]}, 'Message' : '商品名称不能大于100字符'}]"><label style="color:red;">&nbsp;*</label>
			               </TD>
	                    </TR>
                        <TR>
                        ...
                        <tr>
                           ...
                           <TD height="30" class="table_body" >其他视光产品类型</TD>
			               <TD class="table_none" colspan="3">
				               <select id="bgifinishedglassestype" clean=clean name="goodsInfoPo.bgifinishedglassestype">
                                   <option value="" selected>---请选择---</option>
                                   <c:forEach var="optionParamPoTmp" items="${optionParamPolist}" >
		                              <c:if test="${optionParamPoTmp.fopparentid=='SGType'}">
		                               <option value="${optionParamPoTmp.fopparamid }" ${(goodsInfoPo.bgifinishedglassestype == optionParamPoTmp.fopparamid)? 'selected=selected' :'' }>${optionParamPoTmp.fopparamname}</option>
		                              </c:if>	                                      	
	                               </c:forEach> 
                             	</select>
			               </TD>                       	
                        ...
                        <TR>
                           ...
                           <TD class="table_body" >视光类型</TD>
                           <TD class="table_none" colspan="3">
                            <select  id="bgifinishedglassestype" name="goodsInfoPo.bgifinishedglassestype" >
				               <option value="">视光类</option>
				               <option value="Z">助视器</option>
				               <option value="G">功能镜</option>
      	                    </select> 
			               </TD>                           
                        </TR>
                        </c:if>
					  ...
					  <c:if test="${systemParameterPo.fspwholesalepriceset eq '0'}">     
                        <TR>		               
			               ...
			               <TD class="table_none" width="24%">
                             <input class="text_input100" type="text" cleans=cleans onKeyUp="value=value.replace(/[^\d\.]/g,'')" id="bgitaxrate" name="goodsInfoPo.bgitaxrate" value="${goodsInfoPo.bgitaxrate }" maxlength="2" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '税率不能为空！'},{'Type' : Type.String, 'Formula' : Formula.INT, 'Message' : '税率应为整数！'}]"><label style="color:red;">&nbsp;*</label>
			               </TD>
                      ...
                      <TBODY>
						...
						<tr>
						  	<td>
								...
								视光：<br>
								商品代码组成说明：<br>
								<IMG src="${ctx}/img/pic/shiguang.png" ><br>
