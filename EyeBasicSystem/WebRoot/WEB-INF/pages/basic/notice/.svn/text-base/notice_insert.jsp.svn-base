...
<script>
	...
	function save(){
		if(checkForm(document.all.supplierForm)){
			...
			supplierForm.action = "insertNotice.action";
			supplierForm.submit();
		}
	}
	...
	function hshow(){
        ...
        $('input[id=bnedepartmentid]').each(function(){ 
                  ...
                  <DIV>
                    ...
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
			               ...
			               <TD class="table_none">
                             <select id="noticeTypeID" name="noticePo.bnetypeid" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '请选取公告类型!'}]">
                                 ...
                                 <s:iterator value="noticePos">
                                     <option value="${bnetypeid }">${bnetypename}</option>
                                 </s:iterator>
                             </select>
                        ...
                        <TR>
			               <TD width="12%" height="80" class="table_body">公告内容</TD>
                    ...
                    <TABLE id=ctl00_PageBody_PostButton cellSpacing=1 cellPadding=3 width="100%" align=center border=0>
                      <TBODY>
                        <TR>
                          <TD><img id="button1" img src="${ctx }/img/newbtn/btn_save_0.png" btn=btn title='保存' onClick="save()">
