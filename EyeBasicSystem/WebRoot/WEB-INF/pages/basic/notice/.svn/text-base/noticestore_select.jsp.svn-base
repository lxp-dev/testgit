...
<html>
	...
	function detail(id){		
		...
		if(is_iPad()){
			showPopWin("initDetailsNoticeStore.action?bneuuid="+id+"&moduleID=${requestScope.moduleID}",970,screen.height-200,topRows,topCols,returnRefresh(true),true);
		}else{
			showPopWin("initDetailsNoticeStore.action?bneuuid="+id+"&moduleID=${requestScope.moduleID}",screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),true);
		}
								...
								<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center
									...
									<TBODY>
										<TR>
											...
											<td align="left"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：公告通知</td>
										</TR>
										<TR>
