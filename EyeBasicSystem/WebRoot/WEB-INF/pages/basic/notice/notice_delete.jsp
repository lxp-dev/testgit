...
<script>
	...
	function del(id){
		...
		brandForm.action = "deleteNotice.action?bneuuid="+id;
		brandForm.submit();
	}
                ...
                vAlign=top><DIV id=tabContent__1>
                  <DIV>
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 id="title1">
                      <TBODY>
                        <TR>
						   <TD width="10%" height="30">公告标题为:&nbsp;&nbsp;${bnetitle},&nbsp;确认删除吗?</TD>
                        </TR>
                      </TBODY>
                    </TABLE>
                    <TABLE id=ctl00_PageBody_PostButton cellSpacing=1 cellPadding=3 width="100%" align=center border=0>
                      <TBODY>
                        <TR>
                          <TD><img src="${ctx }/img/newbtn/btn_delete_0.png" btn=btn id="submitButton" title='删除' onClick="javascript:del('${bneuuid}')">&nbsp;
                          </TD>
						  </TR>
                      </TBODY>
                    </TABLE>
