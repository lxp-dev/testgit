...
<SCRIPT type="text/javascript">
	...
	function save(){
		if(checkForm(giftsForm)){
			...
			giftsForm.action = "giftsUpdateDpt.action";
			giftsForm.submit();
		}
	}
                        ...
                        <TR>
                          ...
                          <TD width="30%" class="table_none">
                             ...
                             <li class="horizontal_onlyRight">
							     <input name="giftsPo.bdpisshow" type="checkbox" ${giftsPo.bdpisshow eq '1' ? 'checked="checked"' : '' } ${giftsPo.bgsflag eq '1' ? '' : 'disabled="disabled"' }>&nbsp;赠品简称显示在销售页面
							 </li>
                          </TD>
