...
<script>
	...
	function excel(){
		...
		supplierForm.action = "insertSupplierExcel.action";
		supplierForm.submit();
      }  
</script>
                ...
                vAlign=top><DIV id=tabContent__1>
                  <DIV>
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        <TR>
						   <TD width="20%" height="30" class="table_body">制造商Excel文件</TD>
