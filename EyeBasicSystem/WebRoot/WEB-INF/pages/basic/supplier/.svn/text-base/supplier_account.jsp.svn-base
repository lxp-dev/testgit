...
<script>
	...
	function mentSupplierPerson(){
		if('${supplierPo.bspsupplierpersonid }'){ 
			window.location.href='initPersonInfoUpdateSupplier.action?moduleID=B0105&hid=${requestScope.hid}&flag=0';
		}else{
			window.location.href='initPersonInfoInsertSupplier.action?moduleID=B0105&hid=${requestScope.hid}&flag=0';
		}
	}
</script>
                   ...
                   <table width="100%" id="title0"  border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                    ...
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      ...
                      <c:if test="${requestScope.flag=='1'}">
                      	 <TR>
						   <TD width="9%" height="26" class="table_body">制造商账期</TD>
