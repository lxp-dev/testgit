...
<script>
	...
	function save(){
		if(checkForm(document.all.supplierForm)){
			...
			supplierForm.action = "insertSupplier.action";
			supplierForm.submit();
		}
	}
                      ...
                      <TBODY>
                        <TR>
			               ...
			               <TD width="19%" class="table_none">
                            <input clean=clean class="text_input100" onkeyup="checkSupplierId(this);" maxlength="2" type="text" id="bspid" name="supplierPo.bspid" 
                            validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '制造商代码不能为空！'},{'Type' : Type.String, 'Formula' : Formula.Word, 'Message' : '制造商代码只允许输入整数和字母！'},{'Type' : Type.String, 'Formula' : Formula.LongDateFormat, 'Expansion' : {Type : Expansion.EQLength, Params : [2]}, 'Message' : '制造商代码应为2位字符'}]"><label style="color:red;">&nbsp;*&nbsp;制造商代码必须为两位数</label>
			               </TD>
			               ...
			               <TD width="22%" class="table_none">
                             ...
                             validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '制造商简称不能为空！'},{'Type' : Type.String, 'Formula' : Formula.ObjectNameOrNULL, 'Message' : '制造商简称填写有误！'},{'Type' : Type.String, 'Formula' : Formula.LongDateFormat, 'Expansion' : {Type : Expansion.LessThanLength, Params : [31]}, 'Message' : '制造商简称不能大于30字符'}]"><label style="color:red;">&nbsp;*&nbsp;</label>
			               </TD>
			               <TD width="10%" height="26" class="table_body">制造商联系人</TD>
			               <TD width="19%" class="table_none">
                             ...
                             validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '制造商联系人不能为空！'},{'Type' : Type.String, 'Formula' : Formula.PersonNameOrNULL, 'Message' : '制造商联系人姓名填写有误！'},{'Type' : Type.String, 'Formula' : Formula.LongDateFormat, 'Expansion' : {Type : Expansion.LessThanLength, Params : [17]}, 'Message' : '制造商联系人不能大于16字符'}]"><label style="color:red;">&nbsp;*&nbsp;</label>
			               </TD>
                        </TR>
                        <TR>			               
			               ...
			               <TD class="table_none">
                             <input clean=clean class="text_input100" maxlength="18" type="text" id="bspcontactphone" name="supplierPo.bspcontactphone" value="${supplierPo.bspcontactphone }" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '制造商电话不能为空！'},{'Type' : Type.String, 'Formula' : Formula.Phone, 'Message' : '制造商电话填写有误！'},{'Type' : Type.String, 'Formula' : Formula.LongDateFormat, 'Expansion' : {Type : Expansion.LessThanLength, Params : [21]}, 'Message' : '制造商电话不能大于20字符'}]"><label style="color:red;">&nbsp;*&nbsp;如：022-85123455</label>
			               </TD>
                        ...
                        <TR>
			               ...
			               <TD class="table_none">
                             <input clean=clean class="text_input100" maxlength="18" type="text" id="bspfax" name="supplierPo.bspfax" value="${supplierPo.bspfax }" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '制造商传真不能为空！'},{'Type' : Type.String, 'Formula' : Formula.Phone, 'Message' : '制造商传真填写有误！'},{'Type' : Type.String, 'Formula' : Formula.LongDateFormat, 'Expansion' : {Type : Expansion.LessThanLength, Params : [21]}, 'Message' : '制造商传真不能大于20字符'}]"><label style="color:red;">&nbsp;*&nbsp;如：022-85123455</label>
			               </TD>
                        </TR>
                       <TR>
			               ...
			               <TD class="table_none" colspan="5">
                             ...
                             validate="[{'Type' : Type.String, 'Formula' : Formula.LongDateFormat, 'Expansion' : {Type : Expansion.LessThanLength, Params : [51]}, 'Message' : '制造商地址不能大于50字符'}]">
			               </TD>
                        </TR>
                        <TR>
