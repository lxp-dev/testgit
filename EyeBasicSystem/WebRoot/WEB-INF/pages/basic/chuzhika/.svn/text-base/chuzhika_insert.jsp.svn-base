...
<script>
	...
	function save(){
		if(checkForm(document.all.chuzhikaForm)){ 
			...
			chuzhikaForm.action = "chuzhikaInsert.action";
			chuzhikaForm.submit();
		}
	}
                      ...
                      <TBODY>
                      	<TR>
			                ...
			                <TD width="20%" class="table_none">
	                            <input class="text_input200" type="text" id="cstczkcardid" maxlength="16" value="${chuzhikaPo.cstczkcardid}" name="chuzhikaPo.cstczkcardid" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '请填写储值卡号！'},{'Type' : Type.String, 'Formula' : Formula.Word, 'Message' : '储值卡号应为数字或字母！'}]">
				                <label style="color:red;">&nbsp;*</label>
			               	</TD>
			               	<TD width="8%" class="table_body">发放部门</TD>
			               	<TD class="table_none" width="15%" valign="middle" colspan="3">
                        ...
                        <TR>
			               	...
			               	<TD class="table_none" width="15%" valign="middle">
	                            ...
	                            <label style="color:red;">&nbsp;*客户实际付款金额</label>
                            </TD>
						    <TD class="table_body">
							   	赠送金额
						    </TD>
			                <TD class="table_none">
			                	...
			                	<label style="color:red;">&nbsp;*额外赠送的金额</label>			                
			                </TD>	
						    <TD class="table_body">
							   	储值金额
						    </TD>
			             ...
			             <TR>
						    <TD height="30" class="table_body">备注</TD>
