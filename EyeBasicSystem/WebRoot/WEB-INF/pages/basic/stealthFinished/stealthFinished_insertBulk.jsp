...
<script>
	...
	if(checkForm(document.all.stealthFinishedForm)){  
		...
		stealthFinishedForm.action = "insertBulkStealthFinished.action";
                    ...
                    <table width="99%" border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        ...
                        <TR>
			               ...
			               <TD class="table_none" colspan="3">
                           <select id="bgistealthtype" name="goodsInfoPo.bgistealthtype" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '材质不能为空！'}]">
      		                 <option value="">----请选择----</option>
