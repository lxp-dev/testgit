...
<script>
	...
	if(checkForm(document.all.visualOpticsForm)){
		...
		visualOpticsForm.action = "updateVisualOptics.action";
		visualOpticsForm.submit();
		}
	}
	
	function clean(){
		document.visualOpticsForm.reset();
	}
                    ...
                    <table width="99%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        <TR>
			               ...
			               <TD class="table_none">${goodsInfoPo.bgigoodsname}&nbsp;</TD>
                        </TR>
                        <TR>
			            ...
			            <TR>
			               ...
			               <TD class="table_none" colspan="5">
      	                   <c:if test="${goodsInfoPo.bgifinishedglassestype eq ''}">
			                                         视光类
			               </c:if>
			               <c:if test="${goodsInfoPo.bgifinishedglassestype eq 'Z'}">
			                                        助视器
			               </c:if>
			               <c:if test="${goodsInfoPo.bgifinishedglassestype eq 'G'}">
			                                       功能镜
			               </c:if>
			               </TD>
                        </TR>
				 ...
				 <c:if test="${systemParameterPo.fspwholesalepriceset eq '0'}">           
                       <TR>             
			            ...
			            <%--<tr>
			               ...
			               <TD class="table_none" colspan="3">${goodsInfoPo.bgiaveragenotnaxrate}&nbsp;</TD>
                        </TR>--%>
                </c:if>
