...
<script>
	...
	function save(){
		...
		if(checkForm(document.all.glassesFrameForm)){
			...
			glassesFrameForm.action = "insertVIPCard.action";
                      ...
                      <TBODY>
                        <TR>
			                ...
			                <TD width="20%" class="table_none">
                            	<input class="text_input160" type="text" id="ssevcid" maxlength="20" value="${vipCardPo.ssevcid}" name="vipCardPo.ssevcid" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '请填写打折卡号！'},{'Type' : Type.String, 'Formula' : Formula.Word, 'Message' : '打折卡号只允许输入整数和字母！'}]" onblur="this.value = $.trim(this.value)">
                            	<label style="color:red;">&nbsp;*</label></TD>
			                </TD>
			                <TD width="12%" height="26" class="table_body">折扣</TD>
			                <TD class="table_none" valign="middle"  width="20%">
                            	<input class="text_input160" type="text" id="ssevcdiscount" maxlength="5" value="${vipCardPo.ssevcdiscount}" name="vipCardPo.ssevcdiscount" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '请填写折扣！'},{'Type' : Type.String, 'Formula' : Formula.UFloat, 'Message' : '请正确填写折扣！'}]" onblur="this.value = $.trim(this.value)">
			             ...
			             <TR>
			                ...
			                <TD class="table_none">
                            	<input class="text_input160" type="text" id="ssevccustomername" maxlength="20" value="${vipCardPo.ssevccustomername}" name="vipCardPo.ssevccustomername" validate="[{'Type' : Type.String, 'Formula' : Formula.PersonNameOrNULL, 'Message' : '请重新填写持卡人姓名！'}]" onblur="this.value = $.trim(this.value)">
			               	
			                </TD>
			                <TD height="26" class="table_body">身份证</TD>
			                <TD class="table_none" valign="middle">
                            	<input class="text_input160" type="text" id="ssevcidcard" maxlength="18" value="${vipCardPo.ssevcidcard}" name="vipCardPo.ssevcidcard" validate="[{'Type' : Type.String, 'Formula' : Formula.IdentityCardORNULL, 'Message' : '请按正确的身份证格式填写！'}]" onblur="this.value = $.trim(this.value)"/>
                            </TD>
						    <TD  height="26" class="table_body">
						    	<input type="checkbox" id="showpwd" onclick="showpwdinput();"/>是否设置密码
						    </TD>
			                <TD class="table_none">
			                	<div id="divpwd1" style="display: none;"><input class="text_input160" type="text" id="ssevccardpassword" maxlength="10" value="${vipCardPo.ssevccardpassword}" name="vipCardPo.ssevccardpassword" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '请填写打折卡密码！'},{'Type' : Type.String, 'Formula' : Formula.Word, 'Message' : '密码应为英文或数字！'}]" onblur="this.value = $.trim(this.value)"></div>
