...
<script>
	function del(){
       $("img").removeAttr("onclick");
		stealthAccessoriesForm.action = "disableStealthAccessoriesAR.action";
                ...
                vAlign=top><DIV id=tabContent__1>
                  <DIV>
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 id="title1">
                      <TBODY>
                      <TR>
						   <TD width="10%" height="30">接触镜护理液商品:${goodsInfoPo.bgigoodsid},此条数据确认停用么</TD>
                        </TR>
                      </TBODY>
                    </TABLE>
                    <TABLE id=ctl00_PageBody_PostButton cellSpacing=1 cellPadding=3 width="100%" align=center border=0>
                      <TBODY>
                        <TR>
                          <TD><img id="button1" src="${ctx}/img/newbtn/btn_define_0.png" btn=btn  title='确定' onClick="javascript:del()">
                          </TD>
						  </TR>
                      </TBODY>
                    </TABLE>
