...
<script> 
	...
	function save(){
		if(checkForm(document.all.contractForm)){    		
			...
			contractForm.action = "updateContract.action";
			contractForm.submit();
		}
	}
                      ...
                      <TBODY>
                        <TR>
			               ...
			               <TD  colspan="3" class="table_none">
			                 <input class="text_input200" maxlength="25" type="text" id="bctcontracttitle" name="contractPo.bctcontracttitle" value="${contractPo.bctcontracttitle }"
                            validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '合同标题不能为空！'}]"><label style="color:red;">&nbsp;*&nbsp;</label><input type="hidden" id="bctid" name="contractPo.bctid" value="${contractPo.bctid}" /></TD>
			               </TR>
                           <TR>
						   <TD width="12%" height="30" class="table_body">合同内容</TD>
			               <TD  colspan="3" class="table_none"><textarea id="bctcontractcontent" name="contractPo.bctcontractcontent" style="width:98%; overflow:auto" rows="4" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '合同内容不能为空！'}]">${contractPo.bctcontractcontent }</textarea><label style="color:red;">&nbsp;*&nbsp;</label></TD>
			               </TR>
                           <TR>
						   <TD width="12%" height="30" class="table_body">合同时间</TD>
			               <TD  colspan="3" class="table_none"><input class="text_input100"
				               id="bctcontractstartdate"
						       name="contractPo.bctcontractstartdate" value="${fn:substring(contractPo.bctcontractstartdate,0,10)}"
						       type="text" 
					         ...
					         <input class="text_input100"
						       ...
						       name="contractPo.bctcontractenddate" value="${fn:substring(contractPo.bctcontractenddate,0,10)}"
						       type="text" 
			               ...
			               <TD width="38%" class="table_none" colspan="3"><input type="file" name="upload" /></TD>
                        </TR>
                        </table>   
