...
<script>	
	...
	function save(){
		if(checkForm(personInfoForm)){
			...
			personInfoForm.action = "insertTrainingCourses.action";
...
<form name="personInfoForm" method="post" action="" enctype="multipart/form-data">
                    ...
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        <TR>
			               ...
			               <input class="text_input240" id="kjbcoursesname" name="trainingCoursesPo.kjbcoursesname" value="${trainingCoursesPo.kjbcoursesname }"  ></TD>
                        </TR>
                        
						<TR>
						   <TD width="10%" height="30" class="table_body">主讲人</TD>
			               <TD width="90%" class="table_none">
			               <input class="text_input100" id="kjbspeechpersonname" name="trainingCoursesPo.kjbspeechpersonname" value="${trainingCoursesPo.kjbspeechpersonname }" maxlength="20"></TD>
                        </TR>
						...
						<TR>
                          ...
                          <TD width="90%" class="table_none">
                          	<textarea id="kjbcoursescontent" name="trainingCoursesPo.kjbcoursescontent" ></textarea>
						  </TD>
						</TR>
						<TR>
					   <TD height="30" width="10%" class="table_body">选择视频文件</TD>
					   ...
					   <TD height="30" width="10%" class="table_body">选择人员</TD>
				           <TD height="30" width="90%" class="table_none" >
								...
								<input type="text" class="text_input240" name="perNAME" id="perNAME" readonly="readonly"  value="">
								</li>
								 <li class="horizontal_onlyRight">
							  <img src="${ctx}/img/newbtn/btn_change_0.png" btn=btn id="submitButton" title='选择' onClick="openPerson();">
							  </li>
						   </TD>
						</TR>
							<TR>
					   <TD height="30" width="10%" class="table_body">选择角色</TD>
				           <TD height="30" width="90%" class="table_none" >
								...
								<input type="text" class="text_input240" name="rolNAME" id="rolNAME" readonly="readonly"  value="">
								</li>
								 <li class="horizontal_onlyRight">
							  <img src="${ctx}/img/newbtn/btn_change_0.png" btn=btn id="submitButton" title='选择' onClick="openRole();">
							  </li>
						   </TD>
						</TR>
                      </TBODY>
