...
　　 }
	...
	if(checkForm(document.all.lensCustomForm)){
		...
		lensCustomForm.action = "insertLensCustomAR.action";
                    ...
                    <table width="99%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        ...
                        <TR>
			               ...
			               <TD  class="table_none">
	                          <input clean=clean class="text_input80" type="text" id="bgiordercycle" name="goodsInfoPo.bgiordercycle" value="${goodsInfoPo.bgiordercycle}" maxlength="5" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '车房周期不能为空！'},{'Type' : Type.String, 'Formula' : Formula.Float, 'Message' : '车房周期应为数字！'},{'Type' : Type.String, 'Formula' : Formula.Word, 'Message' : '车房周期只允许输入正整数！'}]">天<label style="color:red;">&nbsp;*</label>
