                    ...
                    <table width="99%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        ...
                        <TR>
			               ...
			               <TD  class="table_none">${goodsInfoPo.bgisphup }
	                              - ${goodsInfoPo.bgisphul }	                            
			               </TD>
			               </TR>
                        <TR>
						   <TD  class="table_body">柱镜</TD>
			               <TD  class="table_none">${goodsInfoPo.bgicylup }
								  - ${goodsInfoPo.bgicylul }      	                   		
							</TD>
						   <TD  class="table_body">下加光</TD>
			               <TD  class="table_none">${goodsInfoPo.bgibelowplusluminosityup }
			               	  -${ goodsInfoPo.bgibelowplusluminosityul}
