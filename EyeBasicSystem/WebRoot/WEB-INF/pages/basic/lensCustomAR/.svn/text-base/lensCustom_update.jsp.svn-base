...
　　 }
	...
	function save(){
		...
		if(checkForm(document.all.lensCustomForm)){
			...
			lensCustomForm.action = "updateLensCustomAR.action";
                      ...
                      <TBODY>
                        ...
                        <TR>
			                ...
			                <TD class="table_none" >
			                 ...
			                 <TD class="table_body">车房周期</TD>
			                 <TD class="table_none">
	                         	<input class="text_input80" type="text" id="bgiordercycle" name="goodsInfoPo.bgiordercycle" value="${goodsInfoPo.bgiordercycle}" maxlength="5" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '车房周期不能为空！'},{'Type' : Type.String, 'Formula' : Formula.Float, 'Message' : '车房周期应为数字！'},{'Type' : Type.String, 'Formula' : Formula.Word, 'Message' : '车房周期只允许输入正整数！'}]">天<label style="color:red;">&nbsp;*</label>
			                 </TD>
