...
<script>
	...
	if(checkForm(document.all.unitForm)){	    
		...
		unitForm.action = "updateColor.action";
		unitForm.submit();
		}
	}
                ...
                vAlign=top><DIV id=tabContent__1>
				  ...
				  <table width="100%" id="title0"  border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
					...
					<table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        <TR>
						   <TD width="15%" height="26" class="table_body">商品颜色代码</TD>
			               <TD class="table_none" width="35%">${colorPo.bcid}<input type="hidden" value="${colorPo.bcid}" class="text_input100" id="bcid" name="colorPo.bcid"></TD>						
                          
						  <TD width="15%" class="table_body">商品颜色名称</TD>
                          <TD class="table_none" width="35%"><input value="${colorPo.bccolorname}" class="text_input200" id="butunitname" name="colorPo.bccolorname" maxlength="15" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '商品颜色名称不能为空！'},{'Type' : Type.String, 'Formula' : Formula.LongDateFormat, 'Expansion' : {Type : Expansion.LessThanLength, Params : [16]}, 'Message' : '商品颜色名称输入长度大于系统规定值！'}]"><label style="color:red;">&nbsp;*</label></TD>
