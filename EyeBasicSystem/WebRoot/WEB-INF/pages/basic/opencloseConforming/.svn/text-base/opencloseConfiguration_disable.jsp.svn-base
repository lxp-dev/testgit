...
<script>
	...
	function del(){
		...
		glassesFrameForm.action = "updateStatusguan.action";
...
<input type="hidden" name="hid" value="${statusModulePo.fsmstatusid}">
  ...
  <TR>
    <TD><!-- ?? Start -->
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        ...
        <TR>
          <TD class=menubar_function_text height=27><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：开关设置关闭</TD>
                ...
                vAlign=top><DIV id=tabContent__1>
                  <DIV>
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 id="title1">
                      <TBODY>
                      <TR>
						   <TD width="10%" height="30">关闭:${statusModulePo.fsmstatusremark},此条信息确认关闭么</TD>
                        </TR>
                      </TBODY>
                    </TABLE>
