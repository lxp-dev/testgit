...
<script>
	...
	function del(){
		...
		glassesFrameForm.action = "updateStatuskai.action";
  ...
  <TR>
    <TD><!-- ?? Start -->
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        ...
        <TR>
          <TD class=menubar_function_text height=27><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：开关设置开启</TD>
                ...
                vAlign=top><DIV id=tabContent__1>
                  <DIV>
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 id="title1">
                      <TBODY>
                      <TR>
						   <TD width="10%" height="30">开启:${statusModulePo.fsmstatusremark},此条信息确认启动么</TD>
                        </TR>
                      </TBODY>
                    </TABLE>
