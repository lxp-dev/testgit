      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD align="right">&nbsp;
            	<img src="${ctx }/img/newbtn/btn_xtmkadd_0.png" onmouseover="JavaScript:$(this).attr('src','${ctx }/img/newbtn/btn_xtmkadd_1.png');" onmouseout="JavaScript:$(this).attr('src','${ctx }/img/newbtn/btn_xtmkadd_0.png');" title="系统模块新增" onClick="insert()">            	
            	</TD>
          </TR>
          <TR>
                        ...
                        <TR class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">
                		 ...
                		 <TD width="4%">
		                  ...
		                  <TD width="4%">
                        	...
                        	<c:otherwise>
                        	<img src="${ctx }/img/newbtn/delete_0.png" title='删除' onmouseover="JavaScript:$(this).attr('src','${ctx }/img/newbtn/delete_1.png');" onmouseout="JavaScript:$(this).attr('src','${ctx }/img/newbtn/delete_0.png');" onClick="javascript:del('${moduleid}')" >	
			               	</c:otherwise>
	                       </c:choose> 
		                  </TD>
                          <TD height="28">
                          ...
                          <TD height="26">${moduledirectory}</TD>
                        </TR>
