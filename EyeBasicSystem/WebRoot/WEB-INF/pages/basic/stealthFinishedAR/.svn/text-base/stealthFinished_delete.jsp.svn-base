...
<script>
	function del(){
		...
		if(num==0){
			...
			stealthFinishedForm.action = "deleteStealthFinishedAR.action";
                ...
                vAlign=top><DIV id=tabContent__1>
                  <DIV>
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 id="title1">
                      <TBODY>
                      <TR>
						   <TD width="10%" height="30">软性接触镜成品商品:${goodsInfoPo.bgigoodsid},此条数据确认删除么</TD>
                        </TR>
                      </TBODY>
                    </TABLE>
                    <TABLE id=ctl00_PageBody_PostButton cellSpacing=1 cellPadding=3 width="100%" align=center border=0>
                      <TBODY>
                        <TR>
                          <TD><img id="button1" src="${ctx }/img/newbtn/btn_delete_0.png" btn=btn title="删除" onClick="javascript:del();">
                          </TD>
						  </TR>
                      </TBODY>
                    </TABLE>
