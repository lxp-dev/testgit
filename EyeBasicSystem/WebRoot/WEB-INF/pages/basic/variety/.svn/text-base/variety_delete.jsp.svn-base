...
<script>
	function del(){
		...
		brandForm.action = "varietyDelete.action";
		brandForm.submit();
	}
...
<input type="hidden" name="hid" value="${varietyPo.bvyid}">
<input type="hidden" name="brandid" value="${varietyPo.bvybrandid}">
<input type="hidden" name="bvysupplierid" value="${varietyPo.bvysupplierid}">
<input type="hidden" name="bvygcid" value="${varietyPo.bvygcid}">
  ...
  <TR>
    <TD><!-- ?? Start -->
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        ...
        <TR>
          <TD class=menubar_function_text height=27><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：品种删除</TD>
                ...
                vAlign=top><DIV id=tabContent__1>
                  <DIV>
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 id="title1">
                      <TBODY>
                      <TR>
						   <TD width="10%" height="30">品种名称为:&nbsp;&nbsp;${varietyPo.bvyvarietyname},&nbsp;此条数据确认删除么?</TD>
                        </TR>
                      </TBODY>
                    </TABLE>
                    <TABLE id=ctl00_PageBody_PostButton cellSpacing=1 cellPadding=3 width="100%" align=center border=0>
                      <TBODY>
                        <TR>
                          <TD><input icon='icon-delete' id="submitButton" type='button' value='删除' onClick="javascript:del()">&nbsp;
                          </TD>
						  </TR>
                      </TBODY>
                    </TABLE>
