                    ...
                    <table width="99%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        ...
                        <TR>
			               ...
			               <TD height="26" class="table_body">降度</TD>
			               <TD class="table_none">${goodsInfoPo.bgisphup }-${goodsInfoPo.bgisphul }
			               </TD>
                    ...
                    <table width="99%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        ...
                        <TR>
			               ...
			               <TD  class="table_none" colspan="7">${goodsInfoPo.bgiunionsphcyl}&nbsp;</TD>			               
                        </TR>
                      </TBODY>
                    </TABLE>
