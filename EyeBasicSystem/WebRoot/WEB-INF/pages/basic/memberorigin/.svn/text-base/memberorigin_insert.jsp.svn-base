...
<script>
	...
	function save(){
		if(checkForm(document.all.memberOriginForm)){	
			...
			memberOriginForm.action = "insertMemberOrigin.action";
					...
					<table width="100%" border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        <TR>
			               ...
			               <TD class="table_none" width="24%"><input class="text_input100" id="bmoid" name="memberOriginPo.bmoid" value="${memberOriginPo.bmoid }" maxlength="5" validate="[{'Type' : Type.String, 'Formula' : Formula.Word, 'Message' : '来源代码只允许输入整数和字母！'},{'Type' : Type.String, 'Formula' : Formula.LongDateFormat, 'Expansion' : {Type : Expansion.LessThanLength, Params : [6]}, 'Message' : '来源代码输入长度大于系统规定值！'}]"><label style="color:red;">&nbsp;*</label></TD>						
