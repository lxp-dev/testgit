...
<script type="text/javascript">
	...
	function save(){
	   if (checkForm(noticeTypeFrm)){
		   ...
		   noticeTypeFrm.action = "repairsCostSetUpdate.action";
                      ...
                      <TBODY>
                        <TR height="26px">
                          ...
                          <TD width="24%" class="table_none">
                              ${repairsCostPo.frcid}
                              <input class="text_input160" id="frcid" name="repairsCostPo.frcid" type="hidden" maxlength="20" value="${repairsCostPo.frcid }" readonly="readonly">
