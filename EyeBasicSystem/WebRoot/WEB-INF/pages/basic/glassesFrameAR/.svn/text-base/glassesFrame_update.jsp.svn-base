...
<script>
	...
	function save(){
		...
		if(checkForm(document.all.glassesFrameForm)){  
			...
			glassesFrameForm.action = "updateGlassesFrameAR.action";
                    ...
                    <table width="99%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        ...
                        <TR>
			               ...
			               <TD class="table_none">
                             ${goodsInfoPo.bgispec}
                             <input type="hidden" value="${goodsInfoPo.bgispec}" name="goodsInfoPo.bgispec">
			               </TD>
                           <TD class="table_body">厂家色号</TD>
			               <TD class="table_none">
                            <input class="text_input200" type="text"  id="bgisuppliercolor" name="goodsInfoPo.bgisuppliercolor" maxlength="20" value="${goodsInfoPo.bgisuppliercolor}"><label style="color:red;">&nbsp;*</label>
			               </TD>
                           <TD class="table_body">色号</TD>
			               <TD class="table_none">
                             ${goodsInfoPo.bgicolor}
                             <input type="hidden" value="${goodsInfoPo.bgicolor}" name="goodsInfoPo.bgicolor">
			               </TD>
			            </tr>
			            ...
			            <tr>
			               ...
			               <td align="left" class="table_none">
			               		<input type="radio" name="goodsInfoPo.bgibarcodeflag" value="1" ${goodsInfoPo.bgibarcodeflag eq '1' ? 'checked="checked"' : '' } />是<input type="radio" name="goodsInfoPo.bgibarcodeflag" value="0" ${goodsInfoPo.bgibarcodeflag ne '1' ? 'checked="checked"' : '' } />否<label style="color:red;">&nbsp;*</label>
                           </td>                             
                        </TR>
                        </c:if>
                        ...
                        <TR>
                         <TD height="26" class="table_body" width="9%">镜架尺寸</TD>
                          ...
                          <TD height="26" class="table_body" width="9%">工艺类型</TD>
			               <TD class="table_none" width="24%">
                           <select id="bgiframeprocesscrafttype" name="goodsInfoPo.bgiframeprocesscrafttype" >
      		                 <option value="">----请选择----</option>
							...
							<c:if test="${systemParameterPo.fspwholesalepriceset eq '0'}">
		                      <input class="text_input100" type="hidden" value='0.00' id="bgicostprice" name="goodsInfoPo.bgicostprice" />
		                        <tr>
		                           <TD height="26" class="table_body">税率</TD>
					               <TD class="table_none">
		                             <input class="text_input100" onKeyUp="value=value.replace(/[^\d\.]/g,'')" type="text" id="bgitaxrate" name="goodsInfoPo.bgitaxrate" value="${empty(goodsInfoPo.bgitaxrate) ? '17' : goodsInfoPo.bgitaxrate }" maxlength="2" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '税率不能为空！'},{'Type' : Type.String, 'Formula' : Formula.INT, 'Message' : '税率应为整数！'}]"><label style="color:red;">&nbsp;*</label>
					               </TD>
			                       <TD class="table_body">批发价格</TD>
					               <TD class="table_none" colspan="3">
		                             <input class="text_input100" onKeyUp="value=value.replace(/[^\d\.]/g,'')" type="text" id="bgiwholesaleprice" value="${goodsInfoPo.bgiwholesaleprice}" name="goodsInfoPo.bgiwholesaleprice" onblur="if(!isNaN(this.value)) { if(trim(this.value)!='')this.value = new Number(this.value).toFixed(2);}" maxlength="10"
