...
　　 }
	...
	function save(){
	    ...
	    if(checkForm(document.all.glassesFrameForm)){  
			...
			glassesFrameForm.action = "insertGlassesManyFrameAR.action";
	...
	function importFile(){
		...
		glassesFrameForm.action = "importGlassesFrameManyExcelAR.action";
		glassesFrameForm.submit();
		showLoadingBar();
	}
...
<script language="javascript">
	$("td[checkname='bgichinesecolor']").each(function(){
		<c:forEach var="colorPo" items="${colorPoList1}"> 
	...
	$("td[checkname='bgiframematerialtype']").each(function(){
		<c:forEach var="frameMaterialPo" items="${frameMaterialPoList1}"> 
	...
	$("td[checkname='bgiframeprocesscrafttype']").each(function(){
		<c:forEach var="technologyTypePo" items="${technologyTypePoList1}"> 
