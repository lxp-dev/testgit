...
　　 }
	...
	if(checkForm(document.all.stealthAccessoriesForm)){  
		...
		stealthAccessoriesForm.action = "insertStealthAccessories.action";
                      ...
                      <TBODY>
                        <tr>
                            ...
                            <select id="bgistealthtype" name="goodsInfoPo.bgistealthtype" >
      		                 ...
      		                 <option value="0" ${goodsInfoPo.bgistealthtype != "0" ? '' : 'selected="selected"' }>软水</option>
      		                 <option value="1" ${goodsInfoPo.bgistealthtype != "1" ? '' : 'selected="selected"' }>硬水</option>
      	                   </select> 
			                </TD>
