                    ...
                    <table width="100%" border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        <TR>
                          ...
                          <TD width="10%" height="26" class="table_body">人员工号</TD>
			              <TD width="23%" class="table_none">${trainPo.mttrainpersonid }</TD>
						  <TD width="10%" height="26" class="table_body">姓名</TD>
                          <TD width="23%" class="table_none">${trainPo.mttrainpersonname }</TD>
                        </TR>
                        <TR>
						   <TD width="10%" height="26" class="table_body">创建日期</TD>
                           <TD class="table_none" width="30%" colspan="5">${trainPo.mttraindate }</TD>
                        </TR>
      	                <tr>
