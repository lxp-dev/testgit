				  ...
				  <table width="100%" id="title0"  border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                      ...
                      <TBODY>
                        <TR>
			               ...
			               <TD class="table_none">
                              <select clean="clean" id="bfttype" name="fittingTemplatePo.bfttype" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '请选择报表样式类型!'}]">
                                ...
                                <c:forEach var="fittingTemplateTypePoTmp" items="${fittingTemplateTypeList}" >
                              		<option value="${fittingTemplateTypePoTmp.bfttid }" ${(fittingTemplatePo.bfttype == fittingTemplateTypePoTmp.bfttid)? 'selected=selected' :'' }>${fittingTemplateTypePoTmp.bfttname}</option>	                                      	
                               	</c:forEach>
                              </select>
			               ...
			               <TD class="table_none" width="20%">
                              <input id="bfttemplatename" name="fittingTemplatePo.bfttemplatename" clean="clean" type="text" class="text_input200" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '请填写报表样式名称!'}]"/>
                              <label style="color:red;">&nbsp;*&nbsp;</label>
			              </TD>		
                        ...
                        <TR>
			               ...
			               <TD class="table_none" colspan="5">
                               <input id="bftfilename" name="fittingTemplatePo.bftfilename" clean="clean" type="text" class="text_input300" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '请重新填写报表文件名称!'}]"/>
                               <label style="color:red;">&nbsp;报表文件的文件名全称(包含后缀名)</label>
			              </TD>			              
                        </TR>
                        <TR>
						   <TD height="26" class="table_body">报表样式图 </TD>
			               <TD class="table_none" colspan="5">
                               <input type="file" name="upload" id="bgLogo" style="width: 70%" onchange="CheckExt(this,'b');">
			              </TD>			              
                        </TR>
                        <TR>
						   <TD height="26" class="table_body">报表样式说明</TD>
			               <TD class="table_none" colspan="5">
			                  <textarea clean=clean id="bftremark" name="fittingTemplatePo.bftremark" validate="[{'Type' : Type.String, 'Formula' : '', 'Expansion' : {Type : Expansion.LessThanLengthORNULL, Params : [50]}, 'Message' : '说明内容不能超过100字！'}]" ></textarea>
                    ...
                    <TABLE id=ctl00_PageBody_PostButton cellSpacing=1 cellPadding=3 width="100%" align=center border=0>
                      <TBODY>
                       <TR>
                          <TD align="left">
                          		<input type="checkbox" id="bftflag" name="fittingTemplatePo.bftflag" value="1">启用
                          </TD>
					   </TR>
                        <TR>
