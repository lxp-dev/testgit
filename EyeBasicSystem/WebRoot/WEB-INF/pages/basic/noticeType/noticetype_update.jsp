...
<script type="text/javascript">
	...
	function save(){
	   if (checkForm(noticeTypeFrm)){
		   ...
		   noticeTypeFrm.action = "noticeTypeUpdate.action";
                      ...
                      <TBODY>
                        <TR height="26px">
                          ...
                          <TD width="24%" class="table_none">
                              ${noticePo.bnetypeid }
                              <input class="text_input160" id="bnetypeid" name="noticePo.bnetypeid" type="hidden" maxlength="20" value="${noticePo.bnetypeid }" readonly="readonly">
                         
                          </TD>
                          <TD width="9%" class="table_body">公告类型名称</TD>
                          <TD width="24%" class="table_none">
                             <input clean="clean" class="text_input160" id="bnetypename" name="noticePo.bnetypename" type="text" maxlength="50" value="${noticePo.bnetypename }" 
                      ...
                      <TBODY>
					   <TR>
						  <TD align="left">	
						    ...
						    <img btn=btn src="${ctx}/img/newbtn/btn_reset_0.png" title='重置' onclick="frmreset()">
						  </TD>
                        </TR>
                      </TBODY>
                    </TABLE>
