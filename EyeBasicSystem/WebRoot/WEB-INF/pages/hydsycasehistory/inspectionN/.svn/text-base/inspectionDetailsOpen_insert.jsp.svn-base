...
<script type="text/javascript">
	function save(){
		if(confirm('是否为正式提交处方？')){
			inspectionForm.action="inspectionInsertDetailsOpenHydsy.action?ruleFlag=1&nw='N' ";
			$("img").removeAttr("onclick");
			inspectionForm.submit();
		}else{
			inspectionForm.action="inspectionInsertDetailsOpenHydsy.action?ruleFlag=''&nw='N' ";
			$("img").removeAttr("onclick");
			inspectionForm.submit();
		}
	}
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
  ...
  <TR>
			  ...
			  <TR>
				<TD class=menubar_function_text height=27><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：检查结论详细</TD>
                    ...
                    <table width="100%" id="title0"  border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                      ...
                      <TBODY>
                        ...
                        <TR>
			               ...
			               <TD class="table_none" width="40%" colspan="14">
                           	角膜塑型镜
		 	               </TD>
                        </TR>
                    	<TR>
						   ...
						   <TD width="8%" class="table_none" align="center">暗瞳：${po.sopipantongod  }</TD>
						...
						<TR>
						   ...
						   <TD width="8%" class="table_none" align="center">暗瞳：${po.sopipantongos  }</TD>
