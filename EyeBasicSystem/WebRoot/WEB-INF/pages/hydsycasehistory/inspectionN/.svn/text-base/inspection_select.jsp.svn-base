...
<script>	
	...
	function glassHistory(){
		inspectionForm.action="selectGlassesHistoryHydsy.action?viewDetail=true";
		$("img").removeAttr("onclick");
		inspectionForm.submit();
	}
  ...
  {   
  	...
  	function cornealContactlLens(){
		var dontshow = $('#dontshow').val();
		$("img").removeAttr("onclick");
		inspectionForm.action="initCornealContactlLensSelectHydsy.action?dontshow="+dontshow;
		inspectionForm.submit();
	}
                  ...
                  border=0 align=center cellpadding=1 cellspacing=1 class="privateTable privateBorder">
									...
									<tr>
                                      ...
                                      <c:forEach var="optionParamPoTmp" items="${optionParamPolist}" >
	                                      <c:if test="${optionParamPoTmp.fopparentid=='44'}">
	                                      	${(inspectionPos[0].sopipneareye == optionParamPoTmp.fopparamid)? optionParamPoTmp.fopparamname:'' }
	                                      </c:if>	                                      	
                                      </c:forEach>
									  &nbsp;
									 远视眼：
                                      <c:forEach var="optionParamPoTmp" items="${optionParamPolist}" >
	                                      <c:if test="${optionParamPoTmp.fopparentid=='45'}">
	                                      	${(inspectionPos[0].sopipfareye == optionParamPoTmp.fopparamid)? optionParamPoTmp.fopparamname:'' }
	                                      </c:if>	                                      	
                                      </c:forEach>
									  &nbsp;
									 散光：
                                      <c:forEach var="optionParamPoTmp" items="${optionParamPolist}" >
	                                      <c:if test="${optionParamPoTmp.fopparentid=='46'}">
	                                      	${(inspectionPos[0].sopipastigmia == optionParamPoTmp.fopparamid)? optionParamPoTmp.fopparamname:'' }
	                                      </c:if>	                                      	
                                      </c:forEach>
									  &nbsp;</li>
									</td>
								  ...
								  <tr>
								  	...
								  	<td bgcolor="#CADEE8">&nbsp;近视眼:
	                                          <c:forEach var="optionParamPoTmp" items="${optionParamPolist}" >
			                                      <c:if test="${optionParamPoTmp.fopparentid=='44'}">
			                                      	${(inspectionPos[0].sopipneareyeos == optionParamPoTmp.fopparamid)? optionParamPoTmp.fopparamname:'' }
			                                      </c:if>	                                      	
		                                      </c:forEach>
									  &nbsp;
									 远视眼：
	                                          <c:forEach var="optionParamPoTmp" items="${optionParamPolist}" >
			                                      <c:if test="${optionParamPoTmp.fopparentid=='45'}">
			                                      	${(inspectionPos[0].sopipfareyeos == optionParamPoTmp.fopparamid)? optionParamPoTmp.fopparamname:'' }
			                                      </c:if>	                                      	
		                                      </c:forEach>
									  &nbsp;
									 散光：
	                                          <c:forEach var="optionParamPoTmp" items="${optionParamPolist}" >
			                                      <c:if test="${optionParamPoTmp.fopparentid=='46'}">
			                                      	${(inspectionPos[0].sopipastigmiaos == optionParamPoTmp.fopparamid)? optionParamPoTmp.fopparamname:'' }
			                                      </c:if>	                                      	
		                                      </c:forEach>
									  &nbsp;</li>
									</td>
								  ...
								  <tr>
									...
									<td bgcolor="#CADEE8">
									 <li class="horizontal">
								  	<c:set value="${ fn:split(inspectionPos[0].sopipestimateos, ',') }" var="str1" />                                      	
                                      <c:forEach items="${ str1 }" var="s1">
       									<c:forEach var="optionParamPoTmp" items="${optionParamPolist}" >
	                                      	<c:if test="${fn:trim(s1) == fn:trim(optionParamPoTmp.fopparamid)}">
	                                      		${optionParamPoTmp.fopparamname} 
	                                      	</c:if>	                                      	
                                     	</c:forEach> 
									  </c:forEach>
                  ...
                  border=0 align=center cellPadding=1 cellSpacing=1 class="privateTable PrivateBorderBlue" id="fz">
                                  <TBODY>
                                    ...
                                    <TD height="30" bgcolor="#E8F8FF"><div align="right" class="PrivateBorder">
                                      	戴镜方式：
                                      	<c:forEach var="optionParamPoTmp" items="${optionParamPolist}" >
	                                      	<c:if test="${fn:trim(inspectionPos[0].sopiptaketype) == fn:trim(optionParamPoTmp.fopparamid)}">
	                                      		${optionParamPoTmp.fopparamname} 
	                                      	</c:if>	                                      	
                                     	</c:forEach> 
                                    </div>
