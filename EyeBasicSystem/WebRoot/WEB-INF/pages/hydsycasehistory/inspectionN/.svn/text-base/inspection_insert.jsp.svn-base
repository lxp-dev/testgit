...
// 翻方子
	...
	*/
	...
	function inspectionCopy(){
		location.href="inspectionCopyHydsy.action?chuyanfuyan="+'${chuyanfuyan}'+"&oldOptometryID="+'${oldOptometryID}'+"&customerID="+'${customerID }'+"&optometryBasicID="+'${copyBasicOptometryID}'+"&moduleID="+'${moduleID}'+"&optometryID="+'${optometryID}';
		selectHidden();
	}
	var f1;
	...
	function save(){
		var isSubmit = 1;	
		$('[name*=.sopiparriseglassod1]').each(function (){
			if($(this).val()!=''){
				$('[name*=.sopipbasisod1]').each(function (){
					if($(this).val()==''){
		...
		$('[name*=.sopiparriseglassos1]').each(function (){
			if($(this).val()!=''){
				$('[name*=.sopipbasisos1]').each(function (){
					if($(this).val()==''){
		...
		if($('[name*=.sopipballglassod]').length!=0){
			if(isSubmit == 0){
				...
				inspectionForm.action="inspectionInsertHydsy.action?ruleFlag=0&nw='N'";
	...
	function syjp(glassType,goodsCategoryID,xzindex){ //适用镜片开窗
		...
		if(is_iPad()){
			showPopWin("initWindowInspectionNormalOpen.action?glassType="+glassType+"&goodscategoryID="+goodsCategoryID+"&xzindex="+xzindex,970,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}else{
			showPopWin("initWindowInspectionNormalOpen.action?glassType="+glassType+"&goodscategoryID="+goodsCategoryID+"&xzindex="+xzindex,screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}
	...
	function jyhly(glassType){ //建议护理液开窗
		var topRows = top.document.getElementById("total").rows;
		var topCols = top.document.getElementById("btmframe").cols;
		if(is_iPad()){
	...
	function jmsxjclearSyjp(glassType){
		$('input[name=inspectionPos['+glassType+'].sopipcommendglasses]').val('');
	}

	function jmsxjclearSyjpod(glassType){
		$('input[jmsxjsyjpod='+glassType+']').val('');
	}

	function jmsxjclearSyjpos(glassType){
		$('input[jmsxjsyjpos='+glassType+']').val('');
	}
         				...
         				+"<TABLE width='99%' border=0 align=center cellPadding=1 cellSpacing=1 class='privateTable' id='yy'>"
         					...
         					+"<TR>"
         						+"<TD colspan='9' style='height:20px' class='PrivateBorderGreen' bgcolor='dfffdf'>"
         							+"<p>框架--远用&nbsp;&nbsp;<img onmouseover=\"JavaScript:$(this).attr('src','${ctx }/img/newbtn/btn_delete_1.png');\" onmouseout=\"JavaScript:$(this).attr('src','${ctx }/img/newbtn/btn_delete_0.png');\" src='${ctx }/img/newbtn/btn_delete_0.png' btn=btn title='删除' ln="+allTrafficCount+" onclick='javascript:deletechufang(1,this);'></p></TD></TR>"
         							...
         							+"<TR><TD width='11%' bgcolor='#DFFFDF' class='PrivateBorderGreen'>OS</TD><TD bgcolor='#DFFFDF' class='PrivateBorderGreen'><div align='center'><input needChange='needChange' yyorder='8' sph='sph' name='inspectionPos["+Subtr(1,listindex)+"].sopipballglassos' onKeyPress='EnterDown(this)' value='${refractivePo.soprdbalballglassos}' enter='enter"+(enternum++)+"' class='text_input' size='4'></div></TD><TD bgcolor='#DFFFDF' class='PrivateBorderGreen'><div align='center'><input needChange='needChange' yyorder='9' cyl='cyl' value='${refractivePo.soprdbalpostglassos}' name='inspectionPos["+Subtr(1,listindex)+"].sopippostglassos' onKeyPress='EnterDown(this)' enter='enter"+(enternum++)+"' class='text_input' size='4'></div></TD><TD bgcolor='#DFFFDF' class='PrivateBorderGreen'><div align='center'><input axes='axes' yyorder='10' name='inspectionPos["+Subtr(1,listindex)+"].sopipaxesos' value='${refractivePo.soprdbalaxesos}' onKeyPress='EnterDown(this)' enter='enter"+(enternum++)+"' class='text_input' size='4'></div></TD><TD bgcolor='#DFFFDF' class='PrivateBorderGreen'><div align='center'><input ljxj='ljxj' yyorder='11' name='inspectionPos["+Subtr(1,listindex)+"].sopiparriseglassos1' onKeyPress='EnterDown(this)' enter='enter"+(enternum++)+"' class='text_input' size='4' value='${refractivePo.soprdbalarriseglassos }'></div></TD><TD bgcolor='#DFFFDF' class='PrivateBorderGreen'>"
         								...
         								+"<TD bgcolor='#DFFFDF' class='PrivateBorderGreen'><div align='center'><input yyorder='14' va='va' maxlength='20' name='inspectionPos["+Subtr(1,listindex)+"].sopipfarvaos' onKeyPress='EnterDown(this)' enter='enter"+(enternum++)+"' class='text_input' size='4' value='${refractivePo.soprdbalvaos }'></div></TD></TR><TR><TD colspan='4' bgcolor='#DFFFDF' class='PrivateBorderGreen'></TD><TD colspan='5' bgcolor='#DFFFDF' class='PrivateBorderGreen'><div align='center'>中距离：<INPUT type='checkbox' value='1' name='inspectionPos["+Subtr(1,listindex)+"].sopipmiddledistance'>建议镜框：<SELECT name='inspectionPos["+Subtr(1,listindex)+"].sopipsuggestframe'>"
                                            ...
                                            +"<c:forEach var='optionParamPoTmp' items='${optionParamPolist}' >"
		                                     ...
		                                     +" </c:if>"	                                      	
	                                         +"</c:forEach>"
         									+"</SELECT></TD><TD bgcolor='#DFFFDF' class='PrivateBorderGreen'><div align='right'>处理方式： </div></TD><TD bgcolor='#DFFFDF' class='PrivateBorderGreen'><select name='inspectionPos["+Subtr(1,listindex)+"].sopipdisposemanner'>"
         									+"<option value='' selected></option>"
                                            +"<c:forEach var='optionParamPoTmp' items='${optionParamPolist}' >"
...
+"</td></tr>";  
	  ...
	  if(myValue == "6"){
		  c1.innerHTML="<tr id="+rowadd+"tr><td><input type='hidden' name='inspectionPos["+Subtr(1,listindex)+"].sopipglasstype' value='6'/>"
		  								...
		  								+"<TD id='yxs' colspan='18' style='height:20px' class='PrivateBorderPink' bgcolor='#F8E0F0'>"
		  								+"<p>角膜塑形镜&nbsp;&nbsp;&nbsp;<img onmouseover=\"JavaScript:$(this).attr('src','${ctx }/img/newbtn/btn_delete_0.png');\" onmouseout=\"JavaScript:$(this).attr('src','${ctx }/img/newbtn/btn_delete_1.png');\" src='${ctx }/img/newbtn/btn_delete_0.png' btn=btn  title='删除' ln="+allTrafficCount+" onclick='javascript:deletechufang(1,this);'></p></TD></TR>"
		  								+"<tr>"
		  								+"<td rowspan='2'  width='5%' su=lxd bgcolor='#F8E0F0' class='PrivateBorderPink'></td>"
		  								+"<td bgcolor='#F8E0F0' class='PrivateBorderPink' style='height:20px' colspan='8'><div align='center'>屈光处方及角膜参数</div></td>"
		  								...
		  								+"<TD width='6%' bgcolor='#F8E0F0' class='PrivateBorderPink'><div align='center'>暗瞳</div></TD>"
		  								...
		  								+"<TD bgcolor='#F8E0F0' class='PrivateBorderPink'><div align='center'>"
		  								+"<input name='inspectionPos["+Subtr(1,listindex)+"].sopipaxesod' axes='axes' value='${po.sopipaxesod}' class='text_input' size='2' onKeyPress='EnterDown(this)' enter='enter6'></div></TD>"
		  								+"<TD su=lxd bgcolor='#F8E0F0' class='PrivateBorderPink'><div align='center'>"
		  								+"<input name='inspectionPos["+Subtr(1,listindex)+"].sopipupkod' value='${healthCheckPo.sophctopographyskod}' class='text_input' size='2' onKeyPress='EnterDown(this)' enter='enter7'></div></TD>"
		  								+"<TD su=lxd bgcolor='#F8E0F0' class='PrivateBorderPink'><div align='center'>"
		  								+"<input name='inspectionPos["+Subtr(1,listindex)+"].sopipdownkod' value='${healthCheckPo.sophctopographyfkod}' class='text_input' size='2' onKeyPress='EnterDown(this)' enter='enter7'></div></TD>"
		  								+"<TD su=lxd bgcolor='#F8E0F0' class='PrivateBorderPink'><div align='center'>"
		  								+"<input name='inspectionPos["+Subtr(1,listindex)+"].sopipeod' value='${healthCheckPo.sophctopographyeod}' class='text_input' size='2' onKeyPress='EnterDown(this)' enter='enter7'></div></TD>"
		  								+"<TD su=ht bgcolor='#F8E0F0' class='PrivateBorderPink'><div align='center'>"
		  								+"<input name='inspectionPos["+Subtr(1,listindex)+"].sopipcornealdiameterod' value='${contactGlassPo.sopcgdiameterod}' class='text_input' size='2' onKeyPress='EnterDown(this)' enter='enter7'></div></TD>"

		  								+"<TD su=ht bgcolor='#F8E0F0' class='PrivateBorderPink'><div align='center'>"
		  								+"<input name='inspectionPos["+Subtr(1,listindex)+"].sopipantongod' value='${po.sopipantongod}' class='text_input' size='2' onKeyPress='EnterDown(this)' enter='enter7' maxlength='10'></div></TD>"
		  								
		  								+"<TD su=ht bgcolor='#F8E0F0' class='PrivateBorderPink'><div align='center'>"
		  								+"<input name='inspectionPos["+Subtr(1,listindex)+"].sopipk0od' value='${contactGlassPo.sopcgbasecurveod}' class='text_input' size='2' onKeyPress='EnterDown(this)' enter='enter7'></div></TD>"
		  								+"<TD su=ht bgcolor='#F8E0F0' class='PrivateBorderPink'><div align='center'>"
		  								...
		  								+"<TD su=ht bgcolor='#F8E0F0' class='PrivateBorderPink'><div align='center'>"
		  								+"<input name='inspectionPos["+Subtr(1,listindex)+"].sopipupcod' value='${contactGlassPo.sopcgdiopterod}' class='text_input' size='2' onKeyPress='EnterDown(this)' enter='enter7'></div></TD>"
		  								...
		  								+"<TD su=rb bgcolor='#F8E0F0' class='PrivateBorderPink'><div align='center'>"
		  								+"<input name='inspectionPos["+Subtr(1,listindex)+"].sopipdiameterod' value='${healthCheckPo.sophccorneadiameterod}' class='text_input' size='2' onKeyPress='EnterDown(this)' enter='enter7'></div></TD>"
		  								+"<TD bgcolor='#F8E0F0' class='PrivateBorderPink'><div align='center'><li class='horizontal'>适用镜片："
		  								+"<INPUT jmsxjsyjpod='"+allTrafficCount+"' name='inspectionPos["+Subtr(1,listindex)+"].sopipcommendglassesod' value='${po.sopipcommendglassesod}' id='cc1.commendglasses22' size='8' readOnly></li>"
		  								+"<li class='horizontal'><img name='xzbutton' id='xzbutton' src='${ctx }/img/newbtn/btn_change_0.png' onmouseover=\"JavaScript:$(this).attr('src','${ctx }/img/newbtn/btn_change_1.png');\" onmouseout=\"JavaScript:$(this).attr('src','${ctx }/img/newbtn/btn_change_0.png');\" btn=btn onClick='queryInvisibilityEyeglass(1,"+allTrafficCount+",4,"+xzindex+")' title='选 择'></li><li class='horizontal'><img onmouseover=\"JavaScript:$(this).attr('src','${ctx }/img/newbtn/btn_empty_0.png');\" onmouseout=\"JavaScript:$(this).attr('src','${ctx }/img/newbtn/btn_empty_0.png');\" src='${ctx }/img/newbtn/btn_empty_0.png' btn=btn  name='button23' onClick='jmsxjclearSyjpod("+allTrafficCount+")' value='清 空'></li></div></TD>"
		  								...
		  								+"<TD bgcolor='#F8E0F0' class='PrivateBorderPink'><div align='center'>"
		  								+"<input name='inspectionPos["+Subtr(1,listindex)+"].sopipupkos' value='${healthCheckPo.sophctopographyskos}' class='text_input' size='2' onKeyPress='EnterDown(this)' enter='enter11'></div></TD>"
		  								+"<TD bgcolor='#F8E0F0' class='PrivateBorderPink'><div align='center'>"
		  								+"<input name='inspectionPos["+Subtr(1,listindex)+"].sopipdownkos' value='${healthCheckPo.sophctopographyfkos}' class='text_input' size='2' onKeyPress='EnterDown(this)' enter='enter12'></div></TD>"
		  								+"<TD bgcolor='#F8E0F0' class='PrivateBorderPink'><div align='center'>"
		  								+"<input name='inspectionPos["+Subtr(1,listindex)+"].sopipeos' value='${healthCheckPo.sophctopographyeos}' class='text_input' size='2' onKeyPress='EnterDown(this)' enter='enter13'></div></TD>"
		  								+"<TD bgcolor='#F8E0F0' class='PrivateBorderPink'><div align='center'>"
		  								+"<input name='inspectionPos["+Subtr(1,listindex)+"].sopipcornealdiameteros' value='${contactGlassPo.sopcgdiameteros}' class='text_input' size='2' onKeyPress='EnterDown(this)' enter='enter14'></div></TD>"

		  								+"<TD bgcolor='#F8E0F0' class='PrivateBorderPink'><div align='center'>"
		  								+"<input name='inspectionPos["+Subtr(1,listindex)+"].sopipantongos' value='${po.sopipantongos}' class='text_input' size='2' onKeyPress='EnterDown(this)' enter='enter14' maxlength='10'></div></TD>"

		  								+"<TD su=eae bgcolor='#F8E0F0' class='PrivateBorderPink'><div align='center'>"
		  								+"<input name='inspectionPos["+Subtr(1,listindex)+"].sopipk0os' value='${contactGlassPo.sopcgbasecurveos}' class='text_input' size='2' onKeyPress='EnterDown(this)' enter='enter7'></div></TD>"
		  								+"<TD su=eae bgcolor='#F8E0F0' class='PrivateBorderPink'><div align='center'>"
		  								...
		  								+"<TD su=eae bgcolor='#F8E0F0' class='PrivateBorderPink'><div align='center'>"
		  								+"<input name='inspectionPos["+Subtr(1,listindex)+"].sopipupcos' value='${contactGlassPo.sopcgdiopteros}' class='text_input' size='2' onKeyPress='EnterDown(this)' enter='enter7'></div></TD>"
		  								+"<TD su=eae bgcolor='#F8E0F0' class='PrivateBorderPink'><div align='center'>"
		  								...
		  								+"<TD su=rb bgcolor='#F8E0F0' class='PrivateBorderPink'><div align='center'>"
		  								+"<input name='inspectionPos["+Subtr(1,listindex)+"].sopipdiameteros' value='${healthCheckPo.sophccorneadiameteros}' class='text_input' size='2' onKeyPress='EnterDown(this)' enter='enter7'></div></TD>"
		  								+"<TD bgcolor='#F8E0F0' class='PrivateBorderPink'><div align='center'><li class='horizontal'>适用镜片："
		  								+"<INPUT jmsxjsyjpos='"+allTrafficCount+"' name='inspectionPos["+Subtr(1,listindex)+"].sopipcommendglassesos' value='${po.sopipcommendglassesos}' id='cc1.commendglasses22' size='8' readOnly></li>"
		  								+"<li class='horizontal'><img name='xzbutton' id='xzbutton' src='${ctx }/img/newbtn/btn_change_0.png' onmouseover=\"JavaScript:$(this).attr('src','${ctx }/img/newbtn/btn_change_1.png');\" onmouseout=\"JavaScript:$(this).attr('src','${ctx }/img/newbtn/btn_change_0.png');\" btn=btn onClick='queryInvisibilityEyeglass(2,"+allTrafficCount+",4,"+(xzindex+1)+")' title='选 择'></li><li class='horizontal'><img onmouseover=\"JavaScript:$(this).attr('src','${ctx }/img/newbtn/btn_empty_0.png');\" onmouseout=\"JavaScript:$(this).attr('src','${ctx }/img/newbtn/btn_empty_0.png');\" src='${ctx }/img/newbtn/btn_empty_0.png' btn=btn  name='button23' onClick='jmsxjclearSyjpos("+allTrafficCount+")' title='清 空'></li></div></TD>"
		  								+"</TR>"
	  ...
	  if(myValue == "7"){
		  c1.innerHTML="<tr id="+rowadd+"tr><td><input type='hidden' name='inspectionPos["+Subtr(1,listindex)+"].sopipglasstype' value='7'/>"
		  								...
		  								+"<img onmouseover=\"JavaScript:$(this).attr('src','${ctx }/img/newbtn/btn_delete_0.png');\" onmouseout=\"JavaScript:$(this).attr('src','${ctx }/img/newbtn/btn_delete_1.png');\" src='${ctx }/img/newbtn/btn_delete_0.png' btn=btn  title='删除' ln="+allTrafficCount+" onclick='javascript:deletechufang(1,this);'><br></p></TD>	</TR><TR>"
	...
	function checkCylZero(){
  	...
  	function cornealContactlLens(){
		$("img").removeAttr("onclick");
		inspectionForm.action="cornealContactlLensToolHydsy.action?source=cornealContactlLensu";
		inspectionForm.submit();
	}
              ...
              <TR>
				...
				<br>
                  ...
                  border=0 align=center cellpadding=1 cellspacing=1 class="privateTable privateBorder">
                                  <tbody>
									<tr>
								  	<td height="52" bgcolor="#CADEE8" valign="middle" rowspan="2" align="center">屈光不正</td>
								  	<td height="26" bgcolor="#CADEE8" valign="middle" align="center">OD</td>
								  	<td bgcolor="#CADEE8">
								  	<li class="horizontal">近视眼:
									    <SELECT id="sopipneareye" name="inspectionPo.sopipneareye" style=" width:120;">
	                                          <option value="" selected></option>
	                                          <c:forEach var="optionParamPoTmp" items="${optionParamPolist}" >
			                                      <c:if test="${optionParamPoTmp.fopparentid=='44'}">
			                                      	<option value="${optionParamPoTmp.fopparamid }" ${(inspectionPo.sopipneareye == optionParamPoTmp.fopparamid)? 'selected=selected' :'' }>${optionParamPoTmp.fopparamname}</option>
			                                      </c:if>	                                      	
		                                      </c:forEach>
		                                    </select>
									  &nbsp;
									 ...
									 <SELECT id="sopipseccheckdate" name="inspectionPo.sopipfareye" style=" width:120;">
	                                          ...
	                                          <c:forEach var="optionParamPoTmp" items="${optionParamPolist}" >
			                                      <c:if test="${optionParamPoTmp.fopparentid=='45'}">
			                                      	<option value="${optionParamPoTmp.fopparamid }" ${(inspectionPo.sopipfareye == optionParamPoTmp.fopparamid)? 'selected=selected' :'' }>${optionParamPoTmp.fopparamname}</option>
			                                      </c:if>	                                      	
		                                      </c:forEach>
		                                    </select>
									  &nbsp;
									  ...
									  <SELECT id="sopipastigmia" name="inspectionPo.sopipastigmia" style=" width:120;">
	                                          ...
	                                          <c:forEach var="optionParamPoTmp" items="${optionParamPolist}" >
			                                      <c:if test="${optionParamPoTmp.fopparentid=='46'}">
			                                      	<option value="${optionParamPoTmp.fopparamid }" ${(inspectionPo.sopipastigmia == optionParamPoTmp.fopparamid)? 'selected=selected' :'' }>${optionParamPoTmp.fopparamname}</option>
			                                      </c:if>	                                      	
		                                      </c:forEach>
		                                    </select>
									  &nbsp;</li>
								  ...
								  <tr>
								  	<td height="26" bgcolor="#CADEE8" valign="middle" align="center">OS</td>
								  	<td bgcolor="#CADEE8">&nbsp;近视眼:
									    <SELECT id="sopipneareyeos" name="inspectionPo.sopipneareyeos" style=" width:120;">
	                                          <option value="" selected></option>
	                                          <c:forEach var="optionParamPoTmp" items="${optionParamPolist}" >
			                                      <c:if test="${optionParamPoTmp.fopparentid=='44'}">
			                                      	<option value="${optionParamPoTmp.fopparamid }" ${(inspectionPo.sopipneareyeos == optionParamPoTmp.fopparamid)? 'selected=selected' :'' }>${optionParamPoTmp.fopparamname}</option>
			                                      </c:if>	                                      	
		                                      </c:forEach>
		                                    </select>
									  &nbsp;
									 远视眼：
									 <SELECT id="sopipfareyeos" name="inspectionPo.sopipfareyeos" style=" width:120;">
	                                          <option value="" selected></option>
	                                          <c:forEach var="optionParamPoTmp" items="${optionParamPolist}" >
			                                      <c:if test="${optionParamPoTmp.fopparentid=='45'}">
			                                      	<option value="${optionParamPoTmp.fopparamid }" ${(inspectionPo.sopipfareyeos == optionParamPoTmp.fopparamid)? 'selected=selected' :'' }>${optionParamPoTmp.fopparamname}</option>
			                                      </c:if>	                                      	
		                                      </c:forEach>
		                                    </select>
									  &nbsp;
									 散光：
									  <SELECT id="sopipastigmiaos" name="inspectionPo.sopipastigmiaos" style=" width:120;">
	                                          <option value="" selected></option>
	                                          <c:forEach var="optionParamPoTmp" items="${optionParamPolist}" >
			                                      <c:if test="${optionParamPoTmp.fopparentid=='46'}">
			                                      	<option value="${optionParamPoTmp.fopparamid }" ${(inspectionPo.sopipastigmiaos == optionParamPoTmp.fopparamid)? 'selected=selected' :'' }>${optionParamPoTmp.fopparamname}</option>
			                                      </c:if>	                                      	
		                                      </c:forEach>
		                                    </select>
									  &nbsp;</li>
                                  ...
                                  <tr>
								  	<td height="52" bgcolor="#CADEE8" valign="middle" align="center" rowspan="2">
									 双眼视功能评估
									</td>
									<td height="26" bgcolor="#CADEE8" valign="middle" align="center">OD</td>
									<td bgcolor="#CADEE8">
									 <li class="horizontal">
	                                    <c:forEach var="optionParamPoTmp" items="${optionParamPolist}" >
	                                      <c:if test="${optionParamPoTmp.fopparentid=='47'}">
	                                      	<input name="inspectionPo.sopipestimate" type="checkbox" value="${optionParamPoTmp.fopparamid }">${optionParamPoTmp.fopparamname}
	                                      </c:if>	                                      	
	                                   	</c:forEach> 									 
									 &nbsp;</li>
									</td>
								  ...
								  <tr>
									...
									<td bgcolor="#CADEE8">
									 <li class="horizontal">
	                                    <c:forEach var="optionParamPoTmp" items="${optionParamPolist}" >
	                                      <c:if test="${optionParamPoTmp.fopparentid=='47'}">
	                                      	<input name="inspectionPo.sopipestimateos" type="checkbox" value="${optionParamPoTmp.fopparamid }">${optionParamPoTmp.fopparamname}
	                                      </c:if>	                                      	
	                                   	</c:forEach> 									 
									 &nbsp;</li>
									</td>
                  ...
                  border=0 align=center cellpadding=1 cellspacing=1 class="privateTable privateBorder">
                                  <tbody>
                                    <tr>
									  ...
									  <li class="horizontal">
									  <img src="${ctx }/img/newbtn/btn_change_0.png" btn=btn title='选择' onClick="displayTable();checkCylZero();">
									  </li>
									  </td>
                                    </tr>
                                  </tbody>
                                  ...
                                  <TBODY>
                                    ...
                                    <TD height="30" bgcolor="#E8F8FF"><div align="right" class="PrivateBorder">
									  ...
									  <SELECT id="sopiptaketype" name="inspectionPo.sopiptaketype" style=" width:120;">
	                                       ...
	                                       <c:forEach var="optionParamPoTmp" items="${optionParamPolist}" >
		                                     <c:if test="${optionParamPoTmp.fopparentid=='56'}">
		                                     	<option value="${optionParamPoTmp.fopparamid }" ${(inspectionPo.sopiptaketype == optionParamPoTmp.fopparamid)? 'selected=selected' :'' }>${optionParamPoTmp.fopparamname}</option>
		                                     </c:if>	                                      	
	                                       </c:forEach>
	                                    </select>	
                                    </div>
                                      ...
                                      <TD height="30" bgcolor="#E8F8FF"><div align="left" class="PrivateBorder">复诊时间：
                                          <input id="sopipseccheckdate" name="inspectionPo.sopipseccheckdate" value="${inspectionPo.sopipseccheckdate }" onFocus="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd HH:mm'})" class="text_input120">
                                          </div>
                                      </TD>
                                    </TR>
                                  </TBODY>
