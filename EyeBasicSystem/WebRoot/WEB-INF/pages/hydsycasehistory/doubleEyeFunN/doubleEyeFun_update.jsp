...
function save(){
		...
		if(checkForm(document.all.doubleEyeFunForm)){    
			...
			doubleEyeFunForm.action = "updateDoubleEyeFunHydsy.action";
			if('${copy}'=='copy'){
								...
								<table width="99%" border=0 align=center cellpadding=1 cellspacing=1 class="privateTable privateBorder">
                                  <TBODY>
                                      ...
                                      <td  class="table_none" colspan="6">
                                      	不等像视
										<INPUT  type="radio" name="doubleEyeFunPo.sopdeequalwatch" value="0" ${doubleEyeFunPo.sopdeequalwatch != "1" ? 'checked="checked"' : '' } onclick="javascript:chageOne();" >
										无
										...
										有
										<input moveorder="37"  id="sopdedifwatch" name="doubleEyeFunPo.sopdedifwatch" class="text_input100" value="${doubleEyeFunPo.sopdedifwatch }" >
									  </td>
                                    </TR>
                                    <TR>
                                    ...
                                    <TR>
                                      ...
                                      <TD class="table_none"><div align="center">
                                        <input moveorder="8" id="validateLevel" name="doubleEyeFunPo.sopdefaramaleveln" class="text_input40" value="${doubleEyeFunPo.sopdefaramaleveln }">
                                      </div></TD>
                                      <TD class="table_none"><div align="center">
                                        <input moveorder="9" id="validateLevel" name="doubleEyeFunPo.sopdefaramalevelno" class="text_input40" value="${doubleEyeFunPo.sopdefaramalevelno }">
                                      </div></TD>
                                      <TD class="table_none"><div align="center">
                                        <input moveorder="10" id="validateLevel" name="doubleEyeFunPo.sopdefaramalevelnt" class="text_input40" value="${doubleEyeFunPo.sopdefaramalevelnt }">
                                      </div></TD>
                                      ...
                                      <TD width="5%" class="table_none"><div align="center">
                                        <input moveorder="11" id="validatedotNum" name="doubleEyeFunPo.sopdefaramalbu" class="text_input40" value="${doubleEyeFunPo.sopdefaramalbu }">
                                      </div></TD>
                                      <TD width="6%" class="table_none"><div align="center">
                                        <input  moveorder="12" id="validatedotNum" name="doubleEyeFunPo.sopdefaramalbuo" class="text_input40" value="${doubleEyeFunPo.sopdefaramalbuo }">
                                      </div></TD>
                                      <TD width="6%" class="table_none"><div align="center">
                                        <input moveorder="13" id="validatedotNum" name="doubleEyeFunPo.sopdefaramabu" class="text_input40" value="${doubleEyeFunPo.sopdefaramabu }" >
                                      </div></TD>
                                      <TD width="6%" class="table_none"><div align="center">
                                        <input moveorder="14" id="validatedotNum" name="doubleEyeFunPo.sopdefaramabuo" class="text_input40" value="${doubleEyeFunPo.sopdefaramabuo }">
                                      </div></TD>
                                    </TR>
                                    <TR>
                                      <TD class="table_none"><div align="right">＋</div></TD>
                                      <TD width="6%" class="table_none"><div align="center">
                                        <input moveorder="5" id="validateLevel" name="doubleEyeFunPo.sopdefaramalevelp" class="text_input40" value="${doubleEyeFunPo.sopdefaramalevelp }">
                                      </div></TD>
                                      <TD width="6%" class="table_none"><div align="center">
                                        <input moveorder="6" id="validateLevel" name="doubleEyeFunPo.sopdefaramalevelpo" class="text_input40" value="${doubleEyeFunPo.sopdefaramalevelpo }">
                                      </div></TD>
                                      <TD width="6%" class="table_none"><div align="center">
                                        <input moveorder="7" id="validateLevel" name="doubleEyeFunPo.sopdefaramalevelpt" class="text_input40" value="${doubleEyeFunPo.sopdefaramalevelpt }">
                                      </div></TD>
                                      <TD class="table_none"><div align="right">BD</div></TD>
                                      <TD class="table_none"><div align="center">
                                        <input  moveorder="15" id="validatedotNum" name="doubleEyeFunPo.sopdefaramalbd" class="text_input40" value="${doubleEyeFunPo.sopdefaramalbd }">
                                      </div></TD>
                                      <TD class="table_none"><div align="center">
                                        <input moveorder="16" id="validatedotNum" name="doubleEyeFunPo.sopdefaramalbdo" class="text_input40" value="${doubleEyeFunPo.sopdefaramalbdo }">
                                      </div></TD>
                                      <TD class="table_none"><div align="center">
                                        <input moveorder="17" id="validatedotNum" name="doubleEyeFunPo.sopdefaramabd" class="text_input40" value="${doubleEyeFunPo.sopdefaramabd }">
                                      </div></TD>
                                      <TD class="table_none"><div align="center">
                                        <input moveorder="18" id="validatedotNum" name="doubleEyeFunPo.sopdefaramabdo" class="text_input40" value="${doubleEyeFunPo.sopdefaramabdo }">
                                      </div></TD>
                                    </TR>
                                    <TR>
                                      <TD colspan="8" bgcolor="#FFFFFF" class="Privateborder">&nbsp;</TD>
                                    ...
                                    <TR>
                                      ...
                                      <TD width="10%" class="table_none"><div align="right">－ </div></TD>
                                      <TD class="table_none"><div align="center">
                                          <input moveorder="26" id="validateLevel" name="doubleEyeFunPo.sopdecloseamaleveln" class="text_input40" value="${doubleEyeFunPo.sopdecloseamaleveln }">
                                      </div></TD>
                                      <TD class="table_none"><div align="center">
                                          <input moveorder="27" id="validateLevel" name="doubleEyeFunPo.sopdecloseamalevelno" class="text_input40" value="${doubleEyeFunPo.sopdecloseamalevelno }">
                                      </div></TD>
                                      <TD class="table_none"><div align="center">
                                          <input moveorder="28" id="validateLevel" name="doubleEyeFunPo.sopdecloseamalevelnt" class="text_input40" value="${doubleEyeFunPo.sopdecloseamalevelnt }">
                                      </div></TD>
                                      <TD width="8%" class="table_none" rowspan="2"><div align="right">垂直</div></TD>
                                      <TD width="6%" class="table_none"><div align="right">BU</div></TD>
                                      <TD width="5%" class="table_none"><div align="center">
                                          <input moveorder="29" id="validatedotNum" name="doubleEyeFunPo.sopdecloseamalbu" class="text_input40" value="${doubleEyeFunPo.sopdecloseamalbu }">
                                      </div></TD>
                                      <TD width="6%" class="table_none"><div align="center">
                                          <input moveorder="30" id="validatedotNum" name="doubleEyeFunPo.sopdecloseamalbuo" class="text_input40" value="${doubleEyeFunPo.sopdecloseamalbuo }">
                                      </div></TD>
                                      <TD width="6%" class="table_none"><div align="center">
                                          <input moveorder="31" id="validatedotNum" name="doubleEyeFunPo.sopdecloseamabu" class="text_input40" value="${doubleEyeFunPo.sopdecloseamabu }">
                                      </div></TD>
                                      <TD width="6%" class="table_none"><div align="center">
                                          <input moveorder="32" id="validatedotNum" name="doubleEyeFunPo.sopdecloseamabuo" class="text_input40" value="${doubleEyeFunPo.sopdecloseamabuo }">
                                      </div></TD>
                                    </TR>
                                    <TR>
                                      <TD class="table_none"><div align="right">＋ </div></TD>
                                      <TD width="6%" class="table_none"><div align="center">
                                          <input moveorder="23" id="validateLevel" name="doubleEyeFunPo.sopdecloseamalevelp" class="text_input40" value="${doubleEyeFunPo.sopdecloseamalevelp }">
                                      </div></TD>
                                      <TD width="6%" class="table_none"><div align="center">
                                          <input moveorder="24" id="validateLevel" name="doubleEyeFunPo.sopdecloseamalevelpo" class="text_input40" value="${doubleEyeFunPo.sopdecloseamalevelpo }">
                                      </div></TD>
                                      <TD width="6%" class="table_none"><div align="center">
                                          <input moveorder="25" id="validateLevel" name="doubleEyeFunPo.sopdecloseamalevelpt" class="text_input40" value="${doubleEyeFunPo.sopdecloseamalevelpt }">
                                      </div></TD>
                                      <TD class="table_none"><div align="right">BD</div></TD>
                                      <TD class="table_none"><div align="center">
                                          <input moveorder="33" id="validatedotNum" name="doubleEyeFunPo.sopdecloseamalbd" class="text_input40" value="${doubleEyeFunPo.sopdecloseamalbd }">
                                      </div></TD>
                                      <TD class="table_none"><div align="center">
                                          <input moveorder="34" id="validatedotNum" name="doubleEyeFunPo.sopdecloseamalbdo" class="text_input40" value="${doubleEyeFunPo.sopdecloseamalbdo }">
                                      </div></TD>
                                      <TD class="table_none"><div align="center">
                                          <input moveorder="35" id="validatedotNum" name="doubleEyeFunPo.sopdecloseamabd" class="text_input40" value="${doubleEyeFunPo.sopdecloseamabd }">
                                      </div></TD>
                                      <TD class="table_none"><div align="center">
                                          <input moveorder="36" id="validatedotNum" name="doubleEyeFunPo.sopdecloseamabdo" class="text_input40" value="${doubleEyeFunPo.sopdecloseamabdo }">
                                      </div></TD>
                                    </TR>
                                  </TBODY>
                                </TABLE>
