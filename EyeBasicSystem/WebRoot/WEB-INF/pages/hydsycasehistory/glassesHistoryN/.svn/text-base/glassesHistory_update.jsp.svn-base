...
<script type="text/javascript">
	function save(){
		if(checkForm(document.all.glassesHistoryForm)){    
			...
			glassesHistoryForm.action = "updateGlassesHistoryHydsy.action";
	...
	function optometry(){
		glassesHistoryForm.action="initOptometryBasicSelHydsy.action";
		glassesHistoryForm.submit();
	}
	...
	function refractive(){
		if('${optometryPo.sopoyflag}' != '1'){
			$("img").removeAttr("onclick");
			glassesHistoryForm.action="refractiveToolHydsy.action?source=refractiveiou";
			glassesHistoryForm.submit();
		}else{
			var dontshow = $('#dontshow').val();
			$("img").removeAttr("onclick");
			glassesHistoryForm.action="initRefractiveSelectHydsy.action?dontshow="+dontshow;
			glassesHistoryForm.submit();
		}
	}
	function inspection(){
	/*
		...
		*/
		...
		if('${optometryPo.sopoyflag}' != '1'){
			$("img").removeAttr("onclick");
			glassesHistoryForm.action="inspectionToolHydsy.action?source=inspectioniou";
			glassesHistoryForm.submit();
		}else{
			$("img").removeAttr("onclick");
			var dontshow = $('#dontshow').val();
			glassesHistoryForm.action="initInspectionSelectHydsy.action?dontshow="+dontshow;
			glassesHistoryForm.submit();
		}
	}
	function specialCheck(){
		if('${optometryPo.sopoyflag}' != '1'){
			$("img").removeAttr("onclick");
			glassesHistoryForm.action="specialCheckToolHydsy.action?source=specialcheckiou";
			glassesHistoryForm.submit();
		}else{
			$("img").removeAttr("onclick");
			var dontshow = $('#dontshow').val();
			glassesHistoryForm.action="selectSpecialCheckHydsy.action?dontshow="+dontshow;
			glassesHistoryForm.submit();
		}
	}
	...
	function doubleEyeFun(){
		if('${optometryPo.sopoyflag}' != '1'){
			$("img").removeAttr("onclick");
			glassesHistoryForm.action="doubleEyeFunToolHydsy.action?source=doubleeyefuncopy";
			glassesHistoryForm.submit();
		}else{
			$("img").removeAttr("onclick");
			var dontshow = $('#dontshow').val();
			glassesHistoryForm.action="selectDoubleEyeFunHydsy.action?dontshow="+dontshow;
			glassesHistoryForm.submit();
		}
	}
	...
	function cornealContactlLens(){
		if('${optometryPo.sopoyflag}' != '1'){
			$("img").removeAttr("onclick");
			glassesHistoryForm.action="cornealContactlLensToolHydsy.action?source=cornealContactlLensu";
			glassesHistoryForm.submit();	
		}else{
			var dontshow = $('#dontshow').val();
			$("img").removeAttr("onclick");
			glassesHistoryForm.action="initCornealContactlLensSelectHydsy.action?dontshow="+dontshow;
			glassesHistoryForm.submit();
		}
	}
	...
	function contactGlass(){
		if('${optometryPo.sopoyflag}' != '1'){
			glassesHistoryForm.action="contactGlassToolHydsy.action?source=contactGlassiou";
			$("img").removeAttr("onclick");
			glassesHistoryForm.submit();
		}else{
			var dontshow = $('#dontshow').val();
			glassesHistoryForm.action="initContactGlassSelectHydsy.action?dontshow="+dontshow;
			$("img").removeAttr("onclick");
			glassesHistoryForm.submit();
		}
