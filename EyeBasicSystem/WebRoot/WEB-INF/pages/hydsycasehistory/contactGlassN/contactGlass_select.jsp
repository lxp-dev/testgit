...
// 翻方子
	...
	*/
	...
	function refractive(){
		...
		contactGlassForm.action="initRefractiveSelectHydsy.action?dontshow="+dontshow;
		contactGlassForm.submit();
	}
	function inspection(){
		$("img").removeAttr("onclick");
		var dontshow = $('#dontshow').val();
		contactGlassForm.action="initInspectionSelectHydsy.action?dontshow="+dontshow;
		contactGlassForm.submit();
	}
	function specialCheck(){
		$("img").removeAttr("onclick");
		var dontshow = $('#dontshow').val();
		contactGlassForm.action="selectSpecialCheckHydsy.action?dontshow="+dontshow;
		contactGlassForm.submit();
	}
	...
	function doubleEyeFun(){
		$("img").removeAttr("onclick");
		var dontshow = $('#dontshow').val();
		contactGlassForm.action="selectDoubleEyeFunHydsy.action?dontshow="+dontshow;
		contactGlassForm.submit();
	}
	
	function glassHistory(){
		contactGlassForm.action="selectGlassesHistoryHydsy.action?viewDetail=true";
		$("img").removeAttr("onclick");
		contactGlassForm.submit();
	}
  ...
  {   
	...
	function checkCylZero(){
  	...
  	function cornealContactlLens(){
  		var dontshow = $('#dontshow').val();
		$("img").removeAttr("onclick");
		contactGlassForm.action="initCornealContactlLensSelectHydsy.action?dontshow="+dontshow;
		contactGlassForm.submit();
	}
								...
								<table  width="99%" border=0 align=center cellpadding=1 cellspacing=1 class="privateTable privateBorder">
                                    ...
                                    <TR>
                                      ...
                                      <TD width="6%"  class="table_none">
                                        <div align="center">
                                         <input name="contactGlassPos[${status.index}].sopcjmpgod" value="${pom.sopcjmpgod }" class="text_input" size="4">
                                        </div></TD>
                                 ...
                                 <TD width="8%"  class="table_none"><div align="center">
                                    ...
                                    <TR>
                                      ...
                                      <TD class="table_none">
                                        <div align="center">
                                         <input name="contactGlassPos[${status.index}].sopcjmpgos" value="${pom.sopcjmpgos }" class="text_input" size="4">
                                        </div></TD>
