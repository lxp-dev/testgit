...
// 翻方子
	...
	*/
	...
	function save(){
		...
		contactGlassForm.action="contactGlassInsertHydsy.action?ruleFlag=0&nw='N'";
				...
				+"<p>试戴&nbsp;&nbsp;<img align='right' src='${ctx }/img/newbtn/btn_delete_0.png' btn=btn title='删除' ln="+allTrafficCount+" onclick='javascript:deletechufang(1,this);'></p></TD></TR>"         						
					...
					+"<TR><TD width='11%' bgcolor='#DFFFDF' class='table_body'>OD</TD>"
                      ...
                      +"<c:forEach var='optionParamPoTmp' items='${optionParamPolist}' >"
                       ...
                       +" </c:if>"	                                      	
                    +"</c:forEach>"
							+"</select></div></TD><TD width='8%' bgcolor='#DFFFDF' class='table_body'><div align='center'><input yyorder='4' ljxj='ljxj' value='' name='contactGlassPos["+Subtr(1,listindex)+"].sopcremarkod' onKeyPress='EnterDown(this)' enter='enter"+(enternum++)+"'  class='text_input60' size='4'  maxlength='100'></div></TD></TR>"    
                    ...
                    +"</c:forEach>"
							+"</select></div></TD>"
							+"<TD width='8%' bgcolor='#DFFFDF' class='table_body'><div align='center'><input yyorder='4' ljxj='ljxj' value='' name='contactGlassPos["+Subtr(1,listindex)+"].sopcremarkos' onKeyPress='EnterDown(this)' enter='enter"+(enternum++)+"'  class='text_input60' size='4' maxlength='100'></div></TD>"        								
							+"</TR>"  		        							
		+"</TABLE>"
         				+"</td>"
