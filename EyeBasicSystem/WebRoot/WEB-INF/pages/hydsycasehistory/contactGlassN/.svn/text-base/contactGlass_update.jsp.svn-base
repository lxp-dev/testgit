...
// 翻方子
	...
	*/
	...
	function save(){
		...
		contactGlassForm.action="contactGlassUpdateHydsy.action?ruleFlag=0&nw='N'";
	...
	function doubleEyeFun(){
		contactGlassForm.action="doubleEyeFunToolHydsy.action?source=doubleeyefuniou";
	...
	function specialCheck() {
		contactGlassForm.action="specialCheckToolHydsy.action?source=specialcheckiou";
		$("img").removeAttr("onclick");
		contactGlassForm.submit();
	}
	...
	function refractive(){
		contactGlassForm.action="refractiveToolHydsy.action?source=refractiveiou";
		$("img").removeAttr("onclick");
		contactGlassForm.submit();
	}
	function inspection(){		
		$("img").removeAttr("onclick");
		contactGlassForm.action="inspectionToolHydsy.action?source=inspectioniou";
		contactGlassForm.submit();
	}
	...
	function glassHistory(){
		...
		contactGlassForm.action="selectGlassesHistoryHydsy.action?customerID="+'${customerInfoPo.smecicustomerid }';
		contactGlassForm.submit();
	}
  ...
  {   
	  ...
	  var listindex = allTrafficCount;
         str=str+"<tr id="+rowadd+"tr><td>"
         				+"<TABLE width='99%' border=0 align=center cellPadding=1 cellSpacing=1 class='privateTable' id='yy'>"        					
         					+"<TR>"
         						+"<TD colspan='14' class='Privateborder' style='height:10px' bgcolor='#FFFFFF' >"
         						...
         						+"<p>试戴&nbsp;&nbsp;<img align='right' src='${ctx }/img/newbtn/btn_delete_0.png' btn=btn title='删除' ln="+allTrafficCount+" onclick='javascript:deletechufang(1,this);'></p></TD></TR>"         						
         							+"<TR><TD bgcolor='#DFFFDF' class='table_body'>&nbsp;</TD><TD bgcolor='#DFFFDF' class='table_body'><div align='center'>品种</div></TD>"
         								...
         								+"<TD bgcolor='#DFFFDF' class='table_body'><div align='center'>角膜评估</div></TD>"
         								...
         								str=str+"<TD bgcolor='#DFFFDF' class='table_body'><div align='center'>建议</div></TD><TD bgcolor='#DFFFDF' class='table_body'><div align='center'>备注</div></TD></TR>"
         							+"<TR><TD width='11%' bgcolor='#DFFFDF' class='table_body'>OD</TD>"
         								...
         								+"<TD width='8%' bgcolor='#DFFFDF' class='table_body'><div align='center'><input yyorder='4' ljxj='ljxj' value='' name='contactGlassPos["+Subtr(1,listindex)+"].sopcjmpgod' onKeyPress='EnterDown(this)' enter='enter"+(enternum++)+"'  class='text_input60' size='4' maxlength='10'></div></TD>"
                                        ...
                                        +"<c:forEach var='optionParamPoTmp' items='${optionParamPolist}' >"
	                                     ...
	                                     +" </c:if>"	                                      	
                                      +"</c:forEach>"
											+"</select></div></TD><TD width='8%' bgcolor='#DFFFDF' class='table_body'><div align='center'><input yyorder='4' ljxj='ljxj' value='' name='contactGlassPos["+Subtr(1,listindex)+"].sopcremarkod' onKeyPress='EnterDown(this)' enter='enter"+(enternum++)+"'  class='text_input60' maxlength='100'></div></TD></TR>"    
									+"<TR><TD width='11%' bgcolor='#DFFFDF' class='table_body'>OS</TD>"
         								...
         								+"<TD width='8%' bgcolor='#DFFFDF' class='table_body'><div align='center'><input yyorder='4' ljxj='ljxj' value='' name='contactGlassPos["+Subtr(1,listindex)+"].sopcjmpgos' onKeyPress='EnterDown(this)' enter='enter"+(enternum++)+"'  class='text_input60' size='4' maxlength='10'></div></TD>"
                                      ...
                                      +"</c:forEach>"
	         						  ...
	         						  +"<TD width='8%' bgcolor='#DFFFDF' class='table_body'><div align='center'><input yyorder='4' ljxj='ljxj' value='' name='contactGlassPos["+Subtr(1,listindex)+"].sopcremarkos' onKeyPress='EnterDown(this)' enter='enter"+(enternum++)+"'  class='text_input60' maxlength='100'></div></TD>"         								 
	...
	function checkCylZero(){
  	...
  	function cornealContactlLens(){
		$("img").removeAttr("onclick");
		contactGlassForm.action="cornealContactlLensToolHydsy.action?source=cornealContactlLensu";
		contactGlassForm.submit();
	}
</script>
              ...
              <TR>
				...
				<legend>接触镜评估&nbsp;<input name="contactGlassPo.sopcgtryin" ${contactGlassPo.sopcgtryin == '0' ? 'checked=checked':'' } type="radio" value="0" checked="checked"  />&nbsp;试戴
								...
								<table  width="99%" border=0 align=center cellpadding=1 cellspacing=1 class="privateTable privateBorder">
									...
									<table>
									<TR>
										  <TD colspan="14" bgcolor="#FFFFFF" class="Privateborder"><div align="left">试戴</div>  <img align='right' src='${ctx }/img/newbtn/btn_delete_0.png' btn=btn title='删除' ln="${status.index+1 }" onclick="javascript:deletechu(1,this);"></TD>
                                    </TR>
									<tr >
								    ...
								    <TD class="table_body" ><div align="center">角膜评估</div></TD>								    								    
                                    ...
                                    <TR>
                                      ...
                                      <TD width="20%" class="table_none">
                                         <input name="contactGlassPos[${status.index}].sopcgadditionalod" value="${pom.sopcgadditionalod }" class='text_input60' size="4">
                                         <input name="contactGlassPos[${status.index}].sopcgcylod" value="${pom.sopcgcylod }" class='text_input60' size="4">
                                         <input name="contactGlassPos[${status.index}].sopcgaxeod" value="${pom.sopcgaxeod }" class='text_input60' size="4">
                                      </TD>
                                      
                                      <TD width="6%"  class="table_none">
                                        <div align="center">
                                         <input name="contactGlassPos[${status.index}].sopcjmpgod" value="${pom.sopcjmpgod }" class="text_input" size="4" maxlength="10">
                                        </div></TD>
                                 ...
                                 <TD width="8%"  class="table_none"><div align="center">
                                      ...
                                      <TD width="8%"  class="table_none"><div align="center">
                                        <input name="contactGlassPos[${status.index}].sopcremarkod" class="text_input" size="4" value="${pom.sopcremarkod}" maxlength="100">
                                      </div></TD>
                                    ...
                                    <TR>
                                      ...
                                      <TD class="table_none">
                                         <input name="contactGlassPos[${status.index}].sopcgadditionalos" value="${pom.sopcgadditionalos }" class='text_input60' size="4">
                                         <input name="contactGlassPos[${status.index}].sopcgcylos" value="${pom.sopcgcylos }" class='text_input60' size="4">
                                         <input name="contactGlassPos[${status.index}].sopcgaxeos" value="${pom.sopcgaxeos }" class='text_input60' size="4">
                                      </TD>
                                      
                                      <TD class="table_none">
                                        <div align="center">
                                         <input name="contactGlassPos[${status.index}].sopcjmpgos" value="${pom.sopcjmpgos }" class="text_input" size="4" maxlength="10">
                                        </div></TD>
                                 ...
                                 <TD class="table_none"><div align="center">
                                      ...
                                      <TD class="table_none"><div align="center">
                                        <input name="contactGlassPos[${status.index}].sopcremarkos" class="text_input" size="4" value="${pom.sopcremarkos}" maxlength="100">
                                      </div></TD>
