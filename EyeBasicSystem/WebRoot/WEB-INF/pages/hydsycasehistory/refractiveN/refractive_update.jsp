...
<html>
	...
	function save(){
		...
		if(checkForm(refractiveForm))
		{
			...
			refractiveForm.action="refractiveUpdateHydsy.action";
	...
	function doubleEyeFun(){
		$("img").removeAttr("onclick");
		refractiveForm.action="doubleEyeFunToolHydsy.action?source=doubleeyefuniou";
		refractiveForm.submit();
	}
	function specialCheck(){
		$("img").removeAttr("onclick");
		refractiveForm.action="specialCheckToolHydsy.action?source=specialcheckiou";
		refractiveForm.submit();
	}
