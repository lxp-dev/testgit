...
<script>
	...
	function save(){
		if(checkForm(document.all.registerDepartmentForm)){	
			...
			registerDepartmentForm.action = "insertWeiXinRegisterDepartmentPo.action";
                ...
                vAlign=top><DIV id=tabContent__1>
                  <DIV>
                    ...
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        <TR>
						 <TD class="table_body" width="10%" height="30" align="right">微信账号原始ID</TD>
                        ...
                        <TR>
						 <TD class="table_body" height="30" align="right">注册部门</TD>
			             <TD class="table_none" colspan="5">
