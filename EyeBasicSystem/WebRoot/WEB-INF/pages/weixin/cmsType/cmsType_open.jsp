...
function search(){
	...
	cmsTypeOpenForm.action = "initCmsTypeOpen.action?isOpen=${param.isOpen}";
	cmsTypeOpenForm.submit();		
	showLoadingBar();
}
</script>
<body ${sessionScope.systemParameterPo.fsprightshowurl eq '1' ? 'onkeydown="KeyDown()" oncontextmenu="event.returnValue=false" onhelp="Showhelp();return false;"' : '' }>
<form name="cmsTypeOpenForm" method="post" action="">
                      ...
                      <TBODY>
                        ...
                        <TR class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">
		                  <TD height="26">
				          	<c:choose>
				          		<c:when test="${param.isOpen=='1'}">
				          			<img src="${ctx }/img/newbtn/select_0.png" btn=btn title='选择' onClick="setValue('${po.wcmstid}', '${po.wcmstname}');">	
				          		</c:when>
				          		<c:otherwise>
									<input type="checkbox" id="chk" departmentid="${po.wcmstid}" onClick="setValues();" value="{'bdpdepartmentid':'${po.wcmstid}','bdpdepartmentname':'${po.wcmstname}'}">
				          		</c:otherwise>
				          	</c:choose>		                  
                          </TD>	
