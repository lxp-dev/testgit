...
<script>
	...
	function save(){
		if(checkForm(document.all.cmsContentForm)){	
			$("img").removeAttr("onclick");   
			cmsContentForm.action = "updateWeiXinCmsContentPo.action";
			cmsContentForm.submit();
		}
	}
</script>
...
<DIV>
<form name="cmsContentForm" method="post" action="">
<input type="hidden" name="type" id="type" value="" /> 
<input type="hidden" name="moduleID" value="${requestScope.moduleID}">
<input type="hidden" name="weiXinCmsContentPo.wcmscid" value="${weiXinCmsContentPo.wcmscid }" /> 
                    ...
                    <table width="100%" border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>    
                        <TR>
			             ...
			             <TD class="table_none">
						  	<select id="wcmsctypeid" name="weiXinCmsContentPo.wcmsctypeid" validate="[{'Type' : Type.String, 'Formula' : Formula.notNull, 'Message' : '文章类型不能为空！'}]">
						  		<option value="">----请选择----</option>
						  		<s:iterator value="weiXinCmsTypeList">
								<option value="${wcmstid}" ${wcmstid eq weiXinCmsContentPo.wcmsctypeid ? 'selected="selected"' : '' } >${wcmstname}</option>
	     	               		</s:iterator>
							</select>
                        ...
                        <TR>
						  ...
						  <td class="table_none">
                            <input type="hidden" class="text_input300" name="weiXinCmsContentPo.wcmscpicurl" id="wcmscpicurl" value="${weiXinCmsContentPo.wcmscpicurl2}" readonly="readonly"/>
                        ...
                        <TR>
						  ...
						  <td class="table_none">
                            <div id="wcmscpicurlDiv">
				               	<c:if test="${weiXinCmsContentPo.wcmscpicurl ne ''}" >
				               		<p><img src="${ctx}${weiXinCmsContentPo.wcmscpicurl}" width="300" height="200" border="0" title='点击查看大图' width2="600" height2="400" onclick="imgclick(this)" style="cursor: hand;" /><a style='cursor:hand' onclick=deleteServerFile(this,"${weiXinCmsContentPo.wcmscpicurl}","wcmscpicurl");>删除</a></p>
				               	</c:if>
			               	</div>                            
                          </td>
                        </TR>                        
                        ...
                        <TR>
                          <TD>
                          	...
                          	<li class="horizontal_onlyRight"><input id="stateFlag" name="stateFlag" type="checkbox" value="1" ${weiXinCmsContentPo.wcmscflag eq '1'? ' checked':''}></li>发布
						  </TD>
                        </TR>                                             
                      </TBODY>
                    </TABLE>
