...
<input name="weiXinDoctorAppraisalPo.wdainspectionid" id="wdainspectionid" type="hidden" value="${sopipid}" readonly="readonly"/>
		...
		<div class="xf_ctinner ">
			...
			<div class="zjjs pt1">
				<ul>
					...
					<li class="zjjs6">
						<span>
							<img src="${ctx}/weixin/images/doctors/persondefault.png" alt="" /><i>${po.wdacustomername}</i>
						</span>
						<p>
						${po.wdacontent }
						</p>
