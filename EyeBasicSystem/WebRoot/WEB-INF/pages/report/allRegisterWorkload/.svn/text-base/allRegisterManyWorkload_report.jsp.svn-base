...
<script>	
	function search(){
		...
		if(ShopCode=="" ){
			alert('请选择部门!');
			document.getElementById("bdpdepartmentname").focus();
			return false;
		}
		if(BeginDate==""){
			alert('请选择日期!');
		...
		var DataURL = "report.action?reportlet=treims/sales_registrationDeskManyStoreRpt.cpt&shopCode="+ShopCode+"&begDate="+BeginDate+"&endDate="+End;                      
        window.open (DataURL,'挂号台人员工作量统计表多店', 'fullscreen=no, top=150,left=150, toolbar=no, menubar=no, scrollbars=yes, location=no, status=no,resizable=yes'); 
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD align="left" width="45%">目前操作功能：挂号台工作量统计(多店)</TD>
            <TD align=right></TD>
          </TR>
          <TR>
                      ...
                      <TBODY>
					  	<TR>
                           ...
                           <li class="horizontal_onlyRight">
						   		<input class="text_input300" id="bdpdepartmentname" name="selDepartmentName" readonly="readonly" value="${selDepartmentName}"/>
						   ...
						   <li class="horizontal_onlyRight">
					  				 <img btn=btn src="${ctx }/img/newbtn/btn_today_0.png" btn=btn title="今天" onClick="today('startTime','endTime')"></li>
						   <li class="horizontal_onlyRight">
                            <img btn=btn src="${ctx }/img/newbtn/btn_month_0.png" btn=btn title="当月" onClick="currtMonth('startTime','endTime')"></li>
