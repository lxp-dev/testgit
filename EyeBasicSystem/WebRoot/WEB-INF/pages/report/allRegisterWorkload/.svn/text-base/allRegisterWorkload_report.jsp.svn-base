...
<script>	
	function search(){
		...
		url+="eims_reporting/sales_allRegisterWorkloadRpt&shopcode=''&begintime="+BeginDate+"&endtime="+End+"&rs:Command=Render";
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：挂号台工作量统计表（单店）</TD>
            <TD>&nbsp;</TD>
          </TR>
          <TR>
					...
					<table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        ...
                        <TR>
			               ...
			               <TD class="table_none">
                               <input type="radio" id="showCondition" value="1"/>是
                               <input type="radio" id="showCondition" value="0" checked="checked"/>否
			               </TD>
                        </TR>
                      </TBODY>
                    </TABLE>
