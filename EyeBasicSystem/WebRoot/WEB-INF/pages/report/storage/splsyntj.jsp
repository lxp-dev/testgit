...
<script>
	...
	function search(){
		...
		var DataURL = "report.action?reportlet=storage_splsyntjRpt.cpt&__bypagesize__=false&logincompanyid="+'${person.personcompanyid}'+"&departmentsID="+ShopCode+"&bgnDate="+BeginDate+"&endDate="+End+"&reportID=${moduleID}"+"&ShopCodeName="+EncodeUtf8(ShopCodeName)+'&isShow='+isShow; 
		...
		document.getElementById('popupTitle').innerHTML="【产品零售财物月内毛利统计】";
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：产品零售财物月内毛利统计</TD>
            <TD>&nbsp;</TD>
          </TR>
          <TR>
