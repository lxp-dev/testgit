...
<script>
	...
	function search(){
		...
		var DataURL = "report.action?reportlet=sales_salerAchievementCount.cpt&logincompanyid="+'${person.personcompanyid}'+"&shopcode="+ShopCode+"&bgndate="+BeginDate+"&enddate="+End+"&departmentNames="+departmentNames+'&isShow='+isShow; 
		...
		document.getElementById('popupTitle').innerHTML="【营业员销售业绩统计表】";
	}
	function clean(){
		goodsForm.reset();
	}
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：营业员销售业绩统计表 </TD>
            <TD>&nbsp;</TD>
          </TR>
          <TR>
                ...
                vAlign=top><DIV id=tabContent__1>
				  ...
				  <table width="100%" id="title0"  border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
					...
					<div class="reportHelp">															
						1.用&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;途：统计门店在某时间内的商品销售情况，并按营业员进行分组显示<br/>													
