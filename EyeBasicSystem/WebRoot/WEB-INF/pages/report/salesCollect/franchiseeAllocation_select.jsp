...
<script>
	...
	function search(){
		...
		var DataURL = "report.action?reportlet=jsl_pifaxiaoshoumaolitongjiRpt.cpt&shopCode="+ShopCode+"&bgnDate="+BeginDate+"&endDate="+End+"&departmentName="+EncodeUtf8($('#departmentName').val()); 
		...
		document.getElementById('popupTitle').innerHTML="【批发销售毛利统计表(客户批发调拨)】";
	...
	function openDepartment(){
		...
		var topCols = top.document.getElementById("btmframe").cols;
		if(is_iPad()){
			showPopWin("selManyFranchiseeOpen.action?moduleID=${moduleID}",970,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}else{
			showPopWin("selManyFranchiseeOpen.action?moduleID=${moduleID}",screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：批发销售毛利统计表(客户批发调拨) </TD>
