...
<script>
	...
	function search(){
		...
		var DataURL = "report.action?reportlet=jsl_SalesStoreReceiptFormManyStoreRpt.cpt&shopCode="+ShopCode+"&bgnDate="+BeginDate+"&endDate="+End+"&departmentName="+EncodeUtf8($('#departmentName').val()); 
		...
		document.getElementById('popupTitle').innerHTML="【门店销售收款方式明细表多店 】";
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：门店销售收款方式明细表(多店)</TD>
