...
<script>
	...
	function search(){
		...
		var DataURL = "report.action?reportlet=jsl_posxiaofeientryRpt.cpt&shopCode="+ShopCode+"&bgnDate="+BeginDate+"&endDate="+End+"&departmentName="+EncodeUtf8($('#departmentName').val()); 
		...
		document.getElementById('popupTitle').innerHTML="【收银员交易明细表】";
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：收银员交易明细表 </TD>
				  ...
				  <table width="100%" id="title0"  border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
					...
					<table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        ...
                        <TR>
						   <TD width="10%" height="26" class="table_body">收银员工号</TD>
			               <TD class="table_none" width="40%">
                               <input type="text" id="posID" name="posID" maxlength="25" class="text_input200"/>
			               </TD>
			               <TD width="10%" height="26" class="table_body">商品名称</TD>
			               <TD class="table_none">
			                   <input type="text" id="goodsName" name="goodsName" maxlength="100" class="text_input200"/>
			               </TD>			               
                        </TR>
                      </TBODY>
                    </TABLE>
