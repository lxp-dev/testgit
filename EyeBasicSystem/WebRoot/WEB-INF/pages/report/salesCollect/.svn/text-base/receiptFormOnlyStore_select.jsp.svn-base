...
<script>
	...
	function search(){
		...
		var DataURL = "report.action?reportlet=jsl_SalesStoreReceiptFormOnlyStoreRpt.cpt&shopCode="+ShopCode+"&bgnDate="+BeginDate+"&endDate="+End+"&departmentName="+EncodeUtf8($('#departmentName').val()); 
		...
		document.getElementById('popupTitle').innerHTML="【门店销售收款方式明细表单店 】";
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：门店销售收款方式明细表(单店)</TD>
					...
					<table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                      	<TR>
			               ...
			               <TD class="table_none" width="40%">${person.bdpdepartmentname}
			               <input type="hidden" id="departmentID" value="${person.departmentID}" name="departmentID"/>
			               <input type="hidden" id="departmentName" value="${person.bdpdepartmentname}" name="departmentName"/>
			               </TD>
