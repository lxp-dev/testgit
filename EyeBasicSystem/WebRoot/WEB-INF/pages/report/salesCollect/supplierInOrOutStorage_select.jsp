...
<script>
	...
	function search(){
		var supplierID = $('#departmentID').val();	
		...
		var DataURL = "report.action?reportlet=jsl_supplierinoroutstorageentryRpt.cpt&supplierID="+supplierID+"&bgnDate="+BeginDate+"&endDate="+End+"&goodsCategoryID="+$('#goodscategoryID').val(); 
		...
		document.getElementById('popupTitle').innerHTML="【 商品进货/退货单据汇总表 】";
	...
	function openDepartment(){
		...
		var topCols = top.document.getElementById("btmframe").cols;
		if(is_iPad()){
			showPopWin("selManySupplierOpen.action?moduleID=${moduleID}",970,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}else{
			showPopWin("selManySupplierOpen.action?moduleID=${moduleID}",screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能： 商品进货/退货单据汇总表  </TD>
				  ...
				  <table width="100%" id="title0"  border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
					...
					<table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        ...
                        <TR>
						   <TD width="10%" height="26" class="table_body">商品类型</TD>
