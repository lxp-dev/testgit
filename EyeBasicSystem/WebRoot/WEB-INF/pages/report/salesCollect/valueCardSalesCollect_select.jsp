...
<script>
	...
	function search(){
		...
		var DataURL = "report.action?reportlet=jsl_chuzhikaxiaofeihuizongRpt.cpt&shopCode="+ShopCode+"&bgnDate="+BeginDate+"&endDate="+End+"&departmentName="+EncodeUtf8($('#departmentName').val()); 
		...
		document.getElementById('popupTitle').innerHTML="【储值卡消费汇总表 】";
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：储值卡消费汇总表  </TD>
