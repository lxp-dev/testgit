      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：委外预误期表</TD>
            <TD>&nbsp;</TD>
          </TR>
          <TR>
					...
					<table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
					  	<TR>
                           ...
                           <input class="text_input200" type="text" id="saleid" name="saleid">
			               </TD>
			               <TD height="30" class="table_body">所属部门</TD>
                        ...
                        <TR>
			               ...
			               <TD width="10%" height="30" class="table_body">顾客名称</TD>
			                <TD class="table_none" width="40%">
