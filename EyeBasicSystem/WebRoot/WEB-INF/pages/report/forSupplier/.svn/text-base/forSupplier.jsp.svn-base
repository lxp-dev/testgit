...
<script>	
	function search(){
		...
		if(ShopCode=='1'){
			url+="eims_reporting/storage_forSupplierRpt1&bgndate="+BeginDate+"&enddate="+End+"&rs:Command=Render";
		}else{
			url+="eims_reporting/storage_forSupplierRpt&bgndate="+BeginDate+"&enddate="+End+"&rs:Command=Render";
		}
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：制造商定期评估表</TD>
            <TD>&nbsp;</TD>
          </TR>
          <TR>
