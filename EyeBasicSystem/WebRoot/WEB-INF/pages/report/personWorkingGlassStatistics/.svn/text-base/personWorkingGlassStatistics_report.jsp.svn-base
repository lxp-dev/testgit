...
<script>	
	function search(){
		if(checkForm(document.all.goodsForm)){
			...
			url+="eims_reporting/logistics_personWorkingGlassStatisticsRpt&dateyear="+dateyear+"&datemonth="+datemonth+"&rs:Command=Render"; 
			//window.open (url, 'personWorkingGlassStatisticsRpt', 'fullscreen=no, top=150,left=150, toolbar=no, menubar=no, scrollbars=yes, location=no, status=no,resizable=yes');
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：加工师加工镜片数量统计表</TD>
            <TD>&nbsp;</TD>
          </TR>
          <TR>
