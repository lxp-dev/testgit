...
<script>
	...
	function search(){
		...
		departmentstForm.action = "selManyWarehouseOpen.action";
	...
	function setValue(){ 	         
        ...
        var objValue="";
        var count=0;
        var chktext=$("input[id=warehouseID2]",window.parent.document).val();
		var chkname=$("input[id=warehouseName2]",window.parent.document).val();
        ...
        var t1=	chkname.split(",");
          	...
          	{         		
          		...
          		{	
          			...
          			{
	          			if(temp[i]==$(this).attr("warehouseID"))
	          			{
			              mm=false;
			           }
		           });
		           if(mm)
		           {
		           		if(objValue=="")
		           	 	{
			           		objValue="{'warehouseID':'"+temp[i]+"','warehouseName':'"+t1[i]+"'}";
			         	}else
			         	{
			           		objValue=objValue+","+"{'warehouseID':'"+temp[i]+"','warehouseName':'"+t1[i]+"'}";
			         	}  
			        }
          		}
		}
        ...
        window.parent.openWarehouseValues(objValue);
                    ...
                    <table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        <TR>
			              ...
			              <TD width="23%" class="table_none"><input clean="clean" class="text_input200" id="warehouseid" name="warehouseid" value="${warehouseid}" maxlength="10"></TD>
                          <TD width="10%" height="26" class="table_body">仓位名称</TD>
                          <TD width="23%" class="table_none" colspan="3"><input clean="clean" class="text_input200" id="warehousename" name="warehousename" value="${warehousename}" maxlength="50"/></TD>
                        </TR>
                      ...
                      <TBODY>
						...
						<s:iterator value="warehousePos">	
							<TR class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">
								<TD height="28">
		                          	<input type="checkbox" id="chk" warehouseID="${bwhid}" onClick="setValue();" value="{'warehouseID':'${bwhid}','warehouseName':'${bwhwarehouseName}'}">
		                        </TD>
