	...
	function search(){
		...
		if(begintime == "" || endtime == ""){
			...
			if(checkForm(document.all.goodsForm)){
				...
				var DataURL = "report.action?reportlet=treims/logistics_AllocationSumRpt.cpt&bgnDate="+begindate+"&endDate="+enddate+"&departmentID="+departmentid;                     
    ...
    <TD><!-- ?? Start -->
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          ...
          <TR>
            <TD class=menubar_function_text height=20>目前操作功能：调拨汇总表</TD>
