...
$(document).ready(function() { 
	...
	function search(){
		...
		if(begintime == "" || endtime == ""){
			...
			if ($('#typeID').val() == '1'){
			    DataURL = "report.action?reportlet=L_GoodsInOrOutStorageSumRpt.cpt&departmentID="+departmentid+"&begDate="+begintime+"&endDate="+endtime+'&isShow='+isShow;                     
			}else{
			    DataURL = "report.action?reportlet=L_GoodsInOrOutStorageSumBySupplierRpt.cpt&departmentID="+departmentid+"&begDate="+begintime+"&endDate="+endtime+'&isShow='+isShow;                     
			}
		    
           // window.open (DataURL,'商品收发汇总表', 'fullscreen=no, top=150,left=150, toolbar=no, menubar=no, scrollbars=yes, location=no, status=no,resizable=yes'); 
