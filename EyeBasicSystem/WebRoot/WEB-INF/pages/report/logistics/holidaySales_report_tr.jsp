...
<script>	
	...
	var endtime = document.all.endtime.value;
		if(begintime == "" || endtime == ""){
			...
			var DataURL = "report.action?reportlet=treims/sales_holidaySalesRpt.cpt&begintime="+begindate+"&endtime="+enddate;                      
	        window.open (DataURL,'同期节假日销售对比报表', 'fullscreen=no, top=150,left=150, toolbar=no, menubar=no, scrollbars=yes, location=no, status=no,resizable=yes'); 
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD align="left" width="45%">目前操作功能：门店销售同期对比表</TD>
            <TD align=right>&nbsp;</TD>
          </TR>
         <TR>
