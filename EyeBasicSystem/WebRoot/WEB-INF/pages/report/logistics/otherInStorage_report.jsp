...
<script>	
	...
	var endtime = document.all.endtime.value;
		if(begintime == "" || endtime == ""){
		    ...
		    var DataURL = "report.action?reportlet=L_OtherInStorageSumRpt.cpt&departmentID="+departmentid+"&begDate="+begintime+"&endDate="+endtime;                      
            //window.open (DataURL,'其他入库汇总表', 'fullscreen=no, top=150,left=150, toolbar=no, menubar=no, scrollbars=yes, location=no, status=no,resizable=yes'); 
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：其他入库汇总表</TD>
            <TD>&nbsp;</TD>
          </TR>
          <TR>
					...
					<table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
					  	<TR>
			               ...
			               <TD  height="30" class="table_body">其他入库部门</TD>
