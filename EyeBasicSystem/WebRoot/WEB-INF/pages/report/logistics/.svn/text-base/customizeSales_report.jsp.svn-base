...
<script>	
	function search(){
		...
		if(begintime == "" || endtime == ""){
			...
			if(personType=='1')
			{
				var DataURL = "report.action?reportlet=sales_CustomizeSoSalesRpt.cpt&shopCode="+ShopCode+"&bgndate="+begindate+"&enddate="+enddate;  
			}
			if(personType=='2')
			{
				var DataURL = "report.action?reportlet=sales_CustomizePoSalesRpt.cpt&shopCode="+ShopCode+"&bgndate="+begindate+"&enddate="+enddate;  
			}
			...
			document.getElementById('popupTitle').innerHTML="【定货未结账销售额统计报表】";
			}
		}
	}
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD align="left" width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：定货未结账销售额统计报表</TD>
            <TD align=right>&nbsp;</TD>
          </TR>
         <TR>
				  ...
				  <table width="100%" id="title0"  border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
					...
					<table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                         ...
                         <TR>
						   <TD height="26" class="table_body">统计条件</TD>
