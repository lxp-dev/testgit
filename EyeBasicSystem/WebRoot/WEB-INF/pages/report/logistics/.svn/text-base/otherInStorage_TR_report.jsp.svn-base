...
<script>	
	...
	function search(){
		...
		if(begintime == "" || endtime == ""){
		    ...
		    var DataURL = "report.action?reportlet=treims/L_OtherInStorageSumRpt.cpt&departmentID="+departmentid+"&begDate="+begintime+"&endDate="+endtime+"&categoryid="+goodscategoryID+"&supplierid="+supplierID+"&salestype="+salestype;                      
			...
			document.getElementById('popupTitle').innerHTML="【其他入库汇总表】";
		}
	}
    ...
    <TD><!-- ?? Start -->
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          ...
          <TR>
            <TD class=menubar_function_text height=27>目前操作功能：其他入库汇总表</TD>
