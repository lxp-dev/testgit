...
<script>
	...
	function search(){
		...
		if(begintime == "" || endtime == ""){
		    ...
		    var DataURL = "report.action?reportlet=treims/L_SalesOutStorageBySupplierRpt.cpt&supplierID="+supplierID+"&begDate="+begintime+"&endDate="+endtime+"&departmentID="+departmentid+"&salestype="+salestype;                      
			...
			document.getElementById('popupTitle').innerHTML="【销售出库汇总表(按制造商) 】";
		}
	}
    ...
    <TD><!-- ?? Start -->
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          ...
          <TR>
            <TD class=menubar_function_text height=27>目前操作功能：销售出库汇总表(按制造商) </TD>
