...
<script>	
	function search(){
		...
		var DataURL = "report.action?reportlet=tjyk/sales_mdyxspdhcyjlRpt.cpt&departmentid="+ShopCode+"&bgnDate="+BeginDate+"&endDate="+End;                      
        window.open (DataURL,'门店隐形商品到货查验记录报表', 'fullscreen=no, top=150,left=150, toolbar=no, menubar=no, scrollbars=yes, location=no, status=no,resizable=yes'); 
  ...
  <TR>
    <TD><!-- ?? Start -->
       <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            <TD class=menubar_title width="15%"><img border='0' src='${ctx }/img/pic/module.gif' align='absmiddle' hspace='3' vspace='3'>天津眼科报表</TD>
            <TD align="left" width="45%">目前操作功能：门店隐形商品到货查验记录报表 </TD>
            <TD align=right></TD>
          </TR>
          <TR>
