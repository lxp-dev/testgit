...
<script>	
	...
	var endtime = document.all.endtime.value;
		if(begintime == "" || endtime == ""){
			...
			var DataURL = "report.action?reportlet=sales_FrameCountRpt.cpt&begintime="+begindate+"&endtime="+enddate;                      
	        //window.open (DataURL,'回访汇总表', 'fullscreen=no, top=150,left=150, toolbar=no, menubar=no, scrollbars=yes, location=no, status=no,resizable=yes'); 
			...
			document.getElementById('popupTitle').innerHTML="【框镜统计表】";
			}
		}
	}
	function clean(){
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD align="left" width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：框镜统计表	</TD>
            <TD align=right>&nbsp;</TD>
          </TR>
         <TR>
