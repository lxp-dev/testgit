...
<script>	
	...
	var endtime = document.all.endtime.value;
		if(begintime == "" || endtime == ""){
		    ...
		    var DataURL = "report.action?reportlet=treims/L_NetSales.cpt&startdate="+begintime+"&enddate="+endtime+"&salestype="+salestype;                       
			...
			document.getElementById('popupTitle').innerHTML="【代销款转应付账款】";
		}
	}
	function clean(){
					...
					<table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
					  	<TR>
			               ...
			               <TD class="table_body" width="8%">经销方式</TD>
			               <TD class="table_none">
                            <select id="salestype" name="salestype">
								<option value="">----请选择----</option>
								<option value="jxfs1">代销</option>
								<option value="jxfs12">数期</option>
								<option value="jxfs13">买断</option>
							</select>
			               </TD>
                        </TR>
                      </TBODY>
