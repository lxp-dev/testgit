...
<script>	
	...
	if(ShopCode == ''){
		...
		if(begintime == "" || endtime == ""){
			...
			var DataURL = "report.action?reportlet=sales_dayMonthSalesEntryRpt.cpt&__bypagesize__=false&logincompanyid="+'${person.personcompanyid}'+"&bgndate="+begindate+"&enddate="+enddate+"&departmentsID="+ShopCode+"&departmentNames="+departmentNames+'&isShow='+isShow;                      
			...
			document.getElementById('popupTitle').innerHTML="【日月销售门店汇总表】";
			}
		}
	}
	function clean(){
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD align="left" width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：日月销售门店汇总表	</TD>
            <TD align=right>&nbsp;</TD>
          </TR>
         <TR>
                ...
                vAlign=top><DIV id=tabContent__1>
				  ...
				  <table width="100%" id="title0"  border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
					...
					<div class="reportHelp">															
						1.用&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;途：统计某时间段内的各门店按商品类别销售的数据。<br/>													
