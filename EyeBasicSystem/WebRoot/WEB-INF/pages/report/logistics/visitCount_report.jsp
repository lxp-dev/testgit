...
<script>	
	function search(){
		...
		if(begintime == "" || endtime == ""){
			...
			var DataURL = "report.action?reportlet=sales_visitCountRpt.cpt&begintime="+begindate+"&endtime="+enddate+'&isShow='+isShow;                       
			...
			if(is_iPad()){
				...
				document.getElementById('popupTitle').innerHTML="【回访汇总表】";
			}
		}
	}
	function clean(){
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD align="left" width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：回访汇总表	</TD>
            <TD align=right>&nbsp;</TD>
          </TR>
         <TR>
