	...
	function search(){
		...
		if(begintime == "" || endtime == ""){
			...
			if(checkForm(document.all.goodsForm)){
				...
				url+="eims_reporting/logistics_ProcurementReturnRpt&bgnDate="+begindate+"&endDate="+enddate+
				"&goodsCategoryID="+goodsquantityid+"&departmentID="+departmentid+"&rs:Command=Render"; 
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：采购入库单(退单)汇总表</TD>
            <TD>&nbsp;</TD>
          </TR>
          <TR>
