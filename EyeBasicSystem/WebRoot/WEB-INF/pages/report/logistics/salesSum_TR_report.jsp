...
<script>	
	...
	var endtime = document.all.endtime.value;
		if(begintime == "" || endtime == ""){
		    ...
		    var DataURL = "report.action?reportlet=treims/L_SalesOutStorageByDptTRRpt.cpt&departmentID="+departmentid+"&begDate="+begintime+"&endDate="+endtime+"&salestype="+salestype;                       
			...
			document.getElementById('popupTitle').innerHTML="【销售汇总表】";
		}
	}
	function clean(){
    ...
    <TD><!-- ?? Start -->
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          ...
          <TR>
            <TD class=menubar_function_text height=20>目前操作功能：销售汇总表</TD>
