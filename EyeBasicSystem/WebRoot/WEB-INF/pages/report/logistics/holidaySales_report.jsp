...
<script>	
	function search(){
        ...
        var departmentNames = EncodeUtf8(document.getElementById("bdpdepartmentname").value);
        if(departmentNames == ''){
			departmentNames = EncodeUtf8($("#dnames").val());
		}
        
        var salesTypeName = EncodeUtf8(getSelectText("salesType"));
		...
		var DataURL = "report.action?reportlet=sales_holidaySalesRpt.cpt&__bypagesize__=false&logincompanyid="+'${person.personcompanyid}'+"&departmentsID="+ShopCode
				+"&begintime="+BeginDate+"&endtime="+End+"&salesType="+salesType
				+"&departmentNames="+departmentNames+"&salesTypeName="+salesTypeName+'&isShow='+isShow;                      
		...
		document.getElementById('popupTitle').innerHTML="【门店销售业绩同期对比表 】";
	}
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD align="left" width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：门店销售业绩同期对比表  </TD>
            <TD align=right>&nbsp;</TD>
          </TR>
           <TR>
                ...
                vAlign=top><DIV id=tabContent__1>
				  ...
				  <table width="100%" id="title0"  border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                      ...
                      <TBODY>
					  	...
					  	<TR>
			               ...
			               <c:if test="${person.departmenttype != 1}">
                            ...
                            <input type="hidden" id="bdpdepartmentname" value="${person.bdpdepartmentname}"/>
      	                   </c:if>
			               </TD>
					...
					<div class="reportHelp">															
						1.用&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;途：统计指定门店的特定日期内的销售同期对比情况<br/>													
						2.查询条件：销售门店：文本域显示可选择。门店人员使用时为只读只显示本门店<br/>														
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;日&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;期：为日期段，查询最早为上一天。门店人员使用时只能按特定时间段查询<br/>																										
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;销售类型：5种销售类型	<br/>																											
						3.查询结果：销售流水：配镜单的销售金额合计<br/>														
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;配镜副数：配镜单的数量<br/>													
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;平均单价：销售流水/配镜副数<br/>														
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;验光人数：验光数量<br/>
					</div>														
