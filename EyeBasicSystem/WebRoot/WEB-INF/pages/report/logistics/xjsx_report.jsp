...
<script>	
	...
	function search(){
		...
		var DataURL = "report.action?reportlet=tjyk/sales_xjsx.cpt&__bypagesize__=false&bgnDate="+BeginDate+"&endDate="+End;
		window.open (DataURL, 'sales_xjsx', 'fullscreen=no, top=150,left=150, toolbar=no, menubar=no, scrollbars=yes, location=no, status=no,resizable=yes');
	}
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD align="left" width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：现金、赊销销售分析表</TD>
            <TD align=right>&nbsp;</TD>
          </TR>
          <TR>
