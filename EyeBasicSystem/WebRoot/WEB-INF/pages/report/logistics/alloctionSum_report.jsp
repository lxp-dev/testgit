...
<script>	
	...
	var endTime = document.all.endTime.value;
		if(startTime == "" || endTime == ""){
			...
			url+="eims_reporting/logistics_AllocationSumRpt&bgnDate="+begindate+"&endDate="+enddate+"&departmentID="+departmentid+"&rs:Command=Render"; 
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：调拨汇总表</TD>
            <TD>&nbsp;</TD>
          </TR>
          <TR>
