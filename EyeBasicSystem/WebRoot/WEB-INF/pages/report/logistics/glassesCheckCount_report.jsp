...
<script>	
	...
	var dopersonid=$('#dopersonid').val();
		...
		if(begindate == ""){
			...
			if(checkForm(document.all.goodsForm)){
				var DataURL = "report.action?reportlet=sales_glassescheckcount.cpt&begintime="+begindate+"&endtime="+enddate+"&dopersonid="+dopersonid;                      
	...
	function clean(){
		...
		document.getElementById("dopersonid").value = "";
	}
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD align="left" width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：配镜评估统计表 </TD>
            <TD align=right>&nbsp;</TD>
          </TR>
         <TR>
					...
					<table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
					  	<TR>
			               ...
			               <TD  height="30" class="table_body">加工师</TD>
			               <TD  class="table_none" colspan="3">
			                <select id="dopersonid" name="dopersonid">
                             	<option value="">----请选择----</option>
      		                 	<c:if test="${not empty(workingDopersonList)}">
				               	 <s:iterator value="workingDopersonList">
                    	           	<OPTION value="${id}">${personName}</OPTION>
                    	         </s:iterator>
                    	        </c:if>
      	                   	</select>
			               </TD>
