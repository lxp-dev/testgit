...
<script>	
	function search(){
        ...
        var bgirefractive = $('#bgirefractive').val();
		if(BeginDate==""){
			alert('请选择日期!');
		...
		if(End==""){
			...
			var DataURL = "report.action?reportlet=sales_LensSalesRpt.cpt&departmentsID="+ShopCode+"&begintime="+BeginDate+"&endtime="+End+"&Refractive="+bgirefractive+"&supplierID="+supplierID+"&BandID="+brandID;                      
			...
			document.getElementById('popupTitle').innerHTML="【镜片销售统计报表】";
	}
	...
	function openBrand(){
		...
		if(is_iPad()){
			showPopWin("selBrandOpen.action?categoryID_open=3&supplierID_open=" + supplierID,970,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}else{
			showPopWin("selBrandOpen.action?categoryID_open=3&supplierID_open=" + supplierID,screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD align="left" width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：镜片销售统计报表</TD>
            <TD align=right>&nbsp;</TD>
          </TR>
         <TR>
                        ...
                        <TR>
                         ...
                         <TR>
			               ...
			               <TD  class="table_none" colspan="3">
                            	<select id="bgirefractive" clean=clean name="bgirefractive">
