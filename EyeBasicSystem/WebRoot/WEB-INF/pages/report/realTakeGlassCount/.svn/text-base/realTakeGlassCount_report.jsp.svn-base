...
<script>	
	function search(){
		...
		var departmentName = EncodeUtf8(document.getElementById("departmentName").value);
	    ...
	    var DataURL = "report.action?reportlet=sales_getBackEyeglassPersonOnlyStoreRpt.cpt&shopCode="+ShopCode+"&begDate="+BeginDate+"&endDate="+End+"&departmentName="+departmentName+'&isShow='+isShow; 
		...
		document.getElementById('popupTitle').innerHTML="【取镜员工作量统计报表(单店)】";
	}
	function clean(){
		goodsForm.reset();
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          ...
          <TR>
            ...
            <TD align="left" width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：取镜人员工作量统计表（单店）</TD>
            <TD align=right>&nbsp;</TD>
          </TR>
          <TR>
                      ...
                      <TBODY>
                        <TR>			          
			               ...
			               <c:if test="${person.departmenttype!=1}">
                            ...
                            <input type="hidden" id="departmentName" value="${person.bdpdepartmentname}"/>
      	                   </c:if>
			               </TD>
