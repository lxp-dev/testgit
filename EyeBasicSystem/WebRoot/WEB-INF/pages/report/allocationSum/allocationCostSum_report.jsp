...
$(document).ready(function() { 
	...
	function search(){
		...
		if($("select[id=selecttype]").val() == '1'){
			var DataURL = "report.action?reportlet=storage_allocationCostSumRpt.cpt&departmentid="+ShopCode
					+"&bgnDate="+BeginDate
			...
			var DataURL = "report.action?reportlet=storage_allocationCostDistrisRpt.cpt&billDateStart="+BeginDate
		...
		if($("select[id=selecttype]").val() == '1'){
			document.getElementById('popupTitle').innerHTML="【调拨汇总成本表】";
		}else{
			document.getElementById('popupTitle').innerHTML="【调拨明细成本表】";
		}
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：调拨成本统计表</TD>
            <TD>&nbsp;</TD>
          </TR>
          <TR>
