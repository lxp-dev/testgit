...
<script>
	...
	function search(){
		...
		var DataURL = "report.action?reportlet=lead_StoreSalesResult.cpt&__bypagesize__=false&shopCode="+ShopCode+"&bgnDate="+BeginDate+"&endDate="+End+"&salesType="+salesType; 
		...
		document.getElementById('popupTitle').innerHTML="【门店销售业绩统计报表】";
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：门店销售业绩统计报表</TD>
            <TD>&nbsp;</TD>
          </TR>
          <TR>
...
1.查询条件:查询日期(必选)、销售门店在不选取任何门店的前提下默认为全部门店。<br/>
2.根据选择的销售门店、日期和销售类型统计各门店每种类型的商品销售情况。<br/>																			
					</div>														
			</c:if>		
                  </DIV>
                </DIV>
