...
<script>
	...
	function search(){
		if(checkForm(goodsForm)){
			...
			var DataURL = "report.action?reportlet=lead_SpecialDiscount.cpt&logincompanyid="+'${person.personcompanyid}'+"&shopCode="+ShopCode+"&bgnDate="+BeginDate+"&endDate="+End+"&discountRate="+discountRate+"&departmentName="+EncodeUtf8(departmentName)+"&ShopCodeName="+EncodeUtf8(ShopCodeName)+'&isShow='+isShow; 
			...
			document.getElementById('popupTitle').innerHTML="【特殊折扣报表】";
		}		
	}
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：特殊折扣报表</TD>
            <TD>&nbsp;</TD>
          </TR>
          <TR>
				  ...
				  <table width="100%" id="title0"  border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
					...
					<table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        ...
                        <TR>
						   <TD height="26" class="table_body">折扣率(低于)</TD>
			               <TD class="table_none">
                               <input class="text_input100" type="text" id="discountRate" name="discountRate" validate="[{'Type' : Type.String, 'Formula' : Formula.FloatORNULL, 'Message' : '请重新填写折扣率！'}]"/>
			               </TD>
...
1.查询条件：销售门店(必选)、查询日期段(必选)、折扣率<br/>						
2.销售门店列表：包含所有未停用的门店<br/>
3.报表根据门店和日期对单个销售门店进行统计低于或等于折扣率的配镜单信息<br/>
4.来源:在销售时，配镜单中填写的备注<br/>				
