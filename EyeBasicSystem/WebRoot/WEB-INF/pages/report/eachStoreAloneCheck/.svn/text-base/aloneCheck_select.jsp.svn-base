...
<script>	
	function search(){
		...
		var DataURL = "report.action?reportlet=L_EachStoreAloneAccounts.cpt&departmentid="+ShopCode+"&startTime="+BeginDate+"&endTime="+End;
		...
		document.getElementById('popupTitle').innerHTML="【各店独立核算报表】";
	}
	function clean(){
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD align="left" width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：各店独立核算报表</TD>
            <TD align=right>&nbsp;</TD>
          </TR>
          <TR>
