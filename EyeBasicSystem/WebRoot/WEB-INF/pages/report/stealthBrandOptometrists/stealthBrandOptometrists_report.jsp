...
<script>	
	function search(){
		...
		url+="eims_reporting/sales_stealthBrandOptometrists1&shopCode="+ShopCode+"&beginTime="+BeginDate+"&endTime="+End+"&rs:Command=Render";
		window.open (url, 'stealthBrandOptometrists1', 'fullscreen=no, top=150,left=150, toolbar=no, menubar=no, scrollbars=yes, location=no, status=no,resizable=yes');
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD align="left" width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：隐形品种统计表一（验光师）</TD>
            <TD align=right>&nbsp;</TD>
          </TR>
          <TR>
					...
					<table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
					  	<TR>
			               ...
			               <TD class="table_none" width="40%">${departmentsPo.bdpdepartmentname}
