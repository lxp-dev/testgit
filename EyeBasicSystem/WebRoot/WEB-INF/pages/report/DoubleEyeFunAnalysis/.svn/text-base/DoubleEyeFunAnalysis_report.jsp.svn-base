...
<script>	
	...
	function search(){
		...
		//if (ShopCode == '01'){
			url+="eims_reporting/sales_DoubleEyeFunAnalysisRpt2&bgnDate="+BeginDate+"&endDate="+End+"&shopcode="+ShopCode+"&rs:Command=Render";
			//	}else{
		//	url+="eims_reporting/sales_DoubleEyeFunAnalysisRpt&bgnDate="+BeginDate+"&endDate="+End+"&shopcode="+ShopCode+"&rs:Command=Render";
	    //}
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD align="left" width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：验光师双眼视功能病历完整性分析表</TD>
            <TD align=right>&nbsp;</TD>
          </TR>
          <TR>
