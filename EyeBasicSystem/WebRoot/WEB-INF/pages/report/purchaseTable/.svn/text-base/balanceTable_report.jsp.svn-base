...
$(document).ready(function() { 
	...
	var ji =document.all.ji.value;
		if(begintime == ""){
			...
			url+="eims_reporting/logistics_balanceTableRpt&checkdate="+begindate+
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能： 结存统计表 </TD>
            <TD>&nbsp;</TD>
          </TR>
          <TR>
					...
					<table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
					  	<TR>
			               ...
			               <TD width="10%" height="30" class="table_body">类别</TD>
			               <TD class="table_none" width="40%">
							<select id="ji" name="ji">
							<option value="">请选择级次</option>
                        ...
                        <TR>
			               ...
			               <li class="horizontal_onlyRight">
						   		<input class="text_input200" type="text"  id="supplierName2" name="supplierName" value="${requestScope.supplierName}" readonly="readonly">
