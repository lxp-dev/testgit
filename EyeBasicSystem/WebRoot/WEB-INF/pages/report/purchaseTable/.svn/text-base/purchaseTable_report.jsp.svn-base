...
$(document).ready(function() { 
	...
	var ji =document.all.ji.value;
		if(begintime == "" || endtime == ""){
			...
			url+="eims_reporting/logistics_purchaseTableRpt&begindate="+begindate+"&enddate="+enddate+
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD align="left" width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：采购汇总表</TD>
            <TD align=right>&nbsp;</TD>
          </TR>
          <TR>
