...
<script>	
	function search(){
		...
		url+="eims_reporting/sales_subscriptionRpt&shopCode="+ShopCode+"&beginTime="+BeginDate+"&endTime="+End+"&rs:Command=Render";
		//window.open (url, 'subscriptionRpt', 'fullscreen=no, top=150,left=150, toolbar=no, menubar=no, scrollbars=yes, location=no, status=no,resizable=yes');
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：订金报表</TD>
            <TD>&nbsp;</TD>
          </TR>
          <TR>
