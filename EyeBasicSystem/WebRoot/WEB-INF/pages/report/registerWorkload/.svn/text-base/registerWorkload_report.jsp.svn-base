...
<script>	
	function search(){
		...
		var DataURL = "report.action?reportlet=treims/sales_registrationDeskOnlyStoreRpt.cpt&shopCode="+ShopCode+"&begDate="+BeginDate+"&endDate="+End;                      
        window.open (DataURL,'挂号台工作量统计表单店', 'fullscreen=no, top=150,left=150, toolbar=no, menubar=no, scrollbars=yes, location=no, status=no,resizable=yes'); 
       ...
       <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD align="left" width="45%">目前操作功能：挂号台工作量统计表（单店）</TD>
            <TD align=right></TD>
          </TR>
          <TR>
