...
<script>	
	function search(){
		...
		url+="eims_reporting/sales_OptometryTypeSumRpt";
		if(document.getElementById('departmentid').value!=''){
			url+="&shopcode="+document.getElementById('departmentid').value;
		}
		url+="&startTime="+BeginDate;
		url+="&endTime="+End;
		url+="&rs:Command=Render";
		window.open (url, 'OptometryTypeSum', 'fullscreen=no, top=150,left=150, toolbar=no, menubar=no, scrollbars=yes, location=no, status=no,resizable=yes');
	}
	function clean(){
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD align="left" width="45%">目前操作功能：挂号台收费统计表（单店）</TD>
            <TD align=right></TD>
          </TR>
          <TR>
