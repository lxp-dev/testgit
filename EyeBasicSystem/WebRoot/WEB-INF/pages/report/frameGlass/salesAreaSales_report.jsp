...
<script>
	...
	function search(){
		...
		if(is_iPad()){
			DataURL = "report.action?reportlet=sales_SunGlassesSalesByRpt.cpt&logincompanyid="+'${person.personcompanyid}'+"&departmentsID="+ShopCode+"&bgnDate="+BeginDate+"&endDate="+End+"&priceArea="+area+"&reportID=${moduleID}"+"&lb="+salesType+"&ShopCodeName="+EncodeUtf8(ShopCodeName)+"&QJ="+QJ+'&isShow='+isShow; 
			showPopWin(DataURL,970,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}else{
			DataURL = "report.action?reportlet=sales_SunGlassesSalesByRpt.cpt&__bypagesize__=false&logincompanyid="+'${person.personcompanyid}'+"&departmentsID="+ShopCode+"&bgnDate="+BeginDate+"&endDate="+End+"&priceArea="+area+"&reportID=${moduleID}"+"&lb="+salesType+"&ShopCodeName="+EncodeUtf8(ShopCodeName)+"&QJ="+QJ+'&isShow='+isShow; 
			openWindowForReport(DataURL); 
		}
		document.getElementById('popupTitle').innerHTML="【价位段销售分析报表】";
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：价位段销售分析报表</TD>
					...
					<table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        ...
                        <TR>
			               ...
			               <TD class="table_none" width="40%">
                            <select id="salesType" name="salesType" onchange="cleanSalesArea();">
								<option value="">----请选择----</option>
