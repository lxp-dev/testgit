...
<script>
	...
	function search(){
		...
		if(is_iPad()){
			DataURL = "report.action?reportlet=sales_frameSalesByDpt.cpt&__bypagesize__=false&logincompanyid="+'${person.personcompanyid}'+"&departmentsID="+ShopCode+"&bgnDate="+BeginDate+"&endDate="+End+"&priceArea="+area+"&salesType="+salesType+"&reportID=${moduleID}"+"&ShopCodeName="+EncodeUtf8(ShopCodeName)+"&QJ="+QJ+'&isShow='+isShow; 
			showPopWin(DataURL,970,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}else{			
			DataURL = "report.action?reportlet=sales_frameSalesByDpt.cpt&__bypagesize__=false&logincompanyid="+'${person.personcompanyid}';
			
			var goodsForm = document.getElementById("goodsForm"); 
			var departmentsIDv = document.getElementById("departmentsID");
			var bgnDatev = document.getElementById("bgnDate");
			var endDatev = document.getElementById("endDate");
			var priceAreav = document.getElementById("priceArea");
			var salesTypev = document.getElementById("salesType");
			var ShopCodeNamev = document.getElementById("ShopCodeName");
			var QJv = document.getElementById("QJ");
			var isShowv = document.getElementById("isShow");
			
			departmentsIDv.value = ShopCode;	
			bgnDatev.value = BeginDate;
			endDatev.value = End;
			priceAreav.value = area;
			salesTypev.value = salesType;
			ShopCodeNamev.value = (ShopCode == '' ? '所有门店' : ShopCodeName);
			QJv.value = QJ;
			isShowv.value = isShow;
			
			goodsForm.method="post"; 
			goodsForm.action=DataURL;
			goodsForm.target='store'; 	
			goodsForm.attachEvent("onsubmit",function(){ window.open('about:blank','store','toolbar=0,directories=0,status=0,menubar=0,scrollbars=0,resizable=1,left=0, top=0,width='+(screen.width)+',height='+(screen.height-100)); }); 		
			goodsForm.fireEvent("onsubmit");
			goodsForm.submit();

			return;
		}		
		document.getElementById('popupTitle').innerHTML="【门店销售区间分析表(按销售类型)】";
	}
	function clean(){
		goodsForm.reset();	
	}
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：门店销售区间分析表(按销售类型)</TD>
          ...
          <TD bgColor=#ffffff>
			...
			<c:if test="${systemParameterPo.fspreporthelpshow eq '1'}">		
					...
					<div class="reportHelp">															
						1.用&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;途：可按自定义的价格区间段查询出门店在某时间段内的销售情况（包括销售数量、销售金额、成本、销售毛利）<br/>													
						2.查询条件：部门名称：文本域显示可选择。门店人员使用时为只读只显示本门店。<br/>														
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;日&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;期：为日期段，查询最早为上一天。门店人员使用时只能按特定时间段查询<br/>														
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;价格区间：文本域选择	<br/>													
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;销售类型：5种销售类型	<br/>																												
						3.查询结果：销售副数：配镜单整单数量合计<br/>														
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;销售金额合计：配镜单的销售金额合计<br/>													
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;销售成本合计：销售明细表的不含税成本<br/>														
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;销售毛利率=（销售金额合计-销售成本合计）/销售金额合计<br/>
