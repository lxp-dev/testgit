...
<script>	
	function search(){
		...
		var DataURL = "report.action?reportlet=treims/sales_frameGlassSumRpt.cpt&shopCode="+ShopCode+"&beginTime="+BeginDate+"&endTime="+End;                      
        window.open (DataURL,'框镜销售单据分类表', 'fullscreen=no, top=150,left=150, toolbar=no, menubar=no, scrollbars=yes, location=no, status=no,resizable=yes'); 
	}
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD align="left" width="45%">目前操作功能：框镜销售单据分类表 </TD>
            <TD align=right></TD>
          </TR>
          <TR>
