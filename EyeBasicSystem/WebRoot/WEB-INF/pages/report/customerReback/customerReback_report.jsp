...
<script>	
	function search(){
		...
		url+="eims_reporting/sales_customerReback";
		url+="&startdate="+BeginDate;
		url+="&enddate="+End;
		var optoid = document.getElementById("optoid").value;
		if(optoid==""){	
		}else
		{
		  url+="&optometryerID="+optoid; 
		}
		...
		//window.open (url, 'RealTakeGlassCount', 'fullscreen=no, top=150,left=150, toolbar=no, menubar=no, scrollbars=yes, location=no, status=no,resizable=yes');
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：顾客回访信息表</TD>
            <TD >&nbsp;</TD>
          </TR>
          <TR>
