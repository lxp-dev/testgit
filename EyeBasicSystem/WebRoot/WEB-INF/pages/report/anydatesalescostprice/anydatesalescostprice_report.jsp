...
<script>
	...
	function search(){		
		...
		if(chacktype==1){
		var DataURL = "report.action?reportlet=sales_anydatesalescostprice.cpt&logincompanyid="+'${person.personcompanyid}'+"&beginDate="+BeginDate+"&enddate="+End+"&goodsCategoryID="+goodscategoryID+"&shopCode="+shopCode+"&shopCodeName="+EncodeUtf8(shopCodeName)+"&supplierID="+$('#supplierID').val()+"&supplierName="+EncodeUtf8($('#supplierName').val())+"&brandID="+$('#brandID').val()+"&brandName="+EncodeUtf8($('#brandName').val())+"&goodsID="+$('#goodsCode').val()+"&goodsName="+EncodeUtf8($('#goodsName').val())+'&isShow='+isShow;
		}
		if(chacktype==2){
			var DataURL = "report.action?reportlet=sales_anydatesalescostpricesupplier.cpt&logincompanyid="+'${person.personcompanyid}'+"&beginDate="+BeginDate+"&enddate="+End+"&goodsCategoryID="+goodscategoryID+"&shopCode="+shopCode+"&shopCodeName="+EncodeUtf8(shopCodeName)+"&supplierID="+$('#supplierID').val()+"&supplierName="+EncodeUtf8($('#supplierName').val())+"&brandID="+$('#brandID').val()+"&brandName="+EncodeUtf8($('#brandName').val())+"&goodsID="+$('#goodsCode').val()+"&goodsName="+EncodeUtf8($('#goodsName').val())+'&isShow='+isShow;
		}
		if(chacktype==3){
			var DataURL = "report.action?reportlet=sales_anydatesalescostpricebrand.cpt&logincompanyid="+'${person.personcompanyid}'+"&beginDate="+BeginDate+"&enddate="+End+"&goodsCategoryID="+goodscategoryID+"&shopCode="+shopCode+"&shopCodeName="+EncodeUtf8(shopCodeName)+"&supplierID="+$('#supplierID').val()+"&supplierName="+EncodeUtf8($('#supplierName').val())+"&brandID="+$('#brandID').val()+"&brandName="+EncodeUtf8($('#brandName').val())+"&goodsID="+$('#goodsCode').val()+"&goodsName="+EncodeUtf8($('#goodsName').val())+'&isShow='+isShow;
		}
		if(chacktype==4){
			var DataURL = "report.action?reportlet=sales_anydatesalescostpricegoods.cpt&logincompanyid="+'${person.personcompanyid}'+"&beginDate="+BeginDate+"&enddate="+End+"&goodsCategoryID="+goodscategoryID+"&shopCode="+shopCode+"&shopCodeName="+EncodeUtf8(shopCodeName)+"&supplierID="+$('#supplierID').val()+"&supplierName="+EncodeUtf8($('#supplierName').val())+"&brandID="+$('#brandID').val()+"&brandName="+EncodeUtf8($('#brandName').val())+"&goodsID="+$('#goodsCode').val()+"&goodsName="+EncodeUtf8($('#goodsName').val())+'&isShow='+isShow;
		}
