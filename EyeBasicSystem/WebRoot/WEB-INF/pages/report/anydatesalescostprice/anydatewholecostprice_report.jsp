...
<script>
	...
	function search(){		
		...
		if(chacktype==1){
			var DataURL = "report.action?reportlet=sales_anydatewholecostprice.cpt&beginDate="+BeginDate+"&enddate="+End+"&goodsCategoryID="+goodscategoryID+"&storeID="+shopCode+"&shopCodeName="+EncodeUtf8(shopCodeName)+"&supplierID="+$('#supplierID').val()+"&supplierName="+EncodeUtf8($('#supplierName').val())+"&brandID="+$('#brandID').val()+"&brandName="+EncodeUtf8($('#brandName').val())+"&goodsID="+$('#goodsCode').val()+"&goodsName="+EncodeUtf8($('#goodsName').val())+'&isShow='+isShow;
		}
		if(chacktype==2){
			var DataURL = "report.action?reportlet=sales_anydatewholecostpricesupplier.cpt&beginDate="+BeginDate+"&enddate="+End+"&goodsCategoryID="+goodscategoryID+"&storeID="+shopCode+"&shopCodeName="+EncodeUtf8(shopCodeName)+"&supplierID="+$('#supplierID').val()+"&supplierName="+EncodeUtf8($('#supplierName').val())+"&brandID="+$('#brandID').val()+"&brandName="+EncodeUtf8($('#brandName').val())+"&goodsID="+$('#goodsCode').val()+"&goodsName="+EncodeUtf8($('#goodsName').val())+'&isShow='+isShow;
		}
		if(chacktype==3){
			var DataURL = "report.action?reportlet=sales_anydatewholecostpricebrand.cpt&beginDate="+BeginDate+"&enddate="+End+"&goodsCategoryID="+goodscategoryID+"&storeID="+shopCode+"&shopCodeName="+EncodeUtf8(shopCodeName)+"&supplierID="+$('#supplierID').val()+"&supplierName="+EncodeUtf8($('#supplierName').val())+"&brandID="+$('#brandID').val()+"&brandName="+EncodeUtf8($('#brandName').val())+"&goodsID="+$('#goodsCode').val()+"&goodsName="+EncodeUtf8($('#goodsName').val())+'&isShow='+isShow;
		}
		if(chacktype==4){
			var DataURL = "report.action?reportlet=sales_anydatewholecostpricegoods.cpt&beginDate="+BeginDate+"&enddate="+End+"&goodsCategoryID="+goodscategoryID+"&storeID="+shopCode+"&shopCodeName="+EncodeUtf8(shopCodeName)+"&supplierID="+$('#supplierID').val()+"&supplierName="+EncodeUtf8($('#supplierName').val())+"&brandID="+$('#brandID').val()+"&brandName="+EncodeUtf8($('#brandName').val())+"&goodsID="+$('#goodsCode').val()+"&goodsName="+EncodeUtf8($('#goodsName').val())+'&isShow='+isShow;
		}
		document.getElementById('popupTitle').innerHTML="【任意时段产品批售成本统计】";
                      ...
                      <TBODY>
					  	<TR>
			               ...
			               <TD class="table_none" width="23%">
						   		...
						   		<li class="horizontal_onlyRight">
						  			<img btn=btn src="${ctx }/img/newbtn/btn_change_0.png" title="选择" name=ctl00$PageBody$Button1 onClick="openDepartment();">
						  		</li>
						   </TD>
