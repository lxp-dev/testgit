...
<script>	
	function search(){
		...
		url+="eims_reporting/sales_salseBasicAccessoryQTRpt&shopcode="+ShopCode+"&bgnDate="+BeginDate+"&endDate="+End+"&SalerID="+ShopAssistant+"&PoserID="+Cashier+"&rs:Command=Render";
		//window.open (url, 'salseBasicAccessoryQTRpt', 'fullscreen=no, top=150,left=150, toolbar=no, menubar=no, scrollbars=yes, location=no, status=no,resizable=yes');
