...
<script>	
	function search(){
		...
		url+="eims_reporting/sales_salesPersonRpt&shopCode="+ShopCode+"&begDate="+BeginDate+"&endDate="+End+"&rs:Command=Render";
		//window.open (url, 'salesPersonRpt', 'fullscreen=no, top=150,left=150, toolbar=no, menubar=no, scrollbars=yes, location=no, status=no,resizable=yes');
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD  width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：营业员工作量统计表</TD>
            <TD>&nbsp;</TD>
          </TR>
          <TR>
