...
<script>	
	function search(){
		...
		var DataURL = "report.action?reportlet=process_sendMaterialManyStoreRpt.cpt&shopCode="+ShopCode+"&begDate="+BeginDate+"&endDate="+End+"&shopNames="+EncodeUtf8(shopNames)+"&isShow="+isShow; 
		...
		document.getElementById('popupTitle').innerHTML="【发料人员工作量统计表(多店)】";
	}
	function clean(){
		goodsForm.reset();
	}
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD align="left" width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：发料人员工作量统计表(多店)</TD>
            <TD align=right>&nbsp;</TD>
          </TR>
          <TR>
