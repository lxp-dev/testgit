...
<script>	
	function search(){
		...
		var DataURL = "report.action?reportlet=process_endCheckManyStoreRpt.cpt&shopCode="+ShopCode+"&begDate="+BeginDate+"&endDate="+End+"&shopNames="+EncodeUtf8(shopNames)+"&isShow="+isShow;  
		...
		document.getElementById('popupTitle').innerHTML="【质检人员工作量统计报表(多店)】"; 
	}
	...
	function openDepartment(){
		...
		var topCols = top.document.getElementById("btmframe").cols;		
		if(is_iPad()){
			showPopWin("selDepartmentOpen.action?departmentType=2&isclosed=0",970,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}else{
			showPopWin("selDepartmentOpen.action?departmentType=2&isclosed=0",screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}		
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD align="left" width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：质检人员工作量统计表(多店)</TD>
            <TD align=right>&nbsp;</TD>
          </TR>
          <TR>
                ...
                vAlign=top><DIV id=tabContent__1>
				  ...
				  <table width="100%" id="title0"  border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
					...
					<table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
					  	<TR>
						   <TD width="10%" height="30" class="table_body">加工部门</TD>
		               ...
		               <c:if test="${person.departmenttype!=1}">
			               <li class="horizontal_onlyRight">
						   		<input class="text_input300" id="bdpdepartmentname" name="selDepartmentName" type="hidden" value="${selDepartmentName }"  />
						   		<textarea class="text_input200" id="ds"  name="ds" value=""   style='height:50px' readonly="readonly" >${selDepartmentName}</textarea>
