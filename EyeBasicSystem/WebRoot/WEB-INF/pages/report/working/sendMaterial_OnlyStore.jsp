...
<script>	
	...
	function search(){
		...
		var DataURL = "report.action?reportlet=process_sendMaterialOnlyStoreRpt.cpt&shopCode="+ShopCode+"&begDate="+BeginDate+"&endDate="+End+"&isShow="+isShow; 
		if(is_iPad()){
			showPopWin("report.action?reportlet=process_sendMaterialOnlyStoreRpt.cpt&shopCode="+ShopCode+"&begDate="+BeginDate+"&endDate="+End,970,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}else{
			//showPopWin("report.action?reportlet=process_sendMaterialOnlyStoreRpt.cpt&shopCode="+ShopCode+"&begDate="+BeginDate+"&endDate="+End,screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),false);
			openWindowForReport(DataURL); 
			
		}		
		document.getElementById('popupTitle').innerHTML="【发料员工作量统计报表(单店)】";
	}
	function clean(){
		goodsForm.reset();
	}
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD align="left" width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：发料员工作量统计报表(单店)</TD>
            <TD align=right>&nbsp;</TD>
          </TR>
          <TR>
					...
					<table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
					  	<TR>
			               ...
			               <c:if test="${person.departmenttype!=2}">
