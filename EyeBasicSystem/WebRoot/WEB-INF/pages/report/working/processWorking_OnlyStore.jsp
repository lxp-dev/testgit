...
<script>
	function search(){
		...
		var DataURL = "report.action?reportlet=treims/process_processWorkingOnlyStoreRpt.cpt&shopCode="+ShopCode+"&bgnDate="+BeginDate+"&endDate="+End+"&isShow="+isShow; 
		...
		document.getElementById('popupTitle').innerHTML="【加工人员工作量统计表(单店)】";
	}
	function clean(){
		goodsForm.reset();
	}
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD align="left" width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：加工人员工作量统计表(单店)</TD>
            <TD align=right>&nbsp;</TD>
          </TR>
          <TR>
