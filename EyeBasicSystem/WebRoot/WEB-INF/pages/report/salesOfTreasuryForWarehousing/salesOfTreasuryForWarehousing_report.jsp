...
$(document).ready(function() { 
	...
	function search(){
		...
		url+="eims_reporting/storage_salesOfTreasuryForWarehousingRpt&beginTime="+BeginTime+"&endTime="+EndTime+"&goodsName="+GoodsName+"&remark="+Remark+"&supplierId="+SupplierId+"&rs:Command=Render";
		window.open (url, 'salesOfTreasuryForWarehousingRpt', 'fullscreen=no, top=150,left=150, toolbar=no, menubar=no, scrollbars=yes, location=no, status=no,resizable=yes');
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：外批销售对账单</TD>
            <TD>&nbsp;</TD>
          </TR>
          <TR>
					...
					<table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
					  	<TR>
			               ...
			               <TD width="13%" height="30" class="table_body">备注</TD>
			               <TD class="table_none" width="40%"><input type="text" maxlength="20" id="remark" name="remark"/></TD>
                        </TR>
					  	<TR>
						   <TD width="13%" height="30" class="table_body">商品名称</TD>
			               <TD class="table_none" width="40%"><input type="text" maxlength="20" id="goodsName" name="goodsName"/>
			               									  <input type="hidden" id="goodsId" name="goodsId" value="${requestScope.goodsId}"/></TD>
			               <TD width="13%" height="30" class="table_body">外批部门名称</TD>
			               <TD class="table_none" width="40%">
			                   <select id="supplierId" name="supplierId">
	      		                 	<option value="">请选择外批部门名称</option>
