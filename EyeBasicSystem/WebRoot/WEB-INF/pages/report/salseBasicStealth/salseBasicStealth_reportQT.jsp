...
<script>	
	function search(){
		...
		url+="eims_reporting/sales_salseBasicStealthQTRpt&shopCode="+ShopCode+"&begDate="+BeginDate+"&endDate="+End+"&shopAssistant="+ShopAssistant+"&cashier="+Cashier+"&goodsName="+EncodeUtf8(Goodsname)+"&optID="+OptID+"&rs:Command=Render";
		window.open (url, 'salseBasicStealthQTRpt', 'fullscreen=no, top=150,left=150, toolbar=no, menubar=no, scrollbars=yes, location=no, status=no,resizable=yes');
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD align="left" width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：隐形销售明细报表(眼视光部试用)  </TD>
            <TD align=right></TD>
          </TR>
          <TR>
