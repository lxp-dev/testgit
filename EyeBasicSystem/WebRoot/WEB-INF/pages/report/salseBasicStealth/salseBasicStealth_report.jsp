...
<script>	
	function search(){
		...
		url+="eims_reporting/sales_salseBasicStealthRpt&shopCode="+ShopCode+"&begDate="+BeginDate+"&endDate="+End+"&shopAssistant="+ShopAssistant+"&cashier="+Cashier+"&goodsName="+EncodeUtf8(Goodsname)+"&optID="+OptID+"&rs:Command=Render";
		window.open (url, 'salseBasicStealthRpt', 'fullscreen=no, top=150,left=150, toolbar=no, menubar=no, scrollbars=yes, location=no, status=no,resizable=yes');
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD align="left" width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：隐形销售明细报表  </TD>
            <TD align=right></TD>
          </TR>
          <TR>
...
<!--                            <input type="hidden" id="departmentid" name="departmentid" value="${departmentsPo.bdpdepartmentid}">-->
			               ...
			               <TD width="13%" height="30" class="table_body">查看日期</TD>
			               <TD class="table_none" width="40%">
