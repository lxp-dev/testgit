      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD align="left" width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：商品不合格品分析表</TD>
            <TD align=right>
                      ...
                      <TBODY>
                        <TR>
			               ...
			               <TD class="table_none" colspan="3">
                               ...
                               <input type="radio" id="queryClassify" name="queryClassify" value="1" onclick="queryClass();" checked="checked"/>按门店&nbsp;
                               <input type="radio" id="queryClassify" name="queryClassify" value="2" onclick="queryClass();"/>按加工中心&nbsp;
                               <input type="radio" id="queryClassify" name="queryClassify" value="3" onclick="queryClass();"/>按人员&nbsp;
                               <input type="radio" id="queryClassify" name="queryClassify" value="4" onclick="queryClass();"/>按同期&nbsp;
