...
//			var goodsname = document.getElementById("goodsname").value;
			...
			var DataURL = "report.action?reportlet=SupplierRanking.cpt&startdate="+begintime+"&enddate="+endtime;                      
            //window.open (DataURL,'制造商销售排名汇总表', 'fullscreen=no, top=150,left=150, toolbar=no, menubar=no, scrollbars=yes, location=no, status=no,resizable=yes'); 
  ...
  <TR>
    <TD><!-- ?? Start -->
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            <TD class=menubar_title width="15%"><img border='0' src='${ctx }/img/pic/module.gif' align='absmiddle' hspace='3' vspace='3'>领导看板类报表</TD>
            
            <TD width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：制造商销售排名报表 </TD>
            <TD>&nbsp;</TD>
          </TR>
          <TR>
