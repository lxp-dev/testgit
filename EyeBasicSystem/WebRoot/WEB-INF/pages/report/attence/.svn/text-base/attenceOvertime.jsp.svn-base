...
function search()
{
	...
	var DataURL = "report.action?reportlet=kqovertime.cpt&begintime="+begintime+"&endtime="+endtime+"&departmentid="+departmentId;									                    
	...
	document.getElementById('popupTitle').innerHTML="【考勤加班表】";
}
	function clean(){
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD align="left" width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：考勤加班表    </TD>
            <TD align=right>
