...
<script>	
	function search(){
		...
		url+="eims_reporting/sales_salseBasicFrameRpt&shopCode="+ShopCode+"&bgnDate="+BeginDate+"&endDate="+End;
		...
		window.open (url, 'salseBasicFrameRpt', 'fullscreen=no, top=150,left=150, toolbar=no, menubar=no, scrollbars=yes, location=no, status=no,resizable=yes');
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD align="left" width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：框镜销售明细报表  </TD>
            <TD align=right></TD>
          </TR>
          <TR>
...
<!--                            <input type="hidden" id="departmentid" name="departmentid" value="${departmentsPo.bdpdepartmentid}">-->
					  	...
					  	<TR>
						   <TD width="13%" height="30" class="table_body">商品名称</TD>
			               			<TD class="table_none" width="40%"><input type="text" id="goodsname" name="goodsname"/></TD>
