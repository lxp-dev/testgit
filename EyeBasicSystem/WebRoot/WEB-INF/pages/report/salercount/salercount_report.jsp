...
<script>
	...
	function search(){
		...
		if(End==""){
			...
			var DataURL = "report.action?reportlet=sales_salerCount.cpt&shopcode="+ShopCode+"&bgndate="+BeginDate+"&enddate="+End; 
		...
		document.getElementById('popupTitle').innerHTML="【营业员销售明细表】";
	}
	function clean(){
		goodsForm.reset();	
	}
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：营业员销售明细表</TD>
            <TD>&nbsp;</TD>
          </TR>
          <TR>
