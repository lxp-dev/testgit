...
<script>
	...
	function search(){
		...
		var DataURL = "report.action?reportlet=sales_frameSalesAreaByDpt.cpt&departmentsID="+ShopCode+"&bgnDate="+BeginDate+"&endDate="+End+"&priceArea="+area+"&salesType="+salesType+"&reportID=${moduleID}"; 
		...
		document.getElementById('popupTitle').innerHTML="【框镜销售区间分析表多店】";
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：框镜销售区间分析表</TD>
...
1.查询日期(必选),但不包含今天。<br/>
2.根据选择的年份和月份并配合配镜单的价格区间，进行所有门店的汇总统计，并统计每个区间段配镜单的数量和金额及占总数量和金额的比例。
					</div>														
			</c:if>		
                  </DIV>
                </DIV>
