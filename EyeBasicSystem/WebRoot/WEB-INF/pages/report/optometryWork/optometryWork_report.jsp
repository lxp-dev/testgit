...
<script>	
	function search(){
		...
		url+="eims_reporting/sales_optometryRpt&departmentid="+ShopCode+"&bgndate="+BeginDate+"&enddate="+End+"&rs:Command=Render";
		window.open (url, 'optometryRpt', 'fullscreen=no, top=150,left=150, toolbar=no, menubar=no, scrollbars=yes, location=no, status=no,resizable=yes');
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD align="left" width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：验光师工作量统计报表  </TD>
            <TD align=right></TD>
          </TR>
          <TR>
