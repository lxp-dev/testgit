...
<script>	
	function search(){
		...
		var DataURL = "report.action?reportlet=treims/sales_optometryWorkOnlyStoreRpt.cpt&departmentid="+ShopCode+"&bgndate="+BeginDate+"&enddate="+End;                      
        window.open (DataURL,'验光师工作量统计报表单店', 'fullscreen=no, top=150,left=150, toolbar=no, menubar=no, scrollbars=yes, location=no, status=no,resizable=yes'); 
       ...
       <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD align="left" width="45%">目前操作功能：验光师工作量统计报表(单店)</TD>
            <TD align=right></TD>
          </TR>
          <TR>
