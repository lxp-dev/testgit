...
$(document).ready(function() { 
	...
	function search(){	
		...
		url+="eims_reporting/storage_otherGoodsStorageDetailsRpt";
		
		url+="&StockId=" + outstockID;
		url+="&startDate=" + BeginDate + "&enddate=" + End;

		//alert(url);	
		url+="&rs:Command=Render";		
		window.open (url, 'storage_otherGoodsStorageDetailsRpt', 'fullscreen=no, top=150,left=150, toolbar=no, menubar=no, scrollbars=yes, location=no, status=no,resizable=yes');
	}
	function clean(){
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD align="left" width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：其他商品库存明细表</TD>
            <TD align=right>&nbsp;</TD>
          </TR>
          <TR>
