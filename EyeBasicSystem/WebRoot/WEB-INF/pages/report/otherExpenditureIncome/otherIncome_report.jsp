...
$(document).ready(function() { 
	...
	function search(){		
		...
		url+="eims_reporting/storage_otherIncomeRpt&startDate="+BeginDate+"&endDate="+End+"&rs:Command=Render";		
		window.open (url, 'otherIncomeRpt', 'fullscreen=no, top=150,left=150, toolbar=no, menubar=no, scrollbars=yes, location=no, status=no,resizable=yes');
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：其他材料收入汇总表</TD>
            <TD>&nbsp;</TD>
          </TR>
          <TR>
