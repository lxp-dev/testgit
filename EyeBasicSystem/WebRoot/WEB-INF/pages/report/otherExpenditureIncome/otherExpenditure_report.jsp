...
$(document).ready(function() { 
	...
	function search(){	
		...
		url+="eims_reporting/storage_otherExpenditureRpt";
		
		if(outstockID==""){
			url+="&startDate="+BeginDate+"&endDate="+End;
		}else{
		    url+="&warehouse=" + outstockID + "&startDate=" + BeginDate + "&endDate=" + End;
		}
			
		url+="&rs:Command=Render";		
		window.open (url, 'otherExpenditureRpt', 'fullscreen=no, top=150,left=150, toolbar=no, menubar=no, scrollbars=yes, location=no, status=no,resizable=yes');
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：其他材料支出汇总表</TD>
            <TD>&nbsp;</TD>
          </TR>
          <TR>
                ...
                vAlign=top><DIV id=tabContent__1>
				  ...
				  <table width="100%" id="title0"  border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
					...
					<table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
					  	<TR>					  	 
						   <TD height="30" class="table_body">部门</TD>
			               <TD class="table_none">
