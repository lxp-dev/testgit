...
$(document).ready(function() { 
	...
	function search(id){
        ...
        var DataURL = "report.action?reportlet=procurementCheckGlassCpt.cpt&supplierID="+supplierID+"&begintime="+begintime+"&endtime="+endtime;
		...
		document.getElementById('popupTitle').innerHTML="【镜片商品进货检验记录报表】";
    }
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：镜片商品进货检验记录报表</TD>
            <TD>&nbsp;</TD>
          </TR>
          <TR>
                ...
                vAlign=top><DIV id=tabContent__1>
				  ...
				  <table width="100%" id="title0"  border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
					...
					<table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        <TR>
			               <TD  height="26" width="8%" class="table_body">制造商</TD>
