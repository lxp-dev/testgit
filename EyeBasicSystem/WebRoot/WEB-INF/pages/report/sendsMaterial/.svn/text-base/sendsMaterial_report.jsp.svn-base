...
<script>	
	function search(){
		...
		url+="eims_reporting/logistics_sendsMaterialRpt&year="+Year+"&month="+Month+"&rs:Command=Render";
		//window.open (url, 'sendsMaterialRpt', 'fullscreen=no, top=150,left=150, toolbar=no, menubar=no, scrollbars=yes, location=no, status=no,resizable=yes');
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：发料员工作量统计表</TD>
            <TD>&nbsp;</TD>
          </TR>
          <TR>
                ...
                vAlign=top><DIV id=tabContent__1>
				  ...
				  <table width="100%" id="title0"  border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
					...
					<table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
					  	<TR>
						   <TD width="13%" height="30" class="table_body">年份</TD>
			               ...
			               <TD width="13%" height="30" class="table_body">月份</TD>
						     <TD class="table_none" width="40%">
