...
<script>	
	function search(){
		...
		if(begintime == "" || endtime == ""){
			...
			if ($('#typeID').val() == '1'){
			    DataURL = "report.action?reportlet=L_GoodsInOrOutStorageSumRpt.cpt&departmentID="+departmentid+"&begDate="+begintime+"&endDate="+endtime;                     
			}else{
			    DataURL = "report.action?reportlet=L_GoodsInOrOutStorageSumBySupplierRpt.cpt&departmentID="+departmentid+"&begDate="+begintime+"&endDate="+endtime;                     
			}
