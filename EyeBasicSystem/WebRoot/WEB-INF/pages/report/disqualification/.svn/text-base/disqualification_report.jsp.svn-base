...
$(document).ready(function() { 
	...
	function search(){
		...
		window.open (url, 'disqualificationRpt', 'fullscreen=no, top=150,left=150, toolbar=no, menubar=no, scrollbars=yes, location=no, status=no,resizable=yes');
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：不合格品镜片报残明细表 </TD>
            <TD>&nbsp;</TD>
          </TR>
          <TR>
				  ...
				  <table width="100%" id="title0"  border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
					...
					<table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
					  	...
					  	<TR>
						   <TD width="10%" height="30" class="table_body">不合格品单类型</TD>
			               <TD class="table_none" width="40%">
