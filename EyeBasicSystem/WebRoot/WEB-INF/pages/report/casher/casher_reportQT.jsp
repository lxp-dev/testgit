...
<script>	
	function search(){
        ...
        switch($('input[name=customAmountForm]:checked').val()){
	        case '1':
	        	DataURL = "report.action?reportlet=sales_CashierOnlyStoreRpt.cpt&departmentid="+ShopCode+"&startTime="+BeginDate+"&endTime="+End+"&isShow="+isShow; 
	            break;
	        case '2':
	        	DataURL = "report.action?reportlet=sales_CashierOnlyStoreRpt2.cpt&departmentid="+ShopCode+"&startTime="+BeginDate+"&endTime="+End+"&isShow="+isShow; 
	            break;
	        case '3':
	        	DataURL = "report.action?reportlet=sales_CashierOnlyStoreRpt3.cpt&departmentid="+ShopCode+"&startTime="+BeginDate+"&endTime="+End+"&isShow="+isShow; 
	            break;  
	        default:
		        return;
        }
		...
		document.getElementById('popupTitle').innerHTML="【收银员工作量统计报表(单店)】";
	}
	function clean(){
		goodsForm.reset();
	}
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD align="left" width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能： 收银员工作量统计表(单店)</TD>
            <TD align=right>&nbsp;</TD>
          </TR>
          <TR>
