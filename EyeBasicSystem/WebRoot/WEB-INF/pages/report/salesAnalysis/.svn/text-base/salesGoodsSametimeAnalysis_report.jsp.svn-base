...
<script>
	...
	function search(){
		...
		var DataURL;
		DataURL= "report.action?reportlet=sales_salesGoodsSametimeAnalysis.cpt&__bypagesize__=false&logincompanyid="+'${person.personcompanyid}'+"&departmentsID="+ShopCode+"&begintime="+BeginDate+"&endtime="+End+"&begintime2="+BeginDate2+"&endtime2="+End2+"&ShopCodeName="+EncodeUtf8(ShopCodeName)+"&year="+year+'&isShow='+isShow;
		...
		document.getElementById('popupTitle').innerHTML="【销售产品同期综合对比分析】";
	}
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：销售产品同期综合对比分析</TD>
            <TD>&nbsp;</TD>
          </TR>
          <TR>
