...
<script>	
	function search(){
		if(checkForm(document.all.goodsForm)){
			...
			url+="eims_reporting/logistics_checkPersonTotalStatisticsRpt&dateyear="+dateyear+"&datemonth="+datemonth+"&rs:Command=Render"; 
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD align="left" width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：检验人员工作量统计表(单店)</TD>
            <TD align=right>&nbsp;</TD>
          </TR>
          <TR>
