...
<script>
	...
	function search(){
	    ...
	    selBillWhetherSettleAccountsFrm.action="ykselBillWhetherSettleAccounts.action";
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
        <TBODY>
          <TR>
            ...
            <TD align="left" width="45%"><%@ include file="/commons/helpMovie.jsp" %>目前操作功能：查询未做账单据 </TD>
            <TD align=right>&nbsp;</TD>
          </TR>
          <TR>
					...
					<table width="100%" border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder">
                      <TBODY>
                        <TR class=table_title align=middle>
                          <TD width="3%">选择</TD>
                          <TH width="13%" height="30" scope=col>单据编号</TH>
                          <TH width="8%" height="30" scope=col>单据日期</TH>						
