...
<script type="text/javascript">	      
	 ...
	 function save(){
        ...
        if (chk != 0){ 
            ...
            if (!document.getElementsByName("auditState")[0].checked){
                insertVoucherFrm.action = "ykinsertOutStrogeVoucher.action?auditState=0";
            }else{
                insertVoucherFrm.action = "ykinsertOutStrogeVoucher.action?auditState=1";
            }            
	 ...
	 */         
	 function search(){
	   ...
	   openPopWindow("ykinitSelectBillSels.action?" + url,"单据查看");
	 }
	 ...
	 */        
	 function openGoodSingleValues(objValue){
	      var sVoucherType = document.getElementById('sVoucherType').value;
	      insertVoucherFrm.action="ykselSalesBills.action?billID="+objValue;
	      insertVoucherFrm.submit();
	 }
                      ...
                      <TBODY>
                        ...
                        <s:iterator value="voucherEntryList">
                         <TR class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">
                          <TD height="28"><input id="chk" name="chk" type="checkbox"><input type="hidden" name="voucherEntryTempPo.sLveveID" value="${sLveveID}" /></TD>
						  <TD height="28">${sLveveBillID}<input type="hidden" name="voucherEntryTempPo.sLveveBillID" value="${sLveveBillID}" /></TD>
						  <TD height="28">${sBillDate}<input type="hidden" name="voucherEntryTempPo.sDate" value="${sBillDate}" /></TD>
						  <TD height="28">${sDepartment}<input type="hidden" name="voucherEntryTempPo.sDepartment" value="${sDepartment}" /><input type="hidden" name="voucherEntryTempPo.sDepartmentID" value="${sDepartmentID}" /></TD>
