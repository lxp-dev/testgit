    ...
    */
	function search(voucherID,voucherDate,bType,sType,sVoucherType,supplierName,createPerson,posting){
	   ...
	   var url = "voucherID="+EncodeUtf8(voucherID)+"&voucherDate="+EncodeUtf8(voucherDate)+"&bType="+EncodeUtf8(bType)+"&sType="+EncodeUtf8(sType)
		...
		if(is_iPad()){
			showPopWin('ykselVoucherTally.action?moduleID=${moduleID}&'+url,970,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}else{
			showPopWin('ykselVoucherTally.action?moduleID=${moduleID}&'+url,screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}		
                      ...
                      <TBODY>
                        ...
                        <s:iterator value="voucherEntryList">
                         <TR class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">
						  ...
						  <TD height="26">${sLveveBillID}</TD>
						  <TD height="26">${sLveveGoodsID}</TD>
						  <TD>${sGoodsName}</TD>
						  <TD>${sSpec}</TD>
