...
<script type="text/javascript">
    ...
    */
	function detail(invoiceID){
	   ...
	   if (invoiceID.substring(0,1)=='I'){
		   url = 'ykinitInvoiceDetail.action?invoiceID='+invoiceID;
	   }else{
		   url = 'ykselReversalDetail.action?reversalID='+invoiceID;
	   }
    ...
    */
	...
	function changeParentID(){
        ...
        $('#'+'sVoucherType').load("ykinitVoucherTypeByParentID.action?parentID=" + bVoucherType);
       ...
       if (chk != 0){ 
	       ...
	       if (auditState != null  && auditState.length != 0){
	          if (!auditState[0].checked){
	             updateVoucherFrm.action = "ykupdateVoucher.action?auditState=0&id="+type;
	          }else{
	             updateVoucherFrm.action = "ykupdateVoucher.action?auditState=1&id="+type;
	          }
	...
	function openGoodSingleValues(objValue){
	    ...
	    switch(sVoucherType){
	       ...
	       case '209':
	       case '210':
	                 updateVoucherFrm.action="ykselectBillGoodsUpdate.action?billID="+objValue+"&id="+"F";
	                 break;
	       //冲回
	       case '102':
	       case '106':
	       ...
	       case '206':
	       case '208':
	                 updateVoucherFrm.action="ykselectBillGoodsUpdate.action?billID="+objValue+"&id="+"C";
	                 break;
	       //单据
	       default:
	       	         updateVoucherFrm.action="ykselectBillGoodsUpdate.action?billID="+objValue+"&id="+"D";
	    }
		updateVoucherFrm.submit();
	}
                  ...
                  <DIV>
                      ...
                      <TBODY>
                        <TR height="26">
                          ...
                          <TD width="20%" class="table_none">${voucherID}<input type="hidden" id="voucherID" name="voucherID" value="${voucherID}"></TD>
                         ...
                         ${fn:substring(voucherDate,0,10)}
                          ...
                          <TD class="table_none" colspan="3" width="18%">
                ...
                <c:if test="${id == 'C'}">
                    ...
                    <TABLE id=ctl00_PageBody_PostButton cellSpacing=1 cellPadding=3 width="100%" align=center border=0>
                      <TBODY>
					   ...
					   <TR>
						  <TD align="left">						    
						    <img btn=btn id="submitBtn" name="submitBtn" src="${ctx}/img/newbtn/btn_save_0.png" title='保存' onClick="save('${po.sLvvID}');">
						  </TD>
                        </TR>
                      </TBODY>
                    </TABLE>
