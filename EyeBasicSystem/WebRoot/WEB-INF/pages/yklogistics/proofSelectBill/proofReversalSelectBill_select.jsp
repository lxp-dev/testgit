...
<script>	
	...
	function search(){
		selectBill.action = "ykselectSelectReversal.action?bVoucherType="+document.all.bVoucherType.value;
		selectBill.submit();
		showLoadingBar();
	}
	...
	function billinfo(id){
		...
		if(is_iPad()){
			showPopWin("ykinitReversalInfoSel.action?hid="+id+"&moduleID=${moduleID}",970,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}else{
			showPopWin("ykinitReversalInfoSel.action?hid="+id+"&moduleID=${moduleID}",screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}		
		document.getElementById('popupTitle').innerHTML="【冲回查询】";		
	}
...
<input type="hidden" name="bVoucherType" id="bVoucherType" value="${requestScope.bVoucherType}" />
                ...
                vAlign=top><DIV id=tabContent__1>
                  <DIV>
                    <table width="100%" id="title0"  border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                      ...
                      <TBODY>
					  	<TR>
						   <TD width="10%" height="26" class="table_body">冲回编号</TD>
			               <TD class="table_none" width="40%">
                            <input class="text_input200" type="text" id="billid" name="billid" maxlength=21 value="${requestScope.billid}">
			               </TD>
                    	...
                    	<TR>
                           ...
                           <TD width="10%" height="26" class="table_body">审核状态</TD>
			               <TD class="table_none">
