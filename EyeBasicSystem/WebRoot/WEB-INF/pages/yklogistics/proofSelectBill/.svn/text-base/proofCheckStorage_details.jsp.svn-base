              ...
              <TR>
                ...
                vAlign=top><DIV id=tabContent__1>
                  ...
                  border=0>
                      <TBODY>
                        <TR>
                          <TD width="10%" class="table_body" height="26">单据编号</TD>
                          <TD width="40%" class="table_none">${overagelossesPo.cstibillid}</TD>
                          <TD width="10%" class="table_body">盘点单号</TD>
                          <TD width="40%" class="table_none">${overagelossesPo.cstisourcebillid }
						  </TD>
                        </TR>
                        <TR>                        
						  <TD width="10%" class="table_body" height="26">单据日期</TD>
                          <TD width="40%" class="table_none">${fn:substring(overagelossesPo.cstibilldate,0,10)}</TD>                          
                          <TD width="10%" class="table_body">所属部门</TD>
						  <TD width="40%" class="table_none">${overagelossesPo.cstidepartmentname}</TD>
						</TR>
						<TR>
						<c:choose>
