				  ...
				  <table width="100%" id="title0"  border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
					...
					<table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>
                        ...
                        <TR>
                        <c:if test="${inventoryPo.cstibilltypeid!=3}">
                          <TD class="table_body" height="30">制造商</TD>
                          <TD class="table_none">                          
                          	${inventoryPo.cstisuppliername}
                         </TD> 
                         </c:if>
                         <c:if test="${inventoryPo.cstibilltypeid==3}">
                          <TD class="table_body" height="30">销售部门</TD>
                          <TD class="table_none">                          
                          	${inventoryPo.cstidepartmentname}
                         </TD> 
                         </c:if>
                          ...
                          <c:if test="${inventoryPo.cstibilltypeid==7}">
                          	其它入库单
                          </c:if>
                          
                          <c:if test="${inventoryPo.cstibilltypeid==8}">
                          	其它出库单
                          </c:if>
					...
					<table width="100%"  border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder" id="title1">
                      <TBODY>                        
                        <TR class=table_title align=middle>
                          <TH width="16%" height="30" scope=col>商品代码</TH>
                          <TH width="16%" scope=col>商品名称</TH>
                          <!--<TH width="7%" scope=col>规格</TH>  -->
						  ...
						  <TH width="8%" scope=col>价税合计</TH>
						   <c:if test="${inventoryPo.cstibilltypeid==1 || inventoryPo.cstibilltypeid==2}">
                        ...
                        <TR class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">
                          ...
                          <c:if test="${cstieinvoicestate==0}">
                          	未核销
                          </c:if>
                          
                          <c:if test="${cstieinvoicestate==1}">
                          	部分核销
                          </c:if>
                          
                          <c:if test="${cstieinvoicestate==2}">
                          	已核销
                          </c:if>
