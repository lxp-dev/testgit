...
<script>	
    ...
    function search(){
		...
		selectBill.action = "ykselectSelectInvoice.action";
		selectBill.submit();
		showLoadingBar();
	}
	...
	function billinfo(id){
		...
		if(is_iPad()){
			showPopWin("ykinitInvoiceInfoSel.action?hid="+id+"&moduleID=${moduleID}",970,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}else{
			showPopWin("ykinitInvoiceInfoSel.action?hid="+id+"&moduleID=${moduleID}",screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}		
                ...
                vAlign=top><DIV id=tabContent__1>
                  <DIV>
                    <table width="100%" id="title0"  border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                      ...
                      <TBODY>
					  	<TR height="30">
						   <TD width="10%" height="26" class="table_body">发票编号</TD>
			               ...
			               <TD width="10%" height="26" class="table_body">发票日期</TD>
                           <TD class="table_none" width="40%">
                        ...
                        <TR height="26">
                           <TD width="10%" height="26" class="table_body">发票类型</TD>
					...
					<table width="100%"   border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
                      ...
                      <TBODY>
                        ...
                        <TR class="row" onMouseOver="mover(this,'#a2c1eb')" onMouseOut="mout(this,'#cadee8')">
                          ...
                          <TD>
		                     <input type='button' value='详细' onClick="javascript:billinfo('${cstibillid}')">
		                  </TD>
						</TR>
						</s:iterator>						  
                      </TBODY>
