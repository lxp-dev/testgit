...
<script>   	
	...
	function search(){
		selectBill.action = "ykinvoiceSelectBill.action";
		selectBill.submit();
		showLoadingBar();
	}
	...
	function billinfo(id){
		...
		if(is_iPad()){
			showPopWin("ykinitBillInfoSel.action?hid="+id+"&moduleID=${moduleID}",970,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}else{
			showPopWin("ykinitBillInfoSel.action?hid="+id+"&moduleID=${moduleID}",screen.width-100,screen.height-200,topRows,topCols,returnRefresh(true),false);
		}		
                  ...
                  <DIV>
					...
					<table width="100%"   border=0 align=center cellpadding=0 cellspacing=0 class="privateTable">
					  ...
					  <table width="100%" border=0 align=center cellpadding=1 cellspacing=1 class="privateBorder">
						  ...
						  <TH width="11%" scope=col height="26">&nbsp;</Th>
