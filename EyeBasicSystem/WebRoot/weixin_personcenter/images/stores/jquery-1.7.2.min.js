var system_obj={
	domain:function(domain){
		...
		var domain_list={
			...
			static:'http://pb.static.ptweixin.com',
			img:'http://pb.img.ptweixin.com',
	...
	div_mask:function(){
		if($('#div_mask').size()){
			...
			$('#div_mask').css({width:'100%', height:$(document).height(), overflow:'hidden', position:'absolute', top:0, left:0, background:'#000', opacity:0.8, 'z-index':10000});
		}
	}
};
