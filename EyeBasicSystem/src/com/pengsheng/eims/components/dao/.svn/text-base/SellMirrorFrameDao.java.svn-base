...
public interface SellMirrorFrameDao {
	/**
	 * 查询销售镜架数量
	 * @param po
	 * @return
	 ...
	 * @return
	 */
	public List<GoodsInfoPo> getSellMirrorFrameList(GoodsInfoPo po,int start, int size);
	public List<GoodsInfoPo> getSellMirrorFrameListAll(GoodsInfoPo po,int start, int size);
	public List<GoodsInfoPo> getSellMirrorFrameList1(GoodsInfoPo po,int start, int size);
