...
public class ContactAccessoriesDaoImpl extends BaseJdbcDaoSupport implements ContactAccessoriesDao {
	 ...
	 * @return
	 */
	public List<GoodsInfoPo> contactAccessoriesList(GoodsInfoPo goodsInfoPo,
			int start, int size) {
...
List<String> params=new ArrayList<String>();
		...
		varname1.append("        WHERE  B_GI_GoodsCategoryID = '5' ");
