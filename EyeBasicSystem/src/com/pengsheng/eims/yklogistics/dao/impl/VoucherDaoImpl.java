...
public class VoucherDaoImpl extends BaseJdbcDaoSupport implements VoucherDao {
	...
	public List<VoucherTypePo> getVoucherTypeByID(String parentID){
		...
		sb.append(" from L_VT_VoucherType");
		
		if (!"".equals(Utility.getName(parentID))){
			sb.append(" where isnull(L_VT_VT_ParentID,'0') = ?");
			params.add(parentID);
		}
	...
	public List<VoucherEntryPo> getVoucherEntryByBillsList(VoucherEntryPo po,int start, int size){
		...
		sb.append(" from( select ROW_NUMBER() Over(order by L_VE_VE_ID) as rowNum,L_VE_VE_BillID as sLveveBillID,L_VE_VE_GoodsID as sLveveGoodsID,B_GI_GoodsName as sGoodsName,B_GI_Spec as sSpec,isnull(L_VE_VE_CheckNumber,0) as sGoodsQuantity,");
	...
	public List<VoucherEntryPo> getVoucherEntryByBillsList(VoucherEntryPo po){
		...
		sb.append("select temp.sLveveBillID,temp.sLveveGoodsID as sLveveGoodsID,temp.sGoodsName as sGoodsName,temp.sSpec as sSpec,temp.sGoodsQuantity as sGoodsQuantity,temp.sNotTaxRate as sNotTaxRate,");
		sb.append("temp.sNotTaxRateAmount as sNotTaxRateAmount,temp.sTaxRate as sTaxRate,temp.sCostPrice as sCostPrice,temp.sTaxAmount as sTaxAmount,temp.sCostPriceAmount as sCostPriceAmount ");
		sb.append(" from( select L_VE_VE_BillID as sLveveBillID,L_VE_VE_GoodsID as sLveveGoodsID,B_GI_GoodsName as sGoodsName,B_GI_Spec as sSpec,isnull(L_VE_VE_CheckNumber,0) as sGoodsQuantity,");
		sb.append(" isnull(L_VE_VE_NotTaxRate,0) as sNotTaxRate,isnull(L_VE_VE_NotTaxRateAmount,0) as sNotTaxRateAmount,isnull(L_VE_VE_TaxRate,0) as sTaxRate,isnull(L_VE_VE_CostPrice,0) as sCostPrice,isnull(L_VE_VE_TaxAmount,0) as sTaxAmount,isnull(L_VE_VE_CostPriceAmount,0) as sCostPriceAmount ");
		sb.append(" from L_VE_VoucherEntry left join B_GoodsInfo on L_VE_VE_GoodsID=B_GI_GoodsID ");
		sb.append(" where L_VE_VE_VoucherID=?");
		sb.append(" ) temp ");
	...
	public List<VoucherEntryPo> getBillGoods(VoucherEntryPo po){
		...
		buffer.append("B_GI_GoodsName as sGoodsName , ");
	...
	public List<VoucherEntryPo> getSalesBillGoods(VoucherEntryPo po){
		...
		buffer.append("select C_ST_I_BillID as sLveveID,C_ST_I_BillID as sLveveBillID,convert(varchar(10),C_ST_I_AuditDate,120) as sBillDate,C_ST_I_DepartmentId as sDepartmentID,B_DP_DepartmentName as sDepartment,isnull(sum(C_ST_IE_AverageNotTaxRateAmount),0.00) as sNotTaxRateAmount,isnull(sum(C_ST_IE_CostPriceAmount),0.00) as sCostPriceAmount ");
	...
	public List<VoucherEntryPo> getCheckStorgeBillGoods(VoucherEntryPo po){
		...
		buffer.append("select sLveveID as sLveveID,sLveveBillID as sLveveBillID , ");
		buffer.append("sLveveGoodsID as sLveveGoodsID , ");
		buffer.append("sGoodsName as sGoodsName , ");
		buffer.append("sSpec as sSpec , ");
		buffer.append("abs(sum(sGoodsQuantity)) as sGoodsQuantity , ");
		buffer.append("sNotTaxRate as sNotTaxRate , ");
		buffer.append("sum(sNotTaxRateAmount) as sNotTaxRateAmount , ");
		buffer.append("sTaxRate as sTaxRate , ");
		buffer.append("sCostPrice as sCostPrice , ");
		buffer.append("sum(sTaxAmount) as sTaxAmount , ");
		buffer.append("sum(sCostPriceAmount) as sCostPriceAmount,'' as sInvoiceState, ");
		buffer.append("'' as sStockID ");	
		buffer.append(" from ( ");
		buffer.append("select (C_ST_IE_BillID + C_ST_IE_GoodsId) as sLveveID,C_ST_IE_BillID as sLveveBillID , ");
		buffer.append("C_ST_IE_GoodsId as sLveveGoodsID , ");
		buffer.append("B_GI_GoodsName as sGoodsName , ");
		buffer.append("B_GI_Spec as sSpec , ");
		buffer.append("C_ST_IE_GoodsQuantity as sGoodsQuantity , ");
		buffer.append("C_ST_IE_AverageNotTaxRate as sNotTaxRate , ");
		buffer.append("C_ST_IE_AverageNotTaxRateAmount as sNotTaxRateAmount , ");
		buffer.append("C_ST_IE_TaxRate as sTaxRate , ");
		buffer.append("C_ST_IE_CostPrice as sCostPrice , ");
		buffer.append("C_ST_IE_TaxAmount as sTaxAmount , ");
		buffer.append("C_ST_IE_CostPriceAmount as sCostPriceAmount,'' as sInvoiceState ");
		buffer.append("from C_ST_InventoryEntry ");
		buffer.append("left join B_GoodsInfo ");
		buffer.append("on B_GoodsInfo.B_GI_GoodsID = C_ST_InventoryEntry.C_ST_IE_GoodsId ");
		buffer.append("where C_ST_IE_BillID = ? ");		
		buffer.append("union all ");		// 合并盘盈盘亏，取实际盈亏的商品
		buffer.append("select (? + C_ST_IE_GoodsId) as sLveveID,? as sLveveBillID , ");
		buffer.append("C_ST_IE_GoodsId as sLveveGoodsID , ");
		buffer.append("B_GI_GoodsName as sGoodsName , ");
		buffer.append("B_GI_Spec as sSpec , ");
		buffer.append("-C_ST_IE_GoodsQuantity as sGoodsQuantity , ");
		...
		buffer.append("-C_ST_IE_TaxAmount as sTaxAmount , ");
		buffer.append("-C_ST_IE_CostPriceAmount as sCostPriceAmount,'' as sInvoiceState ");
		buffer.append("from C_ST_InventoryEntry inner join C_ST_Inventory on C_ST_I_BillID = C_ST_IE_BillID ");
		buffer.append("left join B_GoodsInfo ");
		buffer.append("on B_GoodsInfo.B_GI_GoodsID = C_ST_InventoryEntry.C_ST_IE_GoodsId ");
		buffer.append("where C_ST_I_SourceBillId in (select C_ST_I_SourceBillId from (select top 1 C_ST_I_SourceBillId from dbo.C_ST_Inventory where C_ST_I_BillID = ? )t1) ");
		if (Utility.getName(po.getsLveveBillID()).substring(0,3).equals("SCI")){			
			buffer.append(" and C_ST_I_BillTypeId = '6' ");   // 如果是盘盈，此处取盘亏
		}else{
			buffer.append(" and C_ST_I_BillTypeId = '5'  ");    // 如果是盘亏，此处取盘盈
		}
		buffer.append(" )t group by sLveveID,sLveveBillID,sLveveGoodsID,sGoodsName,sSpec,sNotTaxRate,sTaxRate,sCostPrice ");
		buffer.append(" having sum(sGoodsQuantity) > 0 ");
	...
	public void lockBills(VoucherEntryPo voucherEntryPo,String type){
		...
		if (Utility.getName(voucherEntryPo.getsLveveBillID()).substring(0,4).equalsIgnoreCase("SOUT")){
			sb.append("update C_ST_Inventory set C_ST_I_VoucherType=dbo.updateBillVoucherType(?,?),C_ST_I_VoucherDate=getDate() where C_ST_I_BillID=?");
			params.add(Utility.getName(voucherEntryPo.getsLveveBillID()));
		}else{
			sb.append("update C_ST_Inventory set C_ST_I_VoucherType=?,C_ST_I_VoucherDate=getDate() where C_ST_I_BillID=?");
		}
	...
	public void notLockBills(String voucherID,String voucherType){
		...
		sb.append("update C_ST_Inventory set C_ST_I_VoucherType=replace(C_ST_I_VoucherType,?,'0'),C_ST_I_VoucherDate=NULL where C_ST_I_BillID in ( ");
...
//		}
	...
	public List<InventoryPo> selInvoiceAndReversal(InventoryPo po , int start , int size){
		...
		sb.append("       inner join L_IT_InvoiceType on L_I_I_InvoiceType=L_IT_ID ");
		sb.append("       left join L_IE_InvoiceEntry on L_I_I_ID=L_IE_IE_InvoiceID ");
		sb.append("       left join L_VE_VoucherEntry on L_I_I_ID=L_VE_VE_BillID ");
		sb.append("  where L_I_I_AuditStatue='1' ");
		if (!"".equals(Utility.getName(po.getCstibillid()))){
			sb.append(" and L_I_I_ID like '%' + ? + '%'");
			params.add(po.getCstibillid());
	...
	public VoucherPo selCurrentAccountPeriod(){
		...
		StringBuffer sb = new StringBuffer();
		sb.append("select cast(L_SA_Year as varchar)+'-'+L_SA_Month+'-01' as sLvvDateTopLimit,  ");
		...
		sb.append("   from L_SA_SwitchAmount where L_SA_CurrentMonth='1' ");
				
		return (VoucherPo)queryForObject(sb.toString(),null,VoucherPo.class);
	}
	
	/**
	 * 开关账
	 */
	public void switchAmount(String flag){
		
		StringBuffer sb = new StringBuffer();
		sb.append("exec eims_SwitchAmount ? "); 
		
		List<String> params = new ArrayList<String>();
		params.add(flag); // 1:关账    0:开账
