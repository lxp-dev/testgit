...
public class ContactGlassHydsyDaoImpl extends BaseJdbcDaoSupport implements ContactGlassHydsyDao
{
	public void contactGlassInsert(ContactGlassPo contactGlassPo) {
		...
		sb.append(",S_OP_CG_JmpgOD ");
		sb.append(",S_OP_CG_JmpgOS ");
		sb.append(",S_OP_CG_RemarkOD ");
		sb.append(",S_OP_CG_RemarkOS ");
		...
		params.add(Utility.getName(contactGlassPo.getSopcjmpgod()));
		params.add(Utility.getName(contactGlassPo.getSopcjmpgos()));
		params.add(Utility.getName(contactGlassPo.getSopcremarkod()));
		params.add(Utility.getName(contactGlassPo.getSopcremarkos()));
	...
	public List<ContactGlassPo> getContactGlassList(ContactGlassPo contactGlassPo) {
		...
		sb.append(",S_OP_CG_JmpgOD as sopcjmpgod");
		sb.append(",S_OP_CG_JmpgOS as sopcjmpgos");		
		sb.append(",S_OP_CG_RemarkOD as sopcremarkod");
		sb.append(",S_OP_CG_RemarkOS as sopcremarkos");
