...
public class InspectionHydsyDaoImpl extends BaseJdbcDaoSupport implements
		InspectionHydsyDao {
	...
	public void inspectionInsert(InspectionPo inspectionPo) {
		...
		sb.append(",S_OP_IP_AntongOD	             ");
		sb.append(",S_OP_IP_AntongOS	             ");	
		/**
		 * 检查结论中，屈光不正区分左右眼
		 * 检查结论中，双眼视功能评估区分左右眼
		 * 4字段
		 */
		sb.append(",S_OP_IP_NeareyeOS	             ");
		sb.append(",S_OP_IP_FareyeOS	         ");
		sb.append(",S_OP_IP_AstigmiaOS	             ");
		sb.append(",S_OP_IP_EstimateOS	             ");
		...
		params.add(Utility.getName(inspectionPo.getSopipantongod()));
		params.add(Utility.getName(inspectionPo.getSopipantongos()));
		 ...
		 * 4字段
		 */
		params.add(Utility.getName(inspectionPo.getSopipneareyeos()));
		params.add(Utility.getName(inspectionPo.getSopipfareyeos()));
		params.add(Utility.getName(inspectionPo.getSopipastigmiaos()));
		params.add(Utility.getName(inspectionPo.getSopipestimateos()));
	...
	public List<InspectionPo> getInspectionList(InspectionPo inspectionPo) {
		...
		sb.append(",S_OP_IP_AntongOD	        as sopipantongod	             ");
		sb.append(",S_OP_IP_AntongOS	        as sopipantongos	             ");
		 ...
		 * 4字段
		 */
		sb.append(",S_OP_IP_NeareyeOS			as sopipneareyeos	             ");
		sb.append(",S_OP_IP_FareyeOS			as sopipfareyeos		         ");
		sb.append(",S_OP_IP_AstigmiaOS			as sopipastigmiaos       	     ");
		sb.append(",S_OP_IP_EstimateOS			as sopipestimateos	             ");
