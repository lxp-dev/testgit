...
public class DoubleEyeFunPo {
	...
	private String sopdebccou; // bcc - OU
	private String sopdebccod; // bcc - OD
	private String sopdebccos; // bcc - OS
	
	public String getSopdebccou() {
		return sopdebccou;
	}

	public void setSopdebccou(String sopdebccou) {
		this.sopdebccou = sopdebccou;
	}

	public String getSopdebccod() {
		return sopdebccod;
	}

	public void setSopdebccod(String sopdebccod) {
		this.sopdebccod = sopdebccod;
	}

	public String getSopdebccos() {
		return sopdebccos;
	}

	public void setSopdebccos(String sopdebccos) {
		this.sopdebccos = sopdebccos;
	}
