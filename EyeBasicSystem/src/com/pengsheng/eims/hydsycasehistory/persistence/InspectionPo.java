...
public class InspectionPo {
	...
	private String sopipglasstype; // 处方形式 1：远用，2：近用，3：双光/渐进，4：隐形
	...
	private String sopiprecipetype; // 处方形式 远用，近用，双光/渐进，隐形
	...
	private String sopipcommendcardwater; //
	private String sopipconlenodnum; //
	private String sopipconlenosnum; //
	private String sopipsource;
	private String sopippupilheightod;
	private String sopippupilheightos;	
	...
	private String sopipantongod	 ;      //暗瞳 - 右
	private String sopipantongos	 ;      //暗瞳 - 左	
	private String sopipcommendglassesod; // 适用镜片OD
	private String sopipcommendglassesos; // 适用镜片OD
	
	/* 哈医大
	 * 检查结论中，屈光不正区分左右眼
	 */
	private String sopipneareye				;		//近视眼OD
	private String sopipneareyeos			;		//近视眼OS
	private String sopipfareye				;		//远视眼OD
	private String sopipfareyeos			;		//远视眼OS
	private String sopipastigmia			;       //散光OD
	private String sopipastigmiaos			;       //散光OS
	
	/* 哈医大
	 * 检查结论中，双眼视功能评估区分左右眼
	 */
	private String sopipestimate			;       //双眼视功能评估OD
	private String sopipestimateos			;       //双眼视功能评估OS
	
	public String getSopipneareyeos() {
		return sopipneareyeos;
	}

	public void setSopipneareyeos(String sopipneareyeos) {
		this.sopipneareyeos = sopipneareyeos;
	}

	public String getSopipfareyeos() {
		return sopipfareyeos;
	}

	public void setSopipfareyeos(String sopipfareyeos) {
		this.sopipfareyeos = sopipfareyeos;
	}

	public String getSopipastigmiaos() {
		return sopipastigmiaos;
	}

	public void setSopipastigmiaos(String sopipastigmiaos) {
		this.sopipastigmiaos = sopipastigmiaos;
	}

	public String getSopipestimateos() {
		return sopipestimateos;
	}

	public void setSopipestimateos(String sopipestimateos) {
		this.sopipestimateos = sopipestimateos;
	}
	...
	public String getSopipantongod() {
		return sopipantongod;
	}

	public void setSopipantongod(String sopipantongod) {
		this.sopipantongod = sopipantongod;
	}

	public String getSopipantongos() {
		return sopipantongos;
	}

	public void setSopipantongos(String sopipantongos) {
		this.sopipantongos = sopipantongos;
	}
