...
public class DoubleEyeFunHydsyAction extends BaseAction  {
...
//		systemParameterPo = (SystemParameterPo) session.get("systemParameterPo");
	...
	private DoubleEyeFunHydsyMgr doubleEyeFunNMgr;
	public DoubleEyeFunHydsyMgr getDoubleEyeFunHydsyMgr() {
		return doubleEyeFunNMgr;
	}
	public void setDoubleEyeFunHydsyMgr(DoubleEyeFunHydsyMgr doubleEyeFunNMgr) {
	...
	private OptometryBasicHydsyMgr optometryBasicNMgr;
	public OptometryBasicHydsyMgr getOptometryBasicHydsyMgr() {
		return optometryBasicNMgr;
	}
	public void setOptometryBasicHydsyMgr(OptometryBasicHydsyMgr optometryBasicNMgr) {
