...
public class OptometryCaseAction extends BaseAction {
	private PersonPermissionMgr personPermissionMgr;
	
	private OptometryCaseMgr optometryCaseMgr;
	...
	public OptometryCaseMgr getOptometryCaseMgr() {
		return optometryCaseMgr;
	}
	
	public void setOptometryCaseMgr(OptometryCaseMgr optometryCaseMgr) {
		this.optometryCaseMgr = optometryCaseMgr;
	}
	 ...
	 * 扫描卡号得会员信息
	 */
	public String initOptometryCaseSel() {
		/** ********************** 权限设置 ***************************** */
	...
	public String optometryCaseSel() {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
		...
		int count = optometryCaseMgr.getOptometryCaseCount(po);
		if (count > 0) {
			int perPage = 0;
			...
			optometryPos = optometryCaseMgr.getOptometryCases(po, page.getStart(),page.getPageSize());
