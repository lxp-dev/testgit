...
public class RefractiveDaoImpl extends BaseJdbcDaoSupport implements RefractiveDao {
	...
	public void insertRefractivePo(RefractivePo refractivePo) {
		...
		//接诊医师
		if(!"".equals(Utility.getName(refractivePo.getSoprexaminedoctor()))){
			buffer.append(" S_OP_R_ExamineDoctor, ");
			params.add(Utility.getName(refractivePo.getSoprexaminedoctor()));
		}
	...
	public void updateRefractive(RefractivePo refractivePo) {
		...
		//裸眼视力(左)
		buffer.append(" S_OP_R_NakedOS = ?, ");
		params.add(Utility.getName(refractivePo.getSoprnakedos()));

		buffer.append(" S_OP_R_DiffusePupil = ?, ");
		params.add(refractivePo.getSoprdiffusepupil());
		
		buffer.append(" S_OP_R_CheckBallGlassOD = ?, ");
		params.add(refractivePo.getSoprcheckballglassod());
		
		buffer.append(" S_OP_R_CheckBallGlassOS = ?, ");
		params.add(refractivePo.getSoprcheckballglassos());
		
		buffer.append(" S_OP_R_CheckPostGlassOD = ?, ");
		params.add(refractivePo.getSoprcheckpostglassod());
		
		buffer.append(" S_OP_R_CheckPostGlassOS = ?, ");
		params.add(refractivePo.getSoprcheckpostglassos());
		...
		//接诊日期
		buffer.append(" S_OP_R_ExamineDoctor = ?, ");
		params.add(refractivePo.getSoprexaminedoctor());
	...
	public RefractivePo getRefractive(RefractivePo po) {
		...
		sb.append(",S_OP_R_ExamineDoctor as soprexaminedoctor ");
		sb.append(",isnull(a.personName,'') as soprexaminedoctorname ");
		
		sb.append("FROM S_OP_Refractive left join SYS_PersonInfo a on a.id = S_OP_R_ExamineDoctor ");
