 ...
 * 
 */
public class GoodsCostDiscountDaoImpl extends BaseJdbcDaoSupport implements GoodsCostDiscountDao { 
...
//			params.add(Utility.getName(po.getBgiaccessoriestype()));
	...
	public List<IntegralPo> getIntegralSetList(IntegralPo po, int start, int size){
		...
		sb.append("set rowcount " + countPage + " \n");
		sb.append(" select firID as firID,firGoodsCategoryName as firGoodsCategoryName,firGoodsID as firGoodsID,firSupplierName as firSupplierName,firBrandName as firBrandName,firGoodsName as firGoodsName,firIntegralCount as firIntegralCount ");
...
/****************************************************************************************************************/
	...
	public int getMaxDiscountSetCount(MaxDiscountPo po){
		...
		sb.append(" select count(F_MD_ID) from F_FlySheetDiscount where 1=1 ");		
	...
	public List<MaxDiscountPo> getMaxDiscountSetList(MaxDiscountPo po, int start, int size){
		...
		sb.append(" from F_FlySheetDiscount where 1=1  ");
	...
	public void insertMaxDiscountSet(MaxDiscountPo po){
		...
		sb.append("insert into F_FlySheetDiscount(F_MD_ID,  ");
		...
		sb.append("F_MD_MaxDiscount, F_MD_GoodsCategoryName, F_MD_SupplierName, F_MD_BrandName,             ");
	...
	public void updateMaxDiscountSet(MaxDiscountPo po){
		...
		sb.append("update F_FlySheetDiscount set F_MD_MaxDiscount=?,F_MD_Reamrk=? where F_MD_ID=? ");
	...
	public void updateBatchMaxDiscountSet(MaxDiscountPo po){
		...
		sb.append("update F_FlySheetDiscount set F_MD_MaxDiscount=? where F_MD_ID=? ");
	...
	public void deleteMaxDiscountSet(MaxDiscountPo po){
		...
		sb.append("delete from F_FlySheetDiscount where F_MD_ID=? ");
	...
	public MaxDiscountPo getMaxDiscountSetDetail(MaxDiscountPo po){
		...
		sb.append(" F_MD_GoodsCategoryID as fmdgoodscategoryid,F_MD_SupplierID as fmdsupplierid,F_MD_BrandID as fmdbrandid,F_MD_GoodsID as fmdgoodsid,F_MD_Reamrk as fmdreamrk from F_FlySheetDiscount where F_MD_ID=?  ");
	...
	public int isExistMaxDiscountSet(MaxDiscountPo po){
		...
		sb.append(" select count(F_MD_ID) from F_FlySheetDiscount where F_md_GoodsCategoryID=? and F_md_SupplierID=? and F_md_BrandID=? and F_md_GoodsID=? ");
		params.add(Utility.getName(po.getFmdgoodscategoryid()));
		params.add(Utility.getName(po.getFmdsupplierid()));
		params.add(Utility.getName(po.getFmdbrandid()));
		params.add(Utility.getName(po.getFmdgoodsid()));
	...
	public void insertIntegralExchangeSet(IntegralPo po){
		...
		sb.append("insert into F_IntegralExchange(F_IR_GoodsID,F_IR_GoodsName,F_IR_IntegralCount,F_IR_Flag,F_IR_DepartmentID)  ");
		sb.append(" values(?,?,?,?,?)         ");
	...
	public void updateIntegralExchangeSet(IntegralPo po){
		...
		sb.append("update F_IntegralExchange set F_IR_IntegralCount=?,F_IR_DepartmentID=? where F_IR_GoodsID=? ");
	...
	public IntegralPo getIntegralExchangeSetDetail(IntegralPo po){
		...
		sb.append(" select top 1 F_IR_GoodsID as firGoodsID,dbo.getShopCodeNameList(F_IR_DepartmentID) as firdepartmentname,F_IR_DepartmentID as firdepartmentid,F_IR_GoodsName as firGoodsName,F_IR_IntegralCount as firIntegralCount,F_IR_Flag as firFlag from F_IntegralExchange where F_IR_GoodsID=? ");		
	...
	public MaxDiscountPo selectMaxDiscountSetPo(MaxDiscountPo po){
		...
		sb.append("FROM   F_FlySheetDiscount ");
		sb.append("WHERE  1 = 1 ");
		if(!"".equals(Utility.getName(po.getFmdgoodscategoryid()))){
			sb.append("       AND F_MD_GoodsCategoryID = ? ");
			params.add(Utility.getName(po.getFmdgoodscategoryid()));
