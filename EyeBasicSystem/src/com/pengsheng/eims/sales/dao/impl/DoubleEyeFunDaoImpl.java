...
public class DoubleEyeFunDaoImpl extends BaseJdbcDaoSupport implements
		DoubleEyeFunDao {
	...
	public int getDoubleEyeFunCount(OptometryPo optometryPo) {
		...
		StringBuffer sb = new StringBuffer();
		sb
				.append("select count(S_OP_DE_OptometryID) from S_OP_DoubleEyeFunction where S_OP_DE_OptometryID=?");
