...
public class ContactGlassAierAction extends BaseAction {
	...
	private ContactGlassNMgr contactGlassNMgr;
	...
	public String contactGlassInsertN() {
		...
		this.contactGlassNMgr.contactGlassInsertMessage(contactGlassPos,
		...
		request.setAttribute("url", "'initOptometryBasicSelAier.action?moduleID="
				+ moduleID + "'");
		request.setAttribute("customerID", customerID);
		request.setAttribute("optometryID", optometryID);
		request.setAttribute("optometryBasicID", optometryBasicID);
	...
	public String contactGlassInsertDetailsOpenN() throws Exception {
		...
		if ("1".equals(ruleFlag)) {
			CustomerInfoPo cpo = contactGlassNMgr.getCustomerInfo(optometryID);
	...
	public String initContactGlassUpdateN() {
		...
		contactGlassPos = this.contactGlassNMgr.getContactGlassList(contact);
	...
	public String contactGlassUpdateN() {
		...
		this.contactGlassNMgr.contactGlassUpdateMessage(contactGlassPos,
	...
	public String initContactGlassSelectN() {
		...
		contactGlassPos = this.contactGlassNMgr
	...
	public String contactGlassCopyN() {
		...
		contactGlassPos = contactGlassNMgr.getContactGlassList(contactGlassPo);
	...
	public String contactGlassToolN() {
		...
		if ("contactGlassiou".equals(source)) {
			count = this.contactGlassNMgr.getcontactGlassCount(optometryPo);
	...
	// contactGlassNMgr.contactGlassprint(dayin[0]);
	// }
	...
	public ContactGlassNMgr getContactGlassNMgr() {
		return contactGlassNMgr;
	}

	public void setContactGlassNMgr(ContactGlassNMgr contactGlassNMgr) {
		this.contactGlassNMgr = contactGlassNMgr;
	}
