...
public class GlassesHistoryAierAction extends BaseAction {
	...
	private GlassesHistoryNMgr glassesHistoryNMgr;	
	...
	public String selectGlassesHistoryN(){
		...
		hisInfoPo=glassesHistoryNMgr.selectGlassesHistory(hisInfoPo);
		
		optometryPo = optometryBasicNMgr.selectOptometryPo(optometryPo.getSopoyoptometryid());
	...
	public String updateGlassesHistoryN(){
		...
		glassesHistoryNMgr.insertGlassesHistory(hisInfoPo,logPo);
	...
	public GlassesHistoryNMgr getGlassesHistoryNMgr() {
		return glassesHistoryNMgr;
	}
	...
	public void setGlassesHistoryNMgr(GlassesHistoryNMgr glassesHistoryNMgr) {
		this.glassesHistoryNMgr = glassesHistoryNMgr;
	}
