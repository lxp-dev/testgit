...
public interface CustomerReturnVisitDao {
	 ...
	 * @return
	 */
	public int getCustomerReturnVisitCount(SalesBasicPo salesBasicPo , CustomerVisitPo customerVisitPo,SystemParameterPo systemParameterPo);
	 ...
	 * @return
	 */
	public List<SalesBasicPo> selectCustomerReturnVisitList(SalesBasicPo salesBasicPo , CustomerVisitPo customerVisitPo , int start , int size,SystemParameterPo systemParameterPo);
