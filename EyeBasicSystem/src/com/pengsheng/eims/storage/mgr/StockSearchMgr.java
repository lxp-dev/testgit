...
public interface StockSearchMgr {
	/**
	 * 获取库存综合查询的数量
	 * @param po 商品po
	 * @return int 数量
	 ...
	 * @return list 商品list ↓
	 */
	public List<GoodsDetailsInfoPo> getStockSearchDetailsList(GoodsDetailsInfoPo po,PersonInfoPo personInfoPo,int start,int size);
