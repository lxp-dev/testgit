...
public class AllocationApplyDaoImpl extends BaseJdbcDaoSupport implements AllocationApplyDao {
	...
	public int getAllocationCount(AllocationPo po,DepartmentsPo departmentsPo) {
		...
		sb.append("select count(distinct C_SHA_ApplyAllocation.C_SHA_AA_billID) from C_SHA_ApplyAllocation inner join C_SHA_ApplyAllocationEntry on C_SHA_AA_billID=C_SHA_AAE_billId inner join B_GoodsInfo on C_SHA_AAE_goodsId=B_GI_GoodsID ");
		...
		sb.append("where (ISNULL(C_SHA_AA_ForAppFlag, '') = '' OR C_SHA_AA_ForAppFlag = '0') AND C_SHA_AA_flag=?  ");
	...
	public List<AllocationPo> getAllocationList(AllocationPo po,DepartmentsPo departmentsPo, int start,
		...
		sb.append("temp.cshaabillid as cshaabillid,temp.cshaaindepartmentname as cshaaindepartmentname,");
		sb.append("temp.cshaacreatepersonname as cshaacreatepersonname,temp.cshaabilldate as cshaabilldate,");
		sb.append("temp.cshaaauditpersonname as cshaaauditpersonname,temp.cshaaauditdate as cshaaauditdate,");
		sb.append("temp.chaasuppliername as chaasuppliername,temp.goodscategoryname as goodscategoryname,");
		sb.append("temp.cshaaauditstate as cshaaauditstate,temp.cshastatusorderid as cshastatusorderid,temp.cshaaremark as cshaaremark from ( ");
		
		sb.append("select distinct C_SHA_ApplyAllocation.C_SHA_AA_billID as cshaabillid,d.B_DP_DepartmentName as cshaaindepartmentname,");
		...
		sb.append("c.B_SP_SupplierName as chaasuppliername,f.B_GC_GoodsCategoryName as goodscategoryname,e.C_SHA_StatusOrderID as cshastatusorderid,C_SHA_AA_remark as cshaaremark,");
		sb.append("C_SHA_ApplyAllocation.C_SHA_AA_auditState as cshaaauditstate from C_SHA_ApplyAllocation inner join C_SHA_ApplyAllocationEntry on C_SHA_AA_billID=C_SHA_AAE_billId inner join B_GoodsInfo on C_SHA_AAE_goodsId=B_GI_GoodsID ");
		sb.append("inner join (select B_DP_DepartmentID,B_DP_DepartmentName from B_Departments)d on C_SHA_ApplyAllocation.C_SHA_AA_inDepartmentId=d.B_DP_DepartmentID ");
		sb.append("left join (select ID,personName from SYS_PersonInfo)a on C_SHA_ApplyAllocation.C_SHA_AA_createPerson=a.ID ");
		sb.append("left join (select ID,personName from SYS_PersonInfo)b on C_SHA_ApplyAllocation.C_SHA_AA_auditPerson=b.ID ");
		sb.append("left join (select B_SP_ID,B_SP_SupplierName from B_Supplier)c on C_SHA_ApplyAllocation.C_SHA_AA_supplier=c.B_SP_ID ");
	...
	public void insertAllocation(AllocationPo po) {
		...
		sb1.append("C_SHA_AA_createPerson,C_SHA_AA_auditState,C_SHA_AA_remark,C_SHA_AA_flag,C_SHA_AA_supplier,C_SHA_AA_goodscategory,C_SHA_AA_ForAppFlag ");
		sb2.append("?,getdate(),?,?,?,?,");
		sb2.append("?,?,?,0 ");
		List<String> params = new ArrayList<String>();
		params.add(po.getCshaabillid());
	...
	public void updateAllocation(AllocationPo po) {
		...
		sb.append("C_SHA_AA_auditState=?,C_SHA_AA_remark=?,C_SHA_AA_supplier=?,C_SHA_AA_goodscategory=? ");
		params.add(po.getCshaaindepartmentid());
		params.add(po.getCshaaauditstate());
		params.add(po.getCshaaremark());
		params.add(po.getChaasupplier());
	...
	public AllocationPo getAllocation(AllocationPo po) {
		...
		sb.append("             d.B_DP_DepartmentName                          AS cshaaoutdepartmentname,");
		...
		sb.append("             C_SHA_ApplyAllocation.C_SHA_AA_inDepartmentId  AS cshaaindepartmentid,");
	...
	public List<AllocationBarcodePo> getAllocationBarcode(AllocationPo allocationPo){
		...
		params.add(allocationPo.getCshaabillid());
//		if(!"".equals(allocationPo.getCshaaremark())){
//			sb.append(" and C_SHA_B_GoodsID=? ");
//			params.add(allocationPo.getCshaaremark());//此处代表商品代码
//		}
