...
/*********************************************************************************************/
	 ...
	 * 新增记账凭证
	 */
	public void insertVoucherTally(VoucherPo po,List<VoucherTallyPo> voucherEntryList,LogisticsLogPo logPo);
	
	/**
	 * 修改记账凭证
	 */
	public void updateVoucherTally(VoucherPo po,List<VoucherTallyPo> voucherEntryList,LogisticsLogPo logPo);
