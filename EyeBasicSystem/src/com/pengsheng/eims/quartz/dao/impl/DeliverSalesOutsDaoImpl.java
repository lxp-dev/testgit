...
public class DeliverSalesOutsDaoImpl extends BaseJdbcDaoSupport implements DeliverSalesOutsDao {
	...
	public List<InventoryEntryPo> getDeliverEntryList() {
		...
		//委外订单 C_ST_D_AuditState='1'
		 ...
		 sb.append("C_ST_CPRD_TaxRate as cstietaxrate,0 as cstiecostprice,"); 
		 sb.append("0 as cstiecostpriceamount,"); 
		 ...
		 sb.append("where (C_ST_CPR_State='0' or  C_ST_CPR_State is NULL) and C_ST_CPR_AuditState='1'  and C_ST_CPOD_GlassesBillID like 'B%' "); 
//		sb.append("group by C_ST_D_DeliverBillId,B_GI_GoodsID,B_GI_CostPrice,B_GI_TaxRate,B_GI_GoodsBarCode,C_ST_D_AuditDate ");
	...
	public void insertDeliverSalesOuts(InventoryPo po) {
