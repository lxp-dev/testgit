...
public class RefractiveBjtrDaoImpl extends BaseJdbcDaoSupport implements RefractiveBjtrDao {
	...
	public void insertRefractivePo(RefractivePo refractivePo) {
		...
		buffer.append(" S_OP_R_sopmdid, ");
		params.add(Utility.getName(refractivePo.getSoprsopmdid()));
...
//		getJdbcTemplate().update(buffer.toString(), params.toArray());
	...
	public RefractivePo getRefractive(RefractivePo po) {
		...
		sb.append(",isnull(S_OP_R_sopmdid,'')	as soprsopmdid ");
	...
	public void insertRefractiveTempPo(RefractivePo refractivePo) {
		...
		StringBuffer buffer = new StringBuffer();
		List<String> params = new ArrayList<String>();
		buffer.append(" insert into S_OP_RefractiveTemp ( ");
		buffer.append(" S_OP_R_ID, ");
		params.add(this.uuid.generate());
		buffer.append(" S_OP_R_CustomerID, ");
		params.add(refractivePo.getSoprcustomerid());
	...
	public int getRefractiveCount(RefractivePo po) {
		StringBuffer buffer = new StringBuffer();
		buffer.append("select count(S_OP_R_CustomerID) from S_OP_RefractiveTemp ");
		buffer.append("where convert(varchar(10),S_OP_R_Inspection_date,23) >= CONVERT(VARCHAR(10),getdate(), 23) ");
		buffer.append("and	convert(varchar(10),S_OP_R_Inspection_date,23) <= CONVERT(VARCHAR(10),getdate(), 23)  ");
		buffer.append("and S_OP_R_CustomerID=?  ");

		List<String> params = new ArrayList<String>();
		params.add(po.getSoprcustomerid());
	...
	public void updateRefractiveTemp(RefractivePo refractivePo) {
		StringBuffer buffer = new StringBuffer();
		List<String> params = new ArrayList<String>();
		buffer.append(" update  S_OP_RefractiveTemp set ");
		buffer.append(" S_OP_R_RefractiverID = ?, ");
		params.add(Utility.getName(refractivePo.getSoprrefractiverid()));
		//瞳孔距离(右)
		buffer.append(" S_OP_R_CheckPDOD = ?, ");
