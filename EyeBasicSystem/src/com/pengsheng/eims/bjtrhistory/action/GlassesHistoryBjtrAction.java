...
public class GlassesHistoryBjtrAction extends BaseAction {
	...
	private GlassesHistoryBjtrMgr glassesHistoryBjtrMgr;	
	...
	public String selectGlassesHistoryN(){
		...
		hisInfoPo=glassesHistoryBjtrMgr.selectGlassesHistory(hisInfoPo);
		
		optometryPo = optometryBasicBjtrMgr.selectOptometryPo(optometryPo.getSopoyoptometryid());
	...
	public String updateGlassesHistoryN(){
		...
		glassesHistoryBjtrMgr.insertGlassesHistory(hisInfoPo,logPo);
	...
	public GlassesHistoryBjtrMgr getGlassesHistoryBjtrMgr() {
		return glassesHistoryBjtrMgr;
	}

	public void setGlassesHistoryBjtrMgr(GlassesHistoryBjtrMgr glassesHistoryBjtrMgr) {
		this.glassesHistoryBjtrMgr = glassesHistoryBjtrMgr;
	}
