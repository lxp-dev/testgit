...
public class ContactGlassBjtrAction extends BaseAction {
	...
	private ContactGlassBjtrMgr contactGlassBjtrMgr;
	...
	public String contactGlassInsertN() {
		...
		this.contactGlassBjtrMgr.contactGlassInsertMessage(contactGlassPos,
		...
		request.setAttribute("url", "'initOptometryBasicSelBjtr.action?moduleID="
				+ moduleID + "'");
		request.setAttribute("customerID", customerID);
		request.setAttribute("optometryID", optometryID);
		request.setAttribute("optometryBasicID", optometryBasicID);
	...
	public String contactGlassInsertDetailsOpenN() throws Exception {
		...
		if ("1".equals(ruleFlag)) {
			...
			CustomerInfoPo cpo = contactGlassBjtrMgr.getCustomerInfo(optometryID);
			...
			// this.contactGlassBjtrMgr.updateContactGlassFlag(optometryID,null);
		}
	...
	public String initContactGlassUpdateN() {
		...
		contactGlassPos = this.contactGlassBjtrMgr.getContactGlassList(contact);
	...
	public String contactGlassUpdateN() {
		...
		this.contactGlassBjtrMgr.contactGlassUpdateMessage(contactGlassPos,
	...
	public String initContactGlassSelectN() {
		...
		contactGlassPos = this.contactGlassBjtrMgr
	...
	public String contactGlassCopyN() {
		...
		contactGlassPos = contactGlassBjtrMgr.getContactGlassList(contactGlassPo);
	...
	public String contactGlassToolN() {
		...
		if ("contactGlassiou".equals(source)) {
			count = this.contactGlassBjtrMgr.getcontactGlassCount(optometryPo);
	...
	// contactGlassBjtrMgr.contactGlassprint(dayin[0]);
	// }
	...
	public ContactGlassBjtrMgr getContactGlassBjtrMgr() {
		return contactGlassBjtrMgr;
	}

	public void setContactGlassBjtrMgr(ContactGlassBjtrMgr contactGlassBjtrMgr) {
		this.contactGlassBjtrMgr = contactGlassBjtrMgr;
	}
