...
public class OptometryCaseBjtrAction extends BaseAction {
	private PersonPermissionMgr personPermissionMgr;
	
	private OptometryCaseBjtrMgr optometryCaseBjtrMgr;
	...
	public String optometryCaseSelN() {
		...
		int count = optometryCaseBjtrMgr.getOptometryCaseCount(po);
		if (count > 0) {
			int perPage = 0;
			...
			optometryPos = optometryCaseBjtrMgr.getOptometryCases(po, page.getStart(),page.getPageSize());
	...
	public OptometryCaseBjtrMgr getOptometryCaseBjtrMgr() {
		return optometryCaseBjtrMgr;
	}

	public void setOptometryCaseBjtrMgr(OptometryCaseBjtrMgr optometryCaseBjtrMgr) {
		this.optometryCaseBjtrMgr = optometryCaseBjtrMgr;
	}
