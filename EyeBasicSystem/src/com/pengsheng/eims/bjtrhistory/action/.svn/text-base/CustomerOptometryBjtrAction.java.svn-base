...
public class CustomerOptometryBjtrAction  extends BaseAction {

	private CustomerInfoMgr customerInfoMgr;
	private CustomerOptometryBjtrMgr customerOptometryBjtrMgr;
	...
	public CustomerOptometryBjtrMgr getCustomerOptometryBjtrMgr() {
		return customerOptometryBjtrMgr;
	}

	public void setCustomerOptometryBjtrMgr(
			CustomerOptometryBjtrMgr customerOptometryBjtrMgr) {
		this.customerOptometryBjtrMgr = customerOptometryBjtrMgr;
	}
	...
	public String initCustomerOptometryTitleN() {
		...
		optometryPo = customerOptometryBjtrMgr.getOptometryPo(optometryID_title);
