 ...
 * 
 */
public class OptometryBasicBjtrAction extends BaseAction {
	...
	public String initOptometryBasicSelN() {
		...
		if (customerInfoPo != null
			...
			if (StringUtils.isNotEmpty(customerInfoPo.getSmecicustomerid())) {
				int count = optometryBasicBjtrMgr.getcustomerOptometryBasicCount(customerInfoPo.getSmecicustomerid());
				if (count > 0) {
					int perPage = 0;
					...
					optometryBasics = optometryBasicBjtrMgr.getcustomerOptometryBasics(customerInfoPo.getSmecicustomerid(), page.getStart(),page.getPageSize());

					for (OptometryBasicPo basic : optometryBasics) {
						basic.setOptometrys(optometryBasicBjtrMgr.getcustomerOptometrys(basic.getSopoboptometrybasicid()));
					}
	...
	public String deleteOptometryBasicN() {
		...
		optometryBasicBjtrMgr.delOptometryData(basicID, optometryID,logPo);
