...
public class PathUtil {
	public static String WebContextRootPath = "";
	
	static{
		WebContextRootPath = getWebContextRootPath();
	}
	/**
	 * 得到webContext的根路径
	 * */
	public static String getWebContextRootPath()
	{
		...
		try
		{
			String tempPath = getPathFromClass(PathUtil.class);
			
			webContextPath = tempPath.substring(0, tempPath.indexOf("WEB-INF") - 1);
		}
		catch(Exception e)
		{
			e.printStackTrace();
