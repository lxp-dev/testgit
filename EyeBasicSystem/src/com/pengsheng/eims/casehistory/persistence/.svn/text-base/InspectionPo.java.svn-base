...
public class InspectionPo {
	...
	private String sopipdoctorsay			;       //医嘱
	
	public String getSopipdoctorsay() {
		return sopipdoctorsay;
	}

	public void setSopipdoctorsay(String sopipdoctorsay) {
		this.sopipdoctorsay = sopipdoctorsay;
	}
