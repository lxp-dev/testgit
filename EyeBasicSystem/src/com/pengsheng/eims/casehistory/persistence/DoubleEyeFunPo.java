...
public class DoubleEyeFunPo {
	...
	private String sopdecoverod;			//掩盖右
	private String sopdecoveros;			//掩盖左
	private String sopdesumdot;				//集合聚点
	private String sopdetestbig;			//测试+
	private String sopdetestbigio;			//测试+ BO/BI
	private String sopdetestsmall;			//测试-
	private String sopdetestsmallio;		//测试- BO/BI
	private String sopdepositiveaccpraod;	//pra OD
	private String sopdepositiveaccpraos;	//pra OS
	private String sopdenegativeaccnraod;	//nra OD
	private String sopdenegativeaccnraos;	//nra OS
	private String sopdetwosidespec;		//双面镜度数
	private String sopdetwosidetest;		//双面镜测试
	private String sopdeequalwatch;			//不对等视
	private String sopdeinspecteyefun; // 是否进行双眼视功能检查
	private String sopdecoverflag; // 控制交替遮盖试验和遮去遮试验是否必填的下拉选项
	private String sopdefacilityflag; // 控制调节灵敏度中OU、OD、OS是否必填的下拉选项
	private String sopdeaddou; 				// AddOU
	
	public String getSopdeaddou() {
		return sopdeaddou;
	}

	public void setSopdeaddou(String sopdeaddou) {
		this.sopdeaddou = sopdeaddou;
	}

	public String getSopdecoverflag() {
		return sopdecoverflag;
	}

	public void setSopdecoverflag(String sopdecoverflag) {
		this.sopdecoverflag = sopdecoverflag;
	}

	public String getSopdefacilityflag() {
		return sopdefacilityflag;
	}

	public void setSopdefacilityflag(String sopdefacilityflag) {
		this.sopdefacilityflag = sopdefacilityflag;
	}
	...
	public String getSopdeequalwatch() {
		return sopdeequalwatch;
	}

	public void setSopdeequalwatch(String sopdeequalwatch) {
		this.sopdeequalwatch = sopdeequalwatch;
	}

	public String getSopdecoverod() {
		return sopdecoverod;
	}

	public void setSopdecoverod(String sopdecoverod) {
		this.sopdecoverod = sopdecoverod;
	}

	public String getSopdecoveros() {
		return sopdecoveros;
	}

	public void setSopdecoveros(String sopdecoveros) {
		this.sopdecoveros = sopdecoveros;
	}

	public String getSopdesumdot() {
		return sopdesumdot;
	}

	public void setSopdesumdot(String sopdesumdot) {
		this.sopdesumdot = sopdesumdot;
	}

	public String getSopdetestbig() {
		return sopdetestbig;
	}

	public void setSopdetestbig(String sopdetestbig) {
		this.sopdetestbig = sopdetestbig;
	}

	public String getSopdetestbigio() {
		return sopdetestbigio;
	}

	public void setSopdetestbigio(String sopdetestbigio) {
		this.sopdetestbigio = sopdetestbigio;
	}

	public String getSopdetestsmall() {
		return sopdetestsmall;
	}

	public void setSopdetestsmall(String sopdetestsmall) {
		this.sopdetestsmall = sopdetestsmall;
	}

	public String getSopdetestsmallio() {
		return sopdetestsmallio;
	}

	public void setSopdetestsmallio(String sopdetestsmallio) {
		this.sopdetestsmallio = sopdetestsmallio;
	}

	public String getSopdepositiveaccpraod() {
		return sopdepositiveaccpraod;
	}

	public void setSopdepositiveaccpraod(String sopdepositiveaccpraod) {
		this.sopdepositiveaccpraod = sopdepositiveaccpraod;
	}

	public String getSopdepositiveaccpraos() {
		return sopdepositiveaccpraos;
	}

	public void setSopdepositiveaccpraos(String sopdepositiveaccpraos) {
		this.sopdepositiveaccpraos = sopdepositiveaccpraos;
	}

	public String getSopdenegativeaccnraod() {
		return sopdenegativeaccnraod;
	}

	public void setSopdenegativeaccnraod(String sopdenegativeaccnraod) {
		this.sopdenegativeaccnraod = sopdenegativeaccnraod;
	}

	public String getSopdenegativeaccnraos() {
		return sopdenegativeaccnraos;
	}

	public void setSopdenegativeaccnraos(String sopdenegativeaccnraos) {
		this.sopdenegativeaccnraos = sopdenegativeaccnraos;
	}

	public String getSopdetwosidespec() {
		return sopdetwosidespec;
	}

	public void setSopdetwosidespec(String sopdetwosidespec) {
		this.sopdetwosidespec = sopdetwosidespec;
	}

	public String getSopdetwosidetest() {
		return sopdetwosidetest;
	}

	public void setSopdetwosidetest(String sopdetwosidetest) {
		this.sopdetwosidetest = sopdetwosidetest;
	}
