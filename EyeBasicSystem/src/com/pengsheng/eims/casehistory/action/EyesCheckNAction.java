...
public class EyesCheckNAction extends BaseAction {
	...
	public String selEyesCheckForCustomerN() throws Exception {
		...
		//向页面传递当日就诊号
		request.setAttribute("sopoytreatmentnum", eyesCheckPo.getSopoytreatmentnum());
	...
	public String insertEyesCheckN() throws Exception {
		...
		custmerInfoHISPo.setShccocustmerid(smecimemberid);
		...
		request.setAttribute("url", "'initEyesCheckInsertN.action?moduleID="+moduleID+"'");
