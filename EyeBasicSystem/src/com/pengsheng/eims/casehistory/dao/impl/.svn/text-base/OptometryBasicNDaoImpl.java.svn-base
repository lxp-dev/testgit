 ...
 * 
 */
public class OptometryBasicNDaoImpl extends BaseJdbcDaoSupport implements
		OptometryBasicNDao {
	...
	public void delOptometryPhoto(String optometryID) {
		
		StringBuffer buffer = new StringBuffer();
		List<String> params = new ArrayList<String>();
		
		buffer.append("DELETE FROM S_OP_OptometryPhoto ");
		buffer.append("WHERE S_OP_OP_OptometryID = ? ");
