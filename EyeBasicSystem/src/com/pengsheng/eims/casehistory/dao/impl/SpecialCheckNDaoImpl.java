...
public class SpecialCheckNDaoImpl extends BaseJdbcDaoSupport implements SpecialCheckNDao {
	...
	public HealthCheckPo getSpecialCheck(HealthCheckPo healthCheckPo) {
		...
		buffer.append(",S_OP_HC_Remark	        		as sophcremark 		");
	...
	public void insertSpecialCheck(HealthCheckPo healthCheckPo) {
		...
		buffer.append(",S_OP_HC_CheckTime ");
		...
		params.add(Utility.getName(healthCheckPo.getSophcremark()));
	...
	public List<OptometryPhotoPo> getOptometryPhotoList(OptometryPo optometryPo){
		...
		sb.append("SELECT S_OP_OP_ID as sopopid ");
		sb.append("      ,S_OP_OP_CustomerID as sopopcustomerid");
		sb.append("      ,S_OP_OP_OptometryBasicID as sopopoptometryBasicid");
		sb.append("      ,S_OP_OP_OptometryID as sopopoptometryid");
		sb.append("      ,S_OP_OP_OptometryDate as sopopoptometrydate ");
		sb.append("      ,S_OP_OP_PersonID as sopoppersonid");
		sb.append("      ,S_OP_OP_ShopCode as sopopshopcode");
		sb.append("      ,S_OP_OP_FixID as sopopfixid");
		sb.append("      ,S_OP_OP_PicUrl as sopoppicurl");
		sb.append("  FROM S_OP_OptometryPhoto where S_OP_OP_OptometryID = ? ");
		
		params.add(Utility.getName(optometryPo.getSopoyoptometryid()));
		
		return queryForObjectList(sb.toString(), params.toArray(), OptometryPhotoPo.class);
	}
	
	public void insertOptometryPhoto(OptometryPhotoPo optometryPhotoPo){
		
		StringBuffer  buffer = new StringBuffer();
		List<String> params = new ArrayList<String>();
		
		buffer.append("INSERT INTO S_OP_OptometryPhoto ");
		buffer.append("           (S_OP_OP_ID ");
		buffer.append("           ,S_OP_OP_CustomerID ");
		buffer.append("           ,S_OP_OP_OptometryBasicID ");
		buffer.append("           ,S_OP_OP_OptometryID ");
		buffer.append("           ,S_OP_OP_OptometryDate ");
		buffer.append("           ,S_OP_OP_PersonID ");
		buffer.append("           ,S_OP_OP_ShopCode ");
		buffer.append("           ,S_OP_OP_FixID ");
		buffer.append("           ,S_OP_OP_PicUrl) ");
		buffer.append(" values (?,?,?,?,getdate(),?,?,?,?) ");
		
		params.add(this.uuid.generate());
		params.add(Utility.getName(optometryPhotoPo.getSopopcustomerid()));
		params.add(Utility.getName(optometryPhotoPo.getSopopoptometryBasicid()));
		params.add(Utility.getName(optometryPhotoPo.getSopopoptometryid()));
		params.add(Utility.getName(optometryPhotoPo.getSopoppersonid()));
		params.add(Utility.getName(optometryPhotoPo.getSopopshopcode()));
		params.add(Utility.getName(optometryPhotoPo.getSopopfixid()));
		params.add(Utility.getName(optometryPhotoPo.getSopoppicurl()));
		
		getJdbcTemplate().update(buffer.toString(), params.toArray());
	}
	
	public void deleteOptometryPhoto(OptometryPhotoPo oppo){
		
		StringBuffer  buffer = new StringBuffer();
		List<String> params = new ArrayList<String>();
		
		buffer.append("delete from S_OP_OptometryPhoto where S_OP_OP_OptometryID = ? ");
		
		params.add(Utility.getName(oppo.getSopopoptometryid()));
