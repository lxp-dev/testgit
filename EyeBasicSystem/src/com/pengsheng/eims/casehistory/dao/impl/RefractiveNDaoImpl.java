...
public class RefractiveNDaoImpl extends BaseJdbcDaoSupport implements RefractiveNDao {
...
//		getJdbcTemplate().update(buffer.toString(), params.toArray());
	...
	public RefractivePo getLastRefractive(String customerID){
		...
		sb.append("FROM S_OP_Refractive  ");
		sb.append("where S_OP_R_CustomerID= ? ");
		sb.append("order by S_OP_R_Inspection_date desc");
