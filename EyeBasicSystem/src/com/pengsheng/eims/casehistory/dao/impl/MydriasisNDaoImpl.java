...
public class MydriasisNDaoImpl extends BaseJdbcDaoSupport implements
		MydriasisNDao {
	...
	public MydriasisPo getMydriasis(MydriasisPo po) {
		...
		StringBuffer sb = new StringBuffer();
		sb.append("select top 1  S_ME_CustomerInfo.S_ME_CI_CustomerID as sopmdfcustomerid");
		sb.append(",S_ME_CustomerInfo.S_ME_CI_MemberId as sopmdcustomerpostcode,S_ME_CustomerInfo.S_ME_CI_Name as sopmdcustomername");
		sb.append(",S_OP_Mydriasis.S_OP_MD_FamilyHistory as sopmdfamilyhistory,S_OP_Mydriasis.S_OP_MD_GeneralInspection as sopmdgeneralinspection");
		sb.append(",S_OP_Mydriasis.S_OP_MD_FundusInspection as sopmdfundusinspection,S_OP_Mydriasis.S_OP_MD_FIop as sopmdfiop");
		sb.append(",S_OP_Mydriasis.S_OP_MD_Anaesthetic as sopmdanaesthetic,S_OP_Mydriasis.S_OP_MD_RightGlassesVision as sopmdrightglassesvision");
		sb.append(",S_OP_Mydriasis.S_OP_MD_LeftGlassesVision as sopmdleftglassesvision,S_OP_Mydriasis.S_OP_MD_RightNakedVision as sopmdrightnakedvision");
		sb.append(",S_OP_Mydriasis.S_OP_MD_LeftNakedVision as sopmdleftnakedvision,S_OP_Mydriasis.S_OP_MD_RightNearVision as sopmdrightnearvision");
		sb.append(",S_OP_Mydriasis.S_OP_MD_LeftNearVision as sopmdleftnearvision,S_OP_Mydriasis.S_OP_MD_MydriasisPersonID as sopmdmydriasispersonid");
		sb.append(",SYS_PersonInfo.personName as sopmdmydriasispersonname,S_OP_MD_VisionTime as sopmdvisiontime ");
