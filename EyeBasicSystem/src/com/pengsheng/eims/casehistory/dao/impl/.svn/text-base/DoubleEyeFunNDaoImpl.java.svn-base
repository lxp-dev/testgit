...
public class DoubleEyeFunNDaoImpl extends BaseJdbcDaoSupport implements
		DoubleEyeFunNDao {
	...
	public DoubleEyeFunPo getDoubleEyeFun(DoubleEyeFunPo po) {
		...
		sb.append(",isnull(S_OP_DE_Coverflag,'') as sopdecoverflag  ");	
		sb.append(",isnull(S_OP_DE_Facilityflag,'') as sopdefacilityflag  ");	
		sb.append(",S_OP_DE_AddOU            	  as sopdeaddou  ");
	...
	public void insertDoubleEyeFun(DoubleEyeFunPo po) {
		...
		sb.append("S_OP_DE_Coverflag	                       ");
		sb.append(",S_OP_DE_Facilityflag	                   ");
		sb.append(",S_OP_DE_AddOU	                           ");
		sb.append(" ) values ( ");
		sb.append("?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?, ");//20
		sb.append("?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?, ?,?, ");//22
		...
		params.add(Utility.getName(po.getSopdecoverflag()));
		params.add(Utility.getName(po.getSopdefacilityflag()));
		params.add(Utility.getName(po.getSopdeaddou()));
	...
	public void updateDoubleEyeFun(DoubleEyeFunPo po) {
		...
		sb.append(",S_OP_DE_Distance = ? ");
		sb.append(",S_OP_DE_Range = ? ");
		sb.append(",S_OP_DE_RangeO = ?,S_OP_DE_Account = ?,S_OP_DE_CheckDate=getdate() ");
		sb.append(",S_OP_DE_Acaz = ?  ");
		sb.append(",S_OP_DE_Xieshi = ?  ");
		sb.append(",S_OP_DE_Ruoshi = ?  ");
		sb.append(",S_OP_DE_Quguangbuzheng = ?  ");
