...
public interface NonconformingProductDao {
	 ...
	 *           不合格品原因/现象参数集
	 */
	public void insertNonconformingProduct(NonconformingProductPo nonconformingProductPo);
	 ...
	 *            不合格品原因/现象参数集
	 */
	public void updateNonconformingProduct(NonconformingProductPo nonconformingProductPo);
