...
public class VisualOpticsDaoImpl extends BaseJdbcDaoSupport  implements VisualOpticsDao {
	...
	public int getVisualOpticsCount(GoodsInfoPo po) {
		...
		sb.append("inner join B_Unit on B_GoodsInfo.B_GI_UnitId=B_Unit.B_UT_id where 1=1 and B_GoodsInfo.B_GI_GoodsCategoryID='9' ");
	...
	public void insertVisualOptics(GoodsInfoPo po) {
		...
		String sql="insert into B_GoodsInfo(B_GI_GoodsID,B_GI_GoodsBarCode,B_GI_GoodsName,B_GI_GoodsCategoryID,B_GI_SupplierID," +
				"B_GI_BrandID,B_GI_UnitId,B_GI_FinishedGlassesType,B_GI_Spec,B_GI_CostPrice,B_GI_TaxRate," +
	...
	public void updateVisualOptics(GoodsInfoPo po) {
		...
		String sql="update B_GoodsInfo set B_GI_GoodsName= ?,B_GI_UnitId= ?," +
				"B_GI_TaxRate= ?,B_GI_NotTaxRate= ? ,B_GI_WholesalePrice= ?";
	...
	public GoodsInfoPo getVisualOptics(GoodsInfoPo po) {
		...
		sb.append("B_GoodsInfo.B_GI_BrandID as bgibrandid,B_Brand.B_BD_brandName as bgibrandname,B_GI_FinishedGlassesType as bgifinishedglassestype,");
		...
		sb.append("B_GoodsInfo.B_GI_TaxRate as bgitaxrate,B_GoodsInfo.B_GI_RetailPrice as bgiretailprice,B_GI_Color as bgicolor,B_GI_AverageNotTaxRate as bgiaveragenotnaxrate,B_GI_WholesalePrice as bgiwholesaleprice, ");
	...
	public int getGoodsNumber(GoodsInfoPo po) {
		...
		varname1.append("FROM   (SELECT SUM(C_SH_SB_GoodsQuantity) AS num ");
		varname1.append("        FROM   C_SH_StorageBeginning ");
		varname1.append("        WHERE  C_SH_SB_GoodsId = ? ");
		varname1.append("        UNION ALL ");
		varname1.append("        SELECT SUM(C_SH_SC_GoodsQuantity) AS num ");
