...
public class PresbyopicGlassesDaoImpl extends BaseJdbcDaoSupport implements
		PresbyopicGlassesDao {
	...
	public int getPresbyopicGlassesCount(GoodsInfoPo po) {
		...
		sb.append("inner join B_Unit on B_GoodsInfo.B_GI_UnitId=B_Unit.B_UT_id where 1=1 and B_GoodsInfo.B_GI_GoodsCategoryID='8'");
	...
	public void insertPresbyopicGlasses(GoodsInfoPo po) {

		String sql = "insert into B_GoodsInfo(B_GI_GoodsID,B_GI_GoodsBarCode,B_GI_GoodsName,B_GI_GoodsCategoryID,B_GI_SupplierID,"
				+ "B_GI_BrandID,B_GI_UnitId,B_GI_Spec,B_GI_Sph,B_GI_CostPrice,B_GI_TaxRate,"
				+ "B_GI_NotTaxRate,B_GI_RetailPrice,B_GI_Flag,B_GI_WholesalePrice,B_GI_FrameSize,B_GI_SupplierColor,B_GI_AverageNotTaxRate";
		...
		sql = sql+",B_GI_WholeGoodsIsable,B_GI_FrameStyle)";
		sql1 = sql1+",'1',?)";
	...
	public void updatePresbyopicGlasses(GoodsInfoPo po) {
		StringBuffer sb = new StringBuffer();
	...
	public GoodsInfoPo getPresbyopicGlasses(GoodsInfoPo po) {
		...
		sb.append("B_GoodsInfo.B_GI_TaxRate as bgitaxrate,B_GoodsInfo.B_GI_RetailPrice as bgiretailprice,B_GI_AverageNotTaxRate as bgiaveragenotnaxrate,B_GI_WholesalePrice as bgiwholesaleprice,B_GI_FrameSize as bgiframesize,B_GI_SupplierColor as bgisuppliercolor, ");
		...
		sb.append(" left join B_Color on B_GI_ChineseColor=B_C_id ");
	...
	public void deletePresbyopicGlasses(GoodsInfoPo po) {
	...
	public void updatePresbyopicGlassesDisable(GoodsInfoPo po) {
