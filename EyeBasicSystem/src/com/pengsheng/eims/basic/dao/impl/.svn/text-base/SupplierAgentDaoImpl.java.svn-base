...
public class SupplierAgentDaoImpl extends BaseJdbcDaoSupport implements SupplierAgentDao {
	...
	public int getSupplierCount(SupplierPo po) {
		...
		sb.append("select count(B_SP_ID) from B_SupplierAgent where 1=1 and B_SP_ID<>'ZZ' ");
		...
		if (!"".equals(Utility.getName(po.getBsplinksupplierid()))) {
			sb.append(" and B_SP_LinkSupplierID = '" +Utility.getName(po.getBsplinksupplierid()) + "'");
		}
	...
	public List<SupplierPo> getSupplierList(SupplierPo po, int start, int size) {
		...
		sb.append("select (select B_Supplier.B_SP_SupplierName from B_Supplier where B_Supplier.B_SP_ID = temp.B_SP_LinkSupplierID) as bsplinksuppliername,temp.B_SP_ID as bspid,temp.B_SP_SupplierName as bspsuppliername,temp.B_SP_ContactPerson as bspcontactperson, ");
		...
		sb.append(" ) as rowNum,* from B_SupplierAgent ");
		sb.append("where 1=1 and B_SP_ID <> 'ZZ' ");
	...
	public void insertSupplier(SupplierPo po) {
		...
		params.add(Utility.getName(po.getBsplinksupplierid()));
	...
	public void updateSupplier(SupplierPo po) {
		...
		buffer.append("update B_SupplierAgent set ");
		buffer.append("B_SP_SupplierName = ? ");
		buffer.append(",B_SP_ContactPerson = ? ");
		buffer.append(",B_SP_ContactPhone = ? ");
		buffer.append(",B_SP_Fax = ? ");
		...
		buffer.append(",B_SP_LicenceValidity = ? ");	
		buffer.append(",B_SP_Settlement = ? ");
		buffer.append(",B_SP_SettlementMonth = ?,B_SP_MakeInvoiceFlag = ? ");
	...
	public void updateSupplierAccount(SupplierPo po){
		...
		params.add(po.getBspsupplieraccountdate());
		params.add(po.getBspstartprice());
		params.add(po.getBspstartpayment());
		params.add(po.getBspid());
	...
	public void deleteSupplier(SupplierPo po) {
		...
		String sql = "delete from B_SupplierAgent where B_SP_ID='" + po.getBspid() + "'";
	...
	public SupplierPo getSupplier(SupplierPo po) {
		...
		buffer.append("select top 1 B_SupplierAgent.B_SP_ID as bspid,");
		buffer.append("B_SupplierAgent.B_SP_SupplierName as bspsuppliername,B_SupplierAgent.B_SP_ContactPerson as bspcontactperson,");
		buffer.append("B_SupplierAgent.B_SP_ContactPhone as bspcontactphone,B_SupplierAgent.B_SP_Fax as bspfax,");
		buffer.append("B_SupplierAgent.B_SP_Address as bspaddress,");
		buffer.append("B_SupplierAgent.B_SP_Remark as bspremark,B_SupplierAgent.B_SP_CategoryID as bspcategoryid,");
		buffer.append("B_SupplierAgent.B_SP_Flag as bspflag,B_SupplierAgent.B_SP_OrderSupplierID as bspordersupplierid, ");
		buffer.append("B_SupplierAgent.B_SP_SupplierMnemonic as bspsuppliermnemonic, ");
		buffer.append("B_SupplierAgent.B_SP_DistributionMethods as bspdistributionmethods, ");
		buffer.append("B_SupplierAgent.B_SP_DocumentUrl 	as documentUrl, ");
		buffer.append("B_SupplierAgent.B_SP_ContentType 	as contentType, ");
		buffer.append("B_SupplierAgent.B_SP_SaveFileName 	as saveFileName, ");
		buffer.append("B_SupplierAgent.B_SP_ValidDateUL 	as bspvaliddateUL, ");
		buffer.append("B_SupplierAgent.B_SP_ValidDateUP 	as bspvaliddateUP, ");		
		buffer.append("B_SupplierAgent.B_SP_LinkMan 		as bsplinkmanphonel, ");
		buffer.append("B_SupplierAgent.B_SP_ForShort 		as bspfroshort, ");
		buffer.append("B_SupplierAgent.B_SP_LicenceID 		as bsplicenceid, ");
		buffer.append("B_SupplierAgent.B_SP_LicenceValidity as bsplicencevalidity, ");
		buffer.append("B_SupplierAgent.B_SP_DealingsAmount  as bspdealingsAmount, ");
		buffer.append("B_SupplierAgent.B_SP_Settlement      as bspsettlement, ");
		buffer.append("B_SupplierAgent.B_SP_SettlementMonth as bspsettlementmonth, ");
		buffer.append("B_SupplierAgent.B_SP_MakeInvoiceFlag as bspmakeinvoiceflag, ");
		buffer.append(" B_SupplierAgent.B_SP_YLicenceID		as bspylicenceid		 ");
		buffer.append(",B_SupplierAgent.B_SP_YLicenceValidity as bspylicencevalidity	 ");
		buffer.append(",B_SupplierAgent.B_SP_GLicenceID 	as bspglicenceid		 ");
		buffer.append(",B_SupplierAgent.B_SP_GLicenceValidity as bspglicencevalidity	 ");
		buffer.append(",B_Supplier.B_SP_SupplierName 		as bsplinksuppliername ");
		buffer.append("from B_SupplierAgent ");
		buffer.append("left join B_Supplier on B_Supplier.B_SP_ID = B_SP_LinkSupplierID ");
		buffer.append("where B_SupplierAgent.B_SP_ID = ? ");
	...
	public void updateSupplierDisable(SupplierPo po) {
		...
		String sql = "update B_SupplierAgent set B_SP_Flag='" + po.getBspflag()
