...
public class StealthCustomLensesDDaoImpl extends BaseJdbcDaoSupport implements
		StealthCustomLensesDDao {
	...
	public int getStealthCustomLensesCount(GoodsInfoPo po) {
		...
		sb.append("where 1=1 and B_GoodsInfo.B_GI_GoodsCategoryID='4' and B_GI_StealthCustomizeType = '1' ");
	...
	public List<GoodsInfoPo> getStealthCustomLensesList(GoodsInfoPo po,
		...
		sb.append(" and B_GI_StealthCustomizeType = '1' ");
	...
	public void insertStealthCustomLenses(GoodsInfoPo po) {
		...
		if (!"".equals(Utility.getName(po.getBgicontacttyped()))) {
			sql = sql+",B_GI_ContactTypeD ";
			sql1 = sql1 + ",?";
			params.add(Utility.getName(po.getBgicontacttyped()));
		}
	...
	public void updateStealthCustomLenses(GoodsInfoPo po) {
		...
		String sql = "update B_GoodsInfo set B_GI_GoodsName='"
				...
				+ "',B_GI_orderCycle='"+po.getBgiordercycle()+"',B_GI_Curvature1UL='" + po.getBgicurvature1ul()
				+ "',B_GI_UnionSphCyl='" + po.getBgiunionsphcyl() + "',B_GI_Curvature1UP='" + po.getBgicurvature1up() + "',"
				+ "B_GI_Curvature2UL='" + po.getBgicurvature2ul()
				+ "',B_GI_ContactTypeD='" + po.getBgicontacttyped()
	...
	public GoodsInfoPo getStealthCustomLenses(GoodsInfoPo po) {
		...
		sb.append("B_GL_Name					  		as  bgidefaultdiscountvaluename,isnull(B_GI_ContactTypeD,'') as bgicontacttyped ");
		sb.append(" from B_GoodsInfo");
