...
public class StealthCustomLensesDARAction extends BaseAction {
	private StealthCustomLensesDMgr stealthCustomLensesDMgr;
	...
	public StealthCustomLensesDMgr getStealthCustomLensesDMgr() {
		return stealthCustomLensesDMgr;
	}

	public void setStealthCustomLensesDMgr(
			StealthCustomLensesDMgr stealthCustomLensesDMgr) {
		this.stealthCustomLensesDMgr = stealthCustomLensesDMgr;
	}
	 ...
	 * 初始化软性接触镜订制类查询
	 */
	public String initStealthCustomLensesSelDAR()throws Exception{
		...
		/** ********************** 权限设置 ***************************** */
		 systemParameterPo = (SystemParameterPo) session.get("systemParameterPo");		
			if (!Utility.getName(systemParameterPo.getFspshowchange()).equals("1")){
				...
				return "selStealthCustomLensesDAR";
			}
	 ...
	 * 查询软性接触镜订制类
	 */
	public String selStealthCustomLensesDAR()throws Exception{
		...
		int count=stealthCustomLensesDMgr.getStealthCustomLensesCount(goodsInfoPo);
		if (count > 0) {
			int perPage = 0;
	    ...
	    stealthCustomLensesList=stealthCustomLensesDMgr.getStealthCustomLensesList(goodsInfoPo,page.getStart(),page.getPageSize());
	 ...
	 * 初始化软性接触镜订制类新增
	 */
	public String initStealthCustomLensesInsertDAR()throws Exception{
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 新增软性接触镜订制类
	 */
	public String insertStealthCustomLensesDAR()throws Exception{
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
		...
		GoodsInfoPo po=stealthCustomLensesDMgr.getStealthCustomLenses(goodsInfoPo);
		...
		logPo.setsLogContent("软性接触镜订制:" + goodsInfoPo.getBgigoodsid() + "新增!");
		...
		if(po.getBgigoodsid()==null){
			if(po1.getBgigoodsbarcode()==null)
			{
				...
				stealthCustomLensesDMgr.insertStealthCustomLenses(goodsInfoPo,logPo);
	 ...
	 * 初始化软性接触镜订制类修改
	 */
	public String initStealthCustomLensesUpdateDAR()throws Exception{
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
		...
		systemParameterPo = (SystemParameterPo) session.get("systemParameterPo");
		goodsInfoPo=stealthCustomLensesDMgr.getStealthCustomLenses(goodsInfoPo);
		unitList=unitMgr.getUnitList();
		String parent = Utility.getName(request.getParameter("parent"));
		String goodsTree = Utility.getName(request.getParameter("goodsTree"));
	 ...
	 * 初始化软性接触镜订制类详细
	 */
	public String initStealthCustomLensesDetailsDAR()throws Exception{
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 修改软性接触镜订制类
	 */
	public String updateStealthCustomLensesDAR()throws Exception{
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
		...
		systemParameterPo = (SystemParameterPo) session.get("systemParameterPo");
		GoodsInfoPo vgoodsInfoPo=stealthCustomLensesDMgr.getStealthCustomLenses(goodsInfoPo);
		String[] goodsnametype = systemParameterPo.getFspcyxjp().trim().split(",");
		String viewgoodsname = goodsInfoPo.getBgigoodsname();
		for(int i=0; i<goodsnametype.length; i++){
			if(goodsnametype[i].trim().equals("B_GI_Spec")){
		...
		logPo.setsLogContent("软性接触镜订制:" + goodsInfoPo.getBgigoodsid() + "修改!");
		stealthCustomLensesDMgr.updateStealthCustomLenses(goodsInfoPo,logPo);
		this.clearMessages();
	 ...
	 * 初始化软性接触镜订制类删除
	 */
	public String initStealthCustomLensesDeleteDAR()throws Exception{
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 删除软性接触镜订制类
	 */
	public String deleteStealthCustomLensesDAR()throws Exception{
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
		...
		logPo.setsLogContent("软性接触镜订制:" + goodsInfoPo.getBgigoodsid() + "删除!");
		
		int flag=lensFinishedMgr.getGoodsCount(goodsInfoPo);
		this.clearMessages();
		if(flag==0){
			stealthCustomLensesDMgr.deleteStealthCustomLenses(goodsInfoPo,logPo);
	 ...
	 * 初始化软性接触镜订制类停用
	 */
	public String initStealthCustomLensesDisableDAR()throws Exception{
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 停用软性接触镜订制类
	 */
	public String disableStealthCustomLensesDAR()throws Exception{
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
		...
		logPo.setsLogContent("软性接触镜订制:" + goodsInfoPo.getBgigoodsid() + "停用!");
		stealthCustomLensesDMgr.updateStealthCustomLensesDisable(goodsInfoPo,logPo);
	 ...
	 * 初始化软性接触镜订制类启用
	 */
	public String initStealthCustomLensesAbleDAR()throws Exception{
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 启用软性接触镜订制类
	 */
	public String ableStealthCustomLensesDAR()throws Exception{
		...
		logPo.setsLogContent("软性接触镜订制:" + goodsInfoPo.getBgigoodsid() + "启用!");
		stealthCustomLensesDMgr.updateStealthCustomLensesDisable(goodsInfoPo,logPo);
