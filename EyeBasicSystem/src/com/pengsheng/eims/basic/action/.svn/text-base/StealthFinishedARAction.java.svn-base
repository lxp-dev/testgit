...
public class StealthFinishedARAction extends BaseAction {
	 ...
	 * 初始化软性接触镜成品类查询
	 */
	public String initStealthFinishedSelAR()throws Exception{		
	 ...
	 * 查询软性接触镜成品类
	 */
	public String selStealthFinishedAR()throws Exception{		
	 ...
	 * 初始化软性接触镜成品类新增
	 */
	public String initStealthFinishedInsertAR()throws Exception{	
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 新增软性接触镜成品类
	 */
	public String insertStealthFinishedAR()throws Exception{		
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
		...
		logPo.setsLogContent("软性接触镜成品:" + goodsInfoPo.getBgigoodsid() + "新增!");
		this.clearMessages();
	 ...
	 * 初始化软性接触镜成品类批量新增
	 */
	public String initStealthFinishedInsertBulkAR()throws Exception{		
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 批量新增软性接触镜成品类
	 */
	public String insertBulkStealthFinishedAR()throws Exception{		
		...
		logPo.setsLogResult(moduleID); // 表示模块名称 
		logPo.setsLogOpID("1");    // 表示状态
		logPo.setsLogContent("不含税价:" + goodsInfoPo.getBginottaxrate() + "软性接触镜成品批量新增!");
	 ...
	 * 初始化软性接触镜成品类修改
	 */
	public String initStealthFinishedUpdateAR()throws Exception{	
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 初始化软性接触镜成品类详细
	 */
	public String initStealthFinishedDetailsAR()throws Exception{	
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 修改软性接触镜成品类
	 */
	public String updateStealthFinishedAR() throws Exception{		
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
		...
		logPo.setsLogContent("软性接触镜成品:" + Utility.getName(goodsInfoPo.getBgigoodsid()) + "修改!");
	 ...
	 * 初始化软性接触镜成品类删除
	 */
	public String initStealthFinishedDeleteAR()throws Exception{		
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 删除软性接触镜成品类
	 */
	public String deleteStealthFinishedAR()throws Exception{		
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
		...
		logPo.setsLogContent("软性接触镜成品:" + Utility.getName(goodsInfoPo.getBgigoodsid()) + "删除!");
	 ...
	 * 初始化软性接触镜成品类停用
	 */
	public String initStealthFinishedDisableAR()throws Exception{		
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 停用软性接触镜成品类
	 */
	public String disableStealthFinishedAR()throws Exception{		
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
		...
		logPo.setsLogContent("软性接触镜成品:" + Utility.getName(goodsInfoPo.getBgigoodsid()) + "停用!");
	 ...
	 * 初始化软性接触镜成品类启用
	 */
	public String initStealthFinishedAbleAR()throws Exception{		
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 启用软性接触镜成品类
	 */
	public String ableStealthFinishedAR()throws Exception{		
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
		...
		logPo.setsLogContent("软性接触镜成品:" + Utility.getName(goodsInfoPo.getBgigoodsid()) + "启用!");
		stealthFinishedMgr.updateStealthFinishedDisable(goodsInfoPo,logPo);
