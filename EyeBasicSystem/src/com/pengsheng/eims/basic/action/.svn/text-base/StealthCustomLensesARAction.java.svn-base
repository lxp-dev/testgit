...
public class StealthCustomLensesARAction extends BaseAction {
	 ...
	 * 初始化硬性接触镜类查询
	 */
	public String initStealthCustomLensesSelAR()throws Exception{
		...
		/** ********************** 权限设置 ***************************** */
		 systemParameterPo = (SystemParameterPo) session.get("systemParameterPo");		
			if (!Utility.getName(systemParameterPo.getFspshowchange()).equals("1")){
				...
				return "selStealthCustomLensesAR";
			}
	 ...
	 * 查询硬性接触镜类
	 */
	public String selStealthCustomLensesAR()throws Exception{
	 ...
	 * 初始化硬性接触镜类新增
	 */
	public String initStealthCustomLensesInsertAR()throws Exception{
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 新增硬性接触镜类
	 */
	public String insertStealthCustomLensesAR()throws Exception{
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
		...
		logPo.setsLogContent("硬性接触镜:" + goodsInfoPo.getBgigoodsid() + "新增!");
	 ...
	 * 初始化硬性接触镜类修改
	 */
	public String initStealthCustomLensesUpdateAR()throws Exception{
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 初始化硬性接触镜类详细
	 */
	public String initStealthCustomLensesDetailsAR()throws Exception{
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 修改硬性接触镜类
	 */
	public String updateStealthCustomLensesAR()throws Exception{
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
		...
		logPo.setsLogContent("硬性接触镜:" + goodsInfoPo.getBgigoodsid() + "修改!");
	 ...
	 * 初始化硬性接触镜类删除
	 */
	public String initStealthCustomLensesDeleteAR()throws Exception{
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 删除硬性接触镜类
	 */
	public String deleteStealthCustomLensesAR()throws Exception{
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
		...
		logPo.setsLogContent("硬性接触镜:" + goodsInfoPo.getBgigoodsid() + "删除!");
	 ...
	 * 初始化硬性接触镜类停用
	 */
	public String initStealthCustomLensesDisableAR()throws Exception{
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 停用硬性接触镜类
	 */
	public String disableStealthCustomLensesAR()throws Exception{
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
		...
		logPo.setsLogContent("硬性接触镜:" + goodsInfoPo.getBgigoodsid() + "停用!");
	 ...
	 * 初始化硬性接触镜类启用
	 */
	public String initStealthCustomLensesAbleAR()throws Exception{
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 启用硬性接触镜类
	 */
	public String ableStealthCustomLensesAR()throws Exception{
		...
		logPo.setsLogContent("硬性接触镜:" + goodsInfoPo.getBgigoodsid() + "启用!");
		stealthCustomLensesMgr.updateStealthCustomLensesDisable(goodsInfoPo,logPo);
