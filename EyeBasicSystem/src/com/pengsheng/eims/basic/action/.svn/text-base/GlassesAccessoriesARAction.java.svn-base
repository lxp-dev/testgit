 ...
 * 配件类action
 */
public class GlassesAccessoriesARAction extends BaseAction {
	 ...
	 * 初始化配件类查询
	 */
	public String initGlassesAccessoriesSelAR() throws Exception {
		...
		/** ********************** 权限设置 ***************************** */
		 systemParameterPo = (SystemParameterPo) session.get("systemParameterPo");		
			if (!Utility.getName(systemParameterPo.getFspshowchange()).equals("1")){
				...
				return "selGlassesAccessoriesAR";
			}
	 ...
	 * 查询配件类
	 */
	public String selGlassesAccessoriesAR() throws Exception {
		...
		if (count > 0) {
			...
			glassesAccessoriesList = glassesAccessoriesMgr.getGlassesAccessoriesList(goodsInfoPo, page.getStart(),page.getPageSize());
	 ...
	 * 初始化配件类新增
	 */
	public String initGlassesAccessoriesInsertAR() throws Exception {
	 ...
	 * 新增辅料类
	 */
	public String insertGlassesAccessoriesAR() throws Exception {
	 ...
	 * 初始化配件类修改
	 */
	public String initGlassesAccessoriesUpdateAR() throws Exception {
	 ...
	 * 初始化配件类详细
	 */
	public String initGlassesAccessoriesDetailsAR() throws Exception {
	 ...
	 * 修改配件类
	 */
	public String updateGlassesAccessoriesAR() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 初始化配件类删除
	 */
	public String initGlassesAccessoriesDeleteAR() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 删除配件类
	 */
	public String deleteGlassesAccessoriesAR() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 初始化配件类停用
	 */
	public String initGlassesAccessoriesDisableAR() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 停用配件类
	 */
	public String disableGlassesAccessoriesAR() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 初始化配件类启用
	 */
	public String initGlassesAccessoriesAbleAR() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 启用配件类
	 */
	public String ableGlassesAccessoriesAR() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
