...
public class GlassesFrameManyARAction extends BaseAction{
	private File myFile;
	private File[] upload;
	 ...
	 * 初始化镜架类批量新增
	 */
	public String initGlassesFrameManyInsertAR() throws Exception {
	 ...
	 * 初始化太阳镜批量新增
	 */
	public String initGlassesFinishManyInsertAR() throws Exception {
	 ...
	 * 初始化老花镜批量新增
	 */
	public String initGlassesPresbyopicManyInsertAR() throws Exception {
	 ...
	 * @throws Exception
	 */
	public String importGlassesFrameManyExcelAR() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * @throws Exception
	 */
	public String importGlassesFinishManyExcelAR() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * @throws Exception
	 */
	public String importGlassesPresbyopicManyExcelAR() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 新增镜架类
	 */
	public String insertGlassesManyFrameAR() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 新增太阳镜类
	 */
	public String insertGlassesManyFinishAR() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 新增太阳镜类
	 */
	public String insertGlassesManyPresbyopicAR() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
