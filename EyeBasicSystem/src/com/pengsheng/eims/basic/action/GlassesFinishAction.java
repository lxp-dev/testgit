...
public class GlassesFinishAction extends BaseAction {
	 ...
	 * 初始化成镜类查询
	 */
	public String initGlassesFinishSel() throws Exception {
		/** ********************** 权限设置 ***************************** */
	 ...
	 * 查询成镜类
	 */
	public String selGlassesFinish() throws Exception {
	 ...
	 * 初始化成镜类新增
	 */
	public String initGlassesFinishInsert() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 新增成镜类
	 */
	public String insertGlassesFinish() throws Exception {
	 ...
	 * 初始化太阳镜类修改
	 */
	public String initGlassesFinishUpdate() throws Exception {
	 ...
	 * 初始化太阳镜类详细
	 */
	public String initGlassesFinishDetails() throws Exception {
	 ...
	 * 修改太阳镜类
	 */
	public String updateGlassesFinish() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 初始化太阳镜类删除
	 */
	public String initGlassesFinishDelete() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 删除太阳镜类
	 */
	public String deleteGlassesFinish() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 初始化太阳镜类停用
	 */
	public String initGlassesFinishDisable() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 停用太阳镜类
	 */
	public String disableGlassesFinish() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 初始化太阳镜类启用
	 */
	public String initGlassesFinishAble() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 启用太阳镜类
	 */
	public String ableGlassesFinish() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
