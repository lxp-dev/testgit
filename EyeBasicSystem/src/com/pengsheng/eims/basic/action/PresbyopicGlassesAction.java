...
public class PresbyopicGlassesAction extends BaseAction {
	 ...
	 * 初始化老花镜类查询
	 */
	public String initPresbyopicGlassesSel() throws Exception {
	 ...
	 * 查询老花镜类
	 */
	public String selPresbyopicGlasses() throws Exception {
	 ...
	 * 初始化老花镜类新增
	 */
	public String initPresbyopicGlassesInsert() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 新增老花镜类
	 */
	public String insertPresbyopicGlasses() throws Exception {
	 ...
	 * 初始化老花镜类修改
	 */
	public String initPresbyopicGlassesUpdate() throws Exception {
	 ...
	 * 初始化老花镜类详细
	 */
	public String initPresbyopicGlassesDetails() throws Exception {
	 ...
	 * 修改老花镜类
	 */
	public String updatePresbyopicGlasses() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 初始化老花镜类删除
	 */
	public String initPresbyopicGlassesDelete() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 删除老花镜类
	 */
	public String deletePresbyopicGlasses() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 初始化老花镜类停用
	 */
	public String initPresbyopicGlassesDisable() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 停用老花镜类
	 */
	public String disablePresbyopicGlasses() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 初始化老花镜类启用
	 */
	public String initPresbyopicGlassesAble() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 启用老花镜类
	 */
	public String ablePresbyopicGlasses() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
