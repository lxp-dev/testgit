 ...
 * 修改商品属性action
 */
public class UpdateGoodsAttributeAction extends BaseAction {
	...
	private UpdateGoodsAttributeMgr updateGoodsAttributeMgr;
	public UpdateGoodsAttributeMgr getUpdateGoodsAttributeMgr() {
		return updateGoodsAttributeMgr;
	}
	...
	public void setUpdateGoodsAttributeMgr(
			UpdateGoodsAttributeMgr updateGoodsAttributeMgr) {
		this.updateGoodsAttributeMgr = updateGoodsAttributeMgr;
	}
	...
	public String updateGoodsAttribute(){
		...
		updateGoodsAttributeMgr.updateGoodsAttribute(goodsInfoPo, goodsid,logPo);
		
		String url = "''initUpdateGoods.action?moduleID={0}''"; 
