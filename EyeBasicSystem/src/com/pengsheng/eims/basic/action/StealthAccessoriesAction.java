...
public class StealthAccessoriesAction extends BaseAction {
	 ...
	 * 初始化隐形辅料类查询
	 */
	public String initStealthAccessoriesSel()throws Exception{		
	 ...
	 * 查询隐形辅料类
	 */
	public String selStealthAccessories()throws Exception{		
...
//		request.setAttribute("varietyName",varietyName);
	 ...
	 * 初始化隐形辅料类新增
	 */
	public String initStealthAccessoriesInsert()throws Exception{		
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 新增隐形辅料类
	 */
	public String insertStealthAccessories()throws Exception{		
		...
		logPo.setsLogContent("隐形辅料:" + goodsInfoPo.getBgigoodsid() + "新增!");
	 ...
	 * 初始化隐形辅料类修改
	 */
	public String initStealthAccessoriesUpdate()throws Exception{		
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 初始化隐形辅料类详细
	 */
	public String initStealthAccessoriesDetails()throws Exception{		
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 修改隐形辅料类
	 */
	public String updateStealthAccessories()throws Exception{		
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
		...
		logPo.setsLogContent("隐形辅料:" + goodsInfoPo.getBgigoodsid() + "修改!");
	 ...
	 * 初始化隐形辅料类删除
	 */
	public String initStealthAccessoriesDelete()throws Exception{		
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 删除隐形辅料类
	 */
	public String deleteStealthAccessories()throws Exception{		
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
		...
		logPo.setsLogContent("隐形辅料:" + goodsInfoPo.getBgigoodsid() + "删除!");
	 ...
	 * 初始化隐形辅料类停用
	 */
	public String initStealthAccessoriesDisable()throws Exception{		
	 ...
	 * 停用隐形辅料类
	 */
	public String disableStealthAccessories()throws Exception{		
		...
		logPo.setsLogContent("隐形辅料:" + goodsInfoPo.getBgigoodsid() + "停用!");
	 ...
	 * 初始化隐形辅料类启用
	 */
	public String initStealthAccessoriesAble()throws Exception{		
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 启用隐形辅料类
	 */
	public String ableStealthAccessories()throws Exception{		
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
		...
		logPo.setsLogContent("隐形辅料:" + goodsInfoPo.getBgigoodsid() + "启用!");
		stealthAccessoriesMgr.updateStealthAccessoriesDisable(goodsInfoPo,logPo);
