 ...
 * 镜架成品片action
 */
public class LensFinishedAction extends BaseAction {
	 ...
	 * @throws Exception
	 */
	public String initLensFinishedSel() throws Exception {
	 ...
	 * 查询成品镜片类
	 */
	public String selLensFinished() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
...
//		request.setAttribute("varietyName", varietyName);
	 ...
	 * 初始化成品镜片类新增
	 */
	public String initLensFinishedInsert() throws Exception {
	 ...
	 * 初始化成品镜片类新增
	 */
	public String initLensFinished2DInsert() throws Exception {
	 ...
	 * 新增成品镜片类
	 */
	public String insertLensFinished() throws Exception {
	 ...
	 * 新增成品镜片类
	 */
	public String insertLensFinished2D() throws Exception {
	 ...
	 * 初始化成品镜片类修改
	 */
	public String initLensFinishedUpdate() throws Exception {
	 ...
	 * 初始化成品镜片类详细
	 */
	public String initLensFinishedDetails() throws Exception {
	 ...
	 * 修改成品镜片类
	 */
	public String updateLensFinished() throws Exception {
	 ...
	 * 初始化成品镜片类删除
	 */
	public String initLensFinishedDelete() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 删除成品镜片类
	 */
	public String deleteLensFinished() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 初始化成品镜片类停用
	 */
	public String initLensFinishedDisable() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 停用成品镜片类
	 */
	public String disableLensFinished() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 初始化成品镜片类启用
	 */
	public String initLensFinishedAble() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 启用成品镜片类
	 */
	public String ableLensFinished() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 初始化成品镜片类批量新增
	 */
	public String initLensFinishedInsertBulk() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 批量新增成品镜片类
	 */
	public String insertBulkLensFinished() throws Exception {
