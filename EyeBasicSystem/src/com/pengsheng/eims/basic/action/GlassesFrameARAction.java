 ...
 * 镜架类action
 */
public class GlassesFrameARAction extends BaseAction {
	 ...
	 * 初始化镜架类查询
	 */
	public String initGlassesFrameSelAR() throws Exception {
	 ...
	 * 查询镜架类
	 */
	public String selGlassesFrameAR() throws Exception {
	 ...
	 * 初始化镜架类新增
	 */
	public String initGlassesFrameInsertAR() throws Exception {
	 ...
	 * 新增镜架类
	 */
	public String insertGlassesFrameAR() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 初始化镜架类详细
	 */
	public String initGlassesFrameDetailsAR() throws Exception {
	 ...
	 * 初始化镜架类修改
	 */
	public String initGlassesFrameUpdateAR() throws Exception {
	 ...
	 * 修改镜架类
	 */
	public String updateGlassesFrameAR() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 初始化镜架类图片修改
	 */
	public String initGlassesFramePhotoUpdateAR() throws Exception {
	 ...
	 * 初始化镜架类图片预览
	 */
	public String initGlassesFramePhotoDetailAR() throws Exception {
	 ...
	 * 初始化商品图片预览
	 */
	public String initPictureShowSelAR() throws Exception {
	 ...
	 * 初始化单个商品图片预览
	 */
	public String selPictureShowAR() throws Exception {
	 ...
	 * 插入镜架类图片修改
	 */
	public String updateGlassesFramePhotoAR() throws Exception {
	 ...
	 * 初始化图片删除
	 */
	public String initGlassesFramePhotoDeleteAR() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 图片删除
	 */
	public String deleteGlassesFramePhotoAR() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 初始化镜架类删除
	 */
	public String initGlassesFrameDeleteAR() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 删除镜架类
	 */
	public String deleteGlassesFrameAR() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 初始化镜架类停用
	 */
	public String initGlassesFrameDisableAR() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 停用镜架类
	 */
	public String disableGlassesFrameAR() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 初始化镜架类启用
	 */
	public String initGlassesFrameAbleAR() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 启用镜架类
	 */
	public String ableGlassesFrameAR() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 初始化镜架类停用
	 */
	public String initDisableAllWholeAR() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 停用镜架类
	 */
	public String disableAllWholeAR() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 初始化镜架类启用
	 */
	public String initAbleAllWholeAR() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 启用镜架类
	 */
	public String ableAllWholeAR() throws Exception {
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
	 ...
	 * 初始化批量销售停用启用
	 */
	public String initGoodsSalesAbleBatchAR() throws Exception {
	 ...
	 * 批量销售停用启用
	 */
	public String updateGoodsSalesAbleBatchAR() throws Exception {
	 ...
	 * 初始化批量批发价停用启用
	 */
	public String initGoodsWholePriceAbleBatchAR() throws Exception {
	 ...
	 * 批量批发价停用启用
	 */
	public String updateGoodsWholePriceAbleBatchAR() throws Exception {
	 ...
	 * 初始化批量删除
	 */
	public String initGoodsInfoDeleteBatchAR() throws Exception {
	 ...
	 * 批量删除
	 */
	public String deleteGoodsInfoBatchAR() throws Exception {
