...
public class OptometryWorkRptQTAction extends BaseAction {
	...
	public String initOptometryWorkQT() throws Exception{
		/** ********************** 权限设置 ***************************** */
	...
	public String initOptometryWorkManyStore() throws Exception{
		/** ********************** 权限设置 ***************************** */
		String moduleID = Utility.getName(request.getParameter("moduleID"));
		request.setAttribute("moduleID", moduleID);
		PersonInfoPo personInfoPo = (PersonInfoPo) session.get("person");
