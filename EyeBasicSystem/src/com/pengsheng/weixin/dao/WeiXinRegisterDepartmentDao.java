...
public interface WeiXinRegisterDepartmentDao {
	/**
	 * 获取微信用户注册部门总记录数
	 * @param po
	 * @return
	 ...
	 * @param po
	 */
	public List<WeiXinRegisterDepartmentPo> selectWeiXinRegisterDepartments(WeiXinRegisterDepartmentPo po, int start, int size);
