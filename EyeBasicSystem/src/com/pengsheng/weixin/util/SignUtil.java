...
public class SignUtil implements ApplicationContextAware{  
    ...
    // 与接口配置信息中的Token要一致  
    private static String token = "pengsheng";  
...
//    	ApplicationContext context = new ClassPathXmlApplicationContext(new String[]{"classpath:spring/*.xml","classpath:spring/weixin/*.xml"});
    	...
    	token = Utility.getName(configurationPo.getWcrtoken());
